...
import android.view.C0114ViewTreeOnBackPressedDispatcherOwner;
...
public final class LocalOnBackPressedDispatcherOwner {
    ...
    private static final ProvidableCompositionLocal<OnBackPressedDispatcherOwner> LocalOnBackPressedDispatcherOwner = CompositionLocalKt.compositionLocalOf$default(null, new a<OnBackPressedDispatcherOwner>() { // from class: androidx.activity.compose.LocalOnBackPressedDispatcherOwner$LocalOnBackPressedDispatcherOwner$1
        /* JADX INFO: renamed from: invoke, reason: merged with bridge method [inline-methods] */
        public final OnBackPressedDispatcherOwner m13invoke() {
            return null;
        }
    }, 1, null);
    ...
    public final OnBackPressedDispatcherOwner getCurrent(Composer composer, int i2) {
        ...
        if (onBackPressedDispatcherOwner == null) {
            onBackPressedDispatcherOwner = C0114ViewTreeOnBackPressedDispatcherOwner.get((View) composer.consume(AndroidCompositionLocals_androidKt.getLocalView()));
        }
    ...
    public final ProvidedValue<OnBackPressedDispatcherOwner> provides(OnBackPressedDispatcherOwner dispatcherOwner) {
        m.h(dispatcherOwner, "dispatcherOwner");
