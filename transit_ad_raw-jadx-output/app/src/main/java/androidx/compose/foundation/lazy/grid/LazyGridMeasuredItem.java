...
public final class LazyGridMeasuredItem {
    ...
    public /* synthetic */ LazyGridMeasuredItem(int i2, Object obj, boolean z, int i3, int i4, boolean z2, LayoutDirection layoutDirection, int i5, int i6, List list, LazyGridItemPlacementAnimator lazyGridItemPlacementAnimator, long j, DefaultConstructorMarker defaultConstructorMarker) {
        this(i2, obj, z, i3, i4, z2, layoutDirection, i5, i6, list, lazyGridItemPlacementAnimator, j);
    }
    ...
    public final LazyGridPositionedItem position(int mainAxisOffset, int crossAxisOffset, int layoutWidth, int layoutHeight, int row, int column) {
        ...
        int i3 = (z && this.layoutDirection == LayoutDirection.Rtl) ? ((z ? layoutWidth : layoutHeight) - crossAxisOffset) - this.crossAxisSize : crossAxisOffset;
        return new LazyGridPositionedItem(z ? IntOffsetKt.IntOffset(i3, mainAxisOffset) : IntOffsetKt.IntOffset(mainAxisOffset, i3), this.index, this.key, row, column, this.isVertical ? IntSizeKt.IntSize(this.crossAxisSize, this.mainAxisSize) : IntSizeKt.IntSize(this.mainAxisSize, this.crossAxisSize), -this.beforeContentPadding, i2 + this.afterContentPadding, this.isVertical, this.placeables, this.placementAnimator, this.visualOffset, i2, this.reverseLayout, null);
    }

    /* JADX WARN: Multi-variable type inference failed */
    private LazyGridMeasuredItem(int i2, Object obj, boolean z, int i3, int i4, boolean z2, LayoutDirection layoutDirection, int i5, int i6, List<? extends Placeable> list, LazyGridItemPlacementAnimator lazyGridItemPlacementAnimator, long j) {
        this.index = i2;
        this.key = obj;
        this.isVertical = z;
        ...
        int i8 = iMax + this.mainAxisSpacing;
