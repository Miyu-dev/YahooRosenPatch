...
public final class LazyMeasuredItemProvider {
    ...
    public final LazyMeasuredItem m588getAndMeasureZjPyQlc(int index) {
        return this.measuredItemFactory.mo574createItemHK0c1C0(index, this.itemProvider.getKey(index), this.measureScope.mo678measure0kLqBqw(index, this.childConstraints));
    }
    ...
    private LazyMeasuredItemProvider(long j, boolean z, LazyListItemProvider lazyListItemProvider, LazyLayoutMeasureScope lazyLayoutMeasureScope, MeasuredItemFactory measuredItemFactory) {
        ...
        this.childConstraints = ConstraintsKt.Constraints$default(0, z ? Constraints.m5235getMaxWidthimpl(j) : Integer.MAX_VALUE, 0, z ? Integer.MAX_VALUE : Constraints.m5234getMaxHeightimpl(j), 5, null);
    }
}
