...
public final /* data */ class SelectionHandleInfo {
    ...
    public static /* synthetic */ SelectionHandleInfo m931copyUv8p0NA$default(SelectionHandleInfo selectionHandleInfo, Handle handle, long j, int i2, Object obj) {
        if ((i2 & 1) != 0) {
        ...
        return selectionHandleInfo.m933copyUv8p0NA(handle, j);
    }
    ...
    public final SelectionHandleInfo m933copyUv8p0NA(Handle handle, long position) {
        m.h(handle, "handle");
    ...
    public boolean equals(Object other) {
        ...
        return this.handle == selectionHandleInfo.handle && Offset.m2582equalsimpl0(this.position, selectionHandleInfo.position);
    }
    ...
    public final long m934getPositionF1C5BW0() {
        return this.position;
    }

    public int hashCode() {
        return Offset.m2587hashCodeimpl(this.position) + (this.handle.hashCode() * 31);
    }

    public String toString() {
        return "SelectionHandleInfo(handle=" + this.handle + ", position=" + ((Object) Offset.m2593toStringimpl(this.position)) + ')';
    }
