...
public final class EmptyLazyStaggeredGridLayoutInfo implements LazyStaggeredGridLayoutInfo {
    ...
    private static final List<LazyStaggeredGridItemInfo> visibleItemsInfo = EmptyList.INSTANCE;
    private static final long viewportSize = IntSize.INSTANCE.m5432getZeroYbymL2g();
    ...
    public long mo688getViewportSizeYbymL2g() {
        return viewportSize;
    }
