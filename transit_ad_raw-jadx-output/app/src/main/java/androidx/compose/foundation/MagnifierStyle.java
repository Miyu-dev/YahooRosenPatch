...
public final class MagnifierStyle {
    ...
    public static final class Companion {
        ...
        public final boolean isStyleSupported$foundation_release(MagnifierStyle style, int sdkVersion) {
            ...
            if (MagnifierKt.isPlatformMagnifierSupported(sdkVersion) && !style.getFishEyeEnabled()) {
                return style.getUseTextDefault() || m.c(style, getDefault()) || sdkVersion >= 29;
            }
            return false;
        }
    ...
    public boolean equals(Object other) {
        ...
        return this.useTextDefault == magnifierStyle.useTextDefault && DpSize.m5362equalsimpl0(this.size, magnifierStyle.size) && Dp.m5272equalsimpl0(this.cornerRadius, magnifierStyle.cornerRadius) && Dp.m5272equalsimpl0(this.elevation, magnifierStyle.elevation) && this.clippingEnabled == magnifierStyle.clippingEnabled && this.fishEyeEnabled == magnifierStyle.fishEyeEnabled;
    }
    ...
    public int hashCode() {
        return ((androidx.browser.browseractions.a.a(this.elevation, androidx.browser.browseractions.a.a(this.cornerRadius, (DpSize.m5367hashCodeimpl(this.size) + ((this.useTextDefault ? 1231 : 1237) * 31)) * 31, 31), 31) + (this.clippingEnabled ? 1231 : 1237)) * 31) + (this.fishEyeEnabled ? 1231 : 1237);
    }
    ...
    public String toString() {
        ...
        sb.append((Object) DpSize.m5372toStringimpl(this.size));
        sb.append(", cornerRadius=");
        sb.append((Object) Dp.m5278toStringimpl(this.cornerRadius));
        sb.append(", elevation=");
        sb.append((Object) Dp.m5278toStringimpl(this.elevation));
        sb.append(", clippingEnabled=");
        sb.append(this.clippingEnabled);
        sb.append(", fishEyeEnabled=");
        return androidx.compose.animation.a.d(sb, this.fishEyeEnabled, ')');
    }
    ...
    public /* synthetic */ MagnifierStyle(long j, float f, float f2, boolean z, boolean z2, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this((i2 & 1) != 0 ? DpSize.INSTANCE.m5374getUnspecifiedMYxV2XQ() : j, (i2 & 2) != 0 ? Dp.INSTANCE.m5287getUnspecifiedD9Ej5fM() : f, (i2 & 4) != 0 ? Dp.INSTANCE.m5287getUnspecifiedD9Ej5fM() : f2, (i2 & 8) != 0 ? true : z, (i2 & 16) != 0 ? false : z2, (DefaultConstructorMarker) null);
    }
