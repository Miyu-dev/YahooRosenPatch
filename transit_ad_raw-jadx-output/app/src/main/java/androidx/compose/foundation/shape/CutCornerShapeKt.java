...
public final class CutCornerShapeKt {
    ...
    public static /* synthetic */ CutCornerShape CutCornerShape$default(float f, float f2, float f3, float f4, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            f = 0.0f;
        }
        if ((i2 & 2) != 0) {
    ...
    public static final CutCornerShape m774CutCornerShape0680j_4(float f) {
        return CutCornerShape(CornerSizeKt.m773CornerSize0680j_4(f));
    }

    /* JADX INFO: renamed from: CutCornerShape-a9UjIt4, reason: not valid java name */
    public static final CutCornerShape m775CutCornerShapea9UjIt4(float f, float f2, float f3, float f4) {
        return new CutCornerShape(CornerSizeKt.m773CornerSize0680j_4(f), CornerSizeKt.m773CornerSize0680j_4(f2), CornerSizeKt.m773CornerSize0680j_4(f3), CornerSizeKt.m773CornerSize0680j_4(f4));
    }

    /* JADX INFO: renamed from: CutCornerShape-a9UjIt4$default, reason: not valid java name */
    public static /* synthetic */ CutCornerShape m776CutCornerShapea9UjIt4$default(float f, float f2, float f3, float f4, int i2, Object obj) {
        if ((i2 & 1) != 0) {
        ...
        return m775CutCornerShapea9UjIt4(f, f2, f3, f4);
    }
