...
@Metadata(d1 = {"\u0000\u001c\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u001a\u001d\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u0003H\u0000ø\u0001\u0000ø\u0001\u0001¢\u0006\u0004\b\u0004\u0010\u0005\u001a\u0014\u0010\u0006\u001a\u00020\u0007*\u00020\u00072\u0006\u0010\b\u001a\u00020\tH\u0001\u0082\u0002\u000b\n\u0005\b¡\u001e0\u0001\n\u0002\b\u0019¨\u0006\n"}, d2 = {"isCopyKeyEvent", "", "keyEvent", "Landroidx/compose/ui/input/key/KeyEvent;", "isCopyKeyEvent-ZmokQxo", "(Landroid/view/KeyEvent;)Z", "selectionMagnifier", "Landroidx/compose/ui/Modifier;", "manager", "Landroidx/compose/foundation/text/selection/SelectionManager;", "foundation_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class SelectionManager_androidKt {
    /* JADX INFO: renamed from: isCopyKeyEvent-ZmokQxo, reason: not valid java name */
    public static final boolean m972isCopyKeyEventZmokQxo(KeyEvent keyEvent) {
        m.h(keyEvent, "keyEvent");
        return KeyMapping_androidKt.getPlatformDefaultKeyMapping().mo819mapZmokQxo(keyEvent) == KeyCommand.COPY;
    }
    ...
    public static final class AnonymousClass1 extends Lambda implements q<Modifier, Composer, Integer, Modifier> {
        ...
        public final Modifier invoke(Modifier modifier, Composer composer, int i2) {
            if (androidx.compose.animation.b.n(modifier, "$this$composed", composer, -1914520728)) {
                ComposerKt.traceEventStart(-1914520728, i2, -1, "androidx.compose.foundation.text.selection.selectionMagnifier.<anonymous> (SelectionManager.android.kt:47)");
            }
            ...
            kj.a<Offset> aVar = new kj.a<Offset>() { // from class: androidx.compose.foundation.text.selection.SelectionManager_androidKt.selectionMagnifier.1.1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(0);
                }
                ...
                public /* bridge */ /* synthetic */ Object invoke() {
                    return Offset.m2574boximpl(m973invokeF1C5BW0());
                }

                /* JADX INFO: renamed from: invoke-F1C5BW0, reason: not valid java name */
                public final long m973invokeF1C5BW0() {
                    return SelectionManagerKt.m970calculateSelectionMagnifierCenterAndroidO0kMr_c(selectionManager, AnonymousClass1.invoke$lambda$1(mutableState));
                }
            };
            ...
            if (zChanged || objRememberedValue2 == companion.getEmpty()) {
                objRememberedValue2 = new l<kj.a<? extends Offset>, Modifier>() { // from class: androidx.compose.foundation.text.selection.SelectionManager_androidKt$selectionMagnifier$1$2$1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(1);
                    }
                    ...
                    public final Modifier invoke(final kj.a<Offset> aVar2) {
                        ...
                        l<Density, Offset> lVar = new l<Density, Offset>() { // from class: androidx.compose.foundation.text.selection.SelectionManager_androidKt$selectionMagnifier$1$2$1.1
                            ...
                            public /* bridge */ /* synthetic */ Object invoke(Object obj) {
                                return Offset.m2574boximpl(m974invoketuRUvjQ((Density) obj));
                            }

                            /* JADX INFO: renamed from: invoke-tuRUvjQ, reason: not valid java name */
                            public final long m974invoketuRUvjQ(Density density2) {
                        ...
                        return MagnifierKt.magnifier$default(companion2, lVar, null, 0.0f, textDefault, new l<DpSize, j>() { // from class: androidx.compose.foundation.text.selection.SelectionManager_androidKt$selectionMagnifier$1$2$1.2
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            {
                                super(1);
                            }
                            ...
                            public /* bridge */ /* synthetic */ Object invoke(Object obj) {
                                m975invokeEaSLcWc(((DpSize) obj).getPackedValue());
                                return j.a;
                            }

                            /* JADX INFO: renamed from: invoke-EaSLcWc, reason: not valid java name */
                            public final void m975invokeEaSLcWc(long j) {
                                MutableState<IntSize> mutableState3 = mutableState2;
                                Density density3 = density2;
                                SelectionManager_androidKt.AnonymousClass1.invoke$lambda$2(mutableState3, IntSizeKt.IntSize(density3.mo342roundToPx0680j_4(DpSize.m5365getWidthD9Ej5fM(j)), density3.mo342roundToPx0680j_4(DpSize.m5363getHeightD9Ej5fM(j))));
                            }
                        }, 6, null);
                    }
                };
