...
public final class FlowResult {
    ...
    public FlowResult(int i2, int i3, MutableVector<RowColumnMeasureHelperResult> mutableVector) {
        kotlin.jvm.internal.m.h(mutableVector, "items");
