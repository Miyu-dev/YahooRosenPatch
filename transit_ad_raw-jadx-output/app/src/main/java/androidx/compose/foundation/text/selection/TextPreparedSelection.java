...
public final class TextPreparedSelection extends BaseTextPreparedSelection<TextPreparedSelection> {
    ...
    public /* synthetic */ TextPreparedSelection(AnnotatedString annotatedString, long j, TextLayoutResult textLayoutResult, OffsetMapping offsetMapping, TextPreparedSelectionState textPreparedSelectionState, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(annotatedString, j, (i2 & 4) != 0 ? null : textLayoutResult, (i2 & 8) != 0 ? OffsetMapping.INSTANCE.getIdentity() : offsetMapping, (i2 & 16) != 0 ? new TextPreparedSelectionState() : textPreparedSelectionState, null);
    }
