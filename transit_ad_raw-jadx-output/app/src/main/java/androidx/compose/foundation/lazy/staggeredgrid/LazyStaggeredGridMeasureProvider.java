...
final class LazyStaggeredGridMeasureProvider {
    ...
    public LazyStaggeredGridMeasureProvider(boolean z, LazyLayoutItemProvider lazyLayoutItemProvider, LazyLayoutMeasureScope lazyLayoutMeasureScope, int[] iArr, int i2, MeasuredItemFactory measuredItemFactory) {
    ...
    private final long m714childConstraintsJhjzzOo(int slot, int span) {
        int i2 = ((span - 1) * this.crossAxisSpacing) + (this.resolvedSlotSums[(slot + span) - 1] - (slot == 0 ? 0 : this.resolvedSlotSums[slot - 1]));
    ...
    public final LazyStaggeredGridMeasuredItem m715getAndMeasurejy6DScQ(int index, long span) {
        int i2 = (int) (span >> 32);
        int i3 = ((int) (span & 4294967295L)) - i2;
        return this.measuredItemFactory.createItem(index, i2, i3, this.itemProvider.getKey(index), this.measureScope.mo678measure0kLqBqw(index, m714childConstraintsJhjzzOo(i2, i3)));
    }
}
