...
final /* data */ class BoxWithConstraintsScopeImpl implements BoxWithConstraintsScope, BoxScope {
    ...
    public static /* synthetic */ BoxWithConstraintsScopeImpl m437copy0kLqBqw$default(BoxWithConstraintsScopeImpl boxWithConstraintsScopeImpl, Density density, long j, int i2, Object obj) {
        if ((i2 & 1) != 0) {
        ...
        return boxWithConstraintsScopeImpl.m439copy0kLqBqw(density, j);
    }
    ...
    public final long m438component2msEJaDk() {
        return getConstraints();
    }

    /* JADX INFO: renamed from: copy-0kLqBqw, reason: not valid java name */
    public final BoxWithConstraintsScopeImpl m439copy0kLqBqw(Density density, long constraints) {
    ...
    public boolean equals(Object other) {
        ...
        return kotlin.jvm.internal.m.c(this.density, boxWithConstraintsScopeImpl.density) && Constraints.m5228equalsimpl0(getConstraints(), boxWithConstraintsScopeImpl.getConstraints());
    }
    ...
    public float mo433getMaxHeightD9Ej5fM() {
        return Constraints.m5230getHasBoundedHeightimpl(getConstraints()) ? this.density.mo345toDpu2uoSUM(Constraints.m5234getMaxHeightimpl(getConstraints())) : Dp.INSTANCE.m5286getInfinityD9Ej5fM();
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* JADX INFO: renamed from: getMaxWidth-D9Ej5fM */
    public float mo434getMaxWidthD9Ej5fM() {
        return Constraints.m5231getHasBoundedWidthimpl(getConstraints()) ? this.density.mo345toDpu2uoSUM(Constraints.m5235getMaxWidthimpl(getConstraints())) : Dp.INSTANCE.m5286getInfinityD9Ej5fM();
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* JADX INFO: renamed from: getMinHeight-D9Ej5fM */
    public float mo435getMinHeightD9Ej5fM() {
        return this.density.mo345toDpu2uoSUM(Constraints.m5236getMinHeightimpl(getConstraints()));
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* JADX INFO: renamed from: getMinWidth-D9Ej5fM */
    public float mo436getMinWidthD9Ej5fM() {
        return this.density.mo345toDpu2uoSUM(Constraints.m5237getMinWidthimpl(getConstraints()));
    }

    public int hashCode() {
        return Constraints.m5238hashCodeimpl(getConstraints()) + (this.density.hashCode() * 31);
    }
    ...
    public String toString() {
        return "BoxWithConstraintsScopeImpl(density=" + this.density + ", constraints=" + ((Object) Constraints.m5240toStringimpl(getConstraints())) + ')';
    }
