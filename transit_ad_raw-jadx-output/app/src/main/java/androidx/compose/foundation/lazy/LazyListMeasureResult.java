...
public final class LazyListMeasureResult implements LazyListLayoutInfo, MeasureResult {
    ...
    public LazyListMeasureResult(LazyMeasuredItem lazyMeasuredItem, int i2, boolean z, float f, MeasureResult measureResult, List<? extends LazyListItemInfo> list, int i3, int i4, int i5, boolean z2, Orientation orientation, int i6, int i7) {
    ...
    public long mo561getViewportSizeYbymL2g() {
