...
final /* data */ class DpCornerSize implements CornerSize, InspectableValue {
    ...
    public static /* synthetic */ DpCornerSize m778copy0680j_4$default(DpCornerSize dpCornerSize, float f, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            f = dpCornerSize.size;
        }
        return dpCornerSize.m779copy0680j_4(f);
    }

    /* JADX INFO: renamed from: copy-0680j_4, reason: not valid java name */
    public final DpCornerSize m779copy0680j_4(float size) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof DpCornerSize) && Dp.m5272equalsimpl0(this.size, ((DpCornerSize) other).size);
    }
    ...
    public /* bridge */ /* synthetic */ Object getValueOverride() {
        return Dp.m5265boximpl(m780getValueOverrideD9Ej5fM());
    }

    /* JADX INFO: renamed from: getValueOverride-D9Ej5fM, reason: not valid java name */
    public float m780getValueOverrideD9Ej5fM() {
        return this.size;
    }

    public int hashCode() {
        return Dp.m5273hashCodeimpl(this.size);
    }

    @Override // androidx.compose.foundation.shape.CornerSize
    /* JADX INFO: renamed from: toPx-TmRCtEA */
    public float mo772toPxTmRCtEA(long shapeSize, Density density) {
        m.h(density, "density");
        return density.mo348toPx0680j_4(this.size);
    }
