...
final class DerivedHeightModifier extends InspectorValueInfo implements LayoutModifier, ModifierLocalConsumer {
    ...
    public DerivedHeightModifier(WindowInsets windowInsets, kj.l<? super InspectorInfo, kotlin.j> lVar, p<? super WindowInsets, ? super Density, Integer> pVar) {
        super(lVar);
        kotlin.jvm.internal.m.h(windowInsets, "insets");
        kotlin.jvm.internal.m.h(lVar, "inspectorInfo");
        kotlin.jvm.internal.m.h(pVar, "heightCalc");
    ...
    public boolean equals(Object other) {
        ...
        return kotlin.jvm.internal.m.c(this.insets, derivedHeightModifier.insets) && kotlin.jvm.internal.m.c(this.heightCalc, derivedHeightModifier.heightCalc);
    }
    ...
    public MeasureResult mo47measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        if (iIntValue == 0) {
            return MeasureScope.CC.p(measureScope, 0, 0, null, new kj.l<Placeable.PlacementScope, kotlin.j>() { // from class: androidx.compose.foundation.layout.DerivedHeightModifier$measure$1
        ...
        final Placeable placeableMo4235measureBRTryo0 = measurable.mo4235measureBRTryo0(Constraints.m5226copyZbe2FdA$default(j, 0, 0, iIntValue, iIntValue, 3, null));
        return MeasureScope.CC.p(measureScope, placeableMo4235measureBRTryo0.getWidth(), iIntValue, null, new kj.l<Placeable.PlacementScope, kotlin.j>() { // from class: androidx.compose.foundation.layout.DerivedHeightModifier$measure$2
            {
                super(1);
            }
