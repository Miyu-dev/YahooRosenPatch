...
public final class CutCornerShape extends CornerBasedShape {
    ...
    public Outline mo764createOutlineLjSzlW0(long size, float topStart, float topEnd, float bottomEnd, float bottomStart, LayoutDirection layoutDirection) {
        ...
        Path.lineTo(Size.m2654getWidthimpl(size) - topStart, 0.0f);
        Path.lineTo(Size.m2654getWidthimpl(size), topStart);
        float f2 = layoutDirection == layoutDirection2 ? bottomEnd : bottomStart;
        Path.lineTo(Size.m2654getWidthimpl(size), Size.m2651getHeightimpl(size) - f2);
        Path.lineTo(Size.m2654getWidthimpl(size) - f2, Size.m2651getHeightimpl(size));
        if (layoutDirection == layoutDirection2) {
            bottomEnd = bottomStart;
        }
        Path.lineTo(bottomEnd, Size.m2651getHeightimpl(size));
        Path.lineTo(0.0f, Size.m2651getHeightimpl(size) - bottomEnd);
        Path.close();
    ...
    public boolean equals(Object other) {
        ...
        return m.c(getTopStart(), cutCornerShape.getTopStart()) && m.c(getTopEnd(), cutCornerShape.getTopEnd()) && m.c(getBottomEnd(), cutCornerShape.getBottomEnd()) && m.c(getBottomStart(), cutCornerShape.getBottomStart());
    }
