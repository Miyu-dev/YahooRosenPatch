...
public final class RoundedCornerShapeKt {
    ...
    public static /* synthetic */ RoundedCornerShape RoundedCornerShape$default(float f, float f2, float f3, float f4, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            f = 0.0f;
        }
        if ((i2 & 2) != 0) {
    ...
    public static final RoundedCornerShape m781RoundedCornerShape0680j_4(float f) {
        return RoundedCornerShape(CornerSizeKt.m773CornerSize0680j_4(f));
    }

    /* JADX INFO: renamed from: RoundedCornerShape-a9UjIt4, reason: not valid java name */
    public static final RoundedCornerShape m782RoundedCornerShapea9UjIt4(float f, float f2, float f3, float f4) {
        return new RoundedCornerShape(CornerSizeKt.m773CornerSize0680j_4(f), CornerSizeKt.m773CornerSize0680j_4(f2), CornerSizeKt.m773CornerSize0680j_4(f3), CornerSizeKt.m773CornerSize0680j_4(f4));
    }

    /* JADX INFO: renamed from: RoundedCornerShape-a9UjIt4$default, reason: not valid java name */
    public static /* synthetic */ RoundedCornerShape m783RoundedCornerShapea9UjIt4$default(float f, float f2, float f3, float f4, int i2, Object obj) {
        if ((i2 & 1) != 0) {
        ...
        return m782RoundedCornerShapea9UjIt4(f, f2, f3, f4);
    }
