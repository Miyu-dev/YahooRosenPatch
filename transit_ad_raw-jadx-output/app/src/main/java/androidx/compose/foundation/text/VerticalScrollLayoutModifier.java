...
final /* data */ class VerticalScrollLayoutModifier implements LayoutModifier {
    ...
    public VerticalScrollLayoutModifier(TextFieldScrollerPosition textFieldScrollerPosition, int i2, TransformedText transformedText, a<TextLayoutResultProxy> aVar) {
    ...
    public static /* synthetic */ VerticalScrollLayoutModifier copy$default(VerticalScrollLayoutModifier verticalScrollLayoutModifier, TextFieldScrollerPosition textFieldScrollerPosition, int i2, TransformedText transformedText, a aVar, int i3, Object obj) {
        if ((i3 & 1) != 0) {
        ...
        return verticalScrollLayoutModifier.copy(textFieldScrollerPosition, i2, transformedText, aVar);
    }
    ...
    public final VerticalScrollLayoutModifier copy(TextFieldScrollerPosition textFieldScrollerPosition, int i2, TransformedText transformedText, a<TextLayoutResultProxy> aVar) {
        m.h(textFieldScrollerPosition, "scrollerPosition");
        m.h(transformedText, "transformedText");
        m.h(aVar, "textLayoutResultProvider");
        return new VerticalScrollLayoutModifier(textFieldScrollerPosition, i2, transformedText, aVar);
    }
    ...
    public boolean equals(Object other) {
        ...
        return m.c(this.scrollerPosition, verticalScrollLayoutModifier.scrollerPosition) && this.cursorOffset == verticalScrollLayoutModifier.cursorOffset && m.c(this.transformedText, verticalScrollLayoutModifier.transformedText) && m.c(this.textLayoutResultProvider, verticalScrollLayoutModifier.textLayoutResultProvider);
    }
    ...
    public MeasureResult mo47measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        ...
        final Placeable placeableMo4235measureBRTryo0 = measurable.mo4235measureBRTryo0(Constraints.m5226copyZbe2FdA$default(j, 0, 0, 0, Integer.MAX_VALUE, 7, null));
        final int iMin = Math.min(placeableMo4235measureBRTryo0.getHeight(), Constraints.m5234getMaxHeightimpl(j));
        return MeasureScope.CC.p(measureScope, placeableMo4235measureBRTryo0.getWidth(), iMin, null, new l<Placeable.PlacementScope, j>() { // from class: androidx.compose.foundation.text.VerticalScrollLayoutModifier$measure$1
            ...
            public final void invoke(Placeable.PlacementScope placementScope) {
                ...
                this.getScrollerPosition().update(Orientation.Vertical, TextFieldScrollKt.getCursorRectInScroller(measureScope2, cursorOffset, transformedText, textLayoutResultProxy != null ? textLayoutResultProxy.getValue() : null, false, placeableMo4235measureBRTryo0.getWidth()), iMin, placeableMo4235measureBRTryo0.getHeight());
                Placeable.PlacementScope.placeRelative$default(placementScope, placeableMo4235measureBRTryo0, 0, f.f0(-this.getScrollerPosition().getOffset()), 0.0f, 4, null);
            }
        }, 4, null);
    }
