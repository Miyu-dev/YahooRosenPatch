...
public final class SelectionHandlesKt {
    ...
    static {
        float f = 25;
        HandleWidth = Dp.m5267constructorimpl(f);
        HandleHeight = Dp.m5267constructorimpl(f);
    }

    /* JADX INFO: renamed from: getAdjustedCoordinates-k-4lQ0M, reason: not valid java name */
    public static final long m935getAdjustedCoordinatesk4lQ0M(long j) {
        return OffsetKt.Offset(Offset.m2585getXimpl(j), Offset.m2586getYimpl(j) - 1.0f);
    }
