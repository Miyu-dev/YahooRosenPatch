...
public interface Selectable {
    ...
    long mo917getHandlePositiondBAh8RU(Selection selection, boolean isStartHandle);
    ...
    long mo918getRangeOfLineContainingjx7JFs(int offset);
    ...
    Pair<Selection, Boolean> mo919updateSelectionqCDeeow(long startHandlePosition, long endHandlePosition, Offset previousHandlePosition, boolean isStartHandle, LayoutCoordinates containerLayoutCoordinates, SelectionAdjustment adjustment, Selection previousSelection);
}
