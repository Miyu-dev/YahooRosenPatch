...
public final class TextLayoutResultProxy {
    ...
    */
    private final long m900coercedInVisibleBoundsOfInputTextMKHz9U(long r6) {
        /*
            r5 = this;
        ...
        L1e:
            ...
            androidx.compose.ui.geometry.Rect r2 = r0.getZero()
        L24:
            long r6 = androidx.compose.foundation.text.TextLayoutResultProxyKt.m905access$coerceIn3MmeM6k(r6, r2)
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.TextLayoutResultProxy.m900coercedInVisibleBoundsOfInputTextMKHz9U(long):long");
    }
    ...
    public static /* synthetic */ int m901getOffsetForPosition3MmeM6k$default(TextLayoutResultProxy textLayoutResultProxy, long j, boolean z, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            z = true;
        }
        return textLayoutResultProxy.m903getOffsetForPosition3MmeM6k(j, z);
    }

    /* JADX INFO: renamed from: relativeToInputText-MK-Hz9U, reason: not valid java name */
    private final long m902relativeToInputTextMKHz9U(long j) {
        Offset offsetM2574boximpl;
        ...
        if (layoutCoordinates2 != null) {
            offsetM2574boximpl = Offset.m2574boximpl((layoutCoordinates.isAttached() && layoutCoordinates2.isAttached()) ? layoutCoordinates.mo4240localPositionOfR5De75A(layoutCoordinates2, j) : j);
        } else {
            offsetM2574boximpl = null;
        }
        return offsetM2574boximpl != null ? offsetM2574boximpl.getPackedValue() : j;
    }
    ...
    public final int getLineForVerticalPosition(float vertical) {
        return this.value.getLineForVerticalPosition(Offset.m2586getYimpl(m902relativeToInputTextMKHz9U(m900coercedInVisibleBoundsOfInputTextMKHz9U(OffsetKt.Offset(0.0f, vertical)))));
    }

    /* JADX INFO: renamed from: getOffsetForPosition-3MmeM6k, reason: not valid java name */
    public final int m903getOffsetForPosition3MmeM6k(long position, boolean coerceInVisibleBounds) {
        if (coerceInVisibleBounds) {
            position = m900coercedInVisibleBoundsOfInputTextMKHz9U(position);
        }
        return this.value.m4783getOffsetForPositionk4lQ0M(m902relativeToInputTextMKHz9U(position));
    }
    ...
    public final boolean m904isPositionOnTextk4lQ0M(long offset) {
        long jM902relativeToInputTextMKHz9U = m902relativeToInputTextMKHz9U(m900coercedInVisibleBoundsOfInputTextMKHz9U(offset));
        int lineForVerticalPosition = this.value.getLineForVerticalPosition(Offset.m2586getYimpl(jM902relativeToInputTextMKHz9U));
        return Offset.m2585getXimpl(jM902relativeToInputTextMKHz9U) >= this.value.getLineLeft(lineForVerticalPosition) && Offset.m2585getXimpl(jM902relativeToInputTextMKHz9U) <= this.value.getLineRight(lineForVerticalPosition);
    }
