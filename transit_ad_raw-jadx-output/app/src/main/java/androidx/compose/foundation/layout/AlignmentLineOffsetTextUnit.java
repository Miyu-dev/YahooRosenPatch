...
final class AlignmentLineOffsetTextUnit extends InspectorValueInfo implements LayoutModifier {
    ...
    public boolean equals(Object other) {
        ...
        return kotlin.jvm.internal.m.c(this.alignmentLine, alignmentLineOffsetTextUnit.alignmentLine) && TextUnit.m5445equalsimpl0(this.before, alignmentLineOffsetTextUnit.before) && TextUnit.m5445equalsimpl0(this.after, alignmentLineOffsetTextUnit.after);
    }
    ...
    public int hashCode() {
        return TextUnit.m5449hashCodeimpl(this.after) + ((TextUnit.m5449hashCodeimpl(this.before) + (this.alignmentLine.hashCode() * 31)) * 31);
    }
    ...
    public MeasureResult mo47measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        return AlignmentLineKt.m385alignmentLineOffsetMeasuretjqqzMA(measureScope, this.alignmentLine, !TextUnitKt.m5466isUnspecifiedR2X_6o(this.before) ? measureScope.mo343toDpGaN1DYA(this.before) : Dp.INSTANCE.m5287getUnspecifiedD9Ej5fM(), !TextUnitKt.m5466isUnspecifiedR2X_6o(this.after) ? measureScope.mo343toDpGaN1DYA(this.after) : Dp.INSTANCE.m5287getUnspecifiedD9Ej5fM(), measurable, j);
    }
    ...
    public String toString() {
        return "AlignmentLineOffset(alignmentLine=" + this.alignmentLine + ", before=" + ((Object) TextUnit.m5455toStringimpl(this.before)) + ", after=" + ((Object) TextUnit.m5455toStringimpl(this.after)) + ')';
    }

    private AlignmentLineOffsetTextUnit(AlignmentLine alignmentLine, long j, long j2, kj.l<? super InspectorInfo, kotlin.j> lVar) {
        super(lVar);
