...
public final class BorderStroke {
    ...
    public static /* synthetic */ BorderStroke m198copyD5KLDUw$default(BorderStroke borderStroke, float f, Brush brush, int i2, Object obj) {
        if ((i2 & 1) != 0) {
        ...
        return borderStroke.m199copyD5KLDUw(f, brush);
    }

    /* JADX INFO: renamed from: copy-D5KLDUw, reason: not valid java name */
    public final BorderStroke m199copyD5KLDUw(float width, Brush brush) {
        m.h(brush, "brush");
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m5272equalsimpl0(this.width, borderStroke.width) && m.c(this.brush, borderStroke.brush);
    }
    ...
    public int hashCode() {
        return this.brush.hashCode() + (Dp.m5273hashCodeimpl(this.width) * 31);
    }

    public String toString() {
        return "BorderStroke(width=" + ((Object) Dp.m5278toStringimpl(this.width)) + ", brush=" + this.brush + ')';
    }
