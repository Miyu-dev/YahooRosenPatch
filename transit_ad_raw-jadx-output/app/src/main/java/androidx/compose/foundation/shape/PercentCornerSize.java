...
final /* data */ class PercentCornerSize implements CornerSize, InspectableValue {
    ...
    public float mo772toPxTmRCtEA(long shapeSize, Density density) {
        m.h(density, "density");
        return (this.percent / 100.0f) * Size.m2653getMinDimensionimpl(shapeSize);
    }
    ...
    public String getValueOverride() {
        return a6.h.g(new StringBuilder(), this.percent, '%');
    }
}
