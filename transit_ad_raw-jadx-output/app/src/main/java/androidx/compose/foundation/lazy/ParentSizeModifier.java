...
@Metadata(d1 = {"\u0000V\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u0007\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0006\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0002\u0018\u00002\u00020\u00012\u00020\u0002BG\u0012\u0006\u0010\u0013\u001a\u00020\u0012\u0012\u0012\u0010!\u001a\u000e\u0012\u0004\u0012\u00020\u001f\u0012\u0004\u0012\u00020 0\u001e\u0012\u0010\b\u0002\u0010\u0018\u001a\n\u0012\u0004\u0012\u00020\u0010\u0018\u00010\u0017\u0012\u0010\b\u0002\u0010\u001c\u001a\n\u0012\u0004\u0012\u00020\u0010\u0018\u00010\u0017¢\u0006\u0004\b\"\u0010#J)\u0010\u000b\u001a\u00020\b*\u00020\u00032\u0006\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0007\u001a\u00020\u0006H\u0016ø\u0001\u0000ø\u0001\u0001¢\u0006\u0004\b\t\u0010\nJ\u0013\u0010\u000f\u001a\u00020\u000e2\b\u0010\r\u001a\u0004\u0018\u00010\fH\u0096\u0002J\b\u0010\u0011\u001a\u00020\u0010H\u0016R\u0017\u0010\u0013\u001a\u00020\u00128\u0006¢\u0006\f\n\u0004\b\u0013\u0010\u0014\u001a\u0004\b\u0015\u0010\u0016R\u001f\u0010\u0018\u001a\n\u0012\u0004\u0012\u00020\u0010\u0018\u00010\u00178\u0006¢\u0006\f\n\u0004\b\u0018\u0010\u0019\u001a\u0004\b\u001a\u0010\u001bR\u001f\u0010\u001c\u001a\n\u0012\u0004\u0012\u00020\u0010\u0018\u00010\u00178\u0006¢\u0006\f\n\u0004\b\u001c\u0010\u0019\u001a\u0004\b\u001d\u0010\u001b\u0082\u0002\u000b\n\u0005\b¡\u001e0\u0001\n\u0002\b\u0019¨\u0006$"}, d2 = {"Landroidx/compose/foundation/lazy/ParentSizeModifier;", "Landroidx/compose/ui/layout/LayoutModifier;", "Landroidx/compose/ui/platform/InspectorValueInfo;", "Landroidx/compose/ui/layout/MeasureScope;", "Landroidx/compose/ui/layout/Measurable;", "measurable", "Landroidx/compose/ui/unit/Constraints;", "constraints", "Landroidx/compose/ui/layout/MeasureResult;", "measure-3p2s80s", "(Landroidx/compose/ui/layout/MeasureScope;Landroidx/compose/ui/layout/Measurable;J)Landroidx/compose/ui/layout/MeasureResult;", "measure", "", "other", "", "equals", "", "hashCode", "", "fraction", "F", "getFraction", "()F", "Landroidx/compose/runtime/State;", "widthState", "Landroidx/compose/runtime/State;", "getWidthState", "()Landroidx/compose/runtime/State;", "heightState", "getHeightState", "Lkotlin/Function1;", "Landroidx/compose/ui/platform/InspectorInfo;", "Lkotlin/j;", "inspectorInfo", "<init>", "(FLkj/l;Landroidx/compose/runtime/State;Landroidx/compose/runtime/State;)V", "foundation_release"}, k = 1, mv = {1, 8, 0})
final class ParentSizeModifier extends InspectorValueInfo implements LayoutModifier {
    ...
    public /* synthetic */ ParentSizeModifier(float f, l lVar, State state, State state2, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(f, lVar, (i2 & 4) != 0 ? null : state, (i2 & 8) != 0 ? null : state2);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (m.c(this.widthState, parentSizeModifier.widthState) && m.c(this.heightState, parentSizeModifier.heightState)) {
    ...
    public MeasureResult mo47measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        State<Integer> state = this.widthState;
        int iF0 = (state == null || state.getValue().intValue() == Integer.MAX_VALUE) ? Integer.MAX_VALUE : f.f0(this.widthState.getValue().floatValue() * this.fraction);
        State<Integer> state2 = this.heightState;
        int iF02 = (state2 == null || state2.getValue().intValue() == Integer.MAX_VALUE) ? Integer.MAX_VALUE : f.f0(this.heightState.getValue().floatValue() * this.fraction);
        int iM5237getMinWidthimpl = iF0 != Integer.MAX_VALUE ? iF0 : Constraints.m5237getMinWidthimpl(j);
        int iM5236getMinHeightimpl = iF02 != Integer.MAX_VALUE ? iF02 : Constraints.m5236getMinHeightimpl(j);
        if (iF0 == Integer.MAX_VALUE) {
            iF0 = Constraints.m5235getMaxWidthimpl(j);
        }
        if (iF02 == Integer.MAX_VALUE) {
            iF02 = Constraints.m5234getMaxHeightimpl(j);
        }
        final Placeable placeableMo4235measureBRTryo0 = measurable.mo4235measureBRTryo0(ConstraintsKt.Constraints(iM5237getMinWidthimpl, iF0, iM5236getMinHeightimpl, iF02));
        return MeasureScope.CC.p(measureScope, placeableMo4235measureBRTryo0.getWidth(), placeableMo4235measureBRTryo0.getHeight(), null, new l<Placeable.PlacementScope, j>() { // from class: androidx.compose.foundation.lazy.ParentSizeModifier$measure$1
            {
                super(1);
            }
    ...
    public ParentSizeModifier(float f, l<? super InspectorInfo, j> lVar, State<Integer> state, State<Integer> state2) {
        super(lVar);
