...
final class PlaceableInfo {
    ...
    public final void setMainAxisSize(int i2) {
        this.mainAxisSize = i2;
    }

    /* JADX INFO: renamed from: setTargetOffset--gyyYBs, reason: not valid java name */
    public final void m591setTargetOffsetgyyYBs(long j) {
        this.targetOffset = j;
    }

    private PlaceableInfo(long j, int i2) {
        this.mainAxisSize = i2;
        this.animatedOffset = new Animatable<>(IntOffset.m5376boximpl(j), VectorConvertersKt.getVectorConverter(IntOffset.INSTANCE), null, 4, null);
        this.targetOffset = j;
