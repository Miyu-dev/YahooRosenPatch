...
public final class SnapshotContextElementImpl implements SnapshotContextElement, ThreadContextElement<Snapshot> {
    ...
    public Snapshot m2433updateThreadContext(e context) {
        m.h(context, "context");
