...
public final class SmallPersistentVector<E> extends AbstractPersistentList<E> implements ImmutableList<E> {
    ...
    public int indexOf(Object element) {
        return p.J0(this.buffer, element);
    }
    ...
    public PersistentList<E> removeAt(int index) {
        ...
        n.o0(this.buffer, objArrCopyOf, index, index + 1, size());
    ...
    public PersistentList<E> removeAll(l<? super E, Boolean> lVar) {
        ...
        return size == size() ? this : size == 0 ? EMPTY : new SmallPersistentVector(n.u0(objArrCopyOf, 0, size));
    }
    ...
    public PersistentList<E> add(int index, E element) {
        ...
        if (size() < 32) {
            ...
            n.r0(this.buffer, objArrBufferOfSize, 0, 0, index, 6);
            n.o0(this.buffer, objArrBufferOfSize, index + 1, index, size());
        ...
        Object[] objArrCopyOf = Arrays.copyOf(objArr, objArr.length);
        m.g(objArrCopyOf, "copyOf(this, size)");
        n.o0(this.buffer, objArrCopyOf, index + 1, index, size() - 1);
        objArrCopyOf[index] = element;
    ...
    public PersistentList<E> addAll(int index, Collection<? extends E> c2) {
        ...
        if (c2.size() + size() <= 32) {
            ...
            n.r0(this.buffer, objArrBufferOfSize, 0, 0, index, 6);
            n.o0(this.buffer, objArrBufferOfSize, c2.size() + index, index, size());
