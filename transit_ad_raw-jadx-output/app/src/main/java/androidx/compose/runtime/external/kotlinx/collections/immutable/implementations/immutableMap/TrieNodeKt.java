...
public final class TrieNodeKt {
    ...
    public static final <K, V> Object[] insertEntryAtIndex(Object[] objArr, int i2, K k, V v) {
        Object[] objArr2 = new Object[objArr.length + 2];
        n.r0(objArr, objArr2, 0, 0, i2, 6);
        n.o0(objArr, objArr2, i2 + 2, i2, objArr.length);
        objArr2[i2] = k;
        objArr2[i2 + 1] = v;
        return objArr2;
    }
    ...
    public static final Object[] removeEntryAtIndex(Object[] objArr, int i2) {
        Object[] objArr2 = new Object[objArr.length - 2];
        n.r0(objArr, objArr2, 0, 0, i2, 6);
        n.o0(objArr, objArr2, i2, i2 + 2, objArr.length);
        return objArr2;
    }
    ...
    public static final Object[] replaceEntryWithNode(Object[] objArr, int i2, int i3, TrieNode<?, ?> trieNode) {
        ...
        n.r0(objArr, objArr2, 0, 0, i2, 6);
        n.o0(objArr, objArr2, i2, i2 + 2, i3);
        objArr2[i4] = trieNode;
        n.o0(objArr, objArr2, i4 + 1, i3, objArr.length);
        return objArr2;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final <K, V> Object[] replaceNodeWithEntry(Object[] objArr, int i2, int i3, K k, V v) {
        Object[] objArrCopyOf = Arrays.copyOf(objArr, objArr.length + 1);
        m.g(objArrCopyOf, "copyOf(this, newSize)");
        n.o0(objArrCopyOf, objArrCopyOf, i2 + 2, i2 + 1, objArr.length);
        n.o0(objArrCopyOf, objArrCopyOf, i3 + 2, i3, i2);
        objArrCopyOf[i3] = k;
        objArrCopyOf[i3 + 1] = v;
        return objArrCopyOf;
    }
