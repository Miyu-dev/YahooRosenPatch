...
public class PersistentOrderedMapBuilderLinksIterator<K, V> implements Iterator<LinkedValue<V>>, a {
    ...
    public void remove() {
        ...
        v.c(persistentOrderedMapBuilder);
