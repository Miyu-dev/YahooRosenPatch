...
public final /* data */ class TypefaceRequest {
    ...
    public static /* synthetic */ TypefaceRequest m4934copye1PVR60$default(TypefaceRequest typefaceRequest, FontFamily fontFamily, FontWeight fontWeight, int i2, int i3, Object obj, int i4, Object obj2) {
        if ((i4 & 1) != 0) {
        ...
        return typefaceRequest.m4937copye1PVR60(fontFamily, fontWeight2, i5, i6, obj);
    }
    ...
    public final TypefaceRequest m4937copye1PVR60(FontFamily fontFamily, FontWeight fontWeight, int fontStyle, int fontSynthesis, Object resourceLoaderCacheKey) {
    ...
    public boolean equals(Object other) {
        ...
        return m.c(this.fontFamily, typefaceRequest.fontFamily) && m.c(this.fontWeight, typefaceRequest.fontWeight) && FontStyle.m4897equalsimpl0(this.fontStyle, typefaceRequest.fontStyle) && FontSynthesis.m4906equalsimpl0(this.fontSynthesis, typefaceRequest.fontSynthesis) && m.c(this.resourceLoaderCacheKey, typefaceRequest.resourceLoaderCacheKey);
    }
    ...
    public final int m4938getFontStyle_LCdwA() {
        return this.fontStyle;
    }

    /* JADX INFO: renamed from: getFontSynthesis-GVVA2EU, reason: not valid java name */
    public final int m4939getFontSynthesisGVVA2EU() {
        return this.fontSynthesis;
    }
    ...
    public int hashCode() {
        ...
        int iM4907hashCodeimpl = (FontSynthesis.m4907hashCodeimpl(this.fontSynthesis) + ((FontStyle.m4898hashCodeimpl(this.fontStyle) + ((this.fontWeight.hashCode() + ((fontFamily == null ? 0 : fontFamily.hashCode()) * 31)) * 31)) * 31)) * 31;
        Object obj = this.resourceLoaderCacheKey;
        return iM4907hashCodeimpl + (obj != null ? obj.hashCode() : 0);
    }
    ...
    public String toString() {
        ...
        sb.append(", fontStyle=");
        sb.append((Object) FontStyle.m4899toStringimpl(this.fontStyle));
        sb.append(", fontSynthesis=");
        sb.append((Object) FontSynthesis.m4910toStringimpl(this.fontSynthesis));
        sb.append(", resourceLoaderCacheKey=");
        return android.support.v4.media.a.h(sb, this.resourceLoaderCacheKey, ')');
    }
