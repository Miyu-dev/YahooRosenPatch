...
public final class SweepGradient extends ShaderBrush {
    ...
    public Shader mo2793createShaderuvyYCjk(long size) {
        ...
        if (OffsetKt.m2606isUnspecifiedk4lQ0M(this.center)) {
            jOffset = SizeKt.m2664getCenteruvyYCjk(size);
        } else {
            jOffset = OffsetKt.Offset((Offset.m2585getXimpl(this.center) > Float.POSITIVE_INFINITY ? 1 : (Offset.m2585getXimpl(this.center) == Float.POSITIVE_INFINITY ? 0 : -1)) == 0 ? Size.m2654getWidthimpl(size) : Offset.m2585getXimpl(this.center), Offset.m2586getYimpl(this.center) == Float.POSITIVE_INFINITY ? Size.m2651getHeightimpl(size) : Offset.m2586getYimpl(this.center));
        }
        return ShaderKt.m3107SweepGradientShader9KIMszo(jOffset, this.colors, this.stops);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Offset.m2582equalsimpl0(this.center, sweepGradient.center) && m.c(this.colors, sweepGradient.colors) && m.c(this.stops, sweepGradient.stops);
    }

    public int hashCode() {
        int iB = androidx.compose.animation.a.b(this.colors, Offset.m2587hashCodeimpl(this.center) * 31, 31);
    ...
    public String toString() {
        ...
        StringBuilder sbI = a6.h.i("SweepGradient(", str, "colors=");
        sbI.append(this.colors);
        sbI.append(", stops=");
        return v.h(sbI, this.stops, ')');
    }

    public /* synthetic */ SweepGradient(long j, List list, List list2, int i2, DefaultConstructorMarker defaultConstructorMarker) {
