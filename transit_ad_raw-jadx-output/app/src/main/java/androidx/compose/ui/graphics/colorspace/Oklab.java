...
public final class Oklab extends ColorSpace {
    ...
    public long toXy$ui_graphics_release(float v0, float v1, float v2) {
        float fH = a.l.h(v0, 0.0f, 1.0f);
        float fH2 = a.l.h(v1, -0.5f, 0.5f);
        float fH3 = a.l.h(v2, -0.5f, 0.5f);
        float[] fArr = InverseM2;
        float fMul3x3Float3_0 = ColorSpaceKt.mul3x3Float3_0(fArr, fH, fH2, fH3);
        float fMul3x3Float3_1 = ColorSpaceKt.mul3x3Float3_1(fArr, fH, fH2, fH3);
        float fMul3x3Float3_2 = ColorSpaceKt.mul3x3Float3_2(fArr, fH, fH2, fH3);
    ...
    public float[] toXyz(float[] v) {
        kotlin.jvm.internal.m.h(v, "v");
        v[0] = a.l.h(v[0], 0.0f, 1.0f);
        v[1] = a.l.h(v[1], -0.5f, 0.5f);
        v[2] = a.l.h(v[2], -0.5f, 0.5f);
