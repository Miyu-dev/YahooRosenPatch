...
public final class FontListFontFamily extends FileBasedFontFamily implements List<Font>, lj.a {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof FontListFontFamily) && m.c(this.fonts, ((FontListFontFamily) other).fonts);
    }
    ...
    public String toString() {
        return v.h(new StringBuilder("FontListFontFamily(fonts="), this.fonts, ')');
    }
