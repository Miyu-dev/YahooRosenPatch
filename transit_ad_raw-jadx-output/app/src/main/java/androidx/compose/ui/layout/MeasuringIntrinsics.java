...
final class MeasuringIntrinsics {
    ...
    public static final class DefaultIntrinsicMeasurable implements Measurable {
        ...
        public DefaultIntrinsicMeasurable(IntrinsicMeasurable intrinsicMeasurable, IntrinsicMinMax intrinsicMinMax, IntrinsicWidthHeight intrinsicWidthHeight) {
            ...
            kotlin.jvm.internal.m.h(intrinsicMinMax, "minMax");
            kotlin.jvm.internal.m.h(intrinsicWidthHeight, "widthHeight");
        ...
        public Placeable mo4235measureBRTryo0(long constraints) {
            if (this.widthHeight == IntrinsicWidthHeight.Width) {
                return new EmptyPlaceable(this.minMax == IntrinsicMinMax.Max ? this.measurable.maxIntrinsicWidth(Constraints.m5234getMaxHeightimpl(constraints)) : this.measurable.minIntrinsicWidth(Constraints.m5234getMaxHeightimpl(constraints)), Constraints.m5234getMaxHeightimpl(constraints));
            }
            return new EmptyPlaceable(Constraints.m5235getMaxWidthimpl(constraints), this.minMax == IntrinsicMinMax.Max ? this.measurable.maxIntrinsicHeight(Constraints.m5235getMaxWidthimpl(constraints)) : this.measurable.minIntrinsicHeight(Constraints.m5235getMaxWidthimpl(constraints)));
        }
    ...
    /* JADX INFO: compiled from: LayoutModifier.kt */
    @Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0002\b\u0004\b\u0082\u0001\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002j\u0002\b\u0003j\u0002\b\u0004¨\u0006\u0005"}, d2 = {"Landroidx/compose/ui/layout/MeasuringIntrinsics$IntrinsicMinMax;", "", "(Ljava/lang/String;I)V", "Min", "Max", "ui_release"}, k = 1, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
    ...
    /* JADX INFO: compiled from: LayoutModifier.kt */
    @Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0002\b\u0004\b\u0082\u0001\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002j\u0002\b\u0003j\u0002\b\u0004¨\u0006\u0005"}, d2 = {"Landroidx/compose/ui/layout/MeasuringIntrinsics$IntrinsicWidthHeight;", "", "(Ljava/lang/String;I)V", "Width", "Height", "ui_release"}, k = 1, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
    ...
    public final int maxHeight$ui_release(LayoutModifier modifier, IntrinsicMeasureScope instrinsicMeasureScope, IntrinsicMeasurable intrinsicMeasurable, int w) {
        ...
        kotlin.jvm.internal.m.h(instrinsicMeasureScope, "instrinsicMeasureScope");
        kotlin.jvm.internal.m.h(intrinsicMeasurable, "intrinsicMeasurable");
        return modifier.mo47measure3p2s80s(new IntrinsicsMeasureScope(instrinsicMeasureScope, instrinsicMeasureScope.getLayoutDirection()), new DefaultIntrinsicMeasurable(intrinsicMeasurable, IntrinsicMinMax.Max, IntrinsicWidthHeight.Height), ConstraintsKt.Constraints$default(0, w, 0, 0, 13, null)).getHeight();
    }
    ...
    public final int maxWidth$ui_release(LayoutModifier modifier, IntrinsicMeasureScope instrinsicMeasureScope, IntrinsicMeasurable intrinsicMeasurable, int h) {
        ...
        kotlin.jvm.internal.m.h(instrinsicMeasureScope, "instrinsicMeasureScope");
        kotlin.jvm.internal.m.h(intrinsicMeasurable, "intrinsicMeasurable");
        return modifier.mo47measure3p2s80s(new IntrinsicsMeasureScope(instrinsicMeasureScope, instrinsicMeasureScope.getLayoutDirection()), new DefaultIntrinsicMeasurable(intrinsicMeasurable, IntrinsicMinMax.Max, IntrinsicWidthHeight.Width), ConstraintsKt.Constraints$default(0, 0, 0, h, 7, null)).getWidth();
    }
    ...
    public final int minHeight$ui_release(LayoutModifier modifier, IntrinsicMeasureScope instrinsicMeasureScope, IntrinsicMeasurable intrinsicMeasurable, int w) {
        ...
        kotlin.jvm.internal.m.h(instrinsicMeasureScope, "instrinsicMeasureScope");
        kotlin.jvm.internal.m.h(intrinsicMeasurable, "intrinsicMeasurable");
        return modifier.mo47measure3p2s80s(new IntrinsicsMeasureScope(instrinsicMeasureScope, instrinsicMeasureScope.getLayoutDirection()), new DefaultIntrinsicMeasurable(intrinsicMeasurable, IntrinsicMinMax.Min, IntrinsicWidthHeight.Height), ConstraintsKt.Constraints$default(0, w, 0, 0, 13, null)).getHeight();
    }
    ...
    public final int minWidth$ui_release(LayoutModifier modifier, IntrinsicMeasureScope instrinsicMeasureScope, IntrinsicMeasurable intrinsicMeasurable, int h) {
        ...
        kotlin.jvm.internal.m.h(instrinsicMeasureScope, "instrinsicMeasureScope");
        kotlin.jvm.internal.m.h(intrinsicMeasurable, "intrinsicMeasurable");
        return modifier.mo47measure3p2s80s(new IntrinsicsMeasureScope(instrinsicMeasureScope, instrinsicMeasureScope.getLayoutDirection()), new DefaultIntrinsicMeasurable(intrinsicMeasurable, IntrinsicMinMax.Min, IntrinsicWidthHeight.Width), ConstraintsKt.Constraints$default(0, 0, 0, h, 7, null)).getWidth();
    }
