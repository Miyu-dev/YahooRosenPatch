...
public final class Vertices {
    ...
    private final int[] encodeColorList(List<Color> colors) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            iArr[i2] = ColorKt.m2872toArgb8_81llA(colors.get(i2).m2828unboximpl());
        }
        return iArr;
    }
    ...
    private final float[] encodePointList(List<Offset> points) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            fArr[i2] = i2 % 2 == 0 ? Offset.m2585getXimpl(packedValue) : Offset.m2586getYimpl(packedValue);
        }
        return fArr;
    }
    ...
    private Vertices(int i2, final List<Offset> list, List<Offset> list2, List<Color> list3, List<Integer> list4) {
        ...
        while (true) {
            if (i3 >= size) {
                ...
                if (((Boolean) lVar.invoke(list4.get(i3))).booleanValue()) {
                    z = true;
                    break;
                }
                i3++;
