...
public final class AndroidClipboardManager_androidKt {
    ...
    public static final AnnotatedString convertToAnnotatedString(CharSequence charSequence) {
        ...
        kotlin.jvm.internal.m.g(annotationArr, "annotations");
        int length = annotationArr.length - 1;
        if (length >= 0) {
            while (true) {
                Annotation annotation = annotationArr[i2];
                if (kotlin.jvm.internal.m.c(annotation.getKey(), "androidx.compose.text.SpanStyle")) {
                    int spanStart = spanned.getSpanStart(annotation);
                    int spanEnd = spanned.getSpanEnd(annotation);
                    String value = annotation.getValue();
                    kotlin.jvm.internal.m.g(value, "span.value");
    ...
    public static final CharSequence convertToCharSequence(AnnotatedString annotatedString) {
        kotlin.jvm.internal.m.h(annotatedString, "<this>");
