...
final class BlendModeColorFilterHelper {
    ...
    public final BlendModeColorFilter m2770BlendModeColorFilterxETnrds(long color, int blendMode) {
        return new BlendModeColorFilter(ColorKt.m2872toArgb8_81llA(color), AndroidBlendMode_androidKt.m2677toAndroidBlendModes9anfk8(blendMode));
    }
}
