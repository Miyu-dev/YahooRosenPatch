...
public final class DefaultIntrinsicMeasurable implements Measurable {
    ...
    public Placeable mo4235measureBRTryo0(long constraints) {
        if (this.widthHeight == IntrinsicWidthHeight.Width) {
            return new FixedSizeIntrinsicsPlaceable(this.minMax == IntrinsicMinMax.Max ? this.measurable.maxIntrinsicWidth(Constraints.m5234getMaxHeightimpl(constraints)) : this.measurable.minIntrinsicWidth(Constraints.m5234getMaxHeightimpl(constraints)), Constraints.m5234getMaxHeightimpl(constraints));
        }
        return new FixedSizeIntrinsicsPlaceable(Constraints.m5235getMaxWidthimpl(constraints), this.minMax == IntrinsicMinMax.Max ? this.measurable.maxIntrinsicHeight(Constraints.m5235getMaxWidthimpl(constraints)) : this.measurable.minIntrinsicHeight(Constraints.m5235getMaxWidthimpl(constraints)));
    }
