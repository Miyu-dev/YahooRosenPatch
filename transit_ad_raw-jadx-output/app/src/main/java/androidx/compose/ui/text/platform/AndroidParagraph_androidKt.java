...
public final class AndroidParagraph_androidKt {
    public static final Paragraph ActualParagraph(String str, TextStyle textStyle, List<AnnotatedString.Range<SpanStyle>> list, List<AnnotatedString.Range<Placeholder>> list2, int i2, boolean z, float f, Density density, Font.ResourceLoader resourceLoader) {
        ...
        return new AndroidParagraph(new AndroidParagraphIntrinsics(str, textStyle, list, list2, DelegatingFontLoaderForDeprecatedUsage_androidKt.createFontFamilyResolver(resourceLoader), density), i2, z, ConstraintsKt.Constraints$default(0, ParagraphKt.ceilToInt(f), 0, 0, 13, null), null);
    }

    /* JADX INFO: renamed from: ActualParagraph--hBUhpc, reason: not valid java name */
    public static final Paragraph m5033ActualParagraphhBUhpc(ParagraphIntrinsics paragraphIntrinsics, int i2, boolean z, long j) {
    ...
    public static final Paragraph m5034ActualParagraphO3s9Psw(String str, TextStyle textStyle, List<AnnotatedString.Range<SpanStyle>> list, List<AnnotatedString.Range<Placeholder>> list2, int i2, boolean z, long j, Density density, FontFamily.Resolver resolver) {
        m.h(str, "text");
        m.h(textStyle, "style");
        m.h(list, "spanStyles");
        m.h(list2, "placeholders");
        ...
        return new AndroidParagraph(new AndroidParagraphIntrinsics(str, textStyle, list, list2, resolver, density), i2, z, j, null);
    }
}
