...
public final class AndroidPathEffect_androidKt {
    ...
    public static final PathEffect m2722actualStampedPathEffect7aD1DOk(Path path, float f, float f2, int i2) {
        m.h(path, "shape");
        if (path instanceof AndroidPath) {
            return new AndroidPathEffect(new PathDashPathEffect(((AndroidPath) path).getInternalPath(), f, f2, m2723toAndroidPathDashPathEffectStyleoQv6xUo(i2)));
        }
    ...
    public static final PathDashPathEffect.Style m2723toAndroidPathDashPathEffectStyleoQv6xUo(int i2) {
        StampedPathEffectStyle.Companion companion = StampedPathEffectStyle.INSTANCE;
        return StampedPathEffectStyle.m3127equalsimpl0(i2, companion.m3131getMorphYpspkwk()) ? PathDashPathEffect.Style.MORPH : StampedPathEffectStyle.m3127equalsimpl0(i2, companion.m3132getRotateYpspkwk()) ? PathDashPathEffect.Style.ROTATE : StampedPathEffectStyle.m3127equalsimpl0(i2, companion.m3133getTranslateYpspkwk()) ? PathDashPathEffect.Style.TRANSLATE : PathDashPathEffect.Style.TRANSLATE;
    }
