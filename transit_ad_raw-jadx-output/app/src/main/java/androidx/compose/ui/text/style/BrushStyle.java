...
final /* data */ class BrushStyle implements TextForegroundStyle {
    ...
    public BrushStyle(ShaderBrush shaderBrush, float f) {
        m.h(shaderBrush, "value");
        this.value = shaderBrush;
        this.alpha = f;
    }

    public static /* synthetic */ BrushStyle copy$default(BrushStyle brushStyle, ShaderBrush shaderBrush, float f, int i2, Object obj) {
        if ((i2 & 1) != 0) {
    ...
    public boolean equals(Object other) {
        ...
        return m.c(this.value, brushStyle.value) && Float.compare(getAlpha(), brushStyle.getAlpha()) == 0;
    }
