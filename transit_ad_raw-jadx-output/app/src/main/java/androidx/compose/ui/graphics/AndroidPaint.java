...
public final class AndroidPaint implements Paint {
    ...
    public AndroidPaint(android.graphics.Paint paint) {
        m.h(paint, "internalPaint");
        this.internalPaint = paint;
        this._blendMode = BlendMode.INSTANCE.m2768getSrcOver0nO6VwU();
    }
    ...
    public long mo2700getColor0d7_KjU() {
    ...
    public int mo2701getFilterQualityfv9h1I() {
    ...
    public int mo2702getStrokeCapKaPHkGw() {
    ...
    public int mo2703getStrokeJoinLxFBmk8() {
    ...
    public int mo2704getStyleTiuSbCo() {
    ...
    public void mo2705setBlendModes9anfk8(int i2) {
        if (BlendMode.m2737equalsimpl0(this._blendMode, i2)) {
            return;
        }
        this._blendMode = i2;
        AndroidPaint_androidKt.m2711setNativeBlendModeGB0RdKg(this.internalPaint, i2);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* JADX INFO: renamed from: setColor-8_81llA, reason: not valid java name */
    public void mo2706setColor8_81llA(long j) {
        AndroidPaint_androidKt.m2712setNativeColor4WTKRHQ(this.internalPaint, j);
    }
    ...
    public void mo2707setFilterQualityvDHp3xo(int i2) {
        AndroidPaint_androidKt.m2713setNativeFilterQuality50PEsBU(this.internalPaint, i2);
    }
    ...
    public void mo2708setStrokeCapBeK7IIE(int i2) {
        AndroidPaint_androidKt.m2714setNativeStrokeCapCSYIeUk(this.internalPaint, i2);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* JADX INFO: renamed from: setStrokeJoin-Ww9F2mQ, reason: not valid java name */
    public void mo2709setStrokeJoinWw9F2mQ(int i2) {
        AndroidPaint_androidKt.m2715setNativeStrokeJoinkLtJ_vA(this.internalPaint, i2);
    }
    ...
    public void mo2710setStylek9PVt8s(int i2) {
        AndroidPaint_androidKt.m2716setNativeStyle5YerkU(this.internalPaint, i2);
    }
