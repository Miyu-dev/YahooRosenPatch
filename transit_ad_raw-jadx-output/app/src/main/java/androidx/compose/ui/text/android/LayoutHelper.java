...
public final class LayoutHelper {
    ...
    /* JADX INFO: compiled from: LayoutHelper.kt */
    @Metadata(d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0002\b\r\n\u0002\u0010\u000e\n\u0000\b\u0082\b\u0018\u00002\u00020\u0001B\u001d\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0003\u0012\u0006\u0010\u0005\u001a\u00020\u0006¢\u0006\u0002\u0010\u0007J\t\u0010\f\u001a\u00020\u0003HÆ\u0003J\t\u0010\r\u001a\u00020\u0003HÆ\u0003J\t\u0010\u000e\u001a\u00020\u0006HÆ\u0003J'\u0010\u000f\u001a\u00020\u00002\b\b\u0002\u0010\u0002\u001a\u00020\u00032\b\b\u0002\u0010\u0004\u001a\u00020\u00032\b\b\u0002\u0010\u0005\u001a\u00020\u0006HÆ\u0001J\u0013\u0010\u0010\u001a\u00020\u00062\b\u0010\u0011\u001a\u0004\u0018\u00010\u0001HÖ\u0003J\t\u0010\u0012\u001a\u00020\u0003HÖ\u0001J\t\u0010\u0013\u001a\u00020\u0014HÖ\u0001R\u0011\u0010\u0004\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\b\u0010\tR\u0011\u0010\u0005\u001a\u00020\u0006¢\u0006\b\n\u0000\u001a\u0004\b\u0005\u0010\nR\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\u000b\u0010\t¨\u0006\u0015"}, d2 = {"Landroidx/compose/ui/text/android/LayoutHelper$BidiRun;", "", "start", "", "end", "isRtl", "", "(IIZ)V", "getEnd", "()I", "()Z", "getStart", "component1", "component2", "component3", "copy", "equals", "other", "hashCode", "toString", "", "ui-text_release"}, k = 1, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
    public static final /* data */ class BidiRun {
        ...
        public String toString() {
            ...
            sb.append(this.end);
            sb.append(", isRtl=");
            return androidx.compose.animation.a.d(sb, this.isRtl, ')');
        }
    }
    ...
    public LayoutHelper(Layout layout) {
        ...
        do {
            ...
            int iM1 = r.m1(text, '\n', length, false, 4);
            length = iM1 < 0 ? this.layout.getText().length() : iM1 + 1;
    ...
    */
    ...
    public final float getHorizontalPosition(int offset, boolean usePrimaryDirection, boolean upstream) {
        ...
        if (iLineEndToVisibleEnd == lineStart) {
            ...
            return (i6 == 0 && zIsRtlParagraph) ? this.layout.getLineLeft(lineForOffset) : (i6 != runCount + (-1) || zIsRtlParagraph) ? zIsRtlParagraph ? this.layout.getPrimaryHorizontal(bidiRunArr[i6 - 1].getStart()) : this.layout.getPrimaryHorizontal(bidiRunArr[i6 + 1].getStart()) : this.layout.getLineRight(lineForOffset);
        }
        ...
        return (i7 == 0 && zIsRtlParagraph) ? this.layout.getLineLeft(lineForOffset) : (i7 != runCount + (-1) || zIsRtlParagraph) ? zIsRtlParagraph ? this.layout.getPrimaryHorizontal(bidiRunArr[i7 - 1].getEnd()) : this.layout.getPrimaryHorizontal(bidiRunArr[i7 + 1].getEnd()) : this.layout.getLineRight(lineForOffset);
    }
    ...
    public final int getParagraphForOffset(@IntRange(from = 0) int offset, boolean upstream) {
        int iO = f.o(this.paragraphEnds, Integer.valueOf(offset));
