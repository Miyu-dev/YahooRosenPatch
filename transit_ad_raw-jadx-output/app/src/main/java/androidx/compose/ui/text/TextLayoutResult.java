...
public final class TextLayoutResult {
    ...
    public static /* synthetic */ TextLayoutResult m4781copyO0kMr_c$default(TextLayoutResult textLayoutResult, TextLayoutInput textLayoutInput, long j, int i2, Object obj) {
        if ((i2 & 1) != 0) {
        ...
        return textLayoutResult.m4782copyO0kMr_c(textLayoutInput, j);
    }
    ...
    public final TextLayoutResult m4782copyO0kMr_c(TextLayoutInput layoutInput, long size) {
        m.h(layoutInput, "layoutInput");
    ...
    public boolean equals(Object other) {
        ...
        if (!m.c(this.layoutInput, textLayoutResult.layoutInput) || !m.c(this.multiParagraph, textLayoutResult.multiParagraph) || !IntSize.m5425equalsimpl0(this.size, textLayoutResult.size)) {
            return false;
        }
    ...
    public final boolean getDidOverflowHeight() {
        return this.multiParagraph.getDidExceedMaxLines() || ((float) IntSize.m5426getHeightimpl(this.size)) < this.multiParagraph.getHeight();
    }

    public final boolean getDidOverflowWidth() {
        return ((float) IntSize.m5427getWidthimpl(this.size)) < this.multiParagraph.getWidth();
    }
    ...
    public final int m4783getOffsetForPositionk4lQ0M(long position) {
        return this.multiParagraph.m4687getOffsetForPositionk4lQ0M(position);
    }
    ...
    public final long m4785getWordBoundaryjx7JFs(int offset) {
        return this.multiParagraph.m4688getWordBoundaryjx7JFs(offset);
    }

    public int hashCode() {
        return this.placeholderRects.hashCode() + v.a(this.lastBaseline, v.a(this.firstBaseline, (IntSize.m5428hashCodeimpl(this.size) + ((this.multiParagraph.hashCode() + (this.layoutInput.hashCode() * 31)) * 31)) * 31, 31), 31);
    }
    ...
    public String toString() {
        ...
        sb.append(", size=");
        sb.append((Object) IntSize.m5430toStringimpl(this.size));
        ...
        return v.h(sb, this.placeholderRects, ')');
    }
