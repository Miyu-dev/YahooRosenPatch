...
public final /* data */ class AndroidFontResolveInterceptor implements PlatformResolveInterceptor {
    ...
    public FontWeight interceptFontWeight(FontWeight fontWeight) {
        ...
        return (i2 == 0 || i2 == Integer.MAX_VALUE) ? fontWeight : new FontWeight(l.i(fontWeight.getWeight() + this.fontWeightAdjustment, 1, 1000));
    }

    public String toString() {
        return android.support.v4.media.a.f(new StringBuilder("AndroidFontResolveInterceptor(fontWeightAdjustment="), this.fontWeightAdjustment, ')');
    }
}
