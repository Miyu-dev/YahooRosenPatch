...
public final /* data */ class DeviceRenderNodeData {
    ...
    public /* synthetic */ DeviceRenderNodeData(long j, int i2, int i3, int i4, int i5, int i6, int i7, float f, float f2, float f3, float f4, float f5, int i8, int i9, float f6, float f7, float f8, float f9, float f10, float f11, boolean z, boolean z2, float f12, RenderEffect renderEffect, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        this(j, i2, i3, i4, i5, i6, i7, f, f2, f3, f4, f5, i8, i9, f6, f7, f8, f9, f10, f11, z, z2, f12, renderEffect, i10);
    }
    ...
    public final int m4570getCompositingStrategyNrFUSI() {
        return this.compositingStrategy;
    }
    ...
    public int hashCode() {
        ...
        int iA = v.a(this.pivotY, v.a(this.pivotX, v.a(this.cameraDistance, v.a(this.rotationY, v.a(this.rotationX, v.a(this.rotationZ, (((v.a(this.elevation, v.a(this.translationY, v.a(this.translationX, v.a(this.scaleY, v.a(this.scaleX, ((((((((((((((int) (j ^ (j >>> 32))) * 31) + this.left) * 31) + this.top) * 31) + this.right) * 31) + this.bottom) * 31) + this.width) * 31) + this.height) * 31, 31), 31), 31), 31), 31) + this.ambientShadowColor) * 31) + this.spotShadowColor) * 31, 31), 31), 31), 31), 31), 31);
        ...
        int iA2 = v.a(this.alpha, (i2 + (z2 ? 1 : z2)) * 31, 31);
        RenderEffect renderEffect = this.renderEffect;
        return CompositingStrategy.m2899hashCodeimpl(this.compositingStrategy) + ((iA2 + (renderEffect == null ? 0 : renderEffect.hashCode())) * 31);
    }
    ...
    public final void m4571setCompositingStrategyaDBOjCE(int i2) {
