...
final class EmptyBuildDrawCacheParams implements BuildDrawCacheParams {
    ...
    private static final long size = Size.INSTANCE.m2662getUnspecifiedNHjbRc();
