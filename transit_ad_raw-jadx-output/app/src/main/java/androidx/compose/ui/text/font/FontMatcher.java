...
public final class FontMatcher {
    public static /* synthetic */ List filterByClosestWeight$ui_text_release$default(FontMatcher fontMatcher, List list, FontWeight fontWeight, boolean z, FontWeight fontWeight2, FontWeight fontWeight3, int i2, Object obj) {
        ...
        for (int i4 = 0; i4 < size2; i4++) {
            ...
            if (m.c(((Font) obj2).getWeight(), fontWeight4)) {
                arrayList.add(obj2);
            }
        }
        return arrayList;
    ...
    public final List<Font> filterByClosestWeight$ui_text_release(List<? extends Font> list, FontWeight fontWeight, boolean z, FontWeight fontWeight2, FontWeight fontWeight3) {
        ...
        for (int i3 = 0; i3 < size2; i3++) {
            ...
            if (m.c(font.getWeight(), fontWeight4)) {
                arrayList.add(font);
            }
        }
        return arrayList;
    ...
    public final List<Font> m4891matchFontRetOiIg(FontFamily fontFamily, FontWeight fontWeight, int fontStyle) {
        m.h(fontFamily, "fontFamily");
        m.h(fontWeight, "fontWeight");
        if (fontFamily instanceof FontListFontFamily) {
            return m4892matchFontRetOiIg((FontListFontFamily) fontFamily, fontWeight, fontStyle);
        }
        throw new IllegalArgumentException("Only FontFamily instances that presents a list of Fonts can be used");
    }

    /* JADX INFO: renamed from: matchFont-RetOiIg, reason: not valid java name */
    public final List<Font> m4892matchFontRetOiIg(FontListFontFamily fontFamily, FontWeight fontWeight, int fontStyle) {
        m.h(fontFamily, "fontFamily");
        m.h(fontWeight, "fontWeight");
        return m4893matchFontRetOiIg(fontFamily.getFonts(), fontWeight, fontStyle);
    }

    /* JADX INFO: renamed from: matchFont-RetOiIg, reason: not valid java name */
    public final List<Font> m4893matchFontRetOiIg(List<? extends Font> fontList, FontWeight fontWeight, int fontStyle) {
        ...
        while (true) {
            ...
            Font font2 = font;
            if (m.c(font2.getWeight(), fontWeight) && FontStyle.m4897equalsimpl0(font2.getStyle(), fontStyle)) {
                arrayList.add(font);
            }
            i3++;
        }
        ...
        for (int i4 = 0; i4 < size2; i4++) {
            ...
            if (FontStyle.m4897equalsimpl0(font3.getStyle(), fontStyle)) {
        ...
        if (fontWeight.compareTo(companion.getW400()) < 0) {
            ...
            while (i2 < size4) {
                ...
                if (m.c(font4.getWeight(), fontWeight3)) {
        ...
        if (fontWeight.compareTo(companion.getW500()) > 0) {
            ...
            while (i2 < size6) {
                ...
                if (m.c(font5.getWeight(), fontWeight4)) {
        ...
        for (int i8 = 0; i8 < size8; i8++) {
            ...
            if (m.c(font6.getWeight(), fontWeight5)) {
        ...
        while (i2 < size10) {
            ...
            if (m.c(font7.getWeight(), fontWeight2)) {
