...
public final /* data */ class ParagraphIntrinsicInfo {
    ...
    public ParagraphIntrinsicInfo(ParagraphIntrinsics paragraphIntrinsics, int i2, int i3) {
        m.h(paragraphIntrinsics, "intrinsics");
    ...
    public boolean equals(Object other) {
        ...
        return m.c(this.intrinsics, paragraphIntrinsicInfo.intrinsics) && this.startIndex == paragraphIntrinsicInfo.startIndex && this.endIndex == paragraphIntrinsicInfo.endIndex;
    }
    ...
    public String toString() {
        ...
        sb.append(", endIndex=");
        return android.support.v4.media.a.f(sb, this.endIndex, ')');
    }
}
