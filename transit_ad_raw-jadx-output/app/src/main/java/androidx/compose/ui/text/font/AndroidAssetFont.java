...
public final class AndroidAssetFont extends AndroidPreloadedFont {
    ...
    public boolean equals(Object other) {
        ...
        return m.c(this.path, androidAssetFont.path) && m.c(getVariationSettings(), androidAssetFont.getVariationSettings());
    }
    ...
    public String toString() {
        return "Font(assetManager, path=" + this.path + ", weight=" + getWeight() + ", style=" + ((Object) FontStyle.m4899toStringimpl(getStyle())) + ')';
    }
    ...
    public /* synthetic */ AndroidAssetFont(AssetManager assetManager, String str, FontWeight fontWeight, int i2, FontVariation.Settings settings, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        this(assetManager, str, (i3 & 4) != 0 ? FontWeight.INSTANCE.getNormal() : fontWeight, (i3 & 8) != 0 ? FontStyle.INSTANCE.m4902getNormal_LCdwA() : i2, settings, null);
    }
