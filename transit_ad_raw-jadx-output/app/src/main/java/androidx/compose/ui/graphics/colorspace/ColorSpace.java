...
public abstract class ColorSpace {
    ...
    public boolean equals(Object other) {
        ...
        if (this.id == colorSpace.id && kotlin.jvm.internal.m.c(this.name, colorSpace.name)) {
            return ColorModel.m3195equalsimpl0(this.model, colorSpace.model);
        }
        return false;
    }

    public final float[] fromXyz(float x, float y, float z) {
        float[] fArr = new float[ColorModel.m3196getComponentCountimpl(this.model)];
        fArr[0] = x;
        fArr[1] = y;
        fArr[2] = z;
        return fromXyz(fArr);
    ...
    public final int getComponentCount() {
        return ColorModel.m3196getComponentCountimpl(this.model);
    }
    ...
    public int hashCode() {
        return ((ColorModel.m3197hashCodeimpl(this.model) + (this.name.hashCode() * 31)) * 31) + this.id;
    }
    ...
    public String toString() {
        return this.name + " (id=" + this.id + ", model=" + ((Object) ColorModel.m3198toStringimpl(this.model)) + ')';
    }
