...
public final class AndroidTypeface_androidKt {
    ...
    public static final Typeface Typeface(Context context, FontFamily fontFamily, List<Pair<FontWeight, FontStyle>> list) throws NoWhenBranchMatchedException {
        m.h(context, "context");
