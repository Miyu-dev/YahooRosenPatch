...
public final /* data */ class BiasAlignment implements Alignment {
    ...
    public static final /* data */ class Horizontal implements Alignment.Horizontal {
        ...
        public int align(int size, int space, LayoutDirection layoutDirection) {
            ...
            return f.f0((1 + (layoutDirection == LayoutDirection.Ltr ? this.bias : (-1) * this.bias)) * ((space - size) / 2.0f));
        }
        ...
        public String toString() {
            return h.g(new StringBuilder("Horizontal(bias="), this.bias, ')');
        }
    }

    /* JADX INFO: compiled from: Alignment.kt */
    @Immutable
    @Metadata(d1 = {"\u0000.\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0007\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0005\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\b\u0087\b\u0018\u00002\u00020\u0001B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\u0018\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\u00062\u0006\u0010\b\u001a\u00020\u0006H\u0016J\t\u0010\t\u001a\u00020\u0003HÂ\u0003J\u0013\u0010\n\u001a\u00020\u00002\b\b\u0002\u0010\u0002\u001a\u00020\u0003HÆ\u0001J\u0013\u0010\u000b\u001a\u00020\f2\b\u0010\r\u001a\u0004\u0018\u00010\u000eHÖ\u0003J\t\u0010\u000f\u001a\u00020\u0006HÖ\u0001J\t\u0010\u0010\u001a\u00020\u0011HÖ\u0001R\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0012"}, d2 = {"Landroidx/compose/ui/BiasAlignment$Vertical;", "Landroidx/compose/ui/Alignment$Vertical;", "bias", "", "(F)V", "align", "", "size", "space", "component1", "copy", "equals", "", "other", "", "hashCode", "toString", "", "ui_release"}, k = 1, mv = {1, 8, 0}, xi = androidx.appcompat.R.styleable.AppCompatTheme_checkboxStyle)
    public static final /* data */ class Vertical implements Alignment.Vertical {
        ...
        public int align(int size, int space) {
            return f.f0((1 + this.bias) * ((space - size) / 2.0f));
        }
        ...
        public String toString() {
            return h.g(new StringBuilder("Vertical(bias="), this.bias, ')');
        }
    }
    ...
    public long mo2476alignKFBX0sM(long size, long space, LayoutDirection layoutDirection) {
        m.h(layoutDirection, "layoutDirection");
        float fM5427getWidthimpl = (IntSize.m5427getWidthimpl(space) - IntSize.m5427getWidthimpl(size)) / 2.0f;
        float fM5426getHeightimpl = (IntSize.m5426getHeightimpl(space) - IntSize.m5426getHeightimpl(size)) / 2.0f;
        float f = 1;
        return IntOffsetKt.IntOffset(f.f0(((layoutDirection == LayoutDirection.Ltr ? this.horizontalBias : (-1) * this.horizontalBias) + f) * fM5427getWidthimpl), f.f0((f + this.verticalBias) * fM5426getHeightimpl));
    }
    ...
    public String toString() {
        ...
        return h.g(sb, this.verticalBias, ')');
    }
}
