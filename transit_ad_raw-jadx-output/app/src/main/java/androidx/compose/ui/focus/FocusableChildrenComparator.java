...
final class FocusableChildrenComparator implements Comparator<FocusTargetModifierNode> {
    ...
    public int compare(FocusTargetModifierNode focusTarget1, FocusTargetModifierNode focusTarget2) {
        ...
        if (iMin >= 0) {
            while (m.c(mutableVectorPathFromRoot.getContent()[i2], mutableVectorPathFromRoot2.getContent()[i2])) {
                if (i2 != iMin) {
                    i2++;
                }
            }
            return m.j(mutableVectorPathFromRoot.getContent()[i2].getPlaceOrder(), mutableVectorPathFromRoot2.getContent()[i2].getPlaceOrder());
        }
