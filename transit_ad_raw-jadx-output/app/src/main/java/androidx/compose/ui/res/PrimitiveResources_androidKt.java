...
public final class PrimitiveResources_androidKt {
    ...
    @Composable
    @ReadOnlyComposable
    public static final float dimensionResource(@DimenRes int i2, Composer composer, int i3) {
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(804324951, i3, -1, "androidx.compose.ui.res.dimensionResource (PrimitiveResources.android.kt:75)");
        }
        float fM5267constructorimpl = Dp.m5267constructorimpl(((Context) composer.consume(AndroidCompositionLocals_androidKt.getLocalContext())).getResources().getDimension(i2) / ((Density) composer.consume(CompositionLocalsKt.getLocalDensity())).getDensity());
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        return fM5267constructorimpl;
    }

    @Composable
    @ReadOnlyComposable
    public static final int[] integerArrayResource(@ArrayRes int i2, Composer composer, int i3) {
        if (ComposerKt.isTraceInProgress()) {
        ...
        m.g(intArray, "context.resources.getIntArray(id)");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        return intArray;
    ...
    @Composable
    @ReadOnlyComposable
    public static final int integerResource(@IntegerRes int i2, Composer composer, int i3) {
        if (ComposerKt.isTraceInProgress()) {
