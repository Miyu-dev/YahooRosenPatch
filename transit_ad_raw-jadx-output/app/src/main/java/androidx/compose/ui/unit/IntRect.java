...
public final /* data */ class IntRect {
    ...
    /* JADX INFO: compiled from: IntRect.kt */
    @Metadata(d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u001c\u0010\u0003\u001a\u00020\u00048\u0006X\u0087\u0004¢\u0006\u000e\n\u0000\u0012\u0004\b\u0005\u0010\u0002\u001a\u0004\b\u0006\u0010\u0007¨\u0006\b"}, d2 = {"Landroidx/compose/ui/unit/IntRect$Companion;", "", "()V", "Zero", "Landroidx/compose/ui/unit/IntRect;", "getZero$annotations", "getZero", "()Landroidx/compose/ui/unit/IntRect;", "ui-unit_release"}, k = 1, mv = {1, 8, 0}, xi = androidx.appcompat.R.styleable.AppCompatTheme_checkboxStyle)
    ...
    public final boolean m5404containsgyyYBs(long offset) {
        return IntOffset.m5385getXimpl(offset) >= this.left && IntOffset.m5385getXimpl(offset) < this.right && IntOffset.m5386getYimpl(offset) >= this.top && IntOffset.m5386getYimpl(offset) < this.bottom;
    }
    ...
    public final long m5405getBottomCenternOccac() {
    ...
    public final long m5406getBottomLeftnOccac() {
    ...
    public final long m5409getCenterLeftnOccac() {
    ...
    public final long m5410getCenterRightnOccac() {
    ...
    public final long m5411getSizeYbymL2g() {
    ...
    public final long m5412getTopCenternOccac() {
    ...
    public String toString() {
        ...
        sb.append(", ");
        return android.support.v4.media.a.f(sb, this.bottom, ')');
    }
    ...
    public final IntRect m5415translategyyYBs(long offset) {
        return new IntRect(IntOffset.m5385getXimpl(offset) + this.left, IntOffset.m5386getYimpl(offset) + this.top, IntOffset.m5385getXimpl(offset) + this.right, IntOffset.m5386getYimpl(offset) + this.bottom);
    }
    ...
    public static /* synthetic */ void m5403getSizeYbymL2g$annotations() {
    }
