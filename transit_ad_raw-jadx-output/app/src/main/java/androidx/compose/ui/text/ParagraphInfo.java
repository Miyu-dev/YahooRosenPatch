...
public final /* data */ class ParagraphInfo {
    ...
    public int hashCode() {
        return Float.floatToIntBits(this.bottom) + v.a(this.top, ((((((((this.paragraph.hashCode() * 31) + this.startIndex) * 31) + this.endIndex) * 31) + this.startLineIndex) * 31) + this.endLineIndex) * 31, 31);
    }
    ...
    public final Rect toGlobal(Rect rect) {
        m.h(rect, "<this>");
        return rect.m2622translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
    }

    /* JADX INFO: renamed from: toGlobal-GEjPoXI, reason: not valid java name */
    public final long m4694toGlobalGEjPoXI(long j) {
        return TextRangeKt.TextRange(toGlobalIndex(TextRange.m4811getStartimpl(j)), toGlobalIndex(TextRange.m4806getEndimpl(j)));
    }
    ...
    public final long m4695toLocalMKHz9U(long j) {
        return OffsetKt.Offset(Offset.m2585getXimpl(j), Offset.m2586getYimpl(j) - this.top);
    }

    public final int toLocalIndex(int i2) {
        return l.i(i2, this.startIndex, this.endIndex) - this.startIndex;
    }
    ...
    public String toString() {
        ...
        sb.append(this.top);
        sb.append(", bottom=");
        return h.g(sb, this.bottom, ')');
    }

    public final Path toGlobal(Path path) {
        m.h(path, "<this>");
        path.mo2721translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
        return path;
    }

    public /* synthetic */ ParagraphInfo(Paragraph paragraph, int i2, int i3, int i4, int i5, float f, float f2, int i6, DefaultConstructorMarker defaultConstructorMarker) {
