...
@ej.c(c = "androidx.compose.ui.input.pointer.SuspendingPointerInputFilterKt$pointerInput$4$2$1", f = "SuspendingPointerInputFilter.kt", l = {292}, m = "invokeSuspend")
public final class SuspendingPointerInputFilterKt$pointerInput$4$2$1 extends SuspendLambda implements p<CoroutineScope, dj.c<? super j>, Object> {
    ...
    public SuspendingPointerInputFilterKt$pointerInput$4$2$1(SuspendingPointerInputFilter suspendingPointerInputFilter, p<? super PointerInputScope, ? super dj.c<? super j>, ? extends Object> pVar, dj.c<? super SuspendingPointerInputFilterKt$pointerInput$4$2$1> cVar) {
        super(2, cVar);
