...
public final class ColorSpaces {
    ...
    static {
        ...
        LinearSrgb = rgb2;
        int i2 = 0;
        Rgb rgb3 = new Rgb("scRGB-nl IEC 61966-2-2:2003", fArr, illuminant.getD65(), null, new a(i2), new b(i2), -0.799f, 2.399f, transferParameters, 2);
        ExtendedSrgb = rgb3;
    ...
    public final ColorSpace match(float[] toXYZD50, TransferParameters function) {
        kotlin.jvm.internal.m.h(toXYZD50, "toXYZD50");
        ...
        for (ColorSpace colorSpace : ColorSpacesArray) {
            if (ColorModel.m3195equalsimpl0(colorSpace.getModel(), ColorModel.INSTANCE.m3202getRgbxdoWZVw())) {
                ...
                kotlin.jvm.internal.m.f(colorSpaceAdapt$default, "null cannot be cast to non-null type androidx.compose.ui.graphics.colorspace.Rgb");
