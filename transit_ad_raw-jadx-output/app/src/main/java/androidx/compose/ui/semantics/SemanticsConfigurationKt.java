...
public final class SemanticsConfigurationKt {
    public static final <T> T getOrNull(SemanticsConfiguration semanticsConfiguration, SemanticsPropertyKey<T> semanticsPropertyKey) {
        m.h(semanticsConfiguration, "<this>");
        m.h(semanticsPropertyKey, "key");
        return (T) semanticsConfiguration.getOrElseNullable(semanticsPropertyKey, new kj.a<T>() { // from class: androidx.compose.ui.semantics.SemanticsConfigurationKt.getOrNull.1
