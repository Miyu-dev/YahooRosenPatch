...
public final class InternalPointerEvent {
    ...
    public final boolean m4061issuesEnterExitEvent0FcD4WY(long pointerId) {
        ...
        while (true) {
            ...
            if (PointerId.m4114equalsimpl0(pointerInputEventData.m4142getIdJ3iCeTQ(), pointerId)) {
                break;
            }
            i2++;
        }
