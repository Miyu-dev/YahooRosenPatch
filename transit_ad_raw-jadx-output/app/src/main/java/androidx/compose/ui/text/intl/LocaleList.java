...
public final class LocaleList implements Collection<Locale>, a {
    ...
    /* JADX INFO: compiled from: LocaleList.kt */
    @Metadata(d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u0011\u0010\u0003\u001a\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\u0007"}, d2 = {"Landroidx/compose/ui/text/intl/LocaleList$Companion;", "", "()V", "current", "Landroidx/compose/ui/text/intl/LocaleList;", "getCurrent", "()Landroidx/compose/ui/text/intl/LocaleList;", "ui-text_release"}, k = 1, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof LocaleList) && m.c(this.localeList, ((LocaleList) other).localeList);
    }
    ...
    public String toString() {
        return v.h(new StringBuilder("LocaleList(localeList="), this.localeList, ')');
    }
    ...
    public LocaleList(String str) {
        m.h(str, "languageTags");
        List listA1 = r.A1(str, new String[]{","});
        ArrayList arrayList = new ArrayList(listA1.size());
        int size = listA1.size();
        for (int i2 = 0; i2 < size; i2++) {
            arrayList.add(r.L1((String) listA1.get(i2)).toString());
        }
    ...
    public LocaleList(Locale... localeArr) {
        this((List<Locale>) p.T0(localeArr));
        m.h(localeArr, "locales");
    }
}
