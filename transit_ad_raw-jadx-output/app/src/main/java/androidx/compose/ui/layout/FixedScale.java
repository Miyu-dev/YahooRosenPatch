...
public final /* data */ class FixedScale implements ContentScale {
    ...
    public String toString() {
        return a6.h.g(new StringBuilder("FixedScale(value="), this.value, ')');
    }
}
