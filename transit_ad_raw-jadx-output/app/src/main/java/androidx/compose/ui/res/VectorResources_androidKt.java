...
public final class VectorResources_androidKt {
    ...
    @Composable
    public static final ImageVector vectorResource(ImageVector.Companion companion, @DrawableRes int i2, Composer composer, int i3) throws XmlPullParserException, IOException {
        m.h(companion, "<this>");
        ...
        Object[] objArr = {Integer.valueOf(i2), resources, theme, resources.getConfiguration()};
    ...
    public static final ImageVector vectorResource(ImageVector.Companion companion, Resources.Theme theme, Resources resources, int i2) throws XmlPullParserException, IOException {
        ...
        m.g(xml, "vectorResource$lambda$1");
