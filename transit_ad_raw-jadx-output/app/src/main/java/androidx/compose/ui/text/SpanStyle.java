...
public final class SpanStyle {
    ...
    public static /* synthetic */ SpanStyle m4763copyNcG25M8$default(SpanStyle spanStyle, Brush brush, float f, long j, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis, FontFamily fontFamily, String str, long j2, BaselineShift baselineShift, TextGeometricTransform textGeometricTransform, LocaleList localeList, long j3, TextDecoration textDecoration, Shadow shadow, PlatformSpanStyle platformSpanStyle, DrawStyle drawStyle, int i2, Object obj) {
        Shadow shadow2;
        PlatformSpanStyle platformSpanStyle2;
        float alpha = (i2 & 2) != 0 ? spanStyle.getAlpha() : f;
        long j4 = (i2 & 4) != 0 ? spanStyle.fontSize : j;
        FontWeight fontWeight2 = (i2 & 8) != 0 ? spanStyle.fontWeight : fontWeight;
        FontStyle fontStyle2 = (i2 & 16) != 0 ? spanStyle.fontStyle : fontStyle;
        FontSynthesis fontSynthesis2 = (i2 & 32) != 0 ? spanStyle.fontSynthesis : fontSynthesis;
        FontFamily fontFamily2 = (i2 & 64) != 0 ? spanStyle.fontFamily : fontFamily;
        String str2 = (i2 & Optimizer.OPTIMIZATION_GRAPH_WRAP) != 0 ? spanStyle.fontFeatureSettings : str;
        long j5 = (i2 & Optimizer.OPTIMIZATION_CACHE_MEASURES) != 0 ? spanStyle.letterSpacing : j2;
        BaselineShift baselineShift2 = (i2 & Optimizer.OPTIMIZATION_DEPENDENCY_ORDERING) != 0 ? spanStyle.baselineShift : baselineShift;
        TextGeometricTransform textGeometricTransform2 = (i2 & Optimizer.OPTIMIZATION_GROUPING) != 0 ? spanStyle.textGeometricTransform : textGeometricTransform;
        LocaleList localeList2 = (i2 & 2048) != 0 ? spanStyle.localeList : localeList;
        long j6 = (i2 & 4096) != 0 ? spanStyle.background : j3;
        TextDecoration textDecoration2 = (i2 & 8192) != 0 ? spanStyle.textDecoration : textDecoration;
        Shadow shadow3 = (i2 & 16384) != 0 ? spanStyle.shadow : shadow;
        if ((i2 & 32768) != 0) {
            shadow2 = shadow3;
        ...
        return spanStyle.m4767copyNcG25M8(brush, alpha, j4, fontWeight2, fontStyle2, fontSynthesis2, fontFamily2, str2, j5, baselineShift2, textGeometricTransform2, localeList2, j6, textDecoration2, shadow2, platformSpanStyle2, (i2 & 65536) != 0 ? spanStyle.drawStyle : drawStyle);
    }

    private final boolean hasSameNonLayoutAttributes(SpanStyle other) {
        return m.c(this.textForegroundStyle, other.textForegroundStyle) && m.c(this.textDecoration, other.textDecoration) && m.c(this.shadow, other.shadow) && m.c(this.drawStyle, other.drawStyle);
    }
    ...
    public final SpanStyle m4767copyNcG25M8(Brush brush, float alpha, long fontSize, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis, FontFamily fontFamily, String fontFeatureSettings, long letterSpacing, BaselineShift baselineShift, TextGeometricTransform textGeometricTransform, LocaleList localeList, long background, TextDecoration textDecoration, Shadow shadow, PlatformSpanStyle platformStyle, DrawStyle drawStyle) {
    ...
    public final long m4770getColor0d7_KjU() {
        return this.textForegroundStyle.mo5073getColor0d7_KjU();
    }
    ...
    public final boolean hasSameLayoutAffectingAttributes$ui_text_release(SpanStyle other) {
        ...
        return TextUnit.m5445equalsimpl0(this.fontSize, other.fontSize) && m.c(this.fontWeight, other.fontWeight) && m.c(this.fontStyle, other.fontStyle) && m.c(this.fontSynthesis, other.fontSynthesis) && m.c(this.fontFamily, other.fontFamily) && m.c(this.fontFeatureSettings, other.fontFeatureSettings) && TextUnit.m5445equalsimpl0(this.letterSpacing, other.letterSpacing) && m.c(this.baselineShift, other.baselineShift) && m.c(this.textGeometricTransform, other.textGeometricTransform) && m.c(this.localeList, other.localeList) && Color.m2819equalsimpl0(this.background, other.background) && m.c(this.platformStyle, other.platformStyle);
    }

    public int hashCode() {
        int iM2825hashCodeimpl = Color.m2825hashCodeimpl(m4770getColor0d7_KjU()) * 31;
        Brush brush = getBrush();
        int iM5449hashCodeimpl = (TextUnit.m5449hashCodeimpl(this.fontSize) + ((Float.floatToIntBits(getAlpha()) + ((iM2825hashCodeimpl + (brush != null ? brush.hashCode() : 0)) * 31)) * 31)) * 31;
        FontWeight fontWeight = this.fontWeight;
        int iHashCode = (iM5449hashCodeimpl + (fontWeight != null ? fontWeight.hashCode() : 0)) * 31;
        FontStyle fontStyle = this.fontStyle;
        int iM4898hashCodeimpl = (iHashCode + (fontStyle != null ? FontStyle.m4898hashCodeimpl(fontStyle.m4900unboximpl()) : 0)) * 31;
        FontSynthesis fontSynthesis = this.fontSynthesis;
        int iM4907hashCodeimpl = (iM4898hashCodeimpl + (fontSynthesis != null ? FontSynthesis.m4907hashCodeimpl(fontSynthesis.getValue()) : 0)) * 31;
        FontFamily fontFamily = this.fontFamily;
        int iHashCode2 = (iM4907hashCodeimpl + (fontFamily != null ? fontFamily.hashCode() : 0)) * 31;
        String str = this.fontFeatureSettings;
        int iM5449hashCodeimpl2 = (TextUnit.m5449hashCodeimpl(this.letterSpacing) + ((iHashCode2 + (str != null ? str.hashCode() : 0)) * 31)) * 31;
        BaselineShift baselineShift = this.baselineShift;
        int iM5063hashCodeimpl = (iM5449hashCodeimpl2 + (baselineShift != null ? BaselineShift.m5063hashCodeimpl(baselineShift.m5065unboximpl()) : 0)) * 31;
        TextGeometricTransform textGeometricTransform = this.textGeometricTransform;
        int iHashCode3 = (iM5063hashCodeimpl + (textGeometricTransform != null ? textGeometricTransform.hashCode() : 0)) * 31;
        LocaleList localeList = this.localeList;
        int iB = androidx.browser.browseractions.a.b(this.background, (iHashCode3 + (localeList != null ? localeList.hashCode() : 0)) * 31, 31);
        TextDecoration textDecoration = this.textDecoration;
        int iHashCode4 = (iB + (textDecoration != null ? textDecoration.hashCode() : 0)) * 31;
    ...
    public final int hashCodeLayoutAffectingAttributes$ui_text_release() {
        int iM5449hashCodeimpl = TextUnit.m5449hashCodeimpl(this.fontSize) * 31;
        FontWeight fontWeight = this.fontWeight;
        int iHashCode = (iM5449hashCodeimpl + (fontWeight != null ? fontWeight.hashCode() : 0)) * 31;
        FontStyle fontStyle = this.fontStyle;
        int iM4898hashCodeimpl = (iHashCode + (fontStyle != null ? FontStyle.m4898hashCodeimpl(fontStyle.m4900unboximpl()) : 0)) * 31;
        ...
        int iB = androidx.browser.browseractions.a.b(this.background, (iHashCode3 + (localeList != null ? localeList.hashCode() : 0)) * 31, 31);
        PlatformSpanStyle platformSpanStyle = this.platformStyle;
        return iB + (platformSpanStyle != null ? platformSpanStyle.hashCode() : 0);
    }
    ...
    public final SpanStyle merge(SpanStyle other) {
        ...
        long j = !TextUnitKt.m5466isUnspecifiedR2X_6o(other.fontSize) ? other.fontSize : this.fontSize;
        ...
        String str2 = str;
        long j2 = !TextUnitKt.m5466isUnspecifiedR2X_6o(other.letterSpacing) ? other.letterSpacing : this.letterSpacing;
        ...
        if (!(j3 != Color.INSTANCE.m2854getUnspecified0d7_KjU())) {
            j3 = this.background;
        }
        long j4 = j3;
        ...
        return new SpanStyle(textForegroundStyleMerge, j, fontWeight2, fontStyle2, fontSynthesis2, fontFamily2, str2, j2, baselineShift2, textGeometricTransform2, localeList2, j4, textDecoration2, shadow2, platformSpanStyleMergePlatformStyle, drawStyle, (DefaultConstructorMarker) null);
    }
    ...
    public String toString() {
        return "SpanStyle(color=" + ((Object) Color.m2826toStringimpl(m4770getColor0d7_KjU())) + ", brush=" + getBrush() + ", alpha=" + getAlpha() + ", fontSize=" + ((Object) TextUnit.m5455toStringimpl(this.fontSize)) + ", fontWeight=" + this.fontWeight + ", fontStyle=" + this.fontStyle + ", fontSynthesis=" + this.fontSynthesis + ", fontFamily=" + this.fontFamily + ", fontFeatureSettings=" + this.fontFeatureSettings + ", letterSpacing=" + ((Object) TextUnit.m5455toStringimpl(this.letterSpacing)) + ", baselineShift=" + this.baselineShift + ", textGeometricTransform=" + this.textGeometricTransform + ", localeList=" + this.localeList + ", background=" + ((Object) Color.m2826toStringimpl(this.background)) + ", textDecoration=" + this.textDecoration + ", shadow=" + this.shadow + ", platformStyle=" + this.platformStyle + ", drawStyle=" + this.drawStyle + ')';
    }
    ...
    public /* synthetic */ SpanStyle(TextForegroundStyle textForegroundStyle, long j, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis, FontFamily fontFamily, String str, long j2, BaselineShift baselineShift, TextGeometricTransform textGeometricTransform, LocaleList localeList, long j3, TextDecoration textDecoration, Shadow shadow, PlatformSpanStyle platformSpanStyle, DrawStyle drawStyle, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(textForegroundStyle, (i2 & 2) != 0 ? TextUnit.INSTANCE.m5459getUnspecifiedXSAIIZE() : j, (i2 & 4) != 0 ? null : fontWeight, (i2 & 8) != 0 ? null : fontStyle, (i2 & 16) != 0 ? null : fontSynthesis, (i2 & 32) != 0 ? null : fontFamily, (i2 & 64) != 0 ? null : str, (i2 & Optimizer.OPTIMIZATION_GRAPH_WRAP) != 0 ? TextUnit.INSTANCE.m5459getUnspecifiedXSAIIZE() : j2, (i2 & Optimizer.OPTIMIZATION_CACHE_MEASURES) != 0 ? null : baselineShift, (i2 & Optimizer.OPTIMIZATION_DEPENDENCY_ORDERING) != 0 ? null : textGeometricTransform, (i2 & Optimizer.OPTIMIZATION_GROUPING) != 0 ? null : localeList, (i2 & 2048) != 0 ? Color.INSTANCE.m2854getUnspecified0d7_KjU() : j3, (i2 & 4096) != 0 ? null : textDecoration, (i2 & 8192) != 0 ? null : shadow, (i2 & 16384) != 0 ? null : platformSpanStyle, (i2 & 32768) != 0 ? null : drawStyle, (DefaultConstructorMarker) null);
    }

    public /* synthetic */ SpanStyle(long j, long j2, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis, FontFamily fontFamily, String str, long j3, BaselineShift baselineShift, TextGeometricTransform textGeometricTransform, LocaleList localeList, long j4, TextDecoration textDecoration, Shadow shadow, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this((i2 & 1) != 0 ? Color.INSTANCE.m2854getUnspecified0d7_KjU() : j, (i2 & 2) != 0 ? TextUnit.INSTANCE.m5459getUnspecifiedXSAIIZE() : j2, (i2 & 4) != 0 ? null : fontWeight, (i2 & 8) != 0 ? null : fontStyle, (i2 & 16) != 0 ? null : fontSynthesis, (i2 & 32) != 0 ? null : fontFamily, (i2 & 64) != 0 ? null : str, (i2 & Optimizer.OPTIMIZATION_GRAPH_WRAP) != 0 ? TextUnit.INSTANCE.m5459getUnspecifiedXSAIIZE() : j3, (i2 & Optimizer.OPTIMIZATION_CACHE_MEASURES) != 0 ? null : baselineShift, (i2 & Optimizer.OPTIMIZATION_DEPENDENCY_ORDERING) != 0 ? null : textGeometricTransform, (i2 & Optimizer.OPTIMIZATION_GROUPING) != 0 ? null : localeList, (i2 & 2048) != 0 ? Color.INSTANCE.m2854getUnspecified0d7_KjU() : j4, (i2 & 4096) != 0 ? null : textDecoration, (i2 & 8192) != 0 ? null : shadow, (DefaultConstructorMarker) null);
    }
    ...
    private SpanStyle(long j, long j2, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis, FontFamily fontFamily, String str, long j3, BaselineShift baselineShift, TextGeometricTransform textGeometricTransform, LocaleList localeList, long j4, TextDecoration textDecoration, Shadow shadow) {
        this(TextForegroundStyle.INSTANCE.m5189from8_81llA(j), j2, fontWeight, fontStyle, fontSynthesis, fontFamily, str, j3, baselineShift, textGeometricTransform, localeList, j4, textDecoration, shadow, (PlatformSpanStyle) null, (DrawStyle) null, 32768, (DefaultConstructorMarker) null);
    }

    public /* synthetic */ SpanStyle(long j, long j2, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis, FontFamily fontFamily, String str, long j3, BaselineShift baselineShift, TextGeometricTransform textGeometricTransform, LocaleList localeList, long j4, TextDecoration textDecoration, Shadow shadow, PlatformSpanStyle platformSpanStyle, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this((i2 & 1) != 0 ? Color.INSTANCE.m2854getUnspecified0d7_KjU() : j, (i2 & 2) != 0 ? TextUnit.INSTANCE.m5459getUnspecifiedXSAIIZE() : j2, (i2 & 4) != 0 ? null : fontWeight, (i2 & 8) != 0 ? null : fontStyle, (i2 & 16) != 0 ? null : fontSynthesis, (i2 & 32) != 0 ? null : fontFamily, (i2 & 64) != 0 ? null : str, (i2 & Optimizer.OPTIMIZATION_GRAPH_WRAP) != 0 ? TextUnit.INSTANCE.m5459getUnspecifiedXSAIIZE() : j3, (i2 & Optimizer.OPTIMIZATION_CACHE_MEASURES) != 0 ? null : baselineShift, (i2 & Optimizer.OPTIMIZATION_DEPENDENCY_ORDERING) != 0 ? null : textGeometricTransform, (i2 & Optimizer.OPTIMIZATION_GROUPING) != 0 ? null : localeList, (i2 & 2048) != 0 ? Color.INSTANCE.m2854getUnspecified0d7_KjU() : j4, (i2 & 4096) != 0 ? null : textDecoration, (i2 & 8192) != 0 ? null : shadow, (i2 & 16384) != 0 ? null : platformSpanStyle, (DefaultConstructorMarker) null);
    }
    ...
    private SpanStyle(long j, long j2, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis, FontFamily fontFamily, String str, long j3, BaselineShift baselineShift, TextGeometricTransform textGeometricTransform, LocaleList localeList, long j4, TextDecoration textDecoration, Shadow shadow, PlatformSpanStyle platformSpanStyle) {
        this(TextForegroundStyle.INSTANCE.m5189from8_81llA(j), j2, fontWeight, fontStyle, fontSynthesis, fontFamily, str, j3, baselineShift, textGeometricTransform, localeList, j4, textDecoration, shadow, platformSpanStyle, (DrawStyle) null, 32768, (DefaultConstructorMarker) null);
    }

    public /* synthetic */ SpanStyle(long j, long j2, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis, FontFamily fontFamily, String str, long j3, BaselineShift baselineShift, TextGeometricTransform textGeometricTransform, LocaleList localeList, long j4, TextDecoration textDecoration, Shadow shadow, PlatformSpanStyle platformSpanStyle, DrawStyle drawStyle, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this((i2 & 1) != 0 ? Color.INSTANCE.m2854getUnspecified0d7_KjU() : j, (i2 & 2) != 0 ? TextUnit.INSTANCE.m5459getUnspecifiedXSAIIZE() : j2, (i2 & 4) != 0 ? null : fontWeight, (i2 & 8) != 0 ? null : fontStyle, (i2 & 16) != 0 ? null : fontSynthesis, (i2 & 32) != 0 ? null : fontFamily, (i2 & 64) != 0 ? null : str, (i2 & Optimizer.OPTIMIZATION_GRAPH_WRAP) != 0 ? TextUnit.INSTANCE.m5459getUnspecifiedXSAIIZE() : j3, (i2 & Optimizer.OPTIMIZATION_CACHE_MEASURES) != 0 ? null : baselineShift, (i2 & Optimizer.OPTIMIZATION_DEPENDENCY_ORDERING) != 0 ? null : textGeometricTransform, (i2 & Optimizer.OPTIMIZATION_GROUPING) != 0 ? null : localeList, (i2 & 2048) != 0 ? Color.INSTANCE.m2854getUnspecified0d7_KjU() : j4, (i2 & 4096) != 0 ? null : textDecoration, (i2 & 8192) != 0 ? null : shadow, (i2 & 16384) != 0 ? null : platformSpanStyle, (i2 & 32768) != 0 ? null : drawStyle, (DefaultConstructorMarker) null);
    }
    ...
    private SpanStyle(long j, long j2, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis, FontFamily fontFamily, String str, long j3, BaselineShift baselineShift, TextGeometricTransform textGeometricTransform, LocaleList localeList, long j4, TextDecoration textDecoration, Shadow shadow, PlatformSpanStyle platformSpanStyle, DrawStyle drawStyle) {
        this(TextForegroundStyle.INSTANCE.m5189from8_81llA(j), j2, fontWeight, fontStyle, fontSynthesis, fontFamily, str, j3, baselineShift, textGeometricTransform, localeList, j4, textDecoration, shadow, platformSpanStyle, drawStyle, (DefaultConstructorMarker) null);
    }

    public /* synthetic */ SpanStyle(Brush brush, float f, long j, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis, FontFamily fontFamily, String str, long j2, BaselineShift baselineShift, TextGeometricTransform textGeometricTransform, LocaleList localeList, long j3, TextDecoration textDecoration, Shadow shadow, PlatformSpanStyle platformSpanStyle, DrawStyle drawStyle, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(brush, (i2 & 2) != 0 ? Float.NaN : f, (i2 & 4) != 0 ? TextUnit.INSTANCE.m5459getUnspecifiedXSAIIZE() : j, (i2 & 8) != 0 ? null : fontWeight, (i2 & 16) != 0 ? null : fontStyle, (i2 & 32) != 0 ? null : fontSynthesis, (i2 & 64) != 0 ? null : fontFamily, (i2 & Optimizer.OPTIMIZATION_GRAPH_WRAP) != 0 ? null : str, (i2 & Optimizer.OPTIMIZATION_CACHE_MEASURES) != 0 ? TextUnit.INSTANCE.m5459getUnspecifiedXSAIIZE() : j2, (i2 & Optimizer.OPTIMIZATION_DEPENDENCY_ORDERING) != 0 ? null : baselineShift, (i2 & Optimizer.OPTIMIZATION_GROUPING) != 0 ? null : textGeometricTransform, (i2 & 2048) != 0 ? null : localeList, (i2 & 4096) != 0 ? Color.INSTANCE.m2854getUnspecified0d7_KjU() : j3, (i2 & 8192) != 0 ? null : textDecoration, (i2 & 16384) != 0 ? null : shadow, (32768 & i2) != 0 ? null : platformSpanStyle, (i2 & 65536) != 0 ? null : drawStyle, (DefaultConstructorMarker) null);
    }
