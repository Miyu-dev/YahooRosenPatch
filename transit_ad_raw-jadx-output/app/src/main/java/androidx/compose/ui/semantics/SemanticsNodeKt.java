...
public final class SemanticsNodeKt {
    ...
    public static final SemanticsModifierNode getOuterMergingSemantics(LayoutNode layoutNode) {
        ...
        int iM4446constructorimpl = NodeKind.m4446constructorimpl(8);
        if ((nodes.getAggregateChildKindSet() & iM4446constructorimpl) != 0) {
            head = nodes.getHead();
            while (head != 0) {
                if ((head.getKindSet() & iM4446constructorimpl) == 0 || !(head instanceof SemanticsModifierNode) || !((SemanticsModifierNode) head).getSemanticsConfiguration().getIsMergingSemanticsOfDescendants()) {
    ...
    public static final SemanticsModifierNode getOuterSemantics(LayoutNode layoutNode) {
        ...
        if ((nodes.getAggregateChildKindSet() & iM4446constructorimpl) != 0) {
            head = nodes.getHead();
            while (head != 0) {
                if ((head.getKindSet() & iM4446constructorimpl) != 0 && (head instanceof SemanticsModifierNode)) {
                    break;
                }
                if ((head.getAggregateChildKindSet() & iM4446constructorimpl) == 0) {
                    break;
