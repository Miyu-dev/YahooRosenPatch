...
public final class ColorSpaceKt {
    ...
    public static final float[] chromaticAdaptation(float[] fArr, float[] fArr2, float[] fArr3) {
        ...
        kotlin.jvm.internal.m.h(fArr2, "srcWhitePoint");
        kotlin.jvm.internal.m.h(fArr3, "dstWhitePoint");
    ...
    public static final boolean compare(TransferParameters transferParameters, TransferParameters transferParameters2) {
        kotlin.jvm.internal.m.h(transferParameters, "a");
    ...
    public static final Connector m3206connectYBCOT_4(ColorSpace colorSpace, ColorSpace colorSpace2, int i2) {
        kotlin.jvm.internal.m.h(colorSpace, "$this$connect");
        kotlin.jvm.internal.m.h(colorSpace2, "destination");
        ...
        if (colorSpace == colorSpaces.getSrgb()) {
            ...
            if (colorSpace2 == colorSpaces.getOklab() && RenderIntent.m3216equalsimpl0(i2, RenderIntent.INSTANCE.m3221getPerceptualuksYyKA())) {
                return Connector.INSTANCE.getSrgbToOklabPerceptual$ui_graphics_release();
            }
        } else if (colorSpace == colorSpaces.getOklab() && colorSpace2 == colorSpaces.getSrgb() && RenderIntent.m3216equalsimpl0(i2, RenderIntent.INSTANCE.m3221getPerceptualuksYyKA())) {
        ...
        long jM3204getModelxdoWZVw = colorSpace.getModel();
        ColorModel.Companion companion = ColorModel.INSTANCE;
        DefaultConstructorMarker defaultConstructorMarker = null;
        return (ColorModel.m3195equalsimpl0(jM3204getModelxdoWZVw, companion.m3202getRgbxdoWZVw()) && ColorModel.m3195equalsimpl0(colorSpace2.getModel(), companion.m3202getRgbxdoWZVw())) ? new Connector.RgbConnector((Rgb) colorSpace, (Rgb) colorSpace2, i2, defaultConstructorMarker) : new Connector(colorSpace, colorSpace2, i2, defaultConstructorMarker);
    }

    /* JADX INFO: renamed from: connect-YBCOT_4$default, reason: not valid java name */
    public static /* synthetic */ Connector m3207connectYBCOT_4$default(ColorSpace colorSpace, ColorSpace colorSpace2, int i2, int i3, Object obj) {
        if ((i3 & 1) != 0) {
            colorSpace2 = ColorSpaces.INSTANCE.getSrgb();
        }
        if ((i3 & 2) != 0) {
            i2 = RenderIntent.INSTANCE.m3221getPerceptualuksYyKA();
        }
        return m3206connectYBCOT_4(colorSpace, colorSpace2, i2);
    }

    public static final float[] inverse3x3(float[] fArr) {
        kotlin.jvm.internal.m.h(fArr, "m");
        float f = fArr[0];
        float f2 = fArr[3];
        float f3 = fArr[6];
        float f4 = fArr[1];
    ...
    public static final float[] mul3x3(float[] fArr, float[] fArr2) {
        kotlin.jvm.internal.m.h(fArr, "lhs");
        kotlin.jvm.internal.m.h(fArr2, "rhs");
    ...
    public static final ColorSpace adapt(ColorSpace colorSpace, WhitePoint whitePoint, Adaptation adaptation) {
        kotlin.jvm.internal.m.h(colorSpace, "<this>");
        kotlin.jvm.internal.m.h(whitePoint, "whitePoint");
        kotlin.jvm.internal.m.h(adaptation, "adaptation");
        if (!ColorModel.m3195equalsimpl0(colorSpace.getModel(), ColorModel.INSTANCE.m3202getRgbxdoWZVw())) {
            return colorSpace;
        }
    ...
    public static final boolean compare(WhitePoint whitePoint, WhitePoint whitePoint2) {
        kotlin.jvm.internal.m.h(whitePoint, "a");
        kotlin.jvm.internal.m.h(whitePoint2, "b");
    ...
    public static final boolean compare(float[] fArr, float[] fArr2) {
        kotlin.jvm.internal.m.h(fArr, "a");
        kotlin.jvm.internal.m.h(fArr2, "b");
        if (fArr == fArr2) {
            return true;
        }
