...
public final class XmlVectorParser_androidKt {
    ...
    public static final ImageVector.Builder createVectorImageBuilder(AndroidVectorParser androidVectorParser, Resources resources, Resources.Theme theme, AttributeSet attributeSet) throws XmlPullParserException {
        long jM2854getUnspecified0d7_KjU;
        int iM2766getSrcIn0nO6VwU;
        ColorStateList namedColorStateList;
        m.h(androidVectorParser, "<this>");
        m.h(resources, "res");
        ...
        if (typedArrayObtainAttributes.hasValue(androidVectorResources.getSTYLEABLE_VECTOR_DRAWABLE_TINT())) {
            ...
            jM2854getUnspecified0d7_KjU = (typedValue.type == 2 || (namedColorStateList = androidVectorParser.getNamedColorStateList(typedArrayObtainAttributes, theme, "tint", androidVectorResources.getSTYLEABLE_VECTOR_DRAWABLE_TINT())) == null) ? Color.INSTANCE.m2854getUnspecified0d7_KjU() : ColorKt.Color(namedColorStateList.getDefaultColor());
        } else {
            jM2854getUnspecified0d7_KjU = Color.INSTANCE.m2854getUnspecified0d7_KjU();
        }
        long j = jM2854getUnspecified0d7_KjU;
        ...
        if (i2 == -1) {
            iM2766getSrcIn0nO6VwU = BlendMode.INSTANCE.m2766getSrcIn0nO6VwU();
        } else if (i2 == 3) {
            iM2766getSrcIn0nO6VwU = BlendMode.INSTANCE.m2768getSrcOver0nO6VwU();
        } else if (i2 == 5) {
            iM2766getSrcIn0nO6VwU = BlendMode.INSTANCE.m2766getSrcIn0nO6VwU();
        } else if (i2 != 9) {
            switch (i2) {
                case 14:
                    iM2766getSrcIn0nO6VwU = BlendMode.INSTANCE.m2757getModulate0nO6VwU();
                    break;
                case 15:
                    iM2766getSrcIn0nO6VwU = BlendMode.INSTANCE.m2762getScreen0nO6VwU();
                    break;
                case 16:
                    iM2766getSrcIn0nO6VwU = BlendMode.INSTANCE.m2760getPlus0nO6VwU();
                    break;
                default:
                    iM2766getSrcIn0nO6VwU = BlendMode.INSTANCE.m2766getSrcIn0nO6VwU();
                    break;
            ...
            iM2766getSrcIn0nO6VwU = BlendMode.INSTANCE.m2765getSrcAtop0nO6VwU();
        }
        int i3 = iM2766getSrcIn0nO6VwU;
        float fM5267constructorimpl = Dp.m5267constructorimpl(dimension / resources.getDisplayMetrics().density);
        float fM5267constructorimpl2 = Dp.m5267constructorimpl(dimension2 / resources.getDisplayMetrics().density);
        typedArrayObtainAttributes.recycle();
        return new ImageVector.Builder(null, fM5267constructorimpl, fM5267constructorimpl2, namedFloat, namedFloat2, j, i3, namedBoolean, 1, null);
    }

    /* JADX INFO: renamed from: getStrokeLineCap-CSYIeUk, reason: not valid java name */
    private static final int m3386getStrokeLineCapCSYIeUk(int i2, int i3) {
        return i2 != 0 ? i2 != 1 ? i2 != 2 ? i3 : StrokeCap.INSTANCE.m3143getSquareKaPHkGw() : StrokeCap.INSTANCE.m3142getRoundKaPHkGw() : StrokeCap.INSTANCE.m3141getButtKaPHkGw();
    }

    /* JADX INFO: renamed from: getStrokeLineCap-CSYIeUk$default, reason: not valid java name */
    public static /* synthetic */ int m3387getStrokeLineCapCSYIeUk$default(int i2, int i3, int i4, Object obj) {
        if ((i4 & 2) != 0) {
            i3 = StrokeCap.INSTANCE.m3141getButtKaPHkGw();
        }
        return m3386getStrokeLineCapCSYIeUk(i2, i3);
    }

    /* JADX INFO: renamed from: getStrokeLineJoin-kLtJ_vA, reason: not valid java name */
    private static final int m3388getStrokeLineJoinkLtJ_vA(int i2, int i3) {
        return i2 != 0 ? i2 != 1 ? i2 != 2 ? i3 : StrokeJoin.INSTANCE.m3151getBevelLxFBmk8() : StrokeJoin.INSTANCE.m3153getRoundLxFBmk8() : StrokeJoin.INSTANCE.m3152getMiterLxFBmk8();
    }

    /* JADX INFO: renamed from: getStrokeLineJoin-kLtJ_vA$default, reason: not valid java name */
    public static /* synthetic */ int m3389getStrokeLineJoinkLtJ_vA$default(int i2, int i3, int i4, Object obj) {
        if ((i4 & 2) != 0) {
            i3 = StrokeJoin.INSTANCE.m3152getMiterLxFBmk8();
        }
        return m3388getStrokeLineJoinkLtJ_vA(i2, i3);
    }

    public static final boolean isAtEnd(XmlPullParser xmlPullParser) {
        m.h(xmlPullParser, "<this>");
    ...
    public static final void parseClipPath(AndroidVectorParser androidVectorParser, Resources resources, Resources.Theme theme, AttributeSet attributeSet, ImageVector.Builder builder) {
        ...
        typedArrayObtainAttributes.recycle();
        builder.addGroup((254 & 1) != 0 ? "" : string, (254 & 2) != 0 ? 0.0f : 0.0f, (254 & 4) != 0 ? 0.0f : 0.0f, (254 & 8) != 0 ? 0.0f : 0.0f, (254 & 16) != 0 ? 1.0f : 0.0f, (254 & 32) == 0 ? 0.0f : 1.0f, (254 & 64) != 0 ? 0.0f : 0.0f, (254 & Optimizer.OPTIMIZATION_GRAPH_WRAP) == 0 ? 0.0f : 0.0f, (254 & Optimizer.OPTIMIZATION_CACHE_MEASURES) != 0 ? VectorKt.getEmptyPath() : listAddPathNodes);
    }
    ...
    public static final int parseCurrentVectorNode(AndroidVectorParser androidVectorParser, Resources resources, AttributeSet attributeSet, Resources.Theme theme, ImageVector.Builder builder, int i2) throws XmlPullParserException {
        ...
        if (eventType != 2) {
            if (eventType != 3 || !m.c(SHAPE_GROUP, androidVectorParser.getXmlParser().getName())) {
                return i2;
            }
            int i3 = i2 + 1;
    ...
    public static final void parsePath(AndroidVectorParser androidVectorParser, Resources resources, Resources.Theme theme, AttributeSet attributeSet, ImageVector.Builder builder) {
        ...
        int iM3386getStrokeLineCapCSYIeUk = m3386getStrokeLineCapCSYIeUk(androidVectorParser.getNamedInt(typedArrayObtainAttributes, "strokeLineCap", androidVectorResources.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_CAP(), -1), StrokeCap.INSTANCE.m3141getButtKaPHkGw());
        int iM3388getStrokeLineJoinkLtJ_vA = m3388getStrokeLineJoinkLtJ_vA(androidVectorParser.getNamedInt(typedArrayObtainAttributes, "strokeLineJoin", androidVectorResources.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_JOIN(), -1), StrokeJoin.INSTANCE.m3151getBevelLxFBmk8());
        ...
        builder.m3360addPathoIyEayM(listAddPathNodes, namedInt == 0 ? companion.m3072getNonZeroRgk1Os() : companion.m3071getEvenOddRgk1Os(), str, brushObtainBrushFromComplexColor, namedFloat, brushObtainBrushFromComplexColor2, namedFloat3, namedFloat4, iM3386getStrokeLineCapCSYIeUk, iM3388getStrokeLineJoinkLtJ_vA, namedFloat2, namedFloat7, namedFloat5, namedFloat6);
    }
