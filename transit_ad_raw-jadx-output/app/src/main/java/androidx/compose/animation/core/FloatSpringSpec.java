...
public final class FloatSpringSpec implements FloatAnimationSpec {
    ...
    public float getValueFromNanos(long playTimeNanos, float initialValue, float targetValue, float initialVelocity) {
        ...
        return Motion.m129getValueimpl(this.spring.m135updateValuesIJZedt4$animation_core_release(initialValue, initialVelocity, j));
    }
    ...
    public float getVelocityFromNanos(long playTimeNanos, float initialValue, float targetValue, float initialVelocity) {
        long j = playTimeNanos / AnimationKt.MillisToNanos;
        this.spring.setFinalPosition(targetValue);
        return Motion.m130getVelocityimpl(this.spring.m135updateValuesIJZedt4$animation_core_release(initialValue, initialVelocity, j));
    }
    ...
    public /* synthetic */ FloatSpringSpec(float f, float f2, float f3, int i2, DefaultConstructorMarker defaultConstructorMarker) {
