...
public final /* data */ class Scale {
    ...
    public static /* synthetic */ Scale m87copybnNdC4k$default(Scale scale, float f, long j, FiniteAnimationSpec finiteAnimationSpec, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            f = scale.scale;
        }
        if ((i2 & 2) != 0) {
    ...
    public boolean equals(Object other) {
        ...
        return Float.compare(this.scale, scale.scale) == 0 && TransformOrigin.m3173equalsimpl0(this.transformOrigin, scale.transformOrigin) && m.c(this.animationSpec, scale.animationSpec);
    }
    ...
    public int hashCode() {
        return this.animationSpec.hashCode() + ((TransformOrigin.m3176hashCodeimpl(this.transformOrigin) + (Float.floatToIntBits(this.scale) * 31)) * 31);
    }

    public String toString() {
        return "Scale(scale=" + this.scale + ", transformOrigin=" + ((Object) TransformOrigin.m3177toStringimpl(this.transformOrigin)) + ", animationSpec=" + this.animationSpec + ')';
    }
