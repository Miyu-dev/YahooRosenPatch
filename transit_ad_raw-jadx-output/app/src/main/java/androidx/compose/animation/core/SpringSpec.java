...
public final class SpringSpec<T> implements FiniteAnimationSpec<T> {
    ...
    public boolean equals(Object other) {
        ...
        if (springSpec.dampingRatio == this.dampingRatio) {
            return ((springSpec.stiffness > this.stiffness ? 1 : (springSpec.stiffness == this.stiffness ? 0 : -1)) == 0) && m.c(springSpec.visibilityThreshold, this.visibilityThreshold);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return Float.floatToIntBits(this.stiffness) + v.a(this.dampingRatio, (t != null ? t.hashCode() : 0) * 31, 31);
    }
