...
public final /* data */ class Fade {
    ...
    public static /* synthetic */ Fade copy$default(Fade fade, float f, FiniteAnimationSpec finiteAnimationSpec, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            f = fade.alpha;
        }
        if ((i2 & 2) != 0) {
    ...
    public boolean equals(Object other) {
        ...
        return Float.compare(this.alpha, fade.alpha) == 0 && m.c(this.animationSpec, fade.animationSpec);
    }
