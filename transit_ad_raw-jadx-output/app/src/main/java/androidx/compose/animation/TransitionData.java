...
public final /* data */ class TransitionData {
    ...
    public boolean equals(Object other) {
        ...
        return m.c(this.fade, transitionData.fade) && m.c(this.slide, transitionData.slide) && m.c(this.changeSize, transitionData.changeSize) && m.c(this.scale, transitionData.scale);
    }
