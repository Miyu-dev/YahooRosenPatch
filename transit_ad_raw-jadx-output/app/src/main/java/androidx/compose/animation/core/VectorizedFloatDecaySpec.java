...
final class VectorizedFloatDecaySpec<V extends AnimationVector> implements VectorizedDecayAnimationSpec<V> {
    ...
    public VectorizedFloatDecaySpec(FloatDecayAnimationSpec floatDecayAnimationSpec) {
        m.h(floatDecayAnimationSpec, "floatDecaySpec");
    ...
    public V getTargetValue(V initialValue, V initialVelocity) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            v2.set$animation_core_release(i2, this.floatDecaySpec.getTargetValue(initialValue.get$animation_core_release(i2), initialVelocity.get$animation_core_release(i2)));
        }
    ...
    public V getValueFromNanos(long playTimeNanos, V initialValue, V initialVelocity) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            v2.set$animation_core_release(i2, this.floatDecaySpec.getValueFromNanos(playTimeNanos, initialValue.get$animation_core_release(i2), initialVelocity.get$animation_core_release(i2)));
        }
    ...
    public V getVelocityFromNanos(long playTimeNanos, V initialValue, V initialVelocity) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            v2.set$animation_core_release(i2, this.floatDecaySpec.getVelocityFromNanos(playTimeNanos, initialValue.get$animation_core_release(i2), initialVelocity.get$animation_core_release(i2)));
        }
