...
public final class DiscountKt {
    ...
    public static final ImageVector getDiscount(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.Discount", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderX = a.x(19.0f, 9.79f, 11.21f, 2.0f, 5.0f);
        pathBuilderX.verticalLineToRelative(6.21f);
        a.C(pathBuilderX, 12.79f, 16.0f, 19.0f, 9.79f);
        pathBuilderX.moveTo(7.25f, 5.5f);
        pathBuilderX.curveTo(6.56f, 5.5f, 6.0f, 4.94f, 6.0f, 4.25f);
        pathBuilderX.reflectiveCurveTo(6.56f, 3.0f, 7.25f, 3.0f);
        pathBuilderX.reflectiveCurveTo(8.5f, 3.56f, 8.5f, 4.25f);
        ImageVector.Builder.m3359addPathoIyEayM$default(builder, h.t(pathBuilderX, 7.94f, 5.5f, 7.25f, 5.5f), defaultFillType, "", solidColor, 0.3f, null, 0.3f, 1.0f, iM3141getButtKaPHkGw, iM3151getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        int defaultFillType2 = VectorKt.getDefaultFillType();
        SolidColor solidColor2 = new SolidColor(companion.m2844getBlack0d7_KjU(), null);
        int iM3141getButtKaPHkGw2 = companion2.m3141getButtKaPHkGw();
        int iM3151getBevelLxFBmk82 = companion3.m3151getBevelLxFBmk8();
        PathBuilder pathBuilderB = androidx.appcompat.graphics.drawable.a.b(12.79f, 21.0f, 3.0f, 11.21f, 2.0f);
        ...
        ImageVector.Builder.m3359addPathoIyEayM$default(builder, b.h(pathBuilderB, 12.79f, 21.0f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw2, iM3151getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        ImageVector.Builder.m3359addPathoIyEayM$default(builder, s.i(pathBuilderD, 5.0f, 8.21f, 2.0f), defaultFillType3, "", solidColor3, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw3, iM3151getBevelLxFBmk83, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
