...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_rollerSkating", "Landroidx/compose/ui/graphics/vector/ImageVector;", "RollerSkating", "Landroidx/compose/material/icons/Icons$TwoTone;", "getRollerSkating", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class RollerSkatingKt {
    ...
    public static final ImageVector getRollerSkating(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.RollerSkating", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderG = androidx.appcompat.app.m.g(18.0f, 14.0f, 6.0f, 3.0f, 5.0f);
        pathBuilderG.verticalLineToRelative(1.0f);
        pathBuilderG.horizontalLineTo(9.5f);
        pathBuilderG.curveTo(9.22f, 4.0f, 9.0f, 4.22f, 9.0f, 4.5f);
        pathBuilderG.curveTo(9.0f, 4.78f, 9.22f, 5.0f, 9.5f, 5.0f);
        s.C(pathBuilderG, 11.0f, 0.1f, 1.0f, 9.5f);
        pathBuilderG.curveTo(9.22f, 6.0f, 9.0f, 6.22f, 9.0f, 6.5f);
        pathBuilderG.curveTo(9.0f, 6.78f, 9.22f, 7.0f, 9.5f, 7.0f);
        pathBuilderG.horizontalLineToRelative(1.81f);
        pathBuilderG.curveToRelative(0.45f, 1.12f, 1.4f, 2.01f, 2.6f, 2.36f);
        pathBuilderG.lineToRelative(2.62f, 0.73f);
        pathBuilderG.curveTo(17.4f, 10.33f, 18.0f, 11.1f, 18.0f, 12.0f);
        a.y(pathBuilderG, 14.0f, 5.0f, 21.0f);
        ...
        pathBuilderG.curveTo(6.0f, 20.55f, 5.55f, 21.0f, 5.0f, 21.0f);
        pathBuilderG.close();
        pathBuilderG.moveTo(19.0f, 21.0f);
        pathBuilderG.curveToRelative(-0.55f, 0.0f, -1.0f, -0.45f, -1.0f, -1.0f);
        pathBuilderG.curveToRelative(0.0f, -0.55f, 0.45f, -1.0f, 1.0f, -1.0f);
        pathBuilderG.reflectiveCurveToRelative(1.0f, 0.45f, 1.0f, 1.0f);
        pathBuilderG.curveTo(20.0f, 20.55f, 19.55f, 21.0f, 19.0f, 21.0f);
        pathBuilderG.close();
        pathBuilderG.moveTo(12.0f, 21.0f);
        pathBuilderG.curveToRelative(-0.55f, 0.0f, -1.0f, -0.45f, -1.0f, -1.0f);
        pathBuilderG.curveToRelative(0.0f, -0.55f, 0.45f, -1.0f, 1.0f, -1.0f);
        pathBuilderG.reflectiveCurveToRelative(1.0f, 0.45f, 1.0f, 1.0f);
        pathBuilderG.curveTo(13.0f, 20.55f, 12.55f, 21.0f, 12.0f, 21.0f);
        pathBuilderG.close();
        ...
        PathBuilder pathBuilderD = androidx.browser.browseractions.a.d(20.0f, 12.0f);
        ...
        a.y(pathBuilderD, 14.0f, 5.0f, 17.0f);
