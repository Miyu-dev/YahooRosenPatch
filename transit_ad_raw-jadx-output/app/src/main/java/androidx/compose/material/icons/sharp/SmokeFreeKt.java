...
public final class SmokeFreeKt {
    ...
    public static final ImageVector getSmokeFree(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.SmokeFree", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m2844getBlack0d7_KjU(), null);
        int iM3141getButtKaPHkGw = StrokeCap.INSTANCE.m3141getButtKaPHkGw();
        int iM3151getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3151getBevelLxFBmk8();
        PathBuilder pathBuilderB = a.b(20.5f, 13.0f, 22.0f, 13.0f, 3.0f);
        androidx.appcompat.view.menu.a.w(pathBuilderB, -1.5f, 14.5f, 8.65f, 1.53f);
        ...
        androidx.compose.animation.a.j(pathBuilderB, 17.0f, 13.0f, -2.34f);
        androidx.appcompat.view.menu.a.z(pathBuilderB, 17.0f, 15.34f, 18.85f, 4.73f);
        ...
        b.r(pathBuilderB, 18.0f, 13.0f, 1.5f, 3.0f);
        androidx.appcompat.view.menu.a.z(pathBuilderB, 18.0f, 16.0f, 3.41f, 4.59f);
        pathBuilderB.lineTo(2.0f, 6.0f);
        pathBuilderB.lineToRelative(7.0f, 7.0f);
        a.b.s(pathBuilderB, 2.0f, 13.0f, 3.0f, 10.0f);
