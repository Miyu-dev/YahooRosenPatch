...
public final class BungalowKt {
    ...
    public static final ImageVector getBungalow(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.Bungalow", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderW = a.w(12.0f, 6.78f, -3.0f, 4.8f, 19.0f);
        androidx.appcompat.view.menu.a.t(pathBuilderW, 2.0f, -3.0f, 2.0f, 3.0f);
        androidx.appcompat.app.m.C(pathBuilderW, 2.0f, -7.42f, 12.0f, 6.78f);
        androidx.appcompat.view.menu.a.x(pathBuilderW, 13.0f, 14.0f, -2.0f, -2.0f);
        ...
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, android.support.v4.media.a.j(pathBuilderF, 11.59f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw2, iM3151getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
