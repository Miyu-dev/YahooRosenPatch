...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_integrationInstructions", "Landroidx/compose/ui/graphics/vector/ImageVector;", "IntegrationInstructions", "Landroidx/compose/material/icons/Icons$Rounded;", "getIntegrationInstructions", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class IntegrationInstructionsKt {
    ...
    public static final ImageVector getIntegrationInstructions(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.IntegrationInstructions", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        a.t(pathBuilderB, 10.3f, 14.88f, 10.3f, 14.88f);
        ...
        pathBuilderB.curveToRelative(0.39f, 0.39f, 0.39f, 1.02f, 0.0f, 1.41f);
        pathBuilderB.lineTo(8.83f, 12.0f);
        pathBuilderB.lineToRelative(1.46f, 1.46f);
        pathBuilderB.curveTo(10.68f, 13.85f, 10.69f, 14.49f, 10.3f, 14.88f);
        pathBuilderB.close();
        ...
        a.t(pathBuilderB, 13.7f, 14.88f, 13.7f, 14.88f);
        pathBuilderB.curveToRelative(-0.39f, -0.39f, -0.39f, -1.02f, 0.0f, -1.41f);
        ...
        pathBuilderB.curveToRelative(0.39f, 0.39f, 0.39f, 1.02f, 0.0f, 1.41f);
        pathBuilderB.lineToRelative(-2.17f, 2.17f);
        pathBuilderB.curveTo(14.73f, 15.27f, 14.09f, 15.27f, 13.7f, 14.88f);
        pathBuilderB.close();
