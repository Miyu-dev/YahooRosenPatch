...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_draw", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Draw", "Landroidx/compose/material/icons/Icons$Sharp;", "getDraw", "(Landroidx/compose/material/icons/Icons$Sharp;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-sharp_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class DrawKt {
    ...
    public static final ImageVector getDraw(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.Draw", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m2844getBlack0d7_KjU(), null);
        int iM3141getButtKaPHkGw = StrokeCap.INSTANCE.m3141getButtKaPHkGw();
        int iM3151getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3151getBevelLxFBmk8();
        PathBuilder pathBuilderA = b.a(18.85f, 10.39f, 2.48f, -2.48f);
        pathBuilderA.lineToRelative(-4.24f, -4.24f);
        s.r(pathBuilderA, -2.48f, 2.48f, 18.85f, 10.39f);
        pathBuilderA.moveTo(13.19f, 7.56f);
        androidx.appcompat.app.m.r(pathBuilderA, 4.0f, 16.76f, 21.0f, 4.24f);
        s.r(pathBuilderA, 9.19f, -9.19f, 13.19f, 7.56f);
        pathBuilderA.moveTo(19.0f, 17.5f);
        pathBuilderA.curveToRelative(0.0f, 2.19f, -2.54f, 3.5f, -5.0f, 3.5f);
        pathBuilderA.curveToRelative(-0.48f, 0.0f, -1.0f, -0.07f, -1.0f, -0.07f);
        pathBuilderA.curveToRelative(0.0f, -0.34f, 0.0f, -2.03f, 0.0f, -2.03f);
        pathBuilderA.reflectiveCurveTo(13.46f, 19.0f, 14.0f, 19.0f);
        ...
        pathBuilderA.curveTo(5.76f, 5.0f, 5.0f, 5.61f, 5.0f, 6.0f);
        pathBuilderA.horizontalLineTo(3.0f);
        pathBuilderA.curveToRelative(0.0f, -1.65f, 1.7f, -3.0f, 4.0f, -3.0f);
