...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_sentimentDissatisfied", "Landroidx/compose/ui/graphics/vector/ImageVector;", "SentimentDissatisfied", "Landroidx/compose/material/icons/Icons$Filled;", "getSentimentDissatisfied", "(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-filled_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class SentimentDissatisfiedKt {
    ...
    public static final ImageVector getSentimentDissatisfied(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.SentimentDissatisfied", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderD.curveToRelative(0.73f, 0.0f, 1.39f, 0.19f, 1.97f, 0.53f);
        pathBuilderD.curveToRelative(0.12f, -0.14f, 0.86f, -0.98f, 1.01f, -1.14f);
        pathBuilderD.curveToRelative(-0.85f, -0.56f, -1.87f, -0.89f, -2.98f, -0.89f);
        pathBuilderD.curveToRelative(-1.11f, 0.0f, -2.13f, 0.33f, -2.99f, 0.88f);
        pathBuilderD.curveToRelative(0.97f, 1.09f, 0.01f, 0.02f, 1.01f, 1.14f);
        pathBuilderD.curveToRelative(0.59f, -0.33f, 1.25f, -0.52f, 1.98f, -0.52f);
        pathBuilderD.close();
