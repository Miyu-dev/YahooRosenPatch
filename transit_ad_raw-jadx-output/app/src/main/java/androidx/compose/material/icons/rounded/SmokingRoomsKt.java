...
public final class SmokingRoomsKt {
    ...
    public static final ImageVector getSmokingRooms(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.SmokingRooms", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m2844getBlack0d7_KjU(), null);
        int iM3141getButtKaPHkGw = StrokeCap.INSTANCE.m3141getButtKaPHkGw();
        int iM3151getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3151getBevelLxFBmk8();
        PathBuilder pathBuilderB = h.b(15.5f, 16.0f, -12.0f);
        pathBuilderB.curveToRelative(-0.83f, 0.0f, -1.5f, 0.67f, -1.5f, 1.5f);
        pathBuilderB.reflectiveCurveTo(2.67f, 19.0f, 3.5f, 19.0f);
        pathBuilderB.horizontalLineToRelative(12.0f);
        pathBuilderB.curveToRelative(0.83f, 0.0f, 1.5f, -0.67f, 1.5f, -1.5f);
        pathBuilderB.reflectiveCurveToRelative(-0.67f, -1.5f, -1.5f, -1.5f);
        pathBuilderB.close();
        pathBuilderB.moveTo(18.85f, 7.73f);
        pathBuilderB.curveToRelative(0.62f, -0.61f, 1.0f, -1.45f, 1.0f, -2.38f);
        pathBuilderB.curveToRelative(0.0f, -1.51f, -1.0f, -2.79f, -2.38f, -3.21f);
        pathBuilderB.curveToRelative(-0.48f, -0.14f, -0.97f, 0.22f, -0.97f, 0.72f);
        pathBuilderB.curveToRelative(0.0f, 0.33f, 0.21f, 0.62f, 0.52f, 0.71f);
        pathBuilderB.curveToRelative(0.77f, 0.23f, 1.33f, 0.94f, 1.33f, 1.78f);
        pathBuilderB.curveToRelative(0.0f, 0.82f, -0.53f, 1.51f, -1.27f, 1.76f);
        pathBuilderB.curveToRelative(-0.33f, 0.11f, -0.58f, 0.39f, -0.58f, 0.74f);
        pathBuilderB.lineTo(16.5f, 8.0f);
        ...
        a.j(pathBuilderB, 16.03f, 10.2f, -1.3f);
        ...
        pathBuilderB.curveToRelative(0.03f, 1.84f, 1.62f, 3.29f, 3.46f, 3.29f);
        pathBuilderB.horizontalLineToRelative(1.42f);
        ...
        pathBuilderB.curveToRelative(-0.01f, -1.81f, -1.61f, -3.16f, -3.48f, -3.16f);
        b.r(pathBuilderB, 18.0f, 16.0f, 1.5f, 3.0f);
        androidx.appcompat.view.menu.a.z(pathBuilderB, 18.0f, 19.0f, 20.5f, 16.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, b.j(pathBuilderB, 22.0f, 16.0f, 3.0f, -1.5f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw, iM3151getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
