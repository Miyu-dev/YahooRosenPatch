...
public final class ArrowDropDownKt {
    ...
    public static final ImageVector getArrowDropDown(Icons.Outlined outlined) {
        ...
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(new ImageVector.Builder("Outlined.ArrowDropDown", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null), v.k(b.a(7.0f, 10.0f, 5.0f, 5.0f), 5.0f, -5.0f, 7.0f), VectorKt.getDefaultFillType(), "", new SolidColor(Color.INSTANCE.m2844getBlack0d7_KjU(), null), 1.0f, null, 1.0f, 1.0f, StrokeCap.INSTANCE.m3141getButtKaPHkGw(), StrokeJoin.INSTANCE.m3151getBevelLxFBmk8(), 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
