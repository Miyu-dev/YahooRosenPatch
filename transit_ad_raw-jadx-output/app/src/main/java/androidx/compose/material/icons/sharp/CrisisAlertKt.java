...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_crisisAlert", "Landroidx/compose/ui/graphics/vector/ImageVector;", "CrisisAlert", "Landroidx/compose/material/icons/Icons$Sharp;", "getCrisisAlert", "(Landroidx/compose/material/icons/Icons$Sharp;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-sharp_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class CrisisAlertKt {
    ...
    public static final ImageVector getCrisisAlert(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.CrisisAlert", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m2844getBlack0d7_KjU(), null);
        int iM3141getButtKaPHkGw = StrokeCap.INSTANCE.m3141getButtKaPHkGw();
        int iM3151getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3151getBevelLxFBmk8();
        PathBuilder pathBuilderD = a.d(14.5f, 2.5f);
        pathBuilderD.curveToRelative(0.0f, 1.06f, -0.75f, 3.64f, -1.19f, 5.04f);
        pathBuilderD.curveTo(13.13f, 8.11f, 12.6f, 8.5f, 12.0f, 8.5f);
        pathBuilderD.horizontalLineToRelative(0.0f);
        pathBuilderD.curveToRelative(-0.6f, 0.0f, -1.13f, -0.39f, -1.31f, -0.96f);
        pathBuilderD.curveTo(10.25f, 6.14f, 9.5f, 3.56f, 9.5f, 2.5f);
