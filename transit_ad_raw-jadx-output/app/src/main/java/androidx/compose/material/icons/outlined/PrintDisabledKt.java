...
public final class PrintDisabledKt {
    ...
    public static final ImageVector getPrintDisabled(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.PrintDisabled", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderA = b.a(1.41f, 1.6f, 0.0f, 3.01f);
        ...
        pathBuilderA.moveTo(6.0f, 15.0f);
        ...
        androidx.compose.animation.b.k(pathBuilderA, 6.0f, 13.0f, 2.0f);
        b.y(pathBuilderA, 8.0f, 19.0f, -4.0f, 4.0f);
        s.r(pathBuilderA, 4.0f, 4.0f, 8.0f, 19.0f);
        androidx.appcompat.view.menu.a.x(pathBuilderA, 8.0f, 5.0f, 8.0f, 3.0f);
        pathBuilderA.horizontalLineToRelative(-5.34f);
        pathBuilderA.lineToRelative(2.0f, 2.0f);
        pathBuilderA.lineTo(19.0f, 10.0f);
        pathBuilderA.curveToRelative(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        pathBuilderA.verticalLineToRelative(4.0f);
        pathBuilderA.lineToRelative(-2.0f, 0.01f);
        pathBuilderA.lineTo(18.0f, 13.0f);
        pathBuilderA.horizontalLineToRelative(-2.34f);
        ...
        ImageVector.Builder.m3359addPathoIyEayM$default(builder, h.p(pathBuilderA, 2.0f, 2.0f, 8.0f, 5.0f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw, iM3151getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        int defaultFillType2 = VectorKt.getDefaultFillType();
        SolidColor solidColor2 = new SolidColor(companion.m2844getBlack0d7_KjU(), null);
        int iM3141getButtKaPHkGw2 = companion2.m3141getButtKaPHkGw();
        int iM3151getBevelLxFBmk82 = companion3.m3151getBevelLxFBmk8();
        PathBuilder pathBuilderB = v.b(18.0f, 11.51f, -1.0f, 0.0f);
