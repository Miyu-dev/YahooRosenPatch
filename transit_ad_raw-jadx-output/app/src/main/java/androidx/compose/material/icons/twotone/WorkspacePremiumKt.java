...
public final class WorkspacePremiumKt {
    ...
    public static final ImageVector getWorkspacePremium(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.WorkspacePremium", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderD.reflectiveCurveTo(15.31f, 4.0f, 12.0f, 4.0f);
        androidx.compose.animation.a.t(pathBuilderD, 14.31f, 13.69f, 12.0f, 11.93f);
        pathBuilderD.lineToRelative(-2.32f, 1.76f);
        pathBuilderD.lineToRelative(0.88f, -2.85f);
        pathBuilderD.lineTo(8.25f, 9.0f);
        pathBuilderD.horizontalLineToRelative(2.84f);
        pathBuilderD.lineTo(12.0f, 6.19f);
        pathBuilderD.lineTo(12.91f, 9.0f);
        pathBuilderD.horizontalLineToRelative(2.84f);
        s.r(pathBuilderD, -2.32f, 1.84f, 14.31f, 13.69f);
        pathBuilderD.moveTo(12.0f, 19.0f);
        pathBuilderD.lineToRelative(-4.0f, 1.02f);
        pathBuilderD.verticalLineToRelative(-3.1f);
        pathBuilderD.curveTo(9.18f, 17.6f, 10.54f, 18.0f, 12.0f, 18.0f);
        pathBuilderD.reflectiveCurveToRelative(2.82f, -0.4f, 4.0f, -1.08f);
        ImageVector.Builder.m3359addPathoIyEayM$default(builder, androidx.appcompat.view.menu.a.i(pathBuilderD, 3.1f, 12.0f, 19.0f), defaultFillType, "", solidColor, 0.3f, null, 0.3f, 1.0f, iM3141getButtKaPHkGw, iM3151getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        int defaultFillType2 = VectorKt.getDefaultFillType();
        SolidColor solidColor2 = new SolidColor(companion.m2844getBlack0d7_KjU(), null);
        int iM3141getButtKaPHkGw2 = companion2.m3141getButtKaPHkGw();
        int iM3151getBevelLxFBmk82 = companion3.m3151getBevelLxFBmk8();
        PathBuilder pathBuilderA = b.a(9.68f, 13.69f, 12.0f, 11.93f);
        pathBuilderA.lineToRelative(2.31f, 1.76f);
        pathBuilderA.lineToRelative(-0.88f, -2.85f);
        pathBuilderA.lineTo(15.75f, 9.0f);
        pathBuilderA.horizontalLineToRelative(-2.84f);
        pathBuilderA.lineTo(12.0f, 6.19f);
        pathBuilderA.lineTo(11.09f, 9.0f);
        pathBuilderA.horizontalLineTo(8.25f);
        s.r(pathBuilderA, 2.31f, 1.84f, 9.68f, 13.69f);
        ...
        pathBuilderA.verticalLineTo(23.0f);
        pathBuilderA.lineToRelative(6.0f, -2.0f);
        pathBuilderA.lineToRelative(6.0f, 2.0f);
        pathBuilderA.verticalLineToRelative(-7.72f);
        pathBuilderA.curveTo(19.24f, 13.87f, 20.0f, 12.03f, 20.0f, 10.0f);
        pathBuilderA.close();
        ...
        pathBuilderA.reflectiveCurveTo(8.69f, 4.0f, 12.0f, 4.0f);
        a.y(pathBuilderA, 12.0f, 19.0f, -4.0f, 1.02f);
        ...
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, androidx.appcompat.view.menu.a.i(pathBuilderA, 3.1f, 12.0f, 19.0f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw2, iM3151getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
