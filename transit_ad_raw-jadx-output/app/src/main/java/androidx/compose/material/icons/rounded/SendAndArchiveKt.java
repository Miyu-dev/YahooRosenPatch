...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_sendAndArchive", "Landroidx/compose/ui/graphics/vector/ImageVector;", "SendAndArchive", "Landroidx/compose/material/icons/Icons$Rounded;", "getSendAndArchive", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class SendAndArchiveKt {
    ...
    public static final ImageVector getSendAndArchive(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.SendAndArchive", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        a.y(pathBuilderD, 19.15f, 17.85f, -1.79f, 1.79f);
        pathBuilderD.curveToRelative(-0.2f, 0.2f, -0.51f, 0.2f, -0.71f, 0.0f);
        pathBuilderD.lineToRelative(-1.79f, -1.79f);
        pathBuilderD.curveTo(14.54f, 17.54f, 14.76f, 17.0f, 15.21f, 17.0f);
        pathBuilderD.horizontalLineToRelative(1.29f);
        ...
        pathBuilderD.horizontalLineToRelative(1.29f);
        pathBuilderD.curveTo(19.24f, 17.0f, 19.46f, 17.54f, 19.15f, 17.85f);
        pathBuilderD.close();
        ...
        PathBuilder pathBuilderD2 = a.d(17.0f, 10.0f);
        pathBuilderD2.curveToRelative(0.1f, 0.0f, 0.19f, 0.01f, 0.28f, 0.01f);
        pathBuilderD2.lineTo(3.0f, 4.0f);
        pathBuilderD2.verticalLineToRelative(6.0f);
        pathBuilderD2.lineToRelative(8.0f, 2.0f);
        pathBuilderD2.lineToRelative(-8.0f, 2.0f);
        pathBuilderD2.verticalLineToRelative(6.0f);
        pathBuilderD2.lineToRelative(7.0f, -2.95f);
        pathBuilderD2.curveToRelative(0.0f, -0.02f, 0.0f, -0.03f, 0.0f, -0.05f);
        pathBuilderD2.curveTo(10.0f, 13.13f, 13.13f, 10.0f, 17.0f, 10.0f);
        pathBuilderD2.close();
