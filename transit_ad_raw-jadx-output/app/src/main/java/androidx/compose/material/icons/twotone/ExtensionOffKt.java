...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_extensionOff", "Landroidx/compose/ui/graphics/vector/ImageVector;", "ExtensionOff", "Landroidx/compose/material/icons/Icons$TwoTone;", "getExtensionOff", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class ExtensionOffKt {
    ...
    public static final ImageVector getExtensionOff(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.ExtensionOff", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderU = a.u(18.0f, 13.0f, 2.17f, 8.83f, 6.0f);
        pathBuilderU.horizontalLineTo(11.0f);
        pathBuilderU.verticalLineTo(4.0f);
        pathBuilderU.curveToRelative(0.0f, -0.28f, 0.22f, -0.5f, 0.5f, -0.5f);
        pathBuilderU.reflectiveCurveTo(12.0f, 3.72f, 12.0f, 4.0f);
        a.l(pathBuilderU, 2.0f, 6.0f, 6.0f, 2.0f);
        pathBuilderU.curveToRelative(0.28f, 0.0f, 0.5f, 0.22f, 0.5f, 0.5f);
        pathBuilderU.reflectiveCurveTo(20.28f, 13.0f, 20.0f, 13.0f);
        b.w(pathBuilderU, 18.0f, 8.0f, 12.5f);
        pathBuilderU.curveToRelative(0.0f, 1.5f, -0.83f, 3.57f, -3.0f, 4.37f);
        pathBuilderU.verticalLineTo(19.0f);
        pathBuilderU.horizontalLineToRelative(2.13f);
        pathBuilderU.curveToRelative(0.8f, -2.17f, 2.87f, -3.0f, 4.37f, -3.0f);
        pathBuilderU.curveToRelative(0.69f, 0.0f, 1.5f, 0.18f, 2.25f, 0.58f);
        pathBuilderU.lineToRelative(-6.33f, -6.33f);
        pathBuilderU.curveTo(7.82f, 11.0f, 8.0f, 11.81f, 8.0f, 12.5f);
        pathBuilderU.close();
        ...
        a.y(pathBuilderA, 8.83f, 6.0f, -2.0f, -2.0f);
        ...
        a.z(pathBuilderA, 2.17f, -2.0f, -2.0f, 13.0f);
        ...
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, androidx.compose.animation.a.m(pathBuilderA, 2.0f, 8.83f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw2, iM3151getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
