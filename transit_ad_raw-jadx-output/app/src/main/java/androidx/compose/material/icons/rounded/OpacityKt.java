...
public final class OpacityKt {
    ...
    public static final ImageVector getOpacity(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Opacity", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        a.t(pathBuilderA, 7.75f, 8.99f, 12.0f, 4.81f);
        pathBuilderA.lineToRelative(4.25f, 4.18f);
        pathBuilderA.curveToRelative(0.88f, 0.87f, 2.04f, 2.59f, 1.67f, 5.01f);
        pathBuilderA.horizontalLineTo(6.07f);
        pathBuilderA.curveTo(5.7f, 11.58f, 6.87f, 9.85f, 7.75f, 8.99f);
        pathBuilderA.close();
