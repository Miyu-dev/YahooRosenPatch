...
public final class WifiTetheringErrorRoundedKt {
    ...
    public static final ImageVector getWifiTetheringErrorRounded(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.WifiTetheringErrorRounded", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
