...
public final class EmojiEmotionsKt {
    ...
    public static final ImageVector getEmojiEmotions(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.EmojiEmotions", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderD.curveTo(7.78f, 16.34f, 9.72f, 18.0f, 12.0f, 18.0f);
        pathBuilderD.close();
