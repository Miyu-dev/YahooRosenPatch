...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_kingBed", "Landroidx/compose/ui/graphics/vector/ImageVector;", "KingBed", "Landroidx/compose/material/icons/Icons$Rounded;", "getKingBed", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class KingBedKt {
    ...
    public static final ImageVector getKingBed(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.KingBed", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderN.curveTo(3.94f, 18.81f, 4.2f, 19.0f, 4.5f, 19.0f);
        pathBuilderN.horizontalLineToRelative(0.0f);
        pathBuilderN.curveToRelative(0.3f, 0.0f, 0.56f, -0.19f, 0.66f, -0.47f);
        pathBuilderN.lineTo(5.67f, 17.0f);
        pathBuilderN.horizontalLineToRelative(12.67f);
        pathBuilderN.lineToRelative(0.51f, 1.53f);
        pathBuilderN.curveTo(18.94f, 18.81f, 19.2f, 19.0f, 19.5f, 19.0f);
        pathBuilderN.lineToRelative(0.0f, 0.0f);
        pathBuilderN.curveToRelative(0.3f, 0.0f, 0.56f, -0.19f, 0.66f, -0.47f);
        h.n(pathBuilderN, 20.67f, 17.0f, 22.0f, -5.0f);
        pathBuilderN.curveTo(22.0f, 10.9f, 21.1f, 10.0f, 20.0f, 10.0f);
        androidx.appcompat.graphics.drawable.a.w(pathBuilderN, 11.0f, 10.0f, 6.0f, 8.0f);
        pathBuilderN.curveToRelative(0.0f, -0.55f, 0.45f, -1.0f, 1.0f, -1.0f);
        b.m(pathBuilderN, 4.0f, 10.0f, 18.0f, 10.0f);
        v.m(pathBuilderN, -5.0f, 7.0f, 4.0f);
