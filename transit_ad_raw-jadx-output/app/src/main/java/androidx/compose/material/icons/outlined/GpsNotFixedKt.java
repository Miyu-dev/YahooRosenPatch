...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_gpsNotFixed", "Landroidx/compose/ui/graphics/vector/ImageVector;", "GpsNotFixed", "Landroidx/compose/material/icons/Icons$Outlined;", "getGpsNotFixed", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-outlined_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class GpsNotFixedKt {
    ...
    public static final ImageVector getGpsNotFixed(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.GpsNotFixed", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        v.r(pathBuilderD, 1.0f, -2.0f, 2.06f);
        pathBuilderD.curveTo(6.83f, 3.52f, 3.52f, 6.83f, 3.06f, 11.0f);
        androidx.compose.animation.a.s(pathBuilderD, 1.0f, 2.0f, 2.06f);
        pathBuilderD.curveToRelative(0.46f, 4.17f, 3.77f, 7.48f, 7.94f, 7.94f);
        v.r(pathBuilderD, 23.0f, 2.0f, -2.06f);
        pathBuilderD.curveToRelative(4.17f, -0.46f, 7.48f, -3.77f, 7.94f, -7.94f);
        pathBuilderD.horizontalLineTo(23.0f);
