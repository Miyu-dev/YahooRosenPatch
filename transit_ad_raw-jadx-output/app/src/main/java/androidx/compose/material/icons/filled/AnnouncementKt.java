...
public final class AnnouncementKt {
    ...
    public static final ImageVector getAnnouncement(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.Announcement", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        s.w(pathBuilderA, 11.0f, 5.0f, 2.0f, 6.0f);
        androidx.appcompat.view.menu.a.x(pathBuilderA, 13.0f, 15.0f, -2.0f, -2.0f);
