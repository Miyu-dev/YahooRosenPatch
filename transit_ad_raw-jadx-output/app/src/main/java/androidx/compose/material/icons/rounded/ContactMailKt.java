...
public final class ContactMailKt {
    ...
    public static final ImageVector getContactMail(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.ContactMail", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderA.lineToRelative(2.72f, 1.82f);
        pathBuilderA.curveToRelative(0.17f, 0.11f, 0.39f, 0.11f, 0.55f, 0.0f);
        a.z(pathBuilderA, 21.0f, 8.0f, 22.0f, 3.0f);
        ...
        androidx.appcompat.graphics.drawable.a.A(pathBuilderA, 1.0f, 21.5f, 12.0f, -7.0f);
