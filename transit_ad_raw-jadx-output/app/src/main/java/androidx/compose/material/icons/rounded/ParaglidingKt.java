...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_paragliding", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Paragliding", "Landroidx/compose/material/icons/Icons$Rounded;", "getParagliding", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class ParaglidingKt {
    ...
    public static final ImageVector getParagliding(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Paragliding", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderD.close();
        pathBuilderD.moveTo(17.95f, 14.0f);
        pathBuilderD.curveToRelative(-0.52f, 0.0f, -0.94f, 0.4f, -0.99f, 0.92f);
        pathBuilderD.curveToRelative(-0.2f, 2.03f, -1.05f, 2.68f, -1.48f, 3.02f);
        ...
        pathBuilderD.curveTo(6.99f, 14.4f, 6.57f, 14.0f, 6.05f, 14.0f);
        pathBuilderD.curveToRelative(-0.59f, 0.0f, -1.06f, 0.51f, -1.0f, 1.09f);
        pathBuilderD.curveToRelative(0.22f, 2.08f, 1.07f, 3.47f, 2.24f, 4.41f);
        ...
        pathBuilderD.curveToRelative(1.17f, -0.94f, 2.03f, -2.32f, 2.24f, -4.41f);
        pathBuilderD.curveTo(19.01f, 14.51f, 18.53f, 14.0f, 17.95f, 14.0f);
        pathBuilderD.close();
