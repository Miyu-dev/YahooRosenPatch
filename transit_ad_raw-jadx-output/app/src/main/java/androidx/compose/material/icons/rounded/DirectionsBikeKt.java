...
public final class DirectionsBikeKt {
    ...
    public static final ImageVector getDirectionsBike(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.DirectionsBike", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderD.curveToRelative(1.06f, 1.06f, 2.38f, 1.78f, 3.96f, 2.02f);
        pathBuilderD.curveToRelative(0.6f, 0.09f, 1.14f, -0.39f, 1.14f, -1.0f);
        pathBuilderD.curveToRelative(0.0f, -0.49f, -0.37f, -0.91f, -0.85f, -0.99f);
        pathBuilderD.curveToRelative(-1.11f, -0.18f, -2.02f, -0.71f, -2.75f, -1.43f);
        ...
        pathBuilderD.lineTo(11.0f, 14.0f);
        pathBuilderD.verticalLineToRelative(4.0f);
        pathBuilderD.curveToRelative(0.0f, 0.55f, 0.45f, 1.0f, 1.0f, 1.0f);
        pathBuilderD.reflectiveCurveToRelative(1.0f, -0.45f, 1.0f, -1.0f);
        pathBuilderD.verticalLineToRelative(-4.4f);
        pathBuilderD.curveToRelative(0.0f, -0.52f, -0.2f, -1.01f, -0.55f, -1.38f);
        androidx.appcompat.view.menu.a.z(pathBuilderD, 10.8f, 10.5f, 19.0f, 12.0f);
        pathBuilderD.curveToRelative(-2.8f, 0.0f, -5.0f, 2.2f, -5.0f, 5.0f);
        pathBuilderD.reflectiveCurveToRelative(2.2f, 5.0f, 5.0f, 5.0f);
        pathBuilderD.reflectiveCurveToRelative(5.0f, -2.2f, 5.0f, -5.0f);
        pathBuilderD.reflectiveCurveToRelative(-2.2f, -5.0f, -5.0f, -5.0f);
