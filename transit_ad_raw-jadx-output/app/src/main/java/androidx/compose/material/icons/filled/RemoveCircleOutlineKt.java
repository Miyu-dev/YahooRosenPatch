...
public final class RemoveCircleOutlineKt {
    ...
    public static final ImageVector getRemoveCircleOutline(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.RemoveCircleOutline", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
