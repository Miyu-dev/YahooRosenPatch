...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_carRental", "Landroidx/compose/ui/graphics/vector/ImageVector;", "CarRental", "Landroidx/compose/material/icons/Icons$TwoTone;", "getCarRental", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class CarRentalKt {
    ...
    public static final ImageVector getCarRental(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.CarRental", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderC = h.c(7.0f, 15.01f, 18.0f, 10.0f, -2.99f);
        b.z(pathBuilderC, 15.0f, 7.0f, 15.01f);
        pathBuilderC.moveTo(15.0f, 15.5f);
        ...
        pathBuilderC.reflectiveCurveTo(14.45f, 15.5f, 15.0f, 15.5f);
        pathBuilderC.close();
        pathBuilderC.moveTo(9.0f, 15.5f);
        pathBuilderC.curveToRelative(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        pathBuilderC.reflectiveCurveToRelative(-0.45f, 1.0f, -1.0f, 1.0f);
        pathBuilderC.reflectiveCurveToRelative(-1.0f, -0.45f, -1.0f, -1.0f);
        ImageVector.Builder.m3359addPathoIyEayM$default(builder, h.t(pathBuilderC, 8.45f, 15.5f, 9.0f, 15.5f), defaultFillType, "", solidColor, 0.3f, null, 0.3f, 1.0f, iM3141getButtKaPHkGw, iM3151getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        androidx.appcompat.app.m.t(pathBuilderD, 17.0f, 15.01f, 18.0f, 7.0f);
        pathBuilderD.verticalLineToRelative(-2.99f);
        pathBuilderD.verticalLineTo(15.0f);
        pathBuilderD.horizontalLineToRelative(10.0f);
        pathBuilderD.verticalLineTo(15.01f);
        pathBuilderD.close();
        ...
        a.b.w(pathBuilderD2, 1.0f, 3.0f, 10.83f);
        ...
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, h.t(pathBuilderD2, 8.55f, 5.0f, 8.0f, 5.0f), defaultFillType5, "", solidColor5, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw5, iM3151getBevelLxFBmk85, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
