...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_thermostatAuto", "Landroidx/compose/ui/graphics/vector/ImageVector;", "ThermostatAuto", "Landroidx/compose/material/icons/Icons$Rounded;", "getThermostatAuto", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class ThermostatAutoKt {
    ...
    public static final ImageVector getThermostatAuto(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.ThermostatAuto", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        b.w(pathBuilderN, 5.0f, 17.81f, 4.0f);
        pathBuilderN.lineTo(17.81f, 4.0f);
        pathBuilderN.curveToRelative(-0.48f, 0.0f, -0.92f, 0.3f, -1.09f, 0.75f);
        pathBuilderN.lineTo(14.0f, 12.02f);
        pathBuilderN.curveTo(13.82f, 12.49f, 14.17f, 13.0f, 14.67f, 13.0f);
        pathBuilderN.horizontalLineToRelative(0.0f);
        pathBuilderN.curveToRelative(0.31f, 0.0f, 0.58f, -0.19f, 0.68f, -0.48f);
        pathBuilderN.lineTo(16.0f, 10.7f);
        pathBuilderN.horizontalLineToRelative(3.63f);
        pathBuilderN.lineToRelative(0.64f, 1.82f);
        pathBuilderN.curveToRelative(0.1f, 0.29f, 0.38f, 0.48f, 0.68f, 0.48f);
        pathBuilderN.lineToRelative(0.0f, 0.0f);
        pathBuilderN.curveToRelative(0.51f, 0.0f, 0.86f, -0.51f, 0.68f, -0.98f);
        pathBuilderN.lineTo(18.9f, 4.75f);
        pathBuilderN.curveTo(18.73f, 4.3f, 18.3f, 4.0f, 17.81f, 4.0f);
        a.y(pathBuilderN, 16.47f, 9.39f, 1.31f, -3.72f);
