...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_construction", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Construction", "Landroidx/compose/material/icons/Icons$Rounded;", "getConstruction", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class ConstructionKt {
    ...
    public static final ImageVector getConstruction(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Construction", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderA = b.a(20.99f, 17.99f, -4.94f, -4.94f);
        ...
        pathBuilderA.curveTo(21.57f, 19.52f, 21.57f, 18.57f, 20.99f, 17.99f);
        pathBuilderA.close();
        ...
        PathBuilder pathBuilderD = a.d(17.65f, 10.0f);
        ...
        pathBuilderD.lineToRelative(2.7f, -2.7f);
        pathBuilderD.curveTo(18.77f, 3.16f, 18.23f, 3.0f, 17.65f, 3.0f);
        pathBuilderD.curveToRelative(-1.93f, 0.0f, -3.5f, 1.57f, -3.5f, 3.5f);
        ...
        pathBuilderD.lineTo(5.08f, 6.32f);
        pathBuilderD.curveToRelative(-0.39f, 0.39f, -0.39f, 1.02f, 0.0f, 1.41f);
        pathBuilderD.lineToRelative(0.71f, 0.71f);
        pathBuilderD.horizontalLineTo(3.25f);
        pathBuilderD.curveToRelative(-0.19f, 0.0f, -0.37f, 0.07f, -0.5f, 0.21f);
        pathBuilderD.curveToRelative(-0.28f, 0.28f, -0.28f, 0.72f, 0.0f, 1.0f);
        pathBuilderD.lineToRelative(2.54f, 2.54f);
        pathBuilderD.curveToRelative(0.28f, 0.28f, 0.72f, 0.28f, 1.0f, 0.0f);
        pathBuilderD.curveToRelative(0.13f, -0.13f, 0.21f, -0.31f, 0.21f, -0.5f);
        pathBuilderD.verticalLineTo(9.15f);
        pathBuilderD.lineTo(7.2f, 9.85f);
        pathBuilderD.curveToRelative(0.39f, 0.39f, 1.02f, 0.39f, 1.41f, 0.0f);
        pathBuilderD.lineToRelative(1.78f, 1.78f);
        pathBuilderD.lineToRelative(-6.35f, 6.35f);
        ...
        pathBuilderD.lineTo(16.48f, 9.79f);
        pathBuilderD.curveTo(16.85f, 9.92f, 17.24f, 10.0f, 17.65f, 10.0f);
        pathBuilderD.close();
