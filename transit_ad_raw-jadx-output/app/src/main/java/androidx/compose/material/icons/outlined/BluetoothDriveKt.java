...
public final class BluetoothDriveKt {
    ...
    public static final ImageVector getBluetoothDrive(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.BluetoothDrive", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderO = s.o(18.0f, 17.0f, 4.0f, -5.0f, 11.0f);
        androidx.appcompat.app.m.B(pathBuilderO, -2.0f, 4.81f, 1.04f, -3.0f);
        b.B(pathBuilderO, 15.0f, 5.0f, 5.5f);
        ...
        pathBuilderO.horizontalLineToRelative(1.0f);
        pathBuilderO.curveToRelative(0.55f, 0.0f, 1.0f, -0.45f, 1.0f, -1.0f);
        ImageVector.Builder.m3359addPathoIyEayM$default(builder, h.k(pathBuilderO, -8.0f, -2.0f, 17.0f), defaultFillType3, "", solidColor3, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw3, iM3151getBevelLxFBmk83, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        a.C(pathBuilderL, 19.85f, 6.0f, 22.0f, 3.85f);
        ...
        pathBuilderL.lineToRelative(-0.94f, 0.94f);
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, a.b.v(pathBuilderL, 7.2f, 20.59f, 8.14f), defaultFillType4, "", solidColor4, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw4, iM3151getBevelLxFBmk84, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
