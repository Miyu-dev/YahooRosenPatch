...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_localCarWash", "Landroidx/compose/ui/graphics/vector/ImageVector;", "LocalCarWash", "Landroidx/compose/material/icons/Icons$TwoTone;", "getLocalCarWash", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class LocalCarWashKt {
    ...
    public static final ImageVector getLocalCarWash(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.LocalCarWash", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderA = b.a(5.12f, 14.0f, -0.12f, 0.34f);
        a.o(pathBuilderA, 5.0f, 19.0f, 14.0f, -4.66f);
        s.r(pathBuilderA, -0.12f, -0.34f, 5.12f, 14.0f);
        pathBuilderA.moveTo(7.5f, 18.0f);
        pathBuilderA.curveToRelative(-0.83f, 0.0f, -1.5f, -0.67f, -1.5f, -1.5f);
        pathBuilderA.reflectiveCurveTo(6.67f, 15.0f, 7.5f, 15.0f);
        pathBuilderA.reflectiveCurveToRelative(1.5f, 0.67f, 1.5f, 1.5f);
        pathBuilderA.reflectiveCurveTo(8.33f, 18.0f, 7.5f, 18.0f);
        pathBuilderA.close();
        ...
        PathBuilder pathBuilderD = androidx.browser.browseractions.a.d(15.5f, 3.5f);
        pathBuilderD.curveToRelative(0.0f, 0.83f, 0.67f, 1.5f, 1.5f, 1.5f);
        pathBuilderD.reflectiveCurveToRelative(1.5f, -0.67f, 1.5f, -1.5f);
        pathBuilderD.curveToRelative(0.0f, -1.0f, -1.5f, -2.7f, -1.5f, -2.7f);
        pathBuilderD.reflectiveCurveToRelative(-1.5f, 1.7f, -1.5f, 2.7f);
        pathBuilderD.close();
        pathBuilderD.moveTo(13.5f, 3.5f);
        pathBuilderD.curveToRelative(0.0f, -1.0f, -1.5f, -2.7f, -1.5f, -2.7f);
        pathBuilderD.reflectiveCurveToRelative(-1.5f, 1.7f, -1.5f, 2.7f);
        pathBuilderD.curveToRelative(0.0f, 0.83f, 0.67f, 1.5f, 1.5f, 1.5f);
        pathBuilderD.reflectiveCurveToRelative(1.5f, -0.67f, 1.5f, -1.5f);
        pathBuilderD.close();
        pathBuilderD.moveTo(8.5f, 3.5f);
        pathBuilderD.curveTo(8.5f, 2.5f, 7.0f, 0.8f, 7.0f, 0.8f);
        pathBuilderD.reflectiveCurveTo(5.5f, 2.5f, 5.5f, 3.5f);
        pathBuilderD.curveTo(5.5f, 4.33f, 6.17f, 5.0f, 7.0f, 5.0f);
        pathBuilderD.reflectiveCurveToRelative(1.5f, -0.67f, 1.5f, -1.5f);
        androidx.browser.browseractions.a.y(pathBuilderD, 21.0f, 14.0f, -2.08f, -5.99f);
        ...
        pathBuilderD.horizontalLineToRelative(1.0f);
        pathBuilderD.curveToRelative(0.55f, 0.0f, 1.0f, -0.45f, 1.0f, -1.0f);
        androidx.appcompat.graphics.drawable.a.A(pathBuilderD, -8.0f, 6.85f, 9.0f, 10.29f);
        pathBuilderD.lineToRelative(1.04f, 3.0f);
        a.A(pathBuilderD, 5.81f, 12.0f, 1.04f, -3.0f);
        pathBuilderD.moveTo(19.0f, 19.0f);
        pathBuilderD.lineTo(5.0f, 19.0f);
        androidx.appcompat.app.m.s(pathBuilderD, -4.66f, 0.12f, -0.34f, 13.77f);
        ImageVector.Builder.m3359addPathoIyEayM$default(builder, h.p(pathBuilderD, 0.11f, 0.34f, 19.0f, 19.0f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw2, iM3151getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        PathBuilder pathBuilderB2 = v.b(16.5f, 16.5f, -1.5f, 0.0f);
