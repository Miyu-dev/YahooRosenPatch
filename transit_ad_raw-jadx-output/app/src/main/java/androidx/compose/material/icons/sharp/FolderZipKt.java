...
public final class FolderZipKt {
    ...
    public static final ImageVector getFolderZip(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.FolderZip", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        androidx.appcompat.view.menu.a.x(pathBuilderA, 18.0f, 12.0f, -2.0f, 2.0f);
