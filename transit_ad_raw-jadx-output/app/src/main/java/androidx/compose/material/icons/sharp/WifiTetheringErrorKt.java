...
public final class WifiTetheringErrorKt {
    ...
    public static final ImageVector getWifiTetheringError(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.WifiTetheringError", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
