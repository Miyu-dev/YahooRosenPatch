...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_localMall", "Landroidx/compose/ui/graphics/vector/ImageVector;", "LocalMall", "Landroidx/compose/material/icons/Icons$TwoTone;", "getLocalMall", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class LocalMallKt {
    ...
    public static final ImageVector getLocalMall(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.LocalMall", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderE = a.e(5.0f, 8.0f, 12.0f, 14.0f);
        android.support.v4.media.a.C(pathBuilderE, 19.0f, 8.0f, 5.0f, 8.0f);
        pathBuilderE.moveTo(12.0f, 14.0f);
        ...
        pathBuilderD.reflectiveCurveTo(7.0f, 3.24f, 7.0f, 6.0f);
        ...
        pathBuilderD.curveToRelative(0.0f, -1.1f, -0.9f, -2.0f, -2.0f, -2.0f);
        b.q(pathBuilderD, -2.0f, 12.0f, 3.0f);
        pathBuilderD.curveToRelative(1.66f, 0.0f, 3.0f, 1.34f, 3.0f, 3.0f);
        pathBuilderD.lineTo(9.0f, 6.0f);
        ...
        s.w(pathBuilderD, 5.0f, 8.0f, 14.0f, 12.0f);
