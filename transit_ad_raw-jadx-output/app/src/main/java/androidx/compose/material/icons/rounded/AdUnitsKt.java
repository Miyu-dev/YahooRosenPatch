...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_adUnits", "Landroidx/compose/ui/graphics/vector/ImageVector;", "AdUnits", "Landroidx/compose/material/icons/Icons$Rounded;", "getAdUnits", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class AdUnitsKt {
    ...
    public static final ImageVector getAdUnits(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.AdUnits", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        a.k(pathBuilderB, 16.0f, 19.0f, 8.0f);
        ...
        pathBuilderB.curveTo(17.0f, 18.55f, 16.55f, 19.0f, 16.0f, 19.0f);
        pathBuilderB.close();
        ...
        PathBuilder pathBuilderB2 = s.b(15.0f, 6.0f, 9.0f);
        pathBuilderB2.curveTo(8.45f, 6.0f, 8.0f, 6.45f, 8.0f, 7.0f);
        ...
        pathBuilderB2.verticalLineToRelative(0.0f);
        pathBuilderB2.curveTo(16.0f, 6.45f, 15.55f, 6.0f, 15.0f, 6.0f);
        pathBuilderB2.close();
