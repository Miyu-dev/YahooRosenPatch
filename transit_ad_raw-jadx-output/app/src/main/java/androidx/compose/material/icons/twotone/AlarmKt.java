...
public final class AlarmKt {
    ...
    public static final ImageVector getAlarm(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.Alarm", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderB = androidx.appcompat.graphics.drawable.a.b(12.5f, 8.0f, 11.0f, 8.0f, 6.0f);
        pathBuilderB.lineToRelative(4.75f, 2.85f);
        android.support.v4.media.a.n(pathBuilderB, 0.75f, -1.23f, -4.0f, -2.37f);
        pathBuilderB.moveTo(17.337f, 1.81f);
        pathBuilderB.lineToRelative(4.607f, 3.845f);
        android.support.v4.media.a.n(pathBuilderB, -1.28f, 1.535f, -4.61f, -3.843f);
        pathBuilderB.moveTo(6.663f, 1.81f);
        pathBuilderB.lineToRelative(1.282f, 1.536f);
        androidx.compose.animation.a.A(pathBuilderB, 3.337f, 7.19f, -1.28f, -1.536f);
        ...
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, androidx.appcompat.view.menu.a.j(pathBuilderB, -3.14f, 7.0f, -7.0f, 7.0f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw2, iM3151getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
