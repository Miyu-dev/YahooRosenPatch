...
public final class DirectionsBikeKt {
    ...
    public static final ImageVector getDirectionsBike(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.DirectionsBike", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderD.reflectiveCurveToRelative(0.9f, 2.0f, 2.0f, 2.0f);
        pathBuilderD.close();
        pathBuilderD.moveTo(5.0f, 22.0f);
        ...
        pathBuilderD.reflectiveCurveTo(6.9f, 20.5f, 5.0f, 20.5f);
        pathBuilderD.reflectiveCurveTo(1.5f, 18.9f, 1.5f, 17.0f);
        pathBuilderD.reflectiveCurveToRelative(1.6f, -3.5f, 3.5f, -3.5f);
        androidx.compose.animation.a.t(pathBuilderD, 7.8f, 11.2f, 11.0f, 14.0f);
        android.support.v4.media.a.m(pathBuilderD, 5.0f, 2.0f, -6.2f);
        pathBuilderD.lineToRelative(-2.2f, -2.3f);
        pathBuilderD.lineToRelative(2.4f, -2.4f);
