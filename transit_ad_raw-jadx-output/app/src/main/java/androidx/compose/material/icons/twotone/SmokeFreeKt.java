...
public final class SmokeFreeKt {
    ...
    public static final ImageVector getSmokeFree(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.SmokeFree", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        androidx.compose.animation.a.j(pathBuilderB, 14.5f, 8.65f, 1.53f);
        ...
        androidx.appcompat.view.menu.a.z(pathBuilderB, 17.0f, 15.34f, 3.41f, 4.59f);
