...
public final class RestaurantMenuKt {
    ...
    public static final ImageVector getRestaurantMenu(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.RestaurantMenu", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderA.lineTo(4.4f, 19.17f);
