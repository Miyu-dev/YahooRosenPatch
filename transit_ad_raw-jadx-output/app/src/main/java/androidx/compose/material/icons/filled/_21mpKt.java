...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"__21mp", "Landroidx/compose/ui/graphics/vector/ImageVector;", "_21mp", "Landroidx/compose/material/icons/Icons$Filled;", "get_21mp", "(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-filled_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class _21mpKt {
    ...
    public static final ImageVector get_21mp(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled._21mp", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderA.curveToRelative(0.0f, 0.55f, -0.45f, 1.0f, -1.0f, 1.0f);
        androidx.appcompat.graphics.drawable.a.z(pathBuilderA, -2.0f, 1.5f, 11.0f, 9.0f);
        b.s(pathBuilderA, 9.0f, 9.0f, 1.0f, 3.0f);
        pathBuilderA.verticalLineToRelative(1.5f);
        pathBuilderA.lineTo(7.5f, 11.5f);
        pathBuilderA.lineTo(7.5f, 9.0f);
        pathBuilderA.curveToRelative(0.0f, -0.55f, 0.45f, -1.0f, 1.0f, -1.0f);
        androidx.appcompat.view.menu.a.y(pathBuilderA, 2.0f, 10.5f, 7.0f, -3.0f);
        pathBuilderA.lineTo(7.5f, 5.5f);
        pathBuilderA.lineTo(11.0f, 5.5f);
        pathBuilderA.curveToRelative(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        pathBuilderA.lineTo(12.0f, 8.0f);
        pathBuilderA.curveToRelative(0.0f, 0.55f, -0.45f, 1.0f, -1.0f, 1.0f);
        androidx.compose.animation.b.r(pathBuilderA, 14.0f, 5.5f, 3.0f, 6.0f);
        pathBuilderA.horizontalLineToRelative(-1.5f);
        pathBuilderA.lineTo(15.5f, 7.0f);
        android.support.v4.media.a.C(pathBuilderA, 14.0f, 7.0f, 14.0f, 5.5f);
