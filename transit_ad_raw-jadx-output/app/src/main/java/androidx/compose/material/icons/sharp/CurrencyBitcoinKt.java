...
public final class CurrencyBitcoinKt {
    ...
    public static final ImageVector getCurrencyBitcoin(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.CurrencyBitcoin", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
