...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_brightnessAuto", "Landroidx/compose/ui/graphics/vector/ImageVector;", "BrightnessAuto", "Landroidx/compose/material/icons/Icons$TwoTone;", "getBrightnessAuto", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class BrightnessAutoKt {
    ...
    public static final ImageVector getBrightnessAuto(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.BrightnessAuto", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderL.moveTo(14.3f, 16.0f);
        pathBuilderL.lineToRelative(-0.7f, -2.0f);
        pathBuilderL.horizontalLineToRelative(-3.2f);
        pathBuilderL.lineToRelative(-0.7f, 2.0f);
        pathBuilderL.lineTo(7.8f, 16.0f);
        pathBuilderL.lineTo(11.0f, 7.0f);
        pathBuilderL.horizontalLineToRelative(2.0f);
        pathBuilderL.lineToRelative(3.2f, 9.0f);
        pathBuilderL.horizontalLineToRelative(-1.9f);
        pathBuilderL.close();
        pathBuilderL.moveTo(10.85f, 12.65f);
        ImageVector.Builder.m3359addPathoIyEayM$default(builder, android.support.v4.media.a.r(pathBuilderL, 2.3f, 12.0f, 9.0f), defaultFillType, "", solidColor, 0.3f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw, iM3151getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        pathBuilderP.verticalLineToRelative(3.52f);
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, v.l(pathBuilderP, 20.48f, 12.0f, 18.0f, 14.48f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw2, iM3151getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
