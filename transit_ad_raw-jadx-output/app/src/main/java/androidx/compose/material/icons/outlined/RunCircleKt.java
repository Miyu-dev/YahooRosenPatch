...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_runCircle", "Landroidx/compose/ui/graphics/vector/ImageVector;", "RunCircle", "Landroidx/compose/material/icons/Icons$Outlined;", "getRunCircle", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-outlined_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class RunCircleKt {
    ...
    public static final ImageVector getRunCircle(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.RunCircle", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderD2 = a.d(13.54f, 8.97f);
        pathBuilderD2.curveToRelative(-0.23f, -0.47f, -0.76f, -0.71f, -1.26f, -0.53f);
        androidx.appcompat.app.m.r(pathBuilderD2, 9.0f, 9.65f, 12.0f, 1.0f);
        pathBuilderD2.verticalLineToRelative(-1.65f);
        pathBuilderD2.lineToRelative(1.54f, -0.57f);
        pathBuilderD2.lineToRelative(-0.96f, 4.89f);
        pathBuilderD2.lineTo(7.8f, 14.1f);
        pathBuilderD2.lineToRelative(-0.2f, 0.98f);
        pathBuilderD2.lineToRelative(3.76f, 0.77f);
        pathBuilderD2.lineToRelative(0.52f, -2.64f);
        androidx.appcompat.app.m.r(pathBuilderD2, 13.0f, 14.42f, 18.0f, 1.0f);
        pathBuilderD2.verticalLineToRelative(-3.97f);
        pathBuilderD2.lineToRelative(-1.32f, -1.44f);
        pathBuilderD2.lineToRelative(0.41f, -2.35f);
        pathBuilderD2.curveTo(13.99f, 11.46f, 15.3f, 12.0f, 16.0f, 12.0f);
        pathBuilderD2.verticalLineToRelative(-1.0f);
        pathBuilderD2.curveTo(15.59f, 11.0f, 14.37f, 10.67f, 13.54f, 8.97f);
        pathBuilderD2.close();
