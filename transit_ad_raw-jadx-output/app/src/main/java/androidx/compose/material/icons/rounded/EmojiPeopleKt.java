...
public final class EmojiPeopleKt {
    ...
    public static final ImageVector getEmojiPeople(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.EmojiPeople", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderD.curveTo(8.53f, 6.99f, 6.48f, 5.2f, 6.07f, 2.85f);
        pathBuilderD.curveTo(5.99f, 2.36f, 5.58f, 2.0f, 5.09f, 2.0f);
        pathBuilderD.horizontalLineToRelative(0.0f);
        pathBuilderD.curveToRelative(-0.61f, 0.0f, -1.09f, 0.54f, -1.0f, 1.14f);
        pathBuilderD.curveTo(4.53f, 5.8f, 6.47f, 7.95f, 9.0f, 8.71f);
        ...
        pathBuilderD.horizontalLineToRelative(0.0f);
        pathBuilderD.curveToRelative(0.55f, 0.0f, 1.0f, -0.45f, 1.0f, -1.0f);
        pathBuilderD.verticalLineTo(10.05f);
        pathBuilderD.lineToRelative(3.24f, 3.24f);
        ...
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, b.h(pathBuilderD, 15.89f, 8.11f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw2, iM3151getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
