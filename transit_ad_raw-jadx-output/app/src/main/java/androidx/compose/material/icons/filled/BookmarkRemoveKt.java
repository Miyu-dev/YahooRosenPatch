...
public final class BookmarkRemoveKt {
    ...
    public static final ImageVector getBookmarkRemove(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.BookmarkRemove", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderV.curveToRelative(-2.76f, 0.0f, -5.0f, -2.24f, -5.0f, -5.0f);
        pathBuilderV.curveToRelative(0.0f, -1.13f, 0.37f, -2.16f, 1.0f, -3.0f);
