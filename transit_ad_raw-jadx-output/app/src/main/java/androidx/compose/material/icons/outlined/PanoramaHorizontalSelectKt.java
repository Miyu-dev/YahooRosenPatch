...
public final class PanoramaHorizontalSelectKt {
    ...
    public static final ImageVector getPanoramaHorizontalSelect(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.PanoramaHorizontalSelect", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderD.lineToRelative(0.0f, -14.0f);
        pathBuilderD.curveToRelative(0.0f, -0.68f, -0.66f, -1.17f, -1.31f, -0.95f);
