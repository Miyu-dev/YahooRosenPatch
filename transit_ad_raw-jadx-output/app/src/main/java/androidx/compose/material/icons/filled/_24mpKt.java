...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"__24mp", "Landroidx/compose/ui/graphics/vector/ImageVector;", "_24mp", "Landroidx/compose/material/icons/Icons$Filled;", "get_24mp", "(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-filled_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class _24mpKt {
    ...
    public static final ImageVector get_24mp(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled._24mp", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderA.curveToRelative(0.0f, 0.55f, -0.45f, 1.0f, -1.0f, 1.0f);
        androidx.compose.animation.b.r(pathBuilderA, 18.5f, 10.0f, -1.0f, 1.5f);
        pathBuilderA.lineTo(16.0f, 11.5f);
        pathBuilderA.lineTo(16.0f, 10.0f);
        androidx.appcompat.view.menu.a.y(pathBuilderA, -3.0f, 13.0f, 5.5f, 1.5f);
        v.y(pathBuilderA, 3.0f, 16.0f, 8.5f, -3.0f);
        android.support.v4.media.a.s(pathBuilderA, 1.5f, 3.0f, 1.0f);
        androidx.appcompat.view.menu.a.z(pathBuilderA, 18.5f, 10.0f, 15.5f, 14.0f);
