...
public final class LocalPrintshopKt {
    ...
    public static final ImageVector getLocalPrintshop(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.LocalPrintshop", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderN.curveTo(6.45f, 3.0f, 6.0f, 3.45f, 6.0f, 4.0f);
        ImageVector.Builder.m3359addPathoIyEayM$default(builder, a.m(pathBuilderN, 3.0f, 18.0f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw, iM3151getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        int defaultFillType2 = VectorKt.getDefaultFillType();
        SolidColor solidColor2 = new SolidColor(companion.m2844getBlack0d7_KjU(), null);
        int iM3141getButtKaPHkGw2 = companion2.m3141getButtKaPHkGw();
        int iM3151getBevelLxFBmk82 = companion3.m3151getBevelLxFBmk8();
        PathBuilder pathBuilderB = s.b(19.0f, 8.0f, 5.0f);
        ...
        pathBuilderB.verticalLineToRelative(-5.0f);
        pathBuilderB.curveTo(22.0f, 9.34f, 20.66f, 8.0f, 19.0f, 8.0f);
        androidx.browser.browseractions.a.q(pathBuilderB, 16.0f, 19.0f, 8.0f, -4.0f);
        b.m(pathBuilderB, 8.0f, 19.0f, 18.0f, 12.5f);
        pathBuilderB.curveToRelative(-0.55f, 0.0f, -1.0f, -0.45f, -1.0f, -1.0f);
        pathBuilderB.reflectiveCurveToRelative(0.45f, -1.0f, 1.0f, -1.0f);
        pathBuilderB.reflectiveCurveToRelative(1.0f, 0.45f, 1.0f, 1.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, h.t(pathBuilderB, 18.55f, 12.5f, 18.0f, 12.5f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw2, iM3151getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
