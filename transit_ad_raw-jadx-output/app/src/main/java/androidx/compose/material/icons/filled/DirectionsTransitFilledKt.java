...
public final class DirectionsTransitFilledKt {
    ...
    public static final ImageVector getDirectionsTransitFilled(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.DirectionsTransitFilled", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
