...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_escalatorWarning", "Landroidx/compose/ui/graphics/vector/ImageVector;", "EscalatorWarning", "Landroidx/compose/material/icons/Icons$Rounded;", "getEscalatorWarning", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class EscalatorWarningKt {
    ...
    public static final ImageVector getEscalatorWarning(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.EscalatorWarning", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderD.verticalLineToRelative(-9.39f);
        pathBuilderD.lineToRelative(2.24f, 3.89f);
        pathBuilderD.curveToRelative(0.18f, 0.31f, 0.51f, 0.5f, 0.87f, 0.5f);
        pathBuilderD.horizontalLineToRelative(1.1f);
        pathBuilderD.curveToRelative(0.33f, 0.0f, 0.63f, -0.16f, 0.82f, -0.43f);
        pathBuilderD.lineTo(15.0f, 14.9f);
