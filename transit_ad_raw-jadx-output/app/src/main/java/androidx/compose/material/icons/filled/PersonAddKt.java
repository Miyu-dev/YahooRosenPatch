...
public final class PersonAddKt {
    ...
    public static final ImageVector getPersonAdd(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.PersonAdd", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderD.reflectiveCurveToRelative(1.79f, 4.0f, 4.0f, 4.0f);
        androidx.compose.animation.a.t(pathBuilderD, 6.0f, 10.0f, 6.0f, 7.0f);
        ...
        androidx.appcompat.app.m.C(pathBuilderD, 3.0f, -2.0f, 6.0f, 10.0f);
