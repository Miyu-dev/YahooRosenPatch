...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_homeRepairService", "Landroidx/compose/ui/graphics/vector/ImageVector;", "HomeRepairService", "Landroidx/compose/material/icons/Icons$Rounded;", "getHomeRepairService", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class HomeRepairServiceKt {
    ...
    public static final ImageVector getHomeRepairService(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.HomeRepairService", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderD = a.d(17.0f, 16.0f);
        ...
        pathBuilderD.curveTo(18.0f, 15.55f, 17.55f, 16.0f, 17.0f, 16.0f);
        pathBuilderD.close();
        ...
        android.support.v4.media.a.m(pathBuilderT, 4.0f, 4.0f, -1.0f);
        pathBuilderT.curveToRelative(0.0f, -0.55f, 0.45f, -1.0f, 1.0f, -1.0f);
        pathBuilderT.reflectiveCurveToRelative(1.0f, 0.45f, 1.0f, 1.0f);
        android.support.v4.media.a.m(pathBuilderT, 1.0f, 8.0f, -1.0f);
        pathBuilderT.curveToRelative(0.0f, -0.55f, 0.45f, -1.0f, 1.0f, -1.0f);
        pathBuilderT.reflectiveCurveToRelative(1.0f, 0.45f, 1.0f, 1.0f);
        android.support.v4.media.a.m(pathBuilderT, 1.0f, 4.0f, -4.0f);
        pathBuilderT.curveTo(22.0f, 8.9f, 21.1f, 8.0f, 20.0f, 8.0f);
        androidx.appcompat.graphics.drawable.a.w(pathBuilderT, 15.0f, 8.0f, 9.0f, 6.0f);
