...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_dining", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Dining", "Landroidx/compose/material/icons/Icons$Rounded;", "getDining", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class DiningKt {
    ...
    public static final ImageVector getDining(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Dining", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderB.verticalLineToRelative(6.02f);
        pathBuilderB.curveTo(9.5f, 18.66f, 9.16f, 19.0f, 8.75f, 19.0f);
        pathBuilderB.horizontalLineToRelative(0.0f);
        pathBuilderB.curveTo(8.34f, 19.0f, 8.0f, 18.66f, 8.0f, 18.25f);
        pathBuilderB.verticalLineToRelative(-6.02f);
        ...
        a.y(pathBuilderB, 10.3f, 15.58f, 12.59f);
        pathBuilderB.lineToRelative(-0.08f, 0.03f);
        pathBuilderB.verticalLineToRelative(5.63f);
        pathBuilderB.curveToRelative(0.0f, 0.41f, -0.34f, 0.75f, -0.75f, 0.75f);
        pathBuilderB.horizontalLineToRelative(0.0f);
        pathBuilderB.curveTo(14.34f, 19.0f, 14.0f, 18.66f, 14.0f, 18.25f);
        pathBuilderB.verticalLineToRelative(-5.63f);
