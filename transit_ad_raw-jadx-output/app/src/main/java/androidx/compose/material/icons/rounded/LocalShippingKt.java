...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_localShipping", "Landroidx/compose/ui/graphics/vector/ImageVector;", "LocalShipping", "Landroidx/compose/material/icons/Icons$Rounded;", "getLocalShipping", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class LocalShippingKt {
    ...
    public static final ImageVector getLocalShipping(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.LocalShipping", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m2844getBlack0d7_KjU(), null);
        int iM3141getButtKaPHkGw = StrokeCap.INSTANCE.m3141getButtKaPHkGw();
        int iM3151getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3151getBevelLxFBmk8();
        PathBuilder pathBuilderA = b.a(19.5f, 8.0f, 17.0f, 8.0f);
        ...
        pathBuilderA.verticalLineToRelative(-3.33f);
        pathBuilderA.curveToRelative(0.0f, -0.43f, -0.14f, -0.85f, -0.4f, -1.2f);
        pathBuilderA.lineTo(20.3f, 8.4f);
        pathBuilderA.curveToRelative(-0.19f, -0.25f, -0.49f, -0.4f, -0.8f, -0.4f);
        pathBuilderA.close();
        ...
        pathBuilderA.reflectiveCurveToRelative(-0.45f, 1.0f, -1.0f, 1.0f);
        a.y(pathBuilderA, 19.5f, 9.5f, 1.96f, 2.5f);
        pathBuilderA.lineTo(17.0f, 12.0f);
        h.m(pathBuilderA, 17.0f, 9.5f, 2.5f);
