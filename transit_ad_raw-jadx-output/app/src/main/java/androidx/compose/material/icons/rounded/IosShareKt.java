...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_iosShare", "Landroidx/compose/ui/graphics/vector/ImageVector;", "IosShare", "Landroidx/compose/material/icons/Icons$Rounded;", "getIosShare", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class IosShareKt {
    ...
    public static final ImageVector getIosShare(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.IosShare", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderB = h.b(18.0f, 8.0f, -2.0f);
        pathBuilderB.curveToRelative(-0.55f, 0.0f, -1.0f, 0.45f, -1.0f, 1.0f);
        pathBuilderB.verticalLineToRelative(0.0f);
        pathBuilderB.curveToRelative(0.0f, 0.55f, 0.45f, 1.0f, 1.0f, 1.0f);
        a.z(pathBuilderB, 2.0f, 11.0f, 6.0f, 10.0f);
        ...
        pathBuilderB.curveTo(20.0f, 8.9f, 19.1f, 8.0f, 18.0f, 8.0f);
        pathBuilderB.close();
        ...
        PathBuilder pathBuilderA = b.a(12.0f, 16.0f, 12.0f, 16.0f);
        ...
        pathBuilderA.lineTo(8.85f, 4.15f);
        pathBuilderA.curveTo(8.54f, 4.46f, 8.76f, 5.0f, 9.21f, 5.0f);
        pathBuilderA.horizontalLineTo(11.0f);
        pathBuilderA.verticalLineToRelative(10.0f);
        pathBuilderA.curveTo(11.0f, 15.55f, 11.45f, 16.0f, 12.0f, 16.0f);
        pathBuilderA.close();
