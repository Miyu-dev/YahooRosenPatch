...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_photoCameraBack", "Landroidx/compose/ui/graphics/vector/ImageVector;", "PhotoCameraBack", "Landroidx/compose/material/icons/Icons$Rounded;", "getPhotoCameraBack", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class PhotoCameraBackKt {
    ...
    public static final ImageVector getPhotoCameraBack(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.PhotoCameraBack", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderA.curveTo(9.32f, 3.0f, 8.78f, 3.24f, 8.41f, 3.65f);
        ...
        androidx.browser.browseractions.a.k(pathBuilderA, 17.0f, 17.0f, 7.0f);
        ...
        pathBuilderA.lineToRelative(2.6f, -3.47f);
        pathBuilderA.curveToRelative(0.2f, -0.27f, 0.6f, -0.27f, 0.8f, 0.0f);
        pathBuilderA.lineToRelative(2.75f, 3.67f);
        pathBuilderA.curveTo(17.65f, 16.53f, 17.41f, 17.0f, 17.0f, 17.0f);
        pathBuilderA.close();
