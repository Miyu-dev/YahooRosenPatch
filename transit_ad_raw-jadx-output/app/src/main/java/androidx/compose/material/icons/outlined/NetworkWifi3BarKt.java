...
public final class NetworkWifi3BarKt {
    ...
    public static final ImageVector getNetworkWifi3Bar(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.NetworkWifi3Bar", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
