...
public final class PhoneLockedKt {
    ...
    public static final ImageVector getPhoneLocked(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.PhoneLocked", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderN = s.n(20.0f, 5.0f, 4.11f);
        pathBuilderN.curveToRelative(0.0f, -1.0f, -0.68f, -1.92f, -1.66f, -2.08f);
        pathBuilderN.curveTo(17.08f, 1.82f, 16.0f, 2.79f, 16.0f, 4.0f);
        ...
        a.k(pathBuilderN, 19.0f, 5.0f, -2.0f, 4.0f);
        pathBuilderN.curveToRelative(0.0f, -0.55f, 0.45f, -1.0f, 1.0f, -1.0f);
