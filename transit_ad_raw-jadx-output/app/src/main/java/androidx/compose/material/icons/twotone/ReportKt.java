...
public final class ReportKt {
    ...
    public static final ImageVector getReport(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.Report", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderB.lineTo(19.0f, 9.1f);
        android.support.v4.media.a.C(pathBuilderB, 14.9f, 5.0f, 9.1f, 5.0f);
        ...
        pathBuilderB.reflectiveCurveToRelative(-0.45f, 1.0f, -1.0f, 1.0f);
        androidx.compose.animation.a.j(pathBuilderB, 13.0f, 14.0f, -2.0f);
        ImageVector.Builder.m3359addPathoIyEayM$default(builder, b.k(pathBuilderB, 11.0f, 7.0f, 2.0f, 7.0f), defaultFillType, "", solidColor, 0.3f, null, 0.3f, 1.0f, iM3141getButtKaPHkGw, iM3151getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        int defaultFillType2 = VectorKt.getDefaultFillType();
        SolidColor solidColor2 = new SolidColor(companion.m2844getBlack0d7_KjU(), null);
        int iM3141getButtKaPHkGw2 = companion2.m3141getButtKaPHkGw();
        int iM3151getBevelLxFBmk82 = companion3.m3151getBevelLxFBmk8();
        PathBuilder pathBuilderA = c.b.a(15.73f, 3.0f, 8.27f, 3.0f, 8.27f);
        ...
        PathBuilder pathBuilderB2 = v.b(12.0f, 16.0f, -1.0f, 0.0f);
        ...
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, b.i(11.0f, 7.0f, 2.0f, 7.0f, -2.0f), VectorKt.getDefaultFillType(), "", new SolidColor(companion.m2844getBlack0d7_KjU(), null), 1.0f, null, 1.0f, 1.0f, companion2.m3141getButtKaPHkGw(), companion3.m3151getBevelLxFBmk8(), 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
