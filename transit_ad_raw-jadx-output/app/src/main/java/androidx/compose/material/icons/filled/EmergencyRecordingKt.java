...
public final class EmergencyRecordingKt {
    ...
    public static final ImageVector getEmergencyRecording(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.EmergencyRecording", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        androidx.appcompat.view.menu.a.z(pathBuilderN, 18.0f, 10.48f, 12.0f, 12.0f);
        ...
        pathBuilderN.verticalLineToRelative(3.27f);
        pathBuilderN.lineToRelative(3.0f, -1.73f);
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, h.p(pathBuilderN, 1.0f, 1.73f, 12.0f, 12.0f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw, iM3151getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
