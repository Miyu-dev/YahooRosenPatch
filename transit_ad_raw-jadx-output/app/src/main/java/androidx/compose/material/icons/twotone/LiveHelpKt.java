...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_liveHelp", "Landroidx/compose/ui/graphics/vector/ImageVector;", "LiveHelp", "Landroidx/compose/material/icons/Icons$TwoTone;", "getLiveHelp", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class LiveHelpKt {
    ...
    public static final ImageVector getLiveHelp(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.LiveHelp", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderA = a.a(5.0f, 18.0f, 4.83f, 0.59f, 0.59f);
        ...
        b.k(pathBuilderA, 5.0f, 4.0f, 14.0f);
        androidx.appcompat.view.menu.a.x(pathBuilderA, 13.0f, 17.0f, -2.0f, -2.0f);
        androidx.appcompat.graphics.drawable.a.z(pathBuilderA, 2.0f, 2.0f, 12.0f, 5.0f);
        ...
        PathBuilder pathBuilderD = androidx.browser.browseractions.a.d(21.0f, 4.0f);
        pathBuilderD.curveToRelative(0.0f, -1.1f, -0.9f, -2.0f, -2.0f, -2.0f);
        pathBuilderD.lineTo(5.0f, 2.0f);
        ...
        androidx.appcompat.view.menu.a.z(pathBuilderD, 21.0f, 4.0f, 19.0f, 18.0f);
        pathBuilderD.horizontalLineToRelative(-4.83f);
        pathBuilderD.lineToRelative(-0.59f, 0.59f);
        pathBuilderD.lineTo(12.0f, 20.17f);
        pathBuilderD.lineToRelative(-1.59f, -1.59f);
        pathBuilderD.lineToRelative(-0.58f, -0.58f);
        pathBuilderD.lineTo(5.0f, 18.0f);
        s.w(pathBuilderD, 5.0f, 4.0f, 14.0f, 14.0f);
        androidx.appcompat.view.menu.a.x(pathBuilderD, 11.0f, 15.0f, 2.0f, 2.0f);
        b.q(pathBuilderD, -2.0f, 12.0f, 7.0f);
        pathBuilderD.curveToRelative(1.1f, 0.0f, 2.0f, 0.9f, 2.0f, 2.0f);
        pathBuilderD.curveToRelative(0.0f, 2.0f, -3.0f, 1.75f, -3.0f, 5.0f);
        pathBuilderD.horizontalLineToRelative(2.0f);
        pathBuilderD.curveToRelative(0.0f, -2.25f, 3.0f, -2.5f, 3.0f, -5.0f);
        pathBuilderD.curveToRelative(0.0f, -2.21f, -1.79f, -4.0f, -4.0f, -4.0f);
        pathBuilderD.reflectiveCurveTo(8.0f, 6.79f, 8.0f, 9.0f);
        pathBuilderD.horizontalLineToRelative(2.0f);
        pathBuilderD.curveToRelative(0.0f, -1.1f, 0.9f, -2.0f, 2.0f, -2.0f);
        pathBuilderD.close();
