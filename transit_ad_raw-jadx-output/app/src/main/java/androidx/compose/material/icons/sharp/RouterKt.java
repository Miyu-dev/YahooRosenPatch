...
public final class RouterKt {
    ...
    public static final ImageVector getRouter(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.Router", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        a.t(pathBuilderA, 0.8f, -0.8f, 21.0f, 13.0f);
        androidx.appcompat.view.menu.a.y(pathBuilderA, -4.0f, 17.0f, 9.0f, -2.0f);
        v.y(pathBuilderA, 4.0f, 3.0f, 13.0f, 8.0f);
        androidx.appcompat.graphics.drawable.a.z(pathBuilderA, 18.0f, -8.0f, 8.0f, 18.0f);
        a.b.s(pathBuilderA, 6.0f, 18.0f, -2.0f, 2.0f);
        androidx.appcompat.graphics.drawable.a.A(pathBuilderA, 2.0f, 11.5f, 18.0f, -2.0f);
        androidx.appcompat.view.menu.a.n(pathBuilderA, -2.0f, 2.0f, 2.0f);
        androidx.appcompat.view.menu.a.x(pathBuilderA, 15.0f, 18.0f, -2.0f, -2.0f);
