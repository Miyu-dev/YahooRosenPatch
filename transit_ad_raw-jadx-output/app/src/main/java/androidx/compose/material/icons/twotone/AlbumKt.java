...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_album", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Album", "Landroidx/compose/material/icons/Icons$TwoTone;", "getAlbum", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class AlbumKt {
    ...
    public static final ImageVector getAlbum(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.Album", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderD.curveToRelative(-2.49f, 0.0f, -4.5f, -2.01f, -4.5f, -4.5f);
        pathBuilderD.reflectiveCurveTo(9.51f, 7.5f, 12.0f, 7.5f);
        pathBuilderD.reflectiveCurveToRelative(4.5f, 2.01f, 4.5f, 4.5f);
        ImageVector.Builder.m3359addPathoIyEayM$default(builder, androidx.appcompat.view.menu.a.j(pathBuilderD, -2.01f, 4.5f, -4.5f, 4.5f), defaultFillType, "", solidColor, 0.3f, null, 0.3f, 1.0f, iM3141getButtKaPHkGw, iM3151getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        pathBuilderD2.curveToRelative(-2.49f, 0.0f, -4.5f, 2.01f, -4.5f, 4.5f);
        pathBuilderD2.reflectiveCurveToRelative(2.01f, 4.5f, 4.5f, 4.5f);
        pathBuilderD2.reflectiveCurveToRelative(4.5f, -2.01f, 4.5f, -4.5f);
        pathBuilderD2.reflectiveCurveToRelative(-2.01f, -4.5f, -4.5f, -4.5f);
        pathBuilderD2.close();
        pathBuilderD2.moveTo(12.0f, 13.0f);
