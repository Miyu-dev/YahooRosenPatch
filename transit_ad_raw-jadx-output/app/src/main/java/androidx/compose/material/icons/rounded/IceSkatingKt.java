...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_iceSkating", "Landroidx/compose/ui/graphics/vector/ImageVector;", "IceSkating", "Landroidx/compose/material/icons/Icons$Rounded;", "getIceSkating", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class IceSkatingKt {
    ...
    public static final ImageVector getIceSkating(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.IceSkating", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m2844getBlack0d7_KjU(), null);
        int iM3141getButtKaPHkGw = StrokeCap.INSTANCE.m3141getButtKaPHkGw();
        int iM3151getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3151getBevelLxFBmk8();
        PathBuilder pathBuilderD = a.d(21.87f, 17.0f);
        pathBuilderD.curveToRelative(-0.47f, 0.0f, -0.85f, 0.34f, -0.98f, 0.8f);
        pathBuilderD.curveTo(20.54f, 19.07f, 19.38f, 20.0f, 18.0f, 20.0f);
        android.support.v4.media.a.s(pathBuilderD, -2.0f, -2.0f, 1.0f);
        ...
        pathBuilderD.reflectiveCurveTo(8.22f, 8.0f, 8.5f, 8.0f);
        ...
        pathBuilderD.curveToRelative(0.0f, 1.1f, 0.9f, 2.0f, 2.0f, 2.0f);
        v.t(pathBuilderD, 1.0f, 2.0f, 3.0f);
        pathBuilderD.curveToRelative(-0.55f, 0.0f, -1.0f, 0.45f, -1.0f, 1.0f);
        pathBuilderD.reflectiveCurveToRelative(0.45f, 1.0f, 1.0f, 1.0f);
        pathBuilderD.horizontalLineToRelative(15.0f);
        pathBuilderD.curveToRelative(2.33f, 0.0f, 4.29f, -1.6f, 4.84f, -3.75f);
        pathBuilderD.curveTo(23.01f, 17.62f, 22.52f, 17.0f, 21.87f, 17.0f);
