...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"__2kPlus", "Landroidx/compose/ui/graphics/vector/ImageVector;", "_2kPlus", "Landroidx/compose/material/icons/Icons$Sharp;", "get_2kPlus", "(Landroidx/compose/material/icons/Icons$Sharp;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-sharp_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class _2kPlusKt {
    ...
    public static final ImageVector get_2kPlus(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp._2kPlus", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m2844getBlack0d7_KjU(), null);
        int iM3141getButtKaPHkGw = StrokeCap.INSTANCE.m3141getButtKaPHkGw();
        int iM3151getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3151getBevelLxFBmk8();
        PathBuilder pathBuilderO = s.o(21.0f, 3.0f, 3.0f, 18.0f, 18.0f);
        a.y(pathBuilderO, 3.0f, 10.0f, 12.5f, 7.5f);
        c.a.h(pathBuilderO, 1.0f, 10.0f, 15.0f, 6.0f);
        c.a.j(pathBuilderO, -3.5f, 2.5f, -1.0f, 6.0f);
        androidx.appcompat.view.menu.a.v(pathBuilderO, 9.0f, 4.0f, 12.5f);
        pathBuilderO.moveTo(14.25f, 15.0f);
        e.f(pathBuilderO, -1.75f, -2.25f, 15.0f, 11.0f);
        ...
        i.b(pathBuilderO, 16.0f, 15.0f, 14.25f);
