...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_micExternalOn", "Landroidx/compose/ui/graphics/vector/ImageVector;", "MicExternalOn", "Landroidx/compose/material/icons/Icons$Sharp;", "getMicExternalOn", "(Landroidx/compose/material/icons/Icons$Sharp;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-sharp_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class MicExternalOnKt {
    ...
    public static final ImageVector getMicExternalOn(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.MicExternalOn", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        androidx.appcompat.app.m.n(pathBuilderB, 20.0f, 2.0f, 20.0f, -2.0f);
        v.C(pathBuilderB, 4.0f, -4.0f, 18.0f, 6.0f);
        pathBuilderB.curveToRelative(0.0f, 0.0f, 0.0f, -1.79f, 0.0f, -4.0f);
        pathBuilderB.horizontalLineTo(5.0f);
        pathBuilderB.lineTo(4.0f, 8.0f);
        pathBuilderB.horizontalLineToRelative(6.0f);
        h.n(pathBuilderB, 9.0f, 18.0f, 8.0f, 2.0f);
