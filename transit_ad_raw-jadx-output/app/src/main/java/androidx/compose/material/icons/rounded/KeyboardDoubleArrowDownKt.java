...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_keyboardDoubleArrowDown", "Landroidx/compose/ui/graphics/vector/ImageVector;", "KeyboardDoubleArrowDown", "Landroidx/compose/material/icons/Icons$Rounded;", "getKeyboardDoubleArrowDown", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class KeyboardDoubleArrowDownKt {
    ...
    public static final ImageVector getKeyboardDoubleArrowDown(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.KeyboardDoubleArrowDown", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderA = b.a(17.29f, 5.71f, 17.29f, 5.71f);
        pathBuilderA.curveToRelative(-0.39f, -0.39f, -1.02f, -0.39f, -1.41f, 0.0f);
        pathBuilderA.lineTo(12.0f, 9.58f);
        pathBuilderA.lineTo(8.11f, 5.7f);
        pathBuilderA.curveToRelative(-0.39f, -0.39f, -1.02f, -0.39f, -1.41f, 0.0f);
        ...
        pathBuilderA.curveToRelative(0.39f, 0.39f, 1.02f, 0.39f, 1.41f, 0.0f);
        pathBuilderA.lineToRelative(4.59f, -4.59f);
        pathBuilderA.curveTo(17.68f, 6.73f, 17.68f, 6.1f, 17.29f, 5.71f);
        pathBuilderA.close();
        ...
        PathBuilder pathBuilderA2 = b.a(17.29f, 12.3f, 17.29f, 12.3f);
        pathBuilderA2.curveToRelative(-0.39f, -0.39f, -1.02f, -0.39f, -1.41f, 0.0f);
        pathBuilderA2.lineTo(12.0f, 16.17f);
        ...
        pathBuilderA2.lineToRelative(4.59f, 4.59f);
        pathBuilderA2.curveToRelative(0.39f, 0.39f, 1.02f, 0.39f, 1.41f, 0.0f);
        pathBuilderA2.lineToRelative(4.59f, -4.59f);
        pathBuilderA2.curveTo(17.68f, 13.32f, 17.68f, 12.69f, 17.29f, 12.3f);
        pathBuilderA2.close();
