...
public final class GroupOffKt {
    ...
    public static final ImageVector getGroupOff(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.GroupOff", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderD.lineToRelative(-2.99f, -2.99f);
        pathBuilderD.curveTo(16.6f, 19.85f, 16.32f, 20.0f, 16.0f, 20.0f);
        ...
        pathBuilderD.lineTo(9.17f, 12.0f);
        ...
        pathBuilderD.curveTo(1.0f, 3.83f, 1.0f, 3.2f, 1.39f, 2.81f);
        pathBuilderD.reflectiveCurveToRelative(1.02f, -0.39f, 1.41f, 0.0f);
        androidx.appcompat.view.menu.a.z(pathBuilderD, 21.19f, 21.19f, 18.89f, 16.07f);
        pathBuilderD.curveToRelative(-0.29f, -1.22f, -1.13f, -2.19f, -2.23f, -2.94f);
        pathBuilderD.curveTo(19.42f, 13.53f, 23.0f, 14.82f, 23.0f, 17.0f);
        pathBuilderD.verticalLineToRelative(2.0f);
        pathBuilderD.curveToRelative(0.0f, 0.32f, -0.15f, 0.6f, -0.38f, 0.79f);
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, b.h(pathBuilderD, 18.89f, 16.07f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw, iM3151getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
