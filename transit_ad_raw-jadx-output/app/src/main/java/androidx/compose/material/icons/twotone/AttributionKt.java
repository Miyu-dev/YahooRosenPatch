...
public final class AttributionKt {
    ...
    public static final ImageVector getAttribution(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.Attribution", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderD.reflectiveCurveTo(12.83f, 8.0f, 12.0f, 8.0f);
        pathBuilderD.reflectiveCurveToRelative(-1.5f, -0.67f, -1.5f, -1.5f);
        pathBuilderD.reflectiveCurveTo(11.17f, 5.0f, 12.0f, 5.0f);
        androidx.compose.animation.a.j(pathBuilderD, 14.75f, 14.5f, -1.5f);
        androidx.compose.animation.a.o(pathBuilderD, 13.25f, 19.0f, -2.5f, -4.5f);
        pathBuilderD.horizontalLineToRelative(-1.5f);
        pathBuilderD.lineTo(9.25f, 9.88f);
        pathBuilderD.curveToRelative(0.0f, -0.92f, 1.84f, -1.38f, 2.75f, -1.38f);
        pathBuilderD.reflectiveCurveToRelative(2.75f, 0.47f, 2.75f, 1.38f);
        ImageVector.Builder.m3359addPathoIyEayM$default(builder, androidx.appcompat.view.menu.a.h(pathBuilderD, 4.62f), defaultFillType, "", solidColor, 0.3f, null, 0.3f, 1.0f, iM3141getButtKaPHkGw, iM3151getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        pathBuilderD2.reflectiveCurveToRelative(-3.58f, 8.0f, -8.0f, 8.0f);
        pathBuilderD2.close();
        pathBuilderD2.moveTo(12.0f, 8.5f);
        pathBuilderD2.curveToRelative(-0.91f, 0.0f, -2.75f, 0.46f, -2.75f, 1.38f);
        a.x(pathBuilderD2, 4.62f, 1.5f, 10.75f, 19.0f);
        android.support.v4.media.a.s(pathBuilderD2, 2.5f, -4.5f, 1.5f);
        pathBuilderD2.lineTo(14.75f, 9.88f);
        pathBuilderD2.curveToRelative(0.0f, -0.91f, -1.84f, -1.38f, -2.75f, -1.38f);
        pathBuilderD2.close();
        ...
        PathBuilder pathBuilderB = v.b(12.0f, 6.5f, -1.5f, 0.0f);
