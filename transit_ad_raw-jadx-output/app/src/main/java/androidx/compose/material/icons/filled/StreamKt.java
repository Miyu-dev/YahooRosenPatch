...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_stream", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Stream", "Landroidx/compose/material/icons/Icons$Filled;", "getStream", "(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-filled_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class StreamKt {
    ...
    public static final ImageVector getStream(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.Stream", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderL = a.l(10.05f, 8.59f, 6.03f, 4.55f, -0.01f);
        pathBuilderL.lineToRelative(-0.31f, -0.32f);
        pathBuilderL.lineToRelative(-1.42f, 1.41f);
        pathBuilderL.lineToRelative(4.02f, 4.05f);
        android.support.v4.media.a.n(pathBuilderL, 0.01f, -0.01f, 0.31f, 0.32f);
        pathBuilderL.moveTo(13.943f, 8.617f);
        pathBuilderL.lineToRelative(4.405f, -4.392f);
        androidx.compose.animation.a.A(pathBuilderL, 19.76f, 5.64f, -4.405f, 4.393f);
        pathBuilderL.moveTo(10.01f, 15.36f);
        pathBuilderL.lineToRelative(-1.42f, -1.41f);
        pathBuilderL.lineToRelative(-4.03f, 4.01f);
        pathBuilderL.lineToRelative(-0.32f, 0.33f);
        android.support.v4.media.a.n(pathBuilderL, 1.41f, 1.41f, 4.03f, -4.02f);
        pathBuilderL.moveTo(19.76f, 18.3f);
        pathBuilderL.lineToRelative(-3.99f, -4.01f);
        pathBuilderL.lineToRelative(-0.36f, -0.35f);
        pathBuilderL.lineTo(14.0f, 15.35f);
        ImageVector.Builder.m3359addPathoIyEayM$default(builder, a.e(pathBuilderL, 3.99f, 4.01f, 0.35f, 0.35f), defaultFillType4, "", solidColor4, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw4, iM3151getBevelLxFBmk84, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
