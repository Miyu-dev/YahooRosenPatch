...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_batterySaver", "Landroidx/compose/ui/graphics/vector/ImageVector;", "BatterySaver", "Landroidx/compose/material/icons/Icons$Rounded;", "getBatterySaver", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class BatterySaverKt {
    ...
    public static final ImageVector getBatterySaver(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.BatterySaver", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m2844getBlack0d7_KjU(), null);
        int iM3141getButtKaPHkGw = StrokeCap.INSTANCE.m3141getButtKaPHkGw();
        int iM3151getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3151getBevelLxFBmk8();
        PathBuilder pathBuilderT = b.t(16.0f, 4.0f, -2.0f, 3.0f);
        ...
        pathBuilderT.curveTo(7.45f, 4.0f, 7.0f, 4.45f, 7.0f, 5.0f);
        pathBuilderT.verticalLineToRelative(16.0f);
        pathBuilderT.curveToRelative(0.0f, 0.55f, 0.45f, 1.0f, 1.0f, 1.0f);
        pathBuilderT.horizontalLineToRelative(8.0f);
        pathBuilderT.curveToRelative(0.55f, 0.0f, 1.0f, -0.45f, 1.0f, -1.0f);
        pathBuilderT.verticalLineTo(5.0f);
        pathBuilderT.curveTo(17.0f, 4.45f, 16.55f, 4.0f, 16.0f, 4.0f);
        androidx.compose.animation.b.r(pathBuilderT, 14.0f, 14.0f, -1.0f, 1.0f);
        pathBuilderT.curveToRelative(0.0f, 0.55f, -0.45f, 1.0f, -1.0f, 1.0f);
        ...
        pathBuilderT.curveToRelative(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        pathBuilderT.verticalLineToRelative(0.0f);
        pathBuilderT.curveTo(15.0f, 13.55f, 14.55f, 14.0f, 14.0f, 14.0f);
        pathBuilderT.close();
