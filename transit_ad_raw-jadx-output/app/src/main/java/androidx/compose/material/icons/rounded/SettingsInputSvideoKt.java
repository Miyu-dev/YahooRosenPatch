...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_settingsInputSvideo", "Landroidx/compose/ui/graphics/vector/ImageVector;", "SettingsInputSvideo", "Landroidx/compose/material/icons/Icons$Rounded;", "getSettingsInputSvideo", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class SettingsInputSvideoKt {
    ...
    public static final ImageVector getSettingsInputSvideo(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.SettingsInputSvideo", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderB = v.b(7.5f, 11.5f, -1.5f, 0.0f);
        ...
        PathBuilder pathBuilderB2 = v.b(16.5f, 11.5f, -1.5f, 0.0f);
        ...
        PathBuilder pathBuilderB3 = v.b(9.0f, 16.0f, -1.5f, 0.0f);
        ...
        PathBuilder pathBuilderB4 = v.b(15.0f, 16.0f, -1.5f, 0.0f);
        ...
        PathBuilder pathBuilderD2 = a.d(15.0f, 7.5f);
        pathBuilderD2.curveTo(15.0f, 6.67f, 14.33f, 6.0f, 13.5f, 6.0f);
        pathBuilderD2.horizontalLineToRelative(-3.0f);
        pathBuilderD2.curveTo(9.67f, 6.0f, 9.0f, 6.67f, 9.0f, 7.5f);
        pathBuilderD2.reflectiveCurveTo(9.67f, 9.0f, 10.5f, 9.0f);
        pathBuilderD2.horizontalLineToRelative(3.0f);
        pathBuilderD2.curveTo(14.33f, 9.0f, 15.0f, 8.33f, 15.0f, 7.5f);
        pathBuilderD2.close();
