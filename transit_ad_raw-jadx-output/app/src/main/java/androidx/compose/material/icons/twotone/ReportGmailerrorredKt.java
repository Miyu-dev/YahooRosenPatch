...
public final class ReportGmailerrorredKt {
    ...
    public static final ImageVector getReportGmailerrorred(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.ReportGmailerrorred", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
