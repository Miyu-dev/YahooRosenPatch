...
public final class MovingKt {
    ...
    public static final ImageVector getMoving(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Moving", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m2844getBlack0d7_KjU(), null);
        int iM3141getButtKaPHkGw = StrokeCap.INSTANCE.m3141getButtKaPHkGw();
        int iM3151getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3151getBevelLxFBmk8();
        PathBuilder pathBuilderD = a.d(2.7f, 17.29f);
        ...
        pathBuilderD.lineToRelative(4.18f, -4.17f);
        ...
        pathBuilderD.curveTo(22.0f, 6.22f, 21.78f, 6.0f, 21.5f, 6.0f);
        pathBuilderD.horizontalLineToRelative(-4.29f);
        pathBuilderD.curveToRelative(-0.45f, 0.0f, -0.67f, 0.54f, -0.35f, 0.85f);
        pathBuilderD.lineToRelative(1.44f, 1.44f);
        pathBuilderD.lineToRelative(-4.17f, 4.17f);
        pathBuilderD.curveToRelative(-0.39f, 0.39f, -1.02f, 0.39f, -1.41f, 0.0f);
        pathBuilderD.lineToRelative(-1.17f, -1.17f);
        pathBuilderD.curveToRelative(-1.17f, -1.17f, -3.07f, -1.17f, -4.24f, 0.0f);
        pathBuilderD.lineTo(2.7f, 15.88f);
        pathBuilderD.curveTo(2.32f, 16.27f, 2.32f, 16.91f, 2.7f, 17.29f);
        pathBuilderD.close();
