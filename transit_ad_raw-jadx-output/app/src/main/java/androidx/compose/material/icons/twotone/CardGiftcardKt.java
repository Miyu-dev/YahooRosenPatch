...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_cardGiftcard", "Landroidx/compose/ui/graphics/vector/ImageVector;", "CardGiftcard", "Landroidx/compose/material/icons/Icons$TwoTone;", "getCardGiftcard", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class CardGiftcardKt {
    ...
    public static final ImageVector getCardGiftcard(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.CardGiftcard", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderO = b.o(4.0f, 17.0f, 16.0f, 2.0f);
        a.z(pathBuilderO, 4.0f, 19.0f, 17.0f, 10.83f);
        pathBuilderO.lineTo(15.38f, 12.0f);
        pathBuilderO.lineTo(12.0f, 7.4f);
        pathBuilderO.lineTo(8.62f, 12.0f);
        pathBuilderO.lineTo(7.0f, 10.83f);
        pathBuilderO.lineTo(9.08f, 8.0f);
        b.s(pathBuilderO, 4.0f, 8.0f, 6.0f, 16.0f);
        ImageVector.Builder.m3359addPathoIyEayM$default(builder, s.p(pathBuilderO, 20.0f, 8.0f, -5.08f), defaultFillType, "", solidColor, 0.3f, null, 0.3f, 1.0f, iM3141getButtKaPHkGw, iM3151getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        pathBuilderB.reflectiveCurveToRelative(-1.0f, -0.45f, -1.0f, -1.0f);
        pathBuilderB.reflectiveCurveToRelative(0.45f, -1.0f, 1.0f, -1.0f);
        androidx.compose.animation.a.t(pathBuilderB, 20.0f, 19.0f, 4.0f, 19.0f);
        a.n(pathBuilderB, -2.0f, 16.0f, 2.0f);
        ...
        pathBuilderB.lineTo(7.0f, 10.83f);
        pathBuilderB.lineTo(8.62f, 12.0f);
        pathBuilderB.lineTo(12.0f, 7.4f);
        pathBuilderB.lineToRelative(3.38f, 4.6f);
        pathBuilderB.lineTo(17.0f, 10.83f);
        pathBuilderB.lineTo(14.92f, 8.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, c.a.e(pathBuilderB, 20.0f, 8.0f, 6.0f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw2, iM3151getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
