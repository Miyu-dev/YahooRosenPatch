...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"__17mp", "Landroidx/compose/ui/graphics/vector/ImageVector;", "_17mp", "Landroidx/compose/material/icons/Icons$Rounded;", "get_17mp", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class _17mpKt {
    ...
    public static final ImageVector get_17mp(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded._17mp", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderB.curveToRelative(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        android.support.v4.media.a.y(pathBuilderB, 17.75f, 12.0f, 6.25f);
        pathBuilderB.curveToRelative(0.0f, -0.41f, 0.34f, -0.75f, 0.75f, -0.75f);
        pathBuilderB.horizontalLineToRelative(2.75f);
        pathBuilderB.curveToRelative(0.67f, 0.0f, 1.15f, 0.65f, 0.96f, 1.29f);
        pathBuilderB.lineToRelative(-1.28f, 4.12f);
        pathBuilderB.curveToRelative(-0.11f, 0.35f, -0.43f, 0.59f, -0.8f, 0.59f);
        pathBuilderB.curveToRelative(-0.56f, 0.0f, -0.97f, -0.54f, -0.8f, -1.08f);
        pathBuilderB.lineTo(14.62f, 7.0f);
        pathBuilderB.horizontalLineToRelative(-1.87f);
        pathBuilderB.curveTo(12.34f, 7.0f, 12.0f, 6.66f, 12.0f, 6.25f);
        pathBuilderB.close();
