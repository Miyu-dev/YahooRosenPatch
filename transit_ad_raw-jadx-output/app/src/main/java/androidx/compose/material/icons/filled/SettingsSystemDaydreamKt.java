...
public final class SettingsSystemDaydreamKt {
    ...
    public static final ImageVector getSettingsSystemDaydream(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.SettingsSystemDaydream", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderB.curveToRelative(0.0f, -1.1f, -0.9f, -2.0f, -2.0f, -2.0f);
        a.t(pathBuilderB, 21.0f, 19.01f, 3.0f, 19.01f);
