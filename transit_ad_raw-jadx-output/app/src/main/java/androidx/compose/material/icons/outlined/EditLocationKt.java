...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_editLocation", "Landroidx/compose/ui/graphics/vector/ImageVector;", "EditLocation", "Landroidx/compose/material/icons/Icons$Outlined;", "getEditLocation", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-outlined_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class EditLocationKt {
    ...
    public static final ImageVector getEditLocation(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.EditLocation", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        a.t(pathBuilderA, 5.54f, -5.56f, 16.0f, 2.74f);
        pathBuilderA.lineToRelative(1.29f, -1.29f);
        pathBuilderA.arcToRelative(1.49f, 1.49f, 0.0f, false, true, 2.12f, 0.0f);
        ...
        androidx.compose.animation.a.A(pathBuilderA, 10.0f, 8.74f, 6.0f, -6.0f);
        pathBuilderA.moveTo(13.72f, 2.19f);
        pathBuilderA.lineToRelative(-0.55f, 0.55f);
        pathBuilderA.lineToRelative(-1.27f, 1.27f);
        pathBuilderA.curveToRelative(-3.3f, 0.05f, -5.9f, 2.6f, -5.9f, 6.2f);
        ...
        pathBuilderA.curveToRelative(0.58f, 0.0f, 1.16f, 0.06f, 1.72f, 0.18f);
        pathBuilderA.close();
