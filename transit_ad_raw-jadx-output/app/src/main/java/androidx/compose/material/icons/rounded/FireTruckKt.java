...
public final class FireTruckKt {
    ...
    public static final ImageVector getFireTruck(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.FireTruck", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderA.horizontalLineToRelative(1.0f);
        pathBuilderA.curveToRelative(1.1f, 0.0f, 2.0f, -0.9f, 2.0f, -2.0f);
        pathBuilderA.verticalLineToRelative(-4.68f);
        ...
        PathBuilder pathBuilderO = s.o(10.25f, 8.5f, 10.0f, -2.0f, 0.25f);
        pathBuilderO.curveTo(10.66f, 6.5f, 11.0f, 6.16f, 11.0f, 5.75f);
        pathBuilderO.verticalLineToRelative(0.0f);
        pathBuilderO.curveTo(11.0f, 5.34f, 10.66f, 5.0f, 10.25f, 5.0f);
        pathBuilderO.horizontalLineToRelative(-8.5f);
        pathBuilderO.curveTo(1.34f, 5.0f, 1.0f, 5.34f, 1.0f, 5.75f);
        pathBuilderO.verticalLineToRelative(0.0f);
        pathBuilderO.curveTo(1.0f, 6.16f, 1.34f, 6.5f, 1.75f, 6.5f);
        a.b.r(pathBuilderO, 2.0f, 2.0f, 1.75f);
        pathBuilderO.curveTo(1.34f, 8.5f, 1.0f, 8.84f, 1.0f, 9.25f);
        pathBuilderO.verticalLineToRelative(0.0f);
        pathBuilderO.curveTo(1.0f, 9.66f, 1.34f, 10.0f, 1.75f, 10.0f);
        pathBuilderO.horizontalLineToRelative(8.5f);
        pathBuilderO.curveTo(10.66f, 10.0f, 11.0f, 9.66f, 11.0f, 9.25f);
        pathBuilderO.verticalLineToRelative(0.0f);
        pathBuilderO.curveTo(11.0f, 8.84f, 10.66f, 8.5f, 10.25f, 8.5f);
        a.q(pathBuilderO, 5.25f, 8.5f, 3.5f, -2.0f);
        a.b.m(pathBuilderO, 1.75f, 8.5f, 8.5f, 8.5f);
        pathBuilderO.horizontalLineTo(6.75f);
        pathBuilderO.verticalLineToRelative(-2.0f);
        pathBuilderO.horizontalLineTo(8.5f);
        pathBuilderO.verticalLineTo(8.5f);
        pathBuilderO.close();
