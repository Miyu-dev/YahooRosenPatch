...
public final class CancelKt {
    ...
    public static final ImageVector getCancel(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Cancel", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderD.lineToRelative(2.89f, 2.89f);
        pathBuilderD.curveToRelative(0.38f, 0.38f, 0.38f, 1.02f, 0.0f, 1.41f);
        pathBuilderD.close();
