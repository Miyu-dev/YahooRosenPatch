...
public final class VapeFreeKt {
    ...
    public static final ImageVector getVapeFree(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.VapeFree", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        b.B(pathBuilderB2, 2.0f, 16.5f, 16.17f, 19.0f);
        a.s(pathBuilderB2, 8.0f, -3.0f, 5.17f);
        pathBuilderB2.lineTo(1.39f, 4.22f);
        pathBuilderB2.lineToRelative(1.41f, -1.41f);
        pathBuilderB2.lineToRelative(18.38f, 18.38f);
        s.r(pathBuilderB2, -1.41f, 1.41f, 16.17f, 19.0f);
        b.z(pathBuilderB2, 18.83f, 16.0f, 22.0f, 3.0f);
        androidx.appcompat.view.menu.a.s(pathBuilderB2, -0.17f, 18.83f, 16.0f);
        ...
        pathBuilderB2.close();
        pathBuilderB2.moveTo(11.15f, 8.32f);
        pathBuilderB2.curveToRelative(0.0f, -0.01f, 0.0f, -0.01f, 0.0f, -0.02f);
        pathBuilderB2.curveToRelative(0.0f, -1.85f, 1.5f, -3.35f, 3.35f, -3.35f);
        ...
        pathBuilderB2.curveToRelative(1.87f, 0.0f, 3.47f, 1.35f, 3.47f, 3.16f);
        androidx.appcompat.graphics.drawable.a.o(pathBuilderB2, 15.0f, 18.0f, -1.3f);
        pathBuilderB2.curveToRelative(0.0f, -1.31f, -0.92f, -2.05f, -1.97f, -2.05f);
        pathBuilderB2.horizontalLineTo(14.5f);
        pathBuilderB2.curveToRelative(-0.01f, 0.0f, -0.01f, 0.0f, -0.02f, 0.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, androidx.compose.animation.b.h(pathBuilderB2, 11.15f, 8.32f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw2, iM3151getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
