...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_dataThresholding", "Landroidx/compose/ui/graphics/vector/ImageVector;", "DataThresholding", "Landroidx/compose/material/icons/Icons$Filled;", "getDataThresholding", "(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-filled_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class DataThresholdingKt {
    ...
    public static final ImageVector getDataThresholding(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.DataThresholding", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        a.y(pathBuilderB, 10.67f, 8.17f, 2.0f, 2.0f);
        pathBuilderB.lineToRelative(3.67f, -3.67f);
        pathBuilderB.lineToRelative(1.41f, 1.41f);
        pathBuilderB.lineTo(12.67f, 13.0f);
        pathBuilderB.lineToRelative(-2.0f, -2.0f);
        pathBuilderB.lineToRelative(-3.0f, 3.0f);
        s.r(pathBuilderB, -1.41f, -1.41f, 10.67f, 8.17f);
        pathBuilderB.moveTo(5.0f, 16.0f);
        pathBuilderB.horizontalLineToRelative(1.72f);
