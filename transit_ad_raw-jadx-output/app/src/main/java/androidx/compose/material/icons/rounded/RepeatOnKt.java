...
public final class RepeatOnKt {
    ...
    public static final ImageVector getRepeatOn(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.RepeatOn", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        a.y(pathBuilderB, 18.0f, 20.64f, 6.35f);
        pathBuilderB.lineToRelative(-2.79f, 2.79f);
