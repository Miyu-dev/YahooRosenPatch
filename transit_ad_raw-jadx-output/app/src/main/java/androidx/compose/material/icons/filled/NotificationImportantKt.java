...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_notificationImportant", "Landroidx/compose/ui/graphics/vector/ImageVector;", "NotificationImportant", "Landroidx/compose/material/icons/Icons$Filled;", "getNotificationImportant", "(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-filled_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class NotificationImportantKt {
    ...
    public static final ImageVector getNotificationImportant(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.NotificationImportant", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        a.q(pathBuilderE, 5.0f, -2.0f, 2.0f, 1.0f);
        d.g(pathBuilderE, 16.0f, -1.0f, -2.0f, -2.0f);
        androidx.appcompat.view.menu.a.x(pathBuilderE, 13.0f, 16.0f, -2.0f, -2.0f);
        androidx.appcompat.graphics.drawable.a.z(pathBuilderE, 2.0f, 2.0f, 13.0f, 12.0f);
        androidx.appcompat.view.menu.a.y(pathBuilderE, -2.0f, 11.0f, 8.0f, 2.0f);
        android.support.v4.media.a.v(pathBuilderE, 4.0f, 12.0f, 22.0f);
