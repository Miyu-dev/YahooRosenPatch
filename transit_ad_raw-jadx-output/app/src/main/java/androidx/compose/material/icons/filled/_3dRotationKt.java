...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"__3dRotation", "Landroidx/compose/ui/graphics/vector/ImageVector;", "_3dRotation", "Landroidx/compose/material/icons/Icons$Filled;", "get_3dRotation", "(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-filled_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class _3dRotationKt {
    ...
    public static final ImageVector get_3dRotation(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled._3dRotation", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderD.moveTo(8.41f, 14.96f);
        ...
        pathBuilderD.curveToRelative(0.13f, -0.29f, 0.2f, -0.61f, 0.2f, -0.97f);
        ...
        pathBuilderD.curveToRelative(0.05f, -0.16f, 0.07f, -0.32f, 0.07f, -0.48f);
        pathBuilderD.curveToRelative(0.0f, -0.36f, -0.06f, -0.68f, -0.18f, -0.96f);
        pathBuilderD.curveToRelative(-0.12f, -0.28f, -0.29f, -0.51f, -0.51f, -0.69f);
        ...
        pathBuilderD.curveToRelative(0.11f, -0.09f, 0.23f, -0.17f, 0.38f, -0.22f);
        pathBuilderD.curveToRelative(0.15f, -0.05f, 0.3f, -0.08f, 0.48f, -0.08f);
        ...
        pathBuilderD.curveToRelative(-0.05f, 0.15f, -0.14f, 0.27f, -0.25f, 0.37f);
        ...
        pathBuilderD.curveToRelative(0.07f, 0.16f, 0.1f, 0.35f, 0.1f, 0.57f);
        ...
        pathBuilderD.close();
        pathBuilderD.moveTo(16.96f, 9.04f);
        ...
        pathBuilderD.curveToRelative(0.45f, -0.18f, 0.84f, -0.43f, 1.16f, -0.76f);
        ...
        pathBuilderD.close();
        pathBuilderD.moveTo(16.57f, 12.2f);
        ...
        pathBuilderD.curveToRelative(-0.19f, 0.23f, -0.43f, 0.41f, -0.71f, 0.53f);
        pathBuilderD.curveToRelative(-0.29f, 0.12f, -0.62f, 0.18f, -0.99f, 0.18f);
        androidx.appcompat.view.menu.a.y(pathBuilderD, -0.91f, 13.39f, 9.12f, 0.97f);
        ...
        android.support.v4.media.a.v(pathBuilderD, 0.4f, 12.0f, 0.0f);
        pathBuilderD.lineToRelative(-0.66f, 0.03f);
        pathBuilderD.lineToRelative(3.81f, 3.81f);
        pathBuilderD.lineToRelative(1.33f, -1.33f);
        pathBuilderD.curveToRelative(3.27f, 1.55f, 5.61f, 4.72f, 5.96f, 8.48f);
