...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_dry", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Dry", "Landroidx/compose/material/icons/Icons$TwoTone;", "getDry", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class DryKt {
    ...
    public static final ImageVector getDry(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.Dry", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderB = s.b(10.0f, 21.0f, 4.0f);
        pathBuilderB.curveToRelative(-0.55f, 0.0f, -1.0f, -0.45f, -1.0f, -1.0f);
        pathBuilderB.verticalLineToRelative(-6.0f);
        pathBuilderB.curveToRelative(0.0f, -0.39f, 0.23f, -0.64f, 0.36f, -0.75f);
        pathBuilderB.lineTo(7.0f, 9.87f);
        pathBuilderB.verticalLineTo(12.0f);
        pathBuilderB.lineToRelative(3.0f, 0.0f);
        ...
        pathBuilderD.close();
        pathBuilderD.moveTo(15.65f, 4.86f);
        ...
        pathBuilderD.curveToRelative(0.57f, 0.62f, 0.82f, 1.41f, 0.67f, 2.2f);
        pathBuilderD.lineTo(14.98f, 9.0f);
        pathBuilderD.horizontalLineToRelative(1.91f);
        pathBuilderD.lineToRelative(0.06f, -0.43f);
        pathBuilderD.curveTo(17.16f, 7.21f, 16.68f, 5.86f, 15.65f, 4.86f);
        a.y(pathBuilderD, 19.65f, 4.86f, -0.07f, -0.07f);
        pathBuilderD.curveToRelative(-0.57f, -0.62f, -0.82f, -1.41f, -0.67f, -2.2f);
        pathBuilderD.lineTo(19.0f, 2.0f);
        pathBuilderD.horizontalLineToRelative(-1.89f);
        pathBuilderD.lineToRelative(-0.06f, 0.43f);
        pathBuilderD.curveToRelative(-0.2f, 1.36f, 0.27f, 2.71f, 1.3f, 3.72f);
        pathBuilderD.lineToRelative(0.07f, 0.06f);
        pathBuilderD.curveToRelative(0.57f, 0.62f, 0.82f, 1.41f, 0.67f, 2.2f);
        pathBuilderD.lineTo(18.98f, 9.0f);
        pathBuilderD.horizontalLineToRelative(1.91f);
        pathBuilderD.lineToRelative(0.06f, -0.43f);
        pathBuilderD.curveTo(21.16f, 7.21f, 20.68f, 5.86f, 19.65f, 4.86f);
        pathBuilderD.close();
