...
public final class PhoneLockedKt {
    ...
    public static final ImageVector getPhoneLocked(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.PhoneLocked", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderD = a.d(15.0f, 17.83f);
        pathBuilderD.curveToRelative(1.29f, 0.54f, 2.63f, 0.89f, 4.0f, 1.07f);
        pathBuilderD.verticalLineToRelative(-2.23f);
        ImageVector.Builder.m3359addPathoIyEayM$default(builder, h.p(pathBuilderD, -2.35f, -0.47f, 15.0f, 17.83f), defaultFillType2, "", solidColor2, 0.3f, null, 0.3f, 1.0f, iM3141getButtKaPHkGw2, iM3151getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        ImageVector.Builder.m3359addPathoIyEayM$default(builder, v.l(pathBuilderB, 7.8f, 7.35f, 7.33f, 5.0f), defaultFillType3, "", solidColor3, 0.3f, null, 0.3f, 1.0f, iM3141getButtKaPHkGw3, iM3151getBevelLxFBmk83, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
