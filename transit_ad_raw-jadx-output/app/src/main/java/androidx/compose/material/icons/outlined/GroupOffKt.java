...
public final class GroupOffKt {
    ...
    public static final ImageVector getGroupOff(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.GroupOff", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        androidx.appcompat.view.menu.a.z(pathBuilderD, 22.83f, 20.0f, 9.0f, 6.0f);
        ...
        pathBuilderD.curveTo(11.0f, 6.9f, 10.1f, 6.0f, 9.0f, 6.0f);
        pathBuilderD.close();
        pathBuilderD.moveTo(9.17f, 12.0f);
        ...
        androidx.appcompat.view.menu.a.z(pathBuilderD, 9.17f, 12.0f, 9.0f, 15.0f);
