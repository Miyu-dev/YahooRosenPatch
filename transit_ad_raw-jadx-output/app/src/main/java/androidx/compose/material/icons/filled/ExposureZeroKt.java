...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_exposureZero", "Landroidx/compose/ui/graphics/vector/ImageVector;", "ExposureZero", "Landroidx/compose/material/icons/Icons$Filled;", "getExposureZero", "(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-filled_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class ExposureZeroKt {
    ...
    public static final ImageVector getExposureZero(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.ExposureZero", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderD.curveToRelative(-0.2f, 0.7f, -0.48f, 1.27f, -0.83f, 1.7f);
        pathBuilderD.curveToRelative(-0.36f, 0.44f, -0.79f, 0.75f, -1.3f, 0.95f);
        pathBuilderD.curveToRelative(-0.51f, 0.2f, -1.07f, 0.3f, -1.7f, 0.3f);
        ...
        pathBuilderD.curveToRelative(-0.36f, -0.44f, -0.65f, -1.01f, -0.85f, -1.7f);
        ...
        android.support.v4.media.a.v(pathBuilderD, 2.04f, 14.03f, 10.14f);
        ...
        pathBuilderD.curveToRelative(-0.32f, 0.0f, -0.61f, 0.06f, -0.86f, 0.18f);
        pathBuilderD.reflectiveCurveToRelative(-0.47f, 0.31f, -0.64f, 0.58f);
        pathBuilderD.curveToRelative(-0.17f, 0.27f, -0.31f, 0.62f, -0.4f, 1.06f);
        ...
        pathBuilderD.curveToRelative(0.17f, -0.28f, 0.3f, -0.64f, 0.39f, -1.09f);
        pathBuilderD.curveToRelative(0.09f, -0.45f, 0.13f, -0.99f, 0.13f, -1.62f);
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, androidx.appcompat.view.menu.a.h(pathBuilderD, -2.66f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw, iM3151getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
