...
public final class PhotoSizeSelectLargeKt {
    ...
    public static final ImageVector getPhotoSizeSelectLarge(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.PhotoSizeSelectLarge", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderF.verticalLineToRelative(-8.0f);
        pathBuilderF.curveToRelative(0.0f, -1.1f, -0.9f, -2.0f, -2.0f, -2.0f);
        androidx.appcompat.view.menu.a.z(pathBuilderF, 1.0f, 11.0f, 3.63f, 18.19f);
        pathBuilderF.lineToRelative(1.49f, -1.91f);
        pathBuilderF.curveToRelative(0.2f, -0.25f, 0.57f, -0.26f, 0.78f, -0.01f);
        pathBuilderF.lineToRelative(1.39f, 1.67f);
        pathBuilderF.lineToRelative(2.1f, -2.7f);
        pathBuilderF.curveToRelative(0.2f, -0.26f, 0.6f, -0.26f, 0.79f, 0.01f);
        pathBuilderF.lineToRelative(2.22f, 2.96f);
        pathBuilderF.curveToRelative(0.25f, 0.33f, 0.01f, 0.8f, -0.4f, 0.8f);
        pathBuilderF.lineTo(4.02f, 19.01f);
        pathBuilderF.curveToRelative(-0.41f, -0.01f, -0.65f, -0.49f, -0.39f, -0.82f);
        pathBuilderF.close();
