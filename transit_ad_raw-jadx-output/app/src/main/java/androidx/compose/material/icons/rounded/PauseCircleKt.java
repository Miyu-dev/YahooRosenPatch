...
public final class PauseCircleKt {
    ...
    public static final ImageVector getPauseCircle(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.PauseCircle", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        androidx.compose.animation.a.t(pathBuilderD, 10.0f, 16.0f, 10.0f, 16.0f);
        ...
        pathBuilderD.curveTo(11.0f, 15.55f, 10.55f, 16.0f, 10.0f, 16.0f);
        androidx.compose.animation.a.t(pathBuilderD, 14.0f, 16.0f, 14.0f, 16.0f);
        pathBuilderD.curveToRelative(-0.55f, 0.0f, -1.0f, -0.45f, -1.0f, -1.0f);
        pathBuilderD.verticalLineTo(9.0f);
        pathBuilderD.curveToRelative(0.0f, -0.55f, 0.45f, -1.0f, 1.0f, -1.0f);
        pathBuilderD.lineToRelative(0.0f, 0.0f);
        pathBuilderD.curveToRelative(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        pathBuilderD.verticalLineToRelative(6.0f);
        pathBuilderD.curveTo(15.0f, 15.55f, 14.55f, 16.0f, 14.0f, 16.0f);
        pathBuilderD.close();
