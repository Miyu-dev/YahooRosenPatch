...
public final class _4kKt {
    ...
    public static final ImageVector get_4k(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled._4k", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderA.curveToRelative(0.0f, -1.1f, -0.9f, -2.0f, -2.0f, -2.0f);
        a.j(pathBuilderA, 12.0f, 13.5f, -1.0f);
        pathBuilderA.lineTo(11.0f, 15.0f);
        b.s(pathBuilderA, 9.5f, 15.0f, -1.5f, -3.0f);
        pathBuilderA.lineTo(6.5f, 9.0f);
        b.s(pathBuilderA, 8.0f, 9.0f, 3.0f, 1.5f);
        pathBuilderA.lineTo(9.5f, 9.0f);
        b.s(pathBuilderA, 11.0f, 9.0f, 3.0f, 1.0f);
        androidx.appcompat.graphics.drawable.a.A(pathBuilderA, 1.5f, 18.0f, 15.0f, -1.75f);
