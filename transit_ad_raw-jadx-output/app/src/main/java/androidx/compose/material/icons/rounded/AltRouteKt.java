...
public final class AltRouteKt {
    ...
    public static final ImageVector getAltRoute(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.AltRoute", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        a.t(pathBuilderA, 10.15f, 5.15f, 7.35f, 2.35f);
        pathBuilderA.curveToRelative(-0.2f, -0.2f, -0.51f, -0.2f, -0.71f, 0.0f);
        pathBuilderA.lineTo(3.85f, 5.15f);
        pathBuilderA.curveTo(3.54f, 5.46f, 3.76f, 6.0f, 4.21f, 6.0f);
        ...
        pathBuilderA.horizontalLineToRelative(1.78f);
        pathBuilderA.curveTo(10.24f, 6.0f, 10.46f, 5.46f, 10.15f, 5.15f);
        androidx.browser.browseractions.a.y(pathBuilderA, 20.15f, 5.15f, -2.79f, -2.79f);
        pathBuilderA.curveToRelative(-0.2f, -0.2f, -0.51f, -0.2f, -0.71f, 0.0f);
        pathBuilderA.lineToRelative(-2.79f, 2.79f);
        pathBuilderA.curveTo(13.54f, 5.46f, 13.76f, 6.0f, 14.21f, 6.0f);
        pathBuilderA.horizontalLineToRelative(1.78f);
        ...
        pathBuilderA.horizontalLineToRelative(1.8f);
        pathBuilderA.curveTo(20.24f, 6.0f, 20.46f, 5.46f, 20.15f, 5.15f);
        pathBuilderA.close();
