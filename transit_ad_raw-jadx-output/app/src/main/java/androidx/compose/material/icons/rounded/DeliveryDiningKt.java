...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_deliveryDining", "Landroidx/compose/ui/graphics/vector/ImageVector;", "DeliveryDining", "Landroidx/compose/material/icons/Icons$Rounded;", "getDeliveryDining", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class DeliveryDiningKt {
    ...
    public static final ImageVector getDeliveryDining(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.DeliveryDining", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderD.horizontalLineToRelative(3.52f);
        pathBuilderD.curveToRelative(0.61f, 0.0f, 1.18f, -0.28f, 1.56f, -0.75f);
        pathBuilderD.lineToRelative(3.48f, -4.35f);
        pathBuilderD.curveTo(18.85f, 10.54f, 19.0f, 10.1f, 19.0f, 9.65f);
        android.support.v4.media.a.y(pathBuilderD, 7.0f, 7.0f, 17.0f);
        pathBuilderD.curveToRelative(-0.55f, 0.0f, -1.0f, -0.45f, -1.0f, -1.0f);
        pathBuilderD.horizontalLineToRelative(2.0f);
        ...
        PathBuilder pathBuilderB = h.b(6.0f, 6.0f, 3.0f);
        ...
        pathBuilderB.verticalLineToRelative(0.0f);
        pathBuilderB.curveTo(5.0f, 6.45f, 5.45f, 6.0f, 6.0f, 6.0f);
        pathBuilderB.close();
