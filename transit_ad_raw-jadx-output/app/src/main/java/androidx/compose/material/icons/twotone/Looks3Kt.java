...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_looks3", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Looks3", "Landroidx/compose/material/icons/Icons$TwoTone;", "getLooks3", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class Looks3Kt {
    ...
    public static final ImageVector getLooks3(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.Looks3", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        a.x(pathBuilderC, 9.0f, 15.0f, 4.0f, -2.0f);
        android.support.v4.media.a.s(pathBuilderC, -2.0f, -2.0f, 2.0f);
        pathBuilderC.lineTo(13.0f, 9.0f);
        pathBuilderC.lineTo(9.0f, 9.0f);
        pathBuilderC.lineTo(9.0f, 7.0f);
        ...
        pathBuilderC.lineTo(15.0f, 15.0f);
        pathBuilderC.curveToRelative(0.0f, 1.11f, -0.9f, 2.0f, -2.0f, 2.0f);
        ImageVector.Builder.m3359addPathoIyEayM$default(builder, c.a.e(pathBuilderC, 9.0f, 17.0f, -2.0f), defaultFillType, "", solidColor, 0.3f, null, 0.3f, 1.0f, iM3141getButtKaPHkGw, iM3151getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        a.b.s(pathBuilderA, 9.0f, 7.0f, 2.0f, 4.0f);
        androidx.browser.browseractions.a.l(pathBuilderA, 2.0f, -2.0f, 2.0f, 2.0f);
        v.y(pathBuilderA, 2.0f, 9.0f, 15.0f, 2.0f);
