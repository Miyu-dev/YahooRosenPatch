...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_editLocation", "Landroidx/compose/ui/graphics/vector/ImageVector;", "EditLocation", "Landroidx/compose/material/icons/Icons$Filled;", "getEditLocation", "(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-filled_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class EditLocationKt {
    ...
    public static final ImageVector getEditLocation(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.EditLocation", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        androidx.compose.animation.a.t(pathBuilderD, 10.44f, 12.0f, 9.0f, 12.0f);
        pathBuilderD.verticalLineToRelative(-1.44f);
        pathBuilderD.lineToRelative(3.35f, -3.34f);
        s.r(pathBuilderD, 1.43f, 1.43f, 10.44f, 12.0f);
        pathBuilderD.moveTo(14.89f, 7.55f);
        ...
        pathBuilderD.curveToRelative(0.15f, 0.15f, 0.15f, 0.39f, 0.0f, 0.54f);
        pathBuilderD.close();
