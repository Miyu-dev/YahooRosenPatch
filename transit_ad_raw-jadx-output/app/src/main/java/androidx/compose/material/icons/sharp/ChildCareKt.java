...
public final class ChildCareKt {
    ...
    public static final ImageVector getChildCare(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.ChildCare", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderD.close();
        pathBuilderD.moveTo(22.94f, 11.34f);
