...
public final class FormatListBulletedKt {
    ...
    public static final ImageVector getFormatListBulleted(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.FormatListBulleted", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderD.reflectiveCurveToRelative(-0.67f, -1.5f, -1.5f, -1.5f);
        androidx.compose.animation.a.j(pathBuilderD, 8.0f, 19.0f, 12.0f);
