...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_diversity3", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Diversity3", "Landroidx/compose/material/icons/Icons$TwoTone;", "getDiversity3", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class Diversity3Kt {
    ...
    public static final ImageVector getDiversity3(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.Diversity3", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderD = a.d(6.32f, 13.01f);
        pathBuilderD.curveToRelative(0.96f, 0.02f, 1.85f, 0.5f, 2.45f, 1.34f);
        pathBuilderD.curveTo(9.5f, 15.38f, 10.71f, 16.0f, 12.0f, 16.0f);
        pathBuilderD.curveToRelative(1.29f, 0.0f, 2.5f, -0.62f, 3.23f, -1.66f);
        pathBuilderD.curveToRelative(0.6f, -0.84f, 1.49f, -1.32f, 2.45f, -1.34f);
        pathBuilderD.curveTo(16.96f, 11.78f, 14.08f, 11.0f, 12.0f, 11.0f);
        pathBuilderD.curveTo(9.93f, 11.0f, 7.04f, 11.78f, 6.32f, 13.01f);
        pathBuilderD.close();
        ...
        PathBuilder pathBuilderA = b.a(4.0f, 13.0f, 4.0f, 13.0f);
        ...
        pathBuilderA.curveTo(1.0f, 11.66f, 2.34f, 13.0f, 4.0f, 13.0f);
        pathBuilderA.close();
        ...
        PathBuilder pathBuilderA2 = b.a(20.0f, 13.0f, 20.0f, 13.0f);
        ...
        pathBuilderA2.curveTo(17.0f, 11.66f, 18.34f, 13.0f, 20.0f, 13.0f);
        pathBuilderA2.close();
        ...
        PathBuilder pathBuilderD2 = a.d(12.0f, 10.0f);
        ...
        pathBuilderD2.reflectiveCurveTo(9.0f, 5.34f, 9.0f, 7.0f);
        pathBuilderD2.curveTo(9.0f, 8.66f, 10.34f, 10.0f, 12.0f, 10.0f);
        pathBuilderD2.close();
        ...
        PathBuilder pathBuilderB = h.b(21.0f, 14.0f, -3.27f);
        pathBuilderB.curveToRelative(-0.77f, 0.0f, -1.35f, 0.45f, -1.68f, 0.92f);
        pathBuilderB.curveTo(16.01f, 14.98f, 14.69f, 17.0f, 12.0f, 17.0f);
        pathBuilderB.curveToRelative(-1.43f, 0.0f, -3.03f, -0.64f, -4.05f, -2.08f);
        pathBuilderB.curveTo(7.56f, 14.37f, 6.95f, 14.0f, 6.27f, 14.0f);
        pathBuilderB.horizontalLineTo(3.0f);
        pathBuilderB.curveToRelative(-1.1f, 0.0f, -2.0f, 0.9f, -2.0f, 2.0f);
        android.support.v4.media.a.m(pathBuilderB, 4.0f, 7.0f, -2.26f);
        pathBuilderB.curveToRelative(1.15f, 0.8f, 2.54f, 1.26f, 4.0f, 1.26f);
        pathBuilderB.reflectiveCurveToRelative(2.85f, -0.46f, 4.0f, -1.26f);
        v.r(pathBuilderB, 20.0f, 7.0f, -4.0f);
