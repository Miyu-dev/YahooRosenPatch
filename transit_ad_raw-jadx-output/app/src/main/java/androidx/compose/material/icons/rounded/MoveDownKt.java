...
public final class MoveDownKt {
    ...
    public static final ImageVector getMoveDown(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.MoveDown", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderD = a.d(3.01f, 10.72f);
        pathBuilderD.curveToRelative(-0.14f, 2.57f, 1.66f, 4.73f, 4.07f, 5.18f);
        pathBuilderD.lineToRelative(-0.79f, -0.79f);
        ...
        pathBuilderD.curveToRelative(0.39f, 0.39f, 0.39f, 1.02f, 0.0f, 1.41f);
        pathBuilderD.lineTo(7.71f, 20.3f);
        pathBuilderD.curveToRelative(-0.39f, 0.39f, -1.02f, 0.39f, -1.41f, 0.0f);
        ...
        pathBuilderD.curveTo(1.29f, 6.78f, 4.55f, 4.0f, 8.26f, 4.0f);
        pathBuilderD.lineTo(10.0f, 4.0f);
        pathBuilderD.curveToRelative(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        pathBuilderD.verticalLineToRelative(0.0f);
        pathBuilderD.curveToRelative(0.0f, 0.55f, -0.45f, 1.0f, -1.0f, 1.0f);
        pathBuilderD.lineTo(8.22f, 6.0f);
        pathBuilderD.curveTo(5.52f, 6.0f, 3.15f, 8.04f, 3.01f, 10.72f);
        pathBuilderD.close();
        ...
        PathBuilder pathBuilderB = h.b(15.0f, 11.0f, 5.0f);
        ...
        pathBuilderB.curveTo(13.0f, 10.1f, 13.9f, 11.0f, 15.0f, 11.0f);
        androidx.compose.animation.a.k(pathBuilderB, 20.0f, 9.0f, -5.0f, 6.0f);
        ImageVector.Builder.m3359addPathoIyEayM$default(builder, androidx.compose.animation.a.g(pathBuilderB, 5.0f, 9.0f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw2, iM3151getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        int defaultFillType3 = VectorKt.getDefaultFillType();
        SolidColor solidColor3 = new SolidColor(companion.m2844getBlack0d7_KjU(), null);
        int iM3141getButtKaPHkGw3 = companion2.m3141getButtKaPHkGw();
        int iM3151getBevelLxFBmk83 = companion3.m3151getBevelLxFBmk8();
        PathBuilder pathBuilderB2 = h.b(20.0f, 20.0f, -5.0f);
        ...
        pathBuilderB2.curveToRelative(1.1f, 0.0f, 2.0f, 0.9f, 2.0f, 2.0f);
        pathBuilderB2.verticalLineToRelative(3.0f);
        pathBuilderB2.curveTo(22.0f, 19.1f, 21.1f, 20.0f, 20.0f, 20.0f);
        pathBuilderB2.close();
