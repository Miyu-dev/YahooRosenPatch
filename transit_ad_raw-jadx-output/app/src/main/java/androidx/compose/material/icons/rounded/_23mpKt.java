...
public final class _23mpKt {
    ...
    public static final ImageVector get_23mp(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded._23mp", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderB.curveToRelative(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        android.support.v4.media.a.y(pathBuilderB, 17.75f, 13.0f, 10.75f);
        pathBuilderB.curveToRelative(0.0f, -0.41f, 0.34f, -0.75f, 0.75f, -0.75f);
        c.a.i(pathBuilderB, 16.0f, 9.0f, -1.5f);
        pathBuilderB.curveTo(14.22f, 9.0f, 14.0f, 8.78f, 14.0f, 8.5f);
        pathBuilderB.reflectiveCurveTo(14.22f, 8.0f, 14.5f, 8.0f);
        c.a.i(pathBuilderB, 16.0f, 7.0f, -2.25f);
        ...
        pathBuilderB.curveToRelative(0.0f, 0.55f, -0.45f, 1.0f, -1.0f, 1.0f);
        pathBuilderB.horizontalLineToRelative(-2.75f);
        pathBuilderB.curveTo(13.34f, 11.5f, 13.0f, 11.16f, 13.0f, 10.75f);
        pathBuilderB.close();
