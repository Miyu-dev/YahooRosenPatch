...
public final class AirplanemodeInactiveKt {
    ...
    public static final ImageVector getAirplanemodeInactive(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.AirplanemodeInactive", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
