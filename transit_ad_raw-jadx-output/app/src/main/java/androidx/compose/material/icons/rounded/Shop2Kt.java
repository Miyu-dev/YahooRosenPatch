...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_shop2", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Shop2", "Landroidx/compose/material/icons/Icons$Rounded;", "getShop2", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class Shop2Kt {
    ...
    public static final ImageVector getShop2(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Shop2", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderA = b.a(2.0f, 9.0f, 2.0f, 9.0f);
        ...
        pathBuilderA.curveTo(3.0f, 9.45f, 2.55f, 9.0f, 2.0f, 9.0f);
        pathBuilderA.close();
        ...
        pathBuilderN.curveToRelative(1.11f, 0.0f, 2.0f, -0.89f, 2.0f, -2.0f);
        a.o(pathBuilderN, 5.0f, 18.0f, 12.0f, 3.0f);
        androidx.compose.animation.a.B(pathBuilderN, 4.0f, 2.0f, -4.0f, 3.0f);
        pathBuilderN.moveTo(12.0f, 14.09f);
        pathBuilderN.verticalLineTo(8.91f);
        pathBuilderN.curveToRelative(0.0f, -0.39f, 0.44f, -0.63f, 0.77f, -0.42f);
        pathBuilderN.lineToRelative(4.07f, 2.59f);
        pathBuilderN.curveToRelative(0.31f, 0.2f, 0.31f, 0.65f, 0.0f, 0.84f);
        pathBuilderN.lineToRelative(-4.07f, 2.59f);
        pathBuilderN.curveTo(12.44f, 14.72f, 12.0f, 14.48f, 12.0f, 14.09f);
        pathBuilderN.close();
