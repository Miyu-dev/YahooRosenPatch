...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_route", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Route", "Landroidx/compose/material/icons/Icons$TwoTone;", "getRoute", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class RouteKt {
    ...
    public static final ImageVector getRoute(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.Route", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderB = v.b(6.0f, 6.0f, -1.0f, 0.0f);
        ...
        PathBuilder pathBuilderB2 = v.b(18.0f, 18.0f, -1.0f, 0.0f);
        ...
        PathBuilder pathBuilderN = s.n(19.0f, 15.18f, 7.0f);
        ...
        pathBuilderN.verticalLineTo(8.82f);
        pathBuilderN.curveTo(8.16f, 8.4f, 9.0f, 7.3f, 9.0f, 6.0f);
        pathBuilderN.curveToRelative(0.0f, -1.66f, -1.34f, -3.0f, -3.0f, -3.0f);
        pathBuilderN.reflectiveCurveTo(3.0f, 4.34f, 3.0f, 6.0f);
        ...
        pathBuilderN.curveToRelative(0.0f, -1.1f, 0.9f, -2.0f, 2.0f, -2.0f);
        pathBuilderN.reflectiveCurveToRelative(2.0f, 0.9f, 2.0f, 2.0f);
        pathBuilderN.verticalLineToRelative(8.18f);
        pathBuilderN.curveToRelative(-1.16f, 0.41f, -2.0f, 1.51f, -2.0f, 2.82f);
        pathBuilderN.curveToRelative(0.0f, 1.66f, 1.34f, 3.0f, 3.0f, 3.0f);
        pathBuilderN.reflectiveCurveToRelative(3.0f, -1.34f, 3.0f, -3.0f);
        pathBuilderN.curveTo(21.0f, 16.7f, 20.16f, 15.6f, 19.0f, 15.18f);
        pathBuilderN.close();
        pathBuilderN.moveTo(6.0f, 7.0f);
        pathBuilderN.curveTo(5.45f, 7.0f, 5.0f, 6.55f, 5.0f, 6.0f);
        pathBuilderN.reflectiveCurveToRelative(0.45f, -1.0f, 1.0f, -1.0f);
        pathBuilderN.reflectiveCurveToRelative(1.0f, 0.45f, 1.0f, 1.0f);
        pathBuilderN.reflectiveCurveTo(6.55f, 7.0f, 6.0f, 7.0f);
        pathBuilderN.close();
        pathBuilderN.moveTo(18.0f, 19.0f);
        pathBuilderN.curveToRelative(-0.55f, 0.0f, -1.0f, -0.45f, -1.0f, -1.0f);
        pathBuilderN.reflectiveCurveToRelative(0.45f, -1.0f, 1.0f, -1.0f);
        pathBuilderN.reflectiveCurveToRelative(1.0f, 0.45f, 1.0f, 1.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, h.t(pathBuilderN, 18.55f, 19.0f, 18.0f, 19.0f), defaultFillType3, "", solidColor3, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw3, iM3151getBevelLxFBmk83, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
