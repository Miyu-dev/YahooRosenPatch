...
public final class BathroomKt {
    ...
    public static final ImageVector getBathroom(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Bathroom", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        a.t(pathBuilderB, 7.0f, 11.0f, 7.0f, 11.0f);
        ...
        pathBuilderB.curveTo(7.45f, 12.0f, 7.0f, 11.55f, 7.0f, 11.0f);
        pathBuilderB.close();
