...
public final class FileDownloadOffKt {
    ...
    public static final ImageVector getFileDownloadOff(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.FileDownloadOff", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m2844getBlack0d7_KjU(), null);
        int iM3141getButtKaPHkGw = StrokeCap.INSTANCE.m3141getButtKaPHkGw();
        int iM3151getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3151getBevelLxFBmk8();
        PathBuilder pathBuilderC = h.c(18.0f, 15.17f, 15.0f, 2.0f, 2.17f);
        a.z(pathBuilderC, 18.0f, 15.17f, 15.41f, 12.59f);
        pathBuilderC.lineTo(17.0f, 11.0f);
        pathBuilderC.lineToRelative(-1.41f, -1.41f);
        android.support.v4.media.a.C(pathBuilderC, 14.0f, 11.17f, 15.41f, 12.59f);
        h.D(pathBuilderC, 13.0f, 10.17f, 4.0f, -2.0f);
        h.q(pathBuilderC, 4.17f, 13.0f, 10.17f);
        pathBuilderC.moveTo(21.19f, 21.19f);
        pathBuilderC.lineToRelative(-1.78f, -1.78f);
        pathBuilderC.lineTo(2.81f, 2.81f);
        pathBuilderC.lineTo(1.39f, 4.22f);
        pathBuilderC.lineToRelative(6.19f, 6.19f);
        pathBuilderC.lineTo(7.0f, 11.0f);
        pathBuilderC.lineToRelative(5.0f, 5.0f);
        pathBuilderC.lineToRelative(0.59f, -0.59f);
        h.n(pathBuilderC, 15.17f, 18.0f, 6.0f, -3.0f);
        ...
        pathBuilderC.horizontalLineToRelative(11.17f);
