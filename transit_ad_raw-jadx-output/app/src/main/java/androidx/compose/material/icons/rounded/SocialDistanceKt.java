...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_socialDistance", "Landroidx/compose/ui/graphics/vector/ImageVector;", "SocialDistance", "Landroidx/compose/material/icons/Icons$Rounded;", "getSocialDistance", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class SocialDistanceKt {
    ...
    public static final ImageVector getSocialDistance(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.SocialDistance", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        a.y(pathBuilderD, 21.65f, 16.65f, -2.79f, -2.79f);
        pathBuilderD.curveTo(18.54f, 13.54f, 18.0f, 13.76f, 18.0f, 14.21f);
        androidx.appcompat.graphics.drawable.a.o(pathBuilderD, 16.0f, 6.0f, -1.79f);
        ...
        pathBuilderD.lineToRelative(2.79f, 2.79f);
        pathBuilderD.curveTo(5.46f, 20.46f, 6.0f, 20.24f, 6.0f, 19.79f);
        v.r(pathBuilderD, 18.0f, 12.0f, 1.79f);
        pathBuilderD.curveToRelative(0.0f, 0.45f, 0.54f, 0.67f, 0.85f, 0.35f);
        pathBuilderD.lineToRelative(2.79f, -2.79f);
        pathBuilderD.curveTo(21.84f, 17.16f, 21.84f, 16.84f, 21.65f, 16.65f);
        pathBuilderD.close();
