...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_audioFile", "Landroidx/compose/ui/graphics/vector/ImageVector;", "AudioFile", "Landroidx/compose/material/icons/Icons$Rounded;", "getAudioFile", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class AudioFileKt {
    ...
    public static final ImageVector getAudioFile(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.AudioFile", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        b.r(pathBuilderA, 15.0f, 13.0f, -2.0f, 3.61f);
        pathBuilderA.curveToRelative(0.0f, 1.28f, -1.0f, 2.41f, -2.28f, 2.39f);
        pathBuilderA.curveToRelative(-1.44f, -0.02f, -2.56f, -1.39f, -2.13f, -2.91f);
        pathBuilderA.curveToRelative(0.21f, -0.72f, 0.8f, -1.31f, 1.53f, -1.51f);
        pathBuilderA.curveToRelative(0.7f, -0.19f, 1.36f, -0.05f, 1.88f, 0.29f);
        pathBuilderA.verticalLineTo(12.0f);
        pathBuilderA.curveToRelative(0.0f, -0.55f, 0.45f, -1.0f, 1.0f, -1.0f);
        pathBuilderA.horizontalLineToRelative(2.0f);
        pathBuilderA.curveToRelative(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        pathBuilderA.curveTo(16.0f, 12.55f, 15.55f, 13.0f, 15.0f, 13.0f);
        pathBuilderA.close();
