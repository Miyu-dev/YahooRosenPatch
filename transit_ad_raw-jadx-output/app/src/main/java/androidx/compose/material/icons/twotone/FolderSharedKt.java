...
public final class FolderSharedKt {
    ...
    public static final ImageVector getFolderShared(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.FolderShared", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderA.lineTo(9.17f, 6.0f);
        a.b.s(pathBuilderA, 4.0f, 6.0f, 12.0f, 16.0f);
        h.m(pathBuilderA, 20.0f, 8.0f, -8.83f);
        a.b.y(pathBuilderA, 19.0f, 16.0f, 1.0f, -8.0f);
        ...
        pathBuilderA2.moveTo(15.0f, 13.0f);
        pathBuilderA2.curveToRelative(1.1f, 0.0f, 2.0f, -0.9f, 2.0f, -2.0f);
        pathBuilderA2.reflectiveCurveToRelative(-0.9f, -2.0f, -2.0f, -2.0f);
        pathBuilderA2.reflectiveCurveToRelative(-2.0f, 0.9f, -2.0f, 2.0f);
        pathBuilderA2.reflectiveCurveToRelative(0.9f, 2.0f, 2.0f, 2.0f);
        androidx.appcompat.app.m.n(pathBuilderA2, 11.0f, 16.0f, 1.0f, 8.0f);
        pathBuilderA2.verticalLineToRelative(-1.0f);
        pathBuilderA2.curveToRelative(0.0f, -1.33f, -2.67f, -2.0f, -4.0f, -2.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, a.j(pathBuilderA2, -4.0f, 0.67f, -4.0f, 2.0f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw2, iM3151getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
