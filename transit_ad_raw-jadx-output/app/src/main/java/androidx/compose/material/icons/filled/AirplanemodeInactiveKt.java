...
public final class AirplanemodeInactiveKt {
    ...
    public static final ImageVector getAirplanemodeInactive(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.AirplanemodeInactive", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
