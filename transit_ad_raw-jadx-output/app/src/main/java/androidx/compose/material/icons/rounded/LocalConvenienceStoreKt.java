...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_localConvenienceStore", "Landroidx/compose/ui/graphics/vector/ImageVector;", "LocalConvenienceStore", "Landroidx/compose/material/icons/Icons$Rounded;", "getLocalConvenienceStore", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class LocalConvenienceStoreKt {
    ...
    public static final ImageVector getLocalConvenienceStore(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.LocalConvenienceStore", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        a.b.z(pathBuilderA, 10.5f, 16.0f, 9.0f, 1.0f);
        ...
        pathBuilderA.curveTo(8.22f, 18.0f, 8.0f, 17.78f, 8.0f, 17.5f);
        pathBuilderA.verticalLineToRelative(-2.0f);
        pathBuilderA.curveTo(8.0f, 15.22f, 8.22f, 15.0f, 8.5f, 15.0f);
        a.b.r(pathBuilderA, 10.0f, -1.0f, 8.5f);
        pathBuilderA.curveTo(8.22f, 14.0f, 8.0f, 13.78f, 8.0f, 13.5f);
        pathBuilderA.verticalLineToRelative(0.0f);
        pathBuilderA.curveTo(8.0f, 13.22f, 8.22f, 13.0f, 8.5f, 13.0f);
        pathBuilderA.horizontalLineToRelative(2.0f);
        pathBuilderA.curveToRelative(0.28f, 0.0f, 0.5f, 0.22f, 0.5f, 0.5f);
        pathBuilderA.verticalLineToRelative(2.0f);
        pathBuilderA.curveTo(11.0f, 15.78f, 10.78f, 16.0f, 10.5f, 16.0f);
        pathBuilderA.close();
        ...
        pathBuilderA.lineTo(15.5f, 18.0f);
        pathBuilderA.curveToRelative(-0.28f, 0.0f, -0.5f, -0.22f, -0.5f, -0.5f);
        ...
        pathBuilderA.curveToRelative(0.28f, 0.0f, 0.5f, 0.22f, 0.5f, 0.5f);
        v.r(pathBuilderA, 15.0f, 1.0f, -1.5f);
        pathBuilderA.curveToRelative(0.0f, -0.28f, 0.22f, -0.5f, 0.5f, -0.5f);
        pathBuilderA.horizontalLineToRelative(0.0f);
        pathBuilderA.curveToRelative(0.28f, 0.0f, 0.5f, 0.22f, 0.5f, 0.5f);
        pathBuilderA.verticalLineToRelative(4.0f);
        pathBuilderA.curveTo(16.0f, 17.78f, 15.78f, 18.0f, 15.5f, 18.0f);
        pathBuilderA.close();
