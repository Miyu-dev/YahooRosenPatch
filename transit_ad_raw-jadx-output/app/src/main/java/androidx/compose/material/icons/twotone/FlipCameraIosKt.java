...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_flipCameraIos", "Landroidx/compose/ui/graphics/vector/ImageVector;", "FlipCameraIos", "Landroidx/compose/material/icons/Icons$TwoTone;", "getFlipCameraIos", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class FlipCameraIosKt {
    ...
    public static final ImageVector getFlipCameraIos(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.FlipCameraIos", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderA = b.a(14.12f, 5.0f, 9.88f, 8.05f, 7.0f);
        a.i(pathBuilderA, 4.0f, 12.0f, 16.0f, 7.0f);
        androidx.appcompat.view.menu.a.s(pathBuilderA, -4.05f, 14.12f, 5.0f);
        ...
        pathBuilderA.horizontalLineTo(9.97f);
        pathBuilderA.horizontalLineTo(8.0f);
        pathBuilderA.curveToRelative(0.0f, 2.21f, 1.79f, 4.0f, 4.0f, 4.0f);
        pathBuilderA.curveToRelative(0.58f, 0.0f, 1.13f, -0.13f, 1.62f, -0.35f);
        pathBuilderA.lineToRelative(0.74f, 0.74f);
        pathBuilderA.curveTo(13.65f, 17.76f, 12.86f, 18.0f, 12.0f, 18.0f);
        androidx.browser.browseractions.a.y(pathBuilderA, 19.0f, 13.0f, -2.49f, 2.49f);
        pathBuilderA.lineTo(16.5f, 15.5f);
        pathBuilderA.lineTo(14.0f, 13.0f);
        pathBuilderA.horizontalLineToRelative(0.03f);
        pathBuilderA.horizontalLineTo(16.0f);
        pathBuilderA.curveToRelative(0.0f, -2.21f, -1.79f, -4.0f, -4.0f, -4.0f);
        pathBuilderA.curveToRelative(-0.58f, 0.0f, -1.13f, 0.13f, -1.62f, 0.35f);
        pathBuilderA.lineTo(9.64f, 8.62f);
        pathBuilderA.curveTo(10.35f, 8.24f, 11.14f, 8.0f, 12.0f, 8.0f);
        pathBuilderA.curveToRelative(2.76f, 0.0f, 5.0f, 2.24f, 5.0f, 5.0f);
        ImageVector.Builder.m3359addPathoIyEayM$default(builder, androidx.appcompat.app.m.j(pathBuilderA, 19.0f), defaultFillType, "", solidColor, 0.3f, null, 0.3f, 1.0f, iM3141getButtKaPHkGw, iM3151getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        pathBuilderD.horizontalLineToRelative(1.97f);
        ...
        pathBuilderD2.horizontalLineToRelative(-1.97f);
        pathBuilderD2.horizontalLineTo(14.0f);
