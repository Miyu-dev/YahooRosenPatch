...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_linkedCamera", "Landroidx/compose/ui/graphics/vector/ImageVector;", "LinkedCamera", "Landroidx/compose/material/icons/Icons$Filled;", "getLinkedCamera", "(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-filled_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class LinkedCameraKt {
    ...
    public static final ImageVector getLinkedCamera(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.LinkedCamera", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderB = v.b(12.0f, 14.0f, -3.2f, 0.0f);
        ...
        PathBuilder pathBuilderD = a.d(16.0f, 3.33f);
        pathBuilderD.curveToRelative(2.58f, 0.0f, 4.67f, 2.09f, 4.67f, 4.67f);
        ...
        pathBuilderD.moveTo(16.0f, 6.0f);
        pathBuilderD.curveToRelative(1.11f, 0.0f, 2.0f, 0.89f, 2.0f, 2.0f);
        pathBuilderD.horizontalLineToRelative(1.33f);
        pathBuilderD.curveToRelative(0.0f, -1.84f, -1.49f, -3.33f, -3.33f, -3.33f);
        ...
        PathBuilder pathBuilderD2 = a.d(17.0f, 9.0f);
        pathBuilderD2.curveToRelative(0.0f, -1.11f, -0.89f, -2.0f, -2.0f, -2.0f);
        pathBuilderD2.lineTo(15.0f, 4.0f);
        pathBuilderD2.lineTo(9.0f, 4.0f);
        pathBuilderD2.lineTo(7.17f, 6.0f);
        pathBuilderD2.lineTo(4.0f, 6.0f);
        ...
        pathBuilderD2.curveToRelative(1.1f, 0.0f, 2.0f, -0.9f, 2.0f, -2.0f);
        h.m(pathBuilderD2, 22.0f, 9.0f, -5.0f);
        ...
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, androidx.appcompat.view.menu.a.j(pathBuilderD2, -2.24f, 5.0f, -5.0f, 5.0f), defaultFillType3, "", solidColor3, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw3, iM3151getBevelLxFBmk83, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
