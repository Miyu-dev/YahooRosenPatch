...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_menuBook", "Landroidx/compose/ui/graphics/vector/ImageVector;", "MenuBook", "Landroidx/compose/material/icons/Icons$Filled;", "getMenuBook", "(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-filled_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class MenuBookKt {
    ...
    public static final ImageVector getMenuBook(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.MenuBook", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderD2 = a.d(17.5f, 10.5f);
        pathBuilderD2.curveToRelative(0.88f, 0.0f, 1.73f, 0.09f, 2.5f, 0.26f);
        pathBuilderD2.verticalLineTo(9.24f);
        pathBuilderD2.curveTo(19.21f, 9.09f, 18.36f, 9.0f, 17.5f, 9.0f);
        pathBuilderD2.curveToRelative(-1.7f, 0.0f, -3.24f, 0.29f, -4.5f, 0.83f);
        pathBuilderD2.verticalLineToRelative(1.66f);
        pathBuilderD2.curveTo(14.13f, 10.85f, 15.7f, 10.5f, 17.5f, 10.5f);
        pathBuilderD2.close();
        ...
        PathBuilder pathBuilderE = androidx.appcompat.app.m.e(13.0f, 12.49f, 1.66f);
        pathBuilderE.curveToRelative(1.13f, -0.64f, 2.7f, -0.99f, 4.5f, -0.99f);
        pathBuilderE.curveToRelative(0.88f, 0.0f, 1.73f, 0.09f, 2.5f, 0.26f);
        pathBuilderE.verticalLineTo(11.9f);
        pathBuilderE.curveToRelative(-0.79f, -0.15f, -1.64f, -0.24f, -2.5f, -0.24f);
        pathBuilderE.curveTo(15.8f, 11.66f, 14.26f, 11.96f, 13.0f, 12.49f);
        pathBuilderE.close();
        ...
        PathBuilder pathBuilderD3 = a.d(17.5f, 14.33f);
        pathBuilderD3.curveToRelative(-1.7f, 0.0f, -3.24f, 0.29f, -4.5f, 0.83f);
        pathBuilderD3.verticalLineToRelative(1.66f);
        pathBuilderD3.curveToRelative(1.13f, -0.64f, 2.7f, -0.99f, 4.5f, -0.99f);
        pathBuilderD3.curveToRelative(0.88f, 0.0f, 1.73f, 0.09f, 2.5f, 0.26f);
        pathBuilderD3.verticalLineToRelative(-1.52f);
        pathBuilderD3.curveTo(19.21f, 14.41f, 18.36f, 14.33f, 17.5f, 14.33f);
        pathBuilderD3.close();
