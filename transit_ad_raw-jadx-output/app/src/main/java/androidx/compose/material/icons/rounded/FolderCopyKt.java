...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_folderCopy", "Landroidx/compose/ui/graphics/vector/ImageVector;", "FolderCopy", "Landroidx/compose/material/icons/Icons$Rounded;", "getFolderCopy", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class FolderCopyKt {
    ...
    public static final ImageVector getFolderCopy(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.FolderCopy", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderA = b.a(2.0f, 6.0f, 2.0f, 6.0f);
        pathBuilderA.curveTo(1.45f, 6.0f, 1.0f, 6.45f, 1.0f, 7.0f);
        ...
        pathBuilderA.curveTo(3.0f, 6.45f, 2.55f, 6.0f, 2.0f, 6.0f);
        pathBuilderA.close();
        ...
        PathBuilder pathBuilderA2 = a.a(21.0f, 4.0f, -7.0f, -1.41f, -1.41f);
        pathBuilderA2.curveTo(12.21f, 2.21f, 11.7f, 2.0f, 11.17f, 2.0f);
        pathBuilderA2.horizontalLineTo(7.0f);
        pathBuilderA2.curveTo(5.9f, 2.0f, 5.01f, 2.9f, 5.01f, 4.0f);
        ...
        pathBuilderA2.curveTo(23.0f, 4.9f, 22.1f, 4.0f, 21.0f, 4.0f);
        pathBuilderA2.close();
