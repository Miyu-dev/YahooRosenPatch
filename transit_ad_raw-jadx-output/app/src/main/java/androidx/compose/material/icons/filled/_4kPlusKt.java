...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"__4kPlus", "Landroidx/compose/ui/graphics/vector/ImageVector;", "_4kPlus", "Landroidx/compose/material/icons/Icons$Filled;", "get_4kPlus", "(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-filled_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class _4kPlusKt {
    ...
    public static final ImageVector get_4kPlus(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled._4kPlus", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderA.curveToRelative(0.0f, -1.1f, -0.9f, -2.0f, -2.0f, -2.0f);
        a.j(pathBuilderA, 10.5f, 13.5f, -1.0f);
        pathBuilderA.lineTo(9.5f, 15.0f);
        pathBuilderA.lineTo(8.0f, 15.0f);
        pathBuilderA.verticalLineToRelative(-1.5f);
        pathBuilderA.lineTo(5.0f, 13.5f);
        a.o(pathBuilderA, 5.0f, 9.0f, 1.5f, 3.0f);
        pathBuilderA.lineTo(8.0f, 12.0f);
        a.o(pathBuilderA, 8.0f, 9.0f, 1.5f, 3.0f);
        androidx.appcompat.graphics.drawable.a.z(pathBuilderA, 1.0f, 1.5f, 16.0f, 15.0f);
