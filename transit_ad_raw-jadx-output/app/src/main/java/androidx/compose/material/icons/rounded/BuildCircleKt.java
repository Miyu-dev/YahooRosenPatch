...
public final class BuildCircleKt {
    ...
    public static final ImageVector getBuildCircle(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.BuildCircle", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        a.y(pathBuilderD, 16.54f, 15.85f, -0.69f, 0.69f);
        pathBuilderD.curveToRelative(-0.39f, 0.39f, -1.02f, 0.39f, -1.41f, 0.0f);
        pathBuilderD.lineToRelative(-3.05f, -3.05f);
        ...
        pathBuilderD.lineToRelative(3.05f, 3.05f);
        pathBuilderD.curveTo(16.93f, 14.82f, 16.93f, 15.46f, 16.54f, 15.85f);
        pathBuilderD.close();
