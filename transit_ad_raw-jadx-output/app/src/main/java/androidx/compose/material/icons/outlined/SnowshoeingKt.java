...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_snowshoeing", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Snowshoeing", "Landroidx/compose/material/icons/Icons$Outlined;", "getSnowshoeing", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-outlined_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class SnowshoeingKt {
    ...
    public static final ImageVector getSnowshoeing(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.Snowshoeing", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        a.y(pathBuilderD, 6.32f, 19.03f, -1.14f, -1.47f);
        ...
        pathBuilderD.lineTo(11.0f, 18.2f);
        pathBuilderD.lineToRelative(0.89f, -3.22f);
        ...
        pathBuilderD.lineToRelative(0.0f, -6.02f);
        pathBuilderD.lineToRelative(-2.11f, -2.0f);
        pathBuilderD.lineToRelative(0.6f, -3.0f);
        pathBuilderD.curveTo(15.79f, 11.98f, 17.8f, 13.0f, 20.0f, 13.0f);
        pathBuilderD.verticalLineToRelative(-2.0f);
        pathBuilderD.curveToRelative(-1.9f, 0.0f, -3.51f, -1.02f, -4.31f, -2.42f);
        pathBuilderD.lineToRelative(-1.0f, -1.58f);
        pathBuilderD.curveToRelative(-0.4f, -0.6f, -1.0f, -1.0f, -1.7f, -1.0f);
        pathBuilderD.curveTo(12.24f, 6.0f, 11.58f, 6.34f, 7.0f, 8.28f);
        h.w(pathBuilderD, 13.0f, 2.0f, 9.58f);
        pathBuilderD.lineToRelative(1.79f, -0.7f);
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, v.l(pathBuilderD, 9.2f, 17.0f, 6.32f, 19.03f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw, iM3151getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
