...
public final class AssignmentKt {
    ...
    public static final ImageVector getAssignment(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.Assignment", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderE.moveTo(14.0f, 17.0f);
        b.s(pathBuilderE, 7.0f, 17.0f, -2.0f, 7.0f);
        android.support.v4.media.a.v(pathBuilderE, 2.0f, 17.0f, 13.0f);
        b.s(pathBuilderE, 7.0f, 13.0f, -2.0f, 10.0f);
        android.support.v4.media.a.v(pathBuilderE, 2.0f, 17.0f, 9.0f);
        pathBuilderE.lineTo(7.0f, 9.0f);
        ImageVector.Builder.m3359addPathoIyEayM$default(builder, b.k(pathBuilderE, 7.0f, 7.0f, 10.0f, 2.0f), defaultFillType, "", solidColor, 0.3f, null, 0.3f, 1.0f, iM3141getButtKaPHkGw, iM3151getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        int defaultFillType2 = VectorKt.getDefaultFillType();
        SolidColor solidColor2 = new SolidColor(companion.m2844getBlack0d7_KjU(), null);
        int iM3141getButtKaPHkGw2 = companion2.m3141getButtKaPHkGw();
        int iM3151getBevelLxFBmk82 = companion3.m3151getBevelLxFBmk8();
        PathBuilder pathBuilderO = b.o(7.0f, 15.0f, 7.0f, 2.0f);
        androidx.appcompat.view.menu.a.z(pathBuilderO, 7.0f, 17.0f, 7.0f, 11.0f);
        androidx.appcompat.app.m.C(pathBuilderO, 10.0f, 2.0f, 7.0f, 13.0f);
        androidx.appcompat.view.menu.a.x(pathBuilderO, 7.0f, 7.0f, 10.0f, 2.0f);
        androidx.appcompat.view.menu.a.z(pathBuilderO, 7.0f, 9.0f, 19.0f, 3.0f);
        ...
        pathBuilderO.reflectiveCurveTo(3.0f, 4.72f, 3.0f, 5.0f);
        ...
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, b.k(pathBuilderO, 5.0f, 5.0f, 14.0f, 14.0f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw2, iM3151getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
