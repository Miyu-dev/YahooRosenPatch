...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_emojiEvents", "Landroidx/compose/ui/graphics/vector/ImageVector;", "EmojiEvents", "Landroidx/compose/material/icons/Icons$TwoTone;", "getEmojiEvents", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class EmojiEventsKt {
    ...
    public static final ImageVector getEmojiEvents(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.EmojiEvents", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        v.r(pathBuilderD, 5.0f, 6.0f, 6.0f);
        pathBuilderD.curveTo(15.0f, 12.65f, 13.65f, 14.0f, 12.0f, 14.0f);
        pathBuilderD.close();
        ...
        PathBuilder pathBuilderQ = android.support.v4.media.a.q(19.0f, 5.0f, -2.0f, 3.0f, 7.0f);
        ...
        android.support.v4.media.a.m(pathBuilderQ, -2.0f, -4.0f, -3.1f);
        ...
        pathBuilderQ.close();
        pathBuilderQ.moveTo(12.0f, 14.0f);
        pathBuilderQ.curveToRelative(-1.65f, 0.0f, -3.0f, -1.35f, -3.0f, -3.0f);
        v.r(pathBuilderQ, 5.0f, 6.0f, 6.0f);
        pathBuilderQ.curveTo(15.0f, 12.65f, 13.65f, 14.0f, 12.0f, 14.0f);
        pathBuilderQ.close();
        pathBuilderQ.moveTo(19.0f, 8.0f);
        pathBuilderQ.curveToRelative(0.0f, 1.3f, -0.84f, 2.4f, -2.0f, 2.82f);
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, v.q(pathBuilderQ, 7.0f, 2.0f, 8.0f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw2, iM3151getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
