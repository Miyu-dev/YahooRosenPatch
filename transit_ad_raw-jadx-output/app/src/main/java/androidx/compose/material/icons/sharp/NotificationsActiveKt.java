...
public final class NotificationsActiveKt {
    ...
    public static final ImageVector getNotificationsActive(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.NotificationsActive", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m2844getBlack0d7_KjU(), null);
        int iM3141getButtKaPHkGw = StrokeCap.INSTANCE.m3141getButtKaPHkGw();
        int iM3151getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3151getBevelLxFBmk8();
        PathBuilder pathBuilderA = b.a(7.58f, 4.08f, 6.15f, 2.65f);
        pathBuilderA.curveTo(3.75f, 4.48f, 2.17f, 7.3f, 2.03f, 10.5f);
        pathBuilderA.horizontalLineToRelative(2.0f);
        pathBuilderA.curveToRelative(0.15f, -2.65f, 1.51f, -4.97f, 3.55f, -6.42f);
        a.j(pathBuilderA, 19.97f, 10.5f, 2.0f);
        pathBuilderA.curveToRelative(-0.15f, -3.2f, -1.73f, -6.02f, -4.12f, -7.85f);
        pathBuilderA.lineToRelative(-1.42f, 1.43f);
        pathBuilderA.curveToRelative(2.02f, 1.45f, 3.39f, 3.77f, 3.54f, 6.42f);
        pathBuilderA.close();
        pathBuilderA.moveTo(18.0f, 11.0f);
        pathBuilderA.curveToRelative(0.0f, -3.07f, -1.64f, -5.64f, -4.5f, -6.32f);
        a.o(pathBuilderA, 13.5f, 2.5f, -3.0f, 2.18f);
        pathBuilderA.curveTo(7.63f, 5.36f, 6.0f, 7.92f, 6.0f, 11.0f);
        a.q(pathBuilderA, 5.0f, -2.0f, 2.0f, 1.0f);
        s.s(pathBuilderA, 16.0f, -1.0f, -2.0f, -2.0f);
        android.support.v4.media.a.v(pathBuilderA, -5.0f, 12.0f, 22.0f);
        pathBuilderA.curveToRelative(0.14f, 0.0f, 0.27f, -0.01f, 0.4f, -0.04f);
        pathBuilderA.curveToRelative(0.65f, -0.14f, 1.18f, -0.58f, 1.44f, -1.18f);
        pathBuilderA.curveToRelative(0.1f, -0.24f, 0.15f, -0.5f, 0.15f, -0.78f);
        pathBuilderA.horizontalLineToRelative(-4.0f);
        pathBuilderA.curveToRelative(0.01f, 1.1f, 0.9f, 2.0f, 2.01f, 2.0f);
        pathBuilderA.close();
