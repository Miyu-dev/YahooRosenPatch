...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_localGroceryStore", "Landroidx/compose/ui/graphics/vector/ImageVector;", "LocalGroceryStore", "Landroidx/compose/material/icons/Icons$Sharp;", "getLocalGroceryStore", "(Landroidx/compose/material/icons/Icons$Sharp;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-sharp_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class LocalGroceryStoreKt {
    ...
    public static final ImageVector getLocalGroceryStore(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.LocalGroceryStore", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        androidx.compose.animation.a.j(pathBuilderD, 1.0f, 4.0f, 2.0f);
        ...
        pathBuilderD.horizontalLineToRelative(8.64f);
        pathBuilderD.lineToRelative(4.97f, -9.0f);
        pathBuilderD.lineTo(5.21f, 4.0f);
        pathBuilderD.lineToRelative(-0.94f, -2.0f);
        b.k(pathBuilderD, 1.0f, 2.0f, 2.0f);
