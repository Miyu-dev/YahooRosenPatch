...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_adsClick", "Landroidx/compose/ui/graphics/vector/ImageVector;", "AdsClick", "Landroidx/compose/material/icons/Icons$Rounded;", "getAdsClick", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class AdsClickKt {
    ...
    public static final ImageVector getAdsClick(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.AdsClick", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        a.y(pathBuilderD, 18.23f, 16.26f, 2.27f, -0.76f);
        pathBuilderD.curveToRelative(0.46f, -0.15f, 0.45f, -0.81f, -0.01f, -0.95f);
        pathBuilderD.lineToRelative(-7.6f, -2.28f);
        pathBuilderD.curveToRelative(-0.38f, -0.11f, -0.74f, 0.24f, -0.62f, 0.62f);
        pathBuilderD.lineToRelative(2.28f, 7.6f);
        pathBuilderD.curveToRelative(0.14f, 0.47f, 0.8f, 0.48f, 0.95f, 0.01f);
        pathBuilderD.lineToRelative(0.76f, -2.27f);
        pathBuilderD.lineToRelative(3.91f, 3.91f);
        ...
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, b.h(pathBuilderD, 18.23f, 16.26f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw, iM3151getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
