...
public final class AirlineSeatFlatKt {
    ...
    public static final ImageVector getAirlineSeatFlat(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.AirlineSeatFlat", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m2844getBlack0d7_KjU(), null);
        int iM3141getButtKaPHkGw = StrokeCap.INSTANCE.m3141getButtKaPHkGw();
        int iM3151getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3151getBevelLxFBmk8();
        PathBuilder pathBuilderU = a.u(22.0f, 11.0f, 2.0f, 9.0f, 13.0f);
        pathBuilderU.lineTo(9.0f, 9.0f);
        pathBuilderU.curveToRelative(0.0f, -1.1f, 0.9f, -2.0f, 2.0f, -2.0f);
        pathBuilderU.horizontalLineToRelative(7.0f);
        pathBuilderU.curveToRelative(2.21f, 0.0f, 4.0f, 1.79f, 4.0f, 4.0f);
        pathBuilderU.close();
        pathBuilderU.moveTo(2.0f, 15.0f);
        ...
        pathBuilderU.lineTo(3.0f, 14.0f);
        pathBuilderU.curveToRelative(-0.55f, 0.0f, -1.0f, 0.45f, -1.0f, 1.0f);
        pathBuilderU.close();
