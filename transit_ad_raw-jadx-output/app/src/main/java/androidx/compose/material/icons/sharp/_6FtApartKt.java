...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"__6FtApart", "Landroidx/compose/ui/graphics/vector/ImageVector;", "_6FtApart", "Landroidx/compose/material/icons/Icons$Sharp;", "get_6FtApart", "(Landroidx/compose/material/icons/Icons$Sharp;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-sharp_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class _6FtApartKt {
    ...
    public static final ImageVector get_6FtApart(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp._6FtApart", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        android.support.v4.media.a.D(pathBuilderD, 10.0f, 19.0f, -1.0f, 7.0f);
        c.a.j(pathBuilderD, 4.0f, 3.0f, -2.5f, 8.0f);
        androidx.appcompat.view.menu.a.o(pathBuilderD, 19.0f, 10.0f, 9.0f, 20.5f);
        ...
        pathBuilderD.close();
        androidx.appcompat.view.menu.a.x(pathBuilderD, 17.5f, 19.0f, -1.0f, 3.0f);
        androidx.appcompat.view.menu.a.t(pathBuilderD, -1.0f, -3.0f, -1.0f, -1.0f);
        b.m(pathBuilderD, 3.0f, 19.0f, 12.5f, 19.0f);
        a.l(pathBuilderD, 0.5f, 1.0f, 1.0f, -1.0f);
        v.C(pathBuilderD, 22.0f, -1.0f, -4.0f, 14.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, androidx.compose.animation.a.m(pathBuilderD, 1.0f, 12.5f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw, iM3151getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
