...
public final class FilePresentKt {
    ...
    public static final ImageVector getFilePresent(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.FilePresent", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        a.h(pathBuilderO, -4.0f, 2.0f, 15.0f);
        pathBuilderO.moveTo(14.0f, 8.0f);
