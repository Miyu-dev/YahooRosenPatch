...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_adminPanelSettings", "Landroidx/compose/ui/graphics/vector/ImageVector;", "AdminPanelSettings", "Landroidx/compose/material/icons/Icons$Rounded;", "getAdminPanelSettings", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class AdminPanelSettingsKt {
    ...
    public static final ImageVector getAdminPanelSettings(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.AdminPanelSettings", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderD.verticalLineTo(7.58f);
        pathBuilderD.curveToRelative(0.0f, -0.8f, -0.47f, -1.52f, -1.2f, -1.83f);
        pathBuilderD.lineToRelative(-5.5f, -2.4f);
        pathBuilderD.curveToRelative(-0.51f, -0.22f, -1.09f, -0.22f, -1.6f, 0.0f);
        pathBuilderD.lineToRelative(-5.5f, 2.4f);
        pathBuilderD.curveTo(3.47f, 6.07f, 3.0f, 6.79f, 3.0f, 7.58f);
        pathBuilderD.verticalLineToRelative(3.6f);
