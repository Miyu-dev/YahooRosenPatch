...
public final class _20mpKt {
    ...
    public static final ImageVector get_20mp(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded._20mp", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderB.close();
        pathBuilderB.moveTo(6.5f, 9.0f);
        pathBuilderB.curveToRelative(0.0f, -0.55f, 0.45f, -1.0f, 1.0f, -1.0f);
        g.f(pathBuilderB, 2.0f, 7.0f, 7.25f);
        pathBuilderB.curveTo(6.84f, 7.0f, 6.5f, 6.66f, 6.5f, 6.25f);
        pathBuilderB.reflectiveCurveTo(6.84f, 5.5f, 7.25f, 5.5f);
        pathBuilderB.horizontalLineTo(10.0f);
        pathBuilderB.curveToRelative(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        pathBuilderB.verticalLineTo(8.0f);
        pathBuilderB.curveToRelative(0.0f, 0.55f, -0.45f, 1.0f, -1.0f, 1.0f);
        a.s(pathBuilderB, 8.0f, 1.0f, 2.25f);
        ...
        pathBuilderB.curveToRelative(-0.55f, 0.0f, -1.0f, -0.45f, -1.0f, -1.0f);
        android.support.v4.media.a.y(pathBuilderB, 9.0f, 12.5f, 17.75f);
        ...
        pathBuilderB.curveToRelative(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        b.l(pathBuilderB, 17.75f, 13.0f, 10.5f, -4.0f);
        pathBuilderB.curveToRelative(0.0f, -0.55f, 0.45f, -1.0f, 1.0f, -1.0f);
        ...
        pathBuilderB.curveTo(13.45f, 11.5f, 13.0f, 11.05f, 13.0f, 10.5f);
        pathBuilderB.close();
        ...
        ImageVector.Builder.m3359addPathoIyEayM$default(builder, a.b.i(15.0f, 14.0f, 1.5f, 1.5f, -1.5f), VectorKt.getDefaultFillType(), "", new SolidColor(companion.m2844getBlack0d7_KjU(), null), 1.0f, null, 1.0f, 1.0f, companion2.m3141getButtKaPHkGw(), companion3.m3151getBevelLxFBmk8(), 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, a.b.i(14.5f, 7.0f, 1.5f, 3.0f, -1.5f), VectorKt.getDefaultFillType(), "", new SolidColor(companion.m2844getBlack0d7_KjU(), null), 1.0f, null, 1.0f, 1.0f, companion2.m3141getButtKaPHkGw(), companion3.m3151getBevelLxFBmk8(), 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
