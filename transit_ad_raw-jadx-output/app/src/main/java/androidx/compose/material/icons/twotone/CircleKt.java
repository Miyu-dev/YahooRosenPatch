...
public final class CircleKt {
    ...
    public static final ImageVector getCircle(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.Circle", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderD.curveToRelative(0.0f, 5.53f, 4.47f, 10.0f, 10.0f, 10.0f);
        pathBuilderD.reflectiveCurveToRelative(10.0f, -4.47f, 10.0f, -10.0f);
        pathBuilderD.curveTo(22.0f, 6.47f, 17.53f, 2.0f, 12.0f, 2.0f);
        pathBuilderD.close();
