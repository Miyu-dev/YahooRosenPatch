...
public final class BrowseGalleryKt {
    ...
    public static final ImageVector getBrowseGallery(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.BrowseGallery", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        androidx.compose.animation.a.t(pathBuilderD, 11.09f, 15.5f, 8.59f, 13.0f);
        pathBuilderD.curveTo(8.21f, 12.62f, 8.0f, 12.12f, 8.0f, 11.59f);
        pathBuilderD.verticalLineTo(8.0f);
        pathBuilderD.curveToRelative(0.0f, -0.55f, 0.45f, -1.0f, 1.0f, -1.0f);
        pathBuilderD.horizontalLineToRelative(0.0f);
        pathBuilderD.curveToRelative(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        pathBuilderD.verticalLineToRelative(3.59f);
        ...
        pathBuilderD.curveTo(12.11f, 15.89f, 11.48f, 15.89f, 11.09f, 15.5f);
        pathBuilderD.close();
        ...
        PathBuilder pathBuilderA = b.a(17.99f, 5.08f, 17.99f, 5.08f);
        pathBuilderA.curveToRelative(0.0f, 0.37f, 0.21f, 0.69f, 0.53f, 0.88f);
        pathBuilderA.curveTo(20.6f, 7.17f, 22.0f, 9.42f, 22.0f, 12.0f);
        ...
        pathBuilderA.curveTo(22.18f, 18.22f, 24.0f, 15.32f, 24.0f, 12.0f);
        pathBuilderA.curveToRelative(0.0f, -3.32f, -1.82f, -6.22f, -4.5f, -7.78f);
        pathBuilderA.curveTo(18.83f, 3.83f, 17.99f, 4.31f, 17.99f, 5.08f);
        pathBuilderA.close();
