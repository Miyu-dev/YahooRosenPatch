...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_sentimentDissatisfied", "Landroidx/compose/ui/graphics/vector/ImageVector;", "SentimentDissatisfied", "Landroidx/compose/material/icons/Icons$TwoTone;", "getSentimentDissatisfied", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class SentimentDissatisfiedKt {
    ...
    public static final ImageVector getSentimentDissatisfied(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.SentimentDissatisfied", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderD.close();
        pathBuilderD.moveTo(15.45f, 17.5f);
        ...
        pathBuilderD.lineTo(6.88f, 17.5f);
        pathBuilderD.curveTo(7.68f, 15.45f, 9.67f, 14.0f, 12.0f, 14.0f);
        pathBuilderD.reflectiveCurveToRelative(4.32f, 1.45f, 5.12f, 3.5f);
        ImageVector.Builder.m3359addPathoIyEayM$default(builder, androidx.appcompat.graphics.drawable.a.c(pathBuilderD, -1.67f), defaultFillType, "", solidColor, 0.3f, null, 0.3f, 1.0f, iM3141getButtKaPHkGw, iM3151getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        pathBuilderD2.curveToRelative(-2.33f, 0.0f, -4.32f, 1.45f, -5.12f, 3.5f);
        pathBuilderD2.horizontalLineToRelative(1.67f);
        pathBuilderD2.curveToRelative(0.69f, -1.19f, 1.97f, -2.0f, 3.45f, -2.0f);
        pathBuilderD2.reflectiveCurveToRelative(2.75f, 0.81f, 3.45f, 2.0f);
        pathBuilderD2.horizontalLineToRelative(1.67f);
