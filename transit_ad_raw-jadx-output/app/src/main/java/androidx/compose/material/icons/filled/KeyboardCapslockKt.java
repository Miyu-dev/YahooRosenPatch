...
public final class KeyboardCapslockKt {
    ...
    public static final ImageVector getKeyboardCapslock(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.KeyboardCapslock", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
