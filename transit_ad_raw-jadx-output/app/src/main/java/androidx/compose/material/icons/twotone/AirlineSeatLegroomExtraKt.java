...
public final class AirlineSeatLegroomExtraKt {
    ...
    public static final ImageVector getAirlineSeatLegroomExtra(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.AirlineSeatLegroomExtra", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
