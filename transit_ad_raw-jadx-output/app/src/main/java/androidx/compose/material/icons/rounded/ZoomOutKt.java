...
public final class ZoomOutKt {
    ...
    public static final ImageVector getZoomOut(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.ZoomOut", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        androidx.compose.animation.a.j(pathBuilderA, 7.5f, 9.0f, 4.0f);
