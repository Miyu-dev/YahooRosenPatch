...
public final class EditKt {
    ...
    public static final ImageVector getEdit(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.Edit", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        android.support.v4.media.a.n(pathBuilderD, 3.75f, 3.75f, 1.83f, -1.83f);
        h.D(pathBuilderD, 3.0f, 17.25f, 21.0f, 3.75f);
        pathBuilderD.lineTo(17.81f, 9.94f);
        s.r(pathBuilderD, -3.75f, -3.75f, 3.0f, 17.25f);
        a.b.z(pathBuilderD, 5.92f, 19.0f, 5.0f, -0.92f);
        pathBuilderD.lineToRelative(9.06f, -9.06f);
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, h.p(pathBuilderD, 0.92f, 0.92f, 5.92f, 19.0f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw2, iM3151getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
