...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_train", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Train", "Landroidx/compose/material/icons/Icons$Filled;", "getTrain", "(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-filled_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class TrainKt {
    ...
    public static final ImageVector getTrain(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.Train", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        b.s(pathBuilderD, 6.0f, 20.5f, 0.5f, 2.23f);
        pathBuilderD.lineToRelative(2.0f, -2.0f);
        pathBuilderD.lineTo(14.0f, 19.0f);
        a.C(pathBuilderD, 2.0f, 2.0f, 2.0f, -0.5f);
        ...
        androidx.compose.animation.a.o(pathBuilderD, 13.0f, 6.0f, 5.0f, 4.0f);
        androidx.compose.animation.b.q(pathBuilderD, -5.0f, 16.5f, 17.0f);
        pathBuilderD.curveToRelative(-0.83f, 0.0f, -1.5f, -0.67f, -1.5f, -1.5f);
