...
public final class BathtubKt {
    ...
    public static final ImageVector getBathtub(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Bathtub", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderT = b.t(21.0f, 13.0f, -1.0f, 4.83f);
        pathBuilderT.curveTo(20.0f, 3.27f, 18.73f, 2.0f, 17.17f, 2.0f);
        pathBuilderT.curveToRelative(-0.75f, 0.0f, -1.47f, 0.3f, -2.0f, 0.83f);
        pathBuilderT.lineToRelative(-1.25f, 1.25f);
        pathBuilderT.curveTo(13.76f, 4.03f, 13.59f, 4.0f, 13.41f, 4.0f);
        pathBuilderT.curveToRelative(-0.4f, 0.0f, -0.77f, 0.12f, -1.08f, 0.32f);
        pathBuilderT.lineToRelative(2.76f, 2.76f);
        pathBuilderT.curveToRelative(0.2f, -0.31f, 0.32f, -0.68f, 0.32f, -1.08f);
        pathBuilderT.curveToRelative(0.0f, -0.18f, -0.03f, -0.34f, -0.07f, -0.51f);
        pathBuilderT.lineToRelative(1.25f, -1.25f);
        pathBuilderT.curveTo(16.74f, 4.09f, 16.95f, 4.0f, 17.17f, 4.0f);
        pathBuilderT.curveTo(17.63f, 4.0f, 18.0f, 4.37f, 18.0f, 4.83f);
        pathBuilderT.verticalLineTo(13.0f);
        pathBuilderT.horizontalLineToRelative(-6.85f);
        pathBuilderT.curveToRelative(-0.3f, -0.21f, -0.57f, -0.45f, -0.82f, -0.72f);
        pathBuilderT.lineToRelative(-1.4f, -1.55f);
        pathBuilderT.curveToRelative(-0.19f, -0.21f, -0.43f, -0.38f, -0.69f, -0.5f);
        pathBuilderT.curveTo(7.93f, 10.08f, 7.59f, 10.0f, 7.24f, 10.0f);
        pathBuilderT.curveTo(6.0f, 10.01f, 5.0f, 11.01f, 5.0f, 12.25f);
        pathBuilderT.verticalLineTo(13.0f);
        ...
        pathBuilderT.horizontalLineToRelative(14.0f);
        pathBuilderT.curveToRelative(0.55f, 0.0f, 1.0f, -0.45f, 1.0f, -1.0f);
        pathBuilderT.curveToRelative(1.1f, 0.0f, 2.0f, -0.9f, 2.0f, -2.0f);
        pathBuilderT.verticalLineToRelative(-5.0f);
        pathBuilderT.curveTo(22.0f, 13.45f, 21.55f, 13.0f, 21.0f, 13.0f);
        pathBuilderT.close();
