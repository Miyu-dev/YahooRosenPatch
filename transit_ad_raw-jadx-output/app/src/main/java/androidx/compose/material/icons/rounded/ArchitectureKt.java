...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_architecture", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Architecture", "Landroidx/compose/material/icons/Icons$Rounded;", "getArchitecture", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class ArchitectureKt {
    ...
    public static final ImageVector getArchitecture(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Architecture", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderD2 = a.d(14.94f, 8.6f);
        pathBuilderD2.curveToRelative(0.3f, -1.56f, -0.6f, -2.94f, -1.94f, -3.42f);
        ...
        pathBuilderD2.verticalLineToRelative(1.18f);
        pathBuilderD2.curveTo(9.84f, 5.6f, 9.0f, 6.7f, 9.0f, 8.0f);
        pathBuilderD2.curveToRelative(0.0f, 1.84f, 1.66f, 3.3f, 3.56f, 2.95f);
        pathBuilderD2.curveTo(13.74f, 10.73f, 14.71f, 9.78f, 14.94f, 8.6f);
        pathBuilderD2.close();
