...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_sensorsOff", "Landroidx/compose/ui/graphics/vector/ImageVector;", "SensorsOff", "Landroidx/compose/material/icons/Icons$Rounded;", "getSensorsOff", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class SensorsOffKt {
    ...
    public static final ImageVector getSensorsOff(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.SensorsOff", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m2844getBlack0d7_KjU(), null);
        int iM3141getButtKaPHkGw = StrokeCap.INSTANCE.m3141getButtKaPHkGw();
        int iM3151getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3151getBevelLxFBmk8();
        PathBuilder pathBuilderD = a.d(5.68f, 18.32f);
        pathBuilderD.curveToRelative(-0.42f, 0.42f, -1.12f, 0.39f, -1.5f, -0.08f);
        pathBuilderD.curveTo(2.82f, 16.53f, 2.0f, 14.36f, 2.0f, 12.0f);
        ...
        pathBuilderD.curveToRelative(0.0f, 1.89f, 0.66f, 3.63f, 1.76f, 5.0f);
        pathBuilderD.curveTo(6.08f, 17.39f, 6.04f, 17.96f, 5.68f, 18.32f);
        pathBuilderD.close();
        pathBuilderD.moveTo(15.46f, 8.54f);
        ...
        pathBuilderD.lineToRelative(1.55f, 1.55f);
        pathBuilderD.curveTo(17.79f, 13.8f, 18.0f, 12.93f, 18.0f, 12.0f);
        pathBuilderD.curveToRelative(0.0f, -1.24f, -0.38f, -2.4f, -1.03f, -3.36f);
        pathBuilderD.curveTo(16.63f, 8.14f, 15.9f, 8.1f, 15.46f, 8.54f);
        pathBuilderD.close();
        pathBuilderD.moveTo(18.32f, 5.68f);
        ...
        pathBuilderD.curveToRelative(0.0f, -2.36f, -0.82f, -4.53f, -2.18f, -6.24f);
        pathBuilderD.curveTo(19.44f, 5.29f, 18.74f, 5.26f, 18.32f, 5.68f);
        pathBuilderD.close();
