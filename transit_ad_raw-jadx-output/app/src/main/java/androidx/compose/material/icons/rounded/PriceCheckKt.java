...
public final class PriceCheckKt {
    ...
    public static final ImageVector getPriceCheck(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.PriceCheck", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderN.curveToRelative(0.0f, 0.55f, 0.45f, 1.0f, 1.0f, 1.0f);
        v.t(pathBuilderN, 4.0f, 2.0f, 5.0f);
        pathBuilderN.curveToRelative(-0.55f, 0.0f, -1.0f, 0.45f, -1.0f, 1.0f);
        pathBuilderN.reflectiveCurveToRelative(0.45f, 1.0f, 1.0f, 1.0f);
        pathBuilderN.horizontalLineToRelative(1.5f);
        pathBuilderN.curveToRelative(0.0f, 0.55f, 0.45f, 1.0f, 1.0f, 1.0f);
        pathBuilderN.reflectiveCurveToRelative(1.0f, -0.45f, 1.0f, -1.0f);
        ...
        PathBuilder pathBuilderA = b.a(18.88f, 13.22f, -4.95f, 4.95f);
        ...
        pathBuilderA.curveTo(19.9f, 12.83f, 19.27f, 12.83f, 18.88f, 13.22f);
        pathBuilderA.close();
