...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_shower", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Shower", "Landroidx/compose/material/icons/Icons$TwoTone;", "getShower", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class ShowerKt {
    ...
    public static final ImageVector getShower(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.Shower", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderD.curveTo(17.0f, 9.24f, 14.76f, 7.0f, 12.0f, 7.0f);
        pathBuilderD.close();
        ...
        PathBuilder pathBuilderB = v.b(8.0f, 20.0f, -1.0f, 0.0f);
        ...
        PathBuilder pathBuilderB2 = v.b(16.0f, 17.0f, -1.0f, 0.0f);
        ...
        PathBuilder pathBuilderC = h.c(13.0f, 5.08f, 3.0f, -2.0f, 2.08f);
        pathBuilderC.curveTo(7.61f, 5.57f, 5.0f, 8.47f, 5.0f, 12.0f);
        android.support.v4.media.a.m(pathBuilderC, 2.0f, 14.0f, -2.0f);
        pathBuilderC.curveTo(19.0f, 8.47f, 16.39f, 5.57f, 13.0f, 5.08f);
        pathBuilderC.close();
        pathBuilderC.moveTo(7.0f, 12.0f);
        pathBuilderC.curveToRelative(0.0f, -2.76f, 2.24f, -5.0f, 5.0f, -5.0f);
        pathBuilderC.reflectiveCurveToRelative(5.0f, 2.24f, 5.0f, 5.0f);
        ImageVector.Builder.m3359addPathoIyEayM$default(builder, androidx.appcompat.app.m.j(pathBuilderC, 7.0f), defaultFillType4, "", solidColor4, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw4, iM3151getBevelLxFBmk84, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        PathBuilder pathBuilderB3 = v.b(16.0f, 20.0f, -1.0f, 0.0f);
        ...
        PathBuilder pathBuilderB4 = v.b(12.0f, 17.0f, -1.0f, 0.0f);
        ...
        PathBuilder pathBuilderB5 = v.b(8.0f, 17.0f, -1.0f, 0.0f);
        pathBuilderB5.arcToRelative(1.0f, 1.0f, 0.0f, true, true, 2.0f, 0.0f);
        pathBuilderB5.arcToRelative(1.0f, 1.0f, 0.0f, true, true, -2.0f, 0.0f);
        ImageVector.Builder.m3359addPathoIyEayM$default(builder, pathBuilderB5.getNodes(), defaultFillType7, "", solidColor7, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw7, iM3151getBevelLxFBmk87, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        PathBuilder pathBuilderB6 = v.b(12.0f, 20.0f, -1.0f, 0.0f);
        pathBuilderB6.arcToRelative(1.0f, 1.0f, 0.0f, true, true, 2.0f, 0.0f);
        pathBuilderB6.arcToRelative(1.0f, 1.0f, 0.0f, true, true, -2.0f, 0.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, pathBuilderB6.getNodes(), defaultFillType8, "", solidColor8, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw8, iM3151getBevelLxFBmk88, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
