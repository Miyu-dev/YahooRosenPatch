...
public final class _7kKt {
    ...
    public static final ImageVector get_7k(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone._7k", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        b.B(pathBuilderQ, 13.0f, 9.0f, 6.5f, 9.0f);
        pathBuilderQ.horizontalLineTo(10.0f);
        pathBuilderQ.curveToRelative(0.67f, 0.0f, 1.15f, 0.65f, 0.96f, 1.29f);
        pathBuilderQ.lineTo(9.5f, 15.0f);
        s.C(pathBuilderQ, 7.75f, 1.38f, -4.5f, 6.5f);
        ImageVector.Builder.m3359addPathoIyEayM$default(builder, a.j(pathBuilderQ, 9.0f), defaultFillType, "", solidColor, 0.3f, null, 0.3f, 1.0f, iM3141getButtKaPHkGw, iM3151getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        PathBuilder pathBuilderS = h.s(7.75f, 15.0f, 9.5f, 1.46f, -4.71f);
        pathBuilderS.curveTo(11.15f, 9.65f, 10.67f, 9.0f, 10.0f, 9.0f);
        androidx.compose.animation.a.s(pathBuilderS, 6.5f, 1.5f, 2.63f);
        ImageVector.Builder.m3359addPathoIyEayM$default(builder, androidx.compose.animation.b.h(pathBuilderS, 7.75f, 15.0f), defaultFillType3, "", solidColor3, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw3, iM3151getBevelLxFBmk83, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
