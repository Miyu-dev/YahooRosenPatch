...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_localPrintshop", "Landroidx/compose/ui/graphics/vector/ImageVector;", "LocalPrintshop", "Landroidx/compose/material/icons/Icons$Outlined;", "getLocalPrintshop", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-outlined_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class LocalPrintshopKt {
    ...
    public static final ImageVector getLocalPrintshop(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.LocalPrintshop", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        s.z(pathBuilderC, 4.0f, 18.0f, 15.0f, -2.0f);
        pathBuilderC.lineTo(6.0f, 13.0f);
        v.y(pathBuilderC, 2.0f, 4.0f, 15.0f, -4.0f);
        ...
        ImageVector.Builder.m3359addPathoIyEayM$default(builder, v.p(pathBuilderC, 4.0f, -2.0f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw, iM3151getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
