...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_skateboarding", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Skateboarding", "Landroidx/compose/material/icons/Icons$Rounded;", "getSkateboarding", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class SkateboardingKt {
    ...
    public static final ImageVector getSkateboarding(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Skateboarding", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderD.verticalLineToRelative(-4.88f);
        pathBuilderD.curveToRelative(0.0f, -0.69f, -0.36f, -1.34f, -0.95f, -1.7f);
        pathBuilderD.lineToRelative(-3.37f, -2.08f);
        pathBuilderD.lineToRelative(1.8f, -2.89f);
        pathBuilderD.curveToRelative(0.96f, 1.53f, 2.54f, 2.64f, 4.39f, 2.96f);
        pathBuilderD.curveToRelative(0.6f, 0.11f, 1.13f, -0.39f, 1.13f, -0.99f);
        ...
        pathBuilderD.horizontalLineTo(8.11f);
        pathBuilderD.curveToRelative(-0.69f, 0.0f, -1.33f, 0.36f, -1.7f, 0.94f);
        pathBuilderD.lineTo(5.03f, 8.15f);
        pathBuilderD.curveTo(4.74f, 8.62f, 4.88f, 9.24f, 5.35f, 9.53f);
        ...
        pathBuilderD.lineToRelative(1.34f, 4.15f);
        ...
        pathBuilderD.lineToRelative(2.21f, -2.67f);
        pathBuilderD.curveToRelative(0.43f, -0.52f, 0.57f, -1.21f, 0.37f, -1.86f);
        pathBuilderD.lineTo(10.5f, 13.7f);
