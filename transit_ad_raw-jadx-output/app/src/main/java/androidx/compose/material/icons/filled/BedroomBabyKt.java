...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_bedroomBaby", "Landroidx/compose/ui/graphics/vector/ImageVector;", "BedroomBaby", "Landroidx/compose/material/icons/Icons$Filled;", "getBedroomBaby", "(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-filled_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class BedroomBabyKt {
    ...
    public static final ImageVector getBedroomBaby(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.BedroomBaby", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderB.curveToRelative(-2.64f, 0.0f, -5.13f, -1.03f, -7.0f, -2.9f);
        pathBuilderB.lineToRelative(1.06f, -1.06f);
        pathBuilderB.curveToRelative(0.34f, 0.34f, 0.71f, 0.65f, 1.1f, 0.92f);
        pathBuilderB.lineTo(8.0f, 13.5f);
        pathBuilderB.verticalLineTo(9.51f);
        pathBuilderB.lineTo(6.45f, 10.5f);
        pathBuilderB.lineToRelative(-0.95f, -1.0f);
        pathBuilderB.lineTo(7.0f, 7.76f);
        pathBuilderB.lineTo(6.0f, 7.0f);
        a.C(pathBuilderB, 3.65f, 1.73f, 3.0f, 17.0f);
        android.support.v4.media.a.m(pathBuilderB, 1.0f, -1.0f, 2.5f);
        pathBuilderB.lineToRelative(0.84f, 1.46f);
        pathBuilderB.curveToRelative(0.39f, -0.28f, 0.76f, -0.58f, 1.1f, -0.92f);
        pathBuilderB.lineTo(19.0f, 15.1f);
        pathBuilderB.curveTo(17.13f, 16.97f, 14.64f, 18.0f, 12.0f, 18.0f);
        pathBuilderB.close();
