...
public final class RestoreFromTrashKt {
    ...
    public static final ImageVector getRestoreFromTrash(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.RestoreFromTrash", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderD.curveToRelative(-1.1f, 0.0f, -2.0f, 0.9f, -2.0f, 2.0f);
        android.support.v4.media.a.v(pathBuilderD, 10.0f, 11.65f, 10.35f);
        pathBuilderD.curveToRelative(0.2f, -0.2f, 0.51f, -0.2f, 0.71f, 0.0f);
        androidx.compose.animation.a.o(pathBuilderD, 16.0f, 14.0f, -2.0f, 4.0f);
        android.support.v4.media.a.w(pathBuilderD, -4.0f, -4.0f, 8.0f, 14.0f);
        android.support.v4.media.a.t(pathBuilderD, 3.65f, -3.65f, 15.5f, 4.0f);
