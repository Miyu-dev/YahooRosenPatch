...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"__11mp", "Landroidx/compose/ui/graphics/vector/ImageVector;", "_11mp", "Landroidx/compose/material/icons/Icons$Rounded;", "get_11mp", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class _11mpKt {
    ...
    public static final ImageVector get_11mp(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded._11mp", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        a.k(pathBuilderB, 8.75f, 5.5f, 10.0f);
        pathBuilderB.curveToRelative(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        pathBuilderB.verticalLineToRelative(4.25f);
        pathBuilderB.curveToRelative(0.0f, 0.41f, -0.34f, 0.75f, -0.75f, 0.75f);
        pathBuilderB.reflectiveCurveTo(9.5f, 11.16f, 9.5f, 10.75f);
        pathBuilderB.verticalLineTo(7.0f);
        pathBuilderB.horizontalLineTo(8.75f);
        pathBuilderB.curveTo(8.34f, 7.0f, 8.0f, 6.66f, 8.0f, 6.25f);
        pathBuilderB.reflectiveCurveTo(8.34f, 5.5f, 8.75f, 5.5f);
        pathBuilderB.close();
        ...
        pathBuilderB.curveToRelative(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        android.support.v4.media.a.y(pathBuilderB, 17.75f, 13.0f, 6.25f);
        pathBuilderB.curveToRelative(0.0f, -0.41f, 0.34f, -0.75f, 0.75f, -0.75f);
        ...
        pathBuilderB.curveTo(13.34f, 7.0f, 13.0f, 6.66f, 13.0f, 6.25f);
        pathBuilderB.close();
