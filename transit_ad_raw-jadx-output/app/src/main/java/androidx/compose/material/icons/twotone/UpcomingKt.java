...
public final class UpcomingKt {
    ...
    public static final ImageVector getUpcoming(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.Upcoming", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderD.curveToRelative(-2.04f, 0.0f, -3.81f, -1.24f, -4.58f, -3.0f);
        a.B(pathBuilderD, 4.0f, 5.0f, 16.0f, -5.0f);
        pathBuilderD.horizontalLineToRelative(-3.42f);
        pathBuilderD.curveTo(15.81f, 15.76f, 14.04f, 17.0f, 12.0f, 17.0f);
        pathBuilderD.close();
        ...
        a.q(pathBuilderB, 20.0f, 19.0f, 4.0f, -5.0f);
        pathBuilderB.horizontalLineToRelative(3.42f);
        pathBuilderB.curveToRelative(0.77f, 1.76f, 2.54f, 3.0f, 4.58f, 3.0f);
        pathBuilderB.reflectiveCurveToRelative(3.81f, -1.24f, 4.58f, -3.0f);
        ImageVector.Builder.m3359addPathoIyEayM$default(builder, a.i(pathBuilderB, 20.0f, 19.0f), defaultFillType3, "", solidColor3, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw3, iM3151getBevelLxFBmk83, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
