...
public final class LocalConvenienceStoreKt {
    ...
    public static final ImageVector getLocalConvenienceStore(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.LocalConvenienceStore", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        b.s(pathBuilderA, 9.0f, 10.0f, 1.0f, 2.0f);
        ...
        s.w(pathBuilderA, 8.0f, 7.0f, 3.0f, 3.0f);
        a.x(pathBuilderA, 16.0f, 12.0f, -1.0f, -2.0f);
        a.y(pathBuilderA, -2.0f, 13.0f, 7.0f, 1.0f);
        androidx.browser.browseractions.a.x(pathBuilderA, 2.0f, 1.0f, 15.0f, 7.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, v.j(pathBuilderA, 1.0f, 5.0f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw, iM3151getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
