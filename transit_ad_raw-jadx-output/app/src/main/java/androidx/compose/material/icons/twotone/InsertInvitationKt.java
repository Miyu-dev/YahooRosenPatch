...
public final class InsertInvitationKt {
    ...
    public static final ImageVector getInsertInvitation(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.InsertInvitation", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        a.y(pathBuilderB, -1.0f, 18.0f, 1.0f, -2.0f);
        ...
        androidx.compose.animation.a.t(pathBuilderB, 5.0f, 7.0f, 5.0f, 5.0f);
        androidx.appcompat.app.m.C(pathBuilderB, 14.0f, 2.0f, 5.0f, 7.0f);
        a.x(pathBuilderB, 5.0f, 9.0f, 14.0f, 10.0f);
        android.support.v4.media.a.C(pathBuilderB, 5.0f, 19.0f, 5.0f, 9.0f);
        a.x(pathBuilderB, 12.0f, 12.0f, 5.0f, 5.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, androidx.appcompat.graphics.drawable.a.c(pathBuilderB, -5.0f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw2, iM3151getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
