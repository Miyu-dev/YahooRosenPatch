...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_sentimentVeryDissatisfied", "Landroidx/compose/ui/graphics/vector/ImageVector;", "SentimentVeryDissatisfied", "Landroidx/compose/material/icons/Icons$Rounded;", "getSentimentVeryDissatisfied", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class SentimentVeryDissatisfiedKt {
    ...
    public static final ImageVector getSentimentVeryDissatisfied(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.SentimentVeryDissatisfied", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m2844getBlack0d7_KjU(), null);
        int iM3141getButtKaPHkGw = StrokeCap.INSTANCE.m3141getButtKaPHkGw();
        int iM3151getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3151getBevelLxFBmk8();
        PathBuilder pathBuilderD = a.d(12.0f, 13.5f);
        pathBuilderD.curveToRelative(-2.03f, 0.0f, -3.8f, 1.11f, -4.75f, 2.75f);
        pathBuilderD.curveToRelative(-0.19f, 0.33f, 0.06f, 0.75f, 0.44f, 0.75f);
        pathBuilderD.horizontalLineToRelative(8.62f);
        pathBuilderD.curveToRelative(0.38f, 0.0f, 0.63f, -0.42f, 0.44f, -0.75f);
        pathBuilderD.curveToRelative(-0.95f, -1.64f, -2.72f, -2.75f, -4.75f, -2.75f);
        a.y(pathBuilderD, 8.35f, 11.47f, 0.53f, -0.53f);
        ...
        pathBuilderD.reflectiveCurveToRelative(-3.58f, 8.0f, -8.0f, 8.0f);
        a.y(pathBuilderD, 15.65f, 8.29f, -0.53f, 0.53f);
        pathBuilderD.lineToRelative(-0.53f, -0.53f);
        pathBuilderD.curveToRelative(-0.29f, -0.29f, -0.77f, -0.29f, -1.06f, 0.0f);
        pathBuilderD.curveToRelative(-0.29f, 0.29f, -0.29f, 0.77f, 0.0f, 1.06f);
        pathBuilderD.lineToRelative(0.53f, 0.53f);
