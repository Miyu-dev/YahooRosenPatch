...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_directionsCar", "Landroidx/compose/ui/graphics/vector/ImageVector;", "DirectionsCar", "Landroidx/compose/material/icons/Icons$TwoTone;", "getDirectionsCar", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class DirectionsCarKt {
    ...
    public static final ImageVector getDirectionsCar(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.DirectionsCar", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderO = b.o(5.0f, 17.0f, 14.0f, -5.0f);
        androidx.compose.animation.b.k(pathBuilderO, 5.0f, 12.0f, 5.0f);
        pathBuilderO.moveTo(16.5f, 13.0f);
        ...
        pathBuilderO.reflectiveCurveToRelative(0.67f, -1.5f, 1.5f, -1.5f);
        pathBuilderO.close();
        pathBuilderO.moveTo(7.5f, 13.0f);
        pathBuilderO.curveToRelative(0.83f, 0.0f, 1.5f, 0.67f, 1.5f, 1.5f);
        pathBuilderO.reflectiveCurveTo(8.33f, 16.0f, 7.5f, 16.0f);
        pathBuilderO.reflectiveCurveTo(6.0f, 15.33f, 6.0f, 14.5f);
        ImageVector.Builder.m3359addPathoIyEayM$default(builder, h.t(pathBuilderO, 6.67f, 13.0f, 7.5f, 13.0f), defaultFillType, "", solidColor, 0.3f, null, 0.3f, 1.0f, iM3141getButtKaPHkGw, iM3151getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
