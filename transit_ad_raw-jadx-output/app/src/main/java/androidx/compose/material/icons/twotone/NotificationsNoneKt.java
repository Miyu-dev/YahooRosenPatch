...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_notificationsNone", "Landroidx/compose/ui/graphics/vector/ImageVector;", "NotificationsNone", "Landroidx/compose/material/icons/Icons$TwoTone;", "getNotificationsNone", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class NotificationsNoneKt {
    ...
    public static final ImageVector getNotificationsNone(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.NotificationsNone", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderE.curveToRelative(0.0f, -3.07f, -1.63f, -5.64f, -4.5f, -6.32f);
        ...
        pathBuilderE.curveTo(7.64f, 5.36f, 6.0f, 7.92f, 6.0f, 11.0f);
        androidx.compose.animation.a.q(pathBuilderE, 5.0f, -2.0f, 2.0f, 1.0f);
        d.g(pathBuilderE, 16.0f, -1.0f, -2.0f, -2.0f);
        pathBuilderE.moveTo(16.0f, 17.0f);
        pathBuilderE.lineTo(8.0f, 17.0f);
        pathBuilderE.verticalLineToRelative(-6.0f);
        pathBuilderE.curveToRelative(0.0f, -2.48f, 1.51f, -4.5f, 4.0f, -4.5f);
        pathBuilderE.reflectiveCurveToRelative(4.0f, 2.02f, 4.0f, 4.5f);
        android.support.v4.media.a.v(pathBuilderE, 6.0f, 12.0f, 22.0f);
