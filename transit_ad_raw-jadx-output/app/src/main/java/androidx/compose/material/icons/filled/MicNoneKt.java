...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_micNone", "Landroidx/compose/ui/graphics/vector/ImageVector;", "MicNone", "Landroidx/compose/material/icons/Icons$Filled;", "getMicNone", "(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-filled_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class MicNoneKt {
    ...
    public static final ImageVector getMicNone(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.MicNone", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderD.curveToRelative(0.0f, 1.66f, 1.34f, 3.0f, 3.0f, 3.0f);
        pathBuilderD.close();
        pathBuilderD.moveTo(10.8f, 4.9f);
        ...
        pathBuilderD.curveToRelative(0.0f, 0.66f, -0.53f, 1.2f, -1.19f, 1.2f);
        pathBuilderD.curveToRelative(-0.66f, 0.0f, -1.2f, -0.54f, -1.2f, -1.2f);
        androidx.appcompat.view.menu.a.z(pathBuilderD, 10.8f, 4.9f, 17.3f, 11.0f);
        pathBuilderD.curveToRelative(0.0f, 3.0f, -2.54f, 5.1f, -5.3f, 5.1f);
        pathBuilderD.reflectiveCurveTo(6.7f, 14.0f, 6.7f, 11.0f);
        pathBuilderD.lineTo(5.0f, 11.0f);
        pathBuilderD.curveToRelative(0.0f, 3.41f, 2.72f, 6.23f, 6.0f, 6.72f);
        androidx.compose.animation.a.o(pathBuilderD, 11.0f, 21.0f, 2.0f, -3.28f);
