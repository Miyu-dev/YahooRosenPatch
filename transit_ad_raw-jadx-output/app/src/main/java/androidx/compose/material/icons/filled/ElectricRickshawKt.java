...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_electricRickshaw", "Landroidx/compose/ui/graphics/vector/ImageVector;", "ElectricRickshaw", "Landroidx/compose/material/icons/Icons$Filled;", "getElectricRickshaw", "(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-filled_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class ElectricRickshawKt {
    ...
    public static final ImageVector getElectricRickshaw(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.ElectricRickshaw", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        androidx.appcompat.view.menu.a.z(pathBuilderN, 18.4f, 9.0f, 3.0f, 5.0f);
        s.A(pathBuilderN, 4.0f, 4.0f, 3.0f, 5.0f);
        ...
        androidx.appcompat.app.m.n(pathBuilderN, 9.0f, 13.0f, -2.0f, 3.0f);
        c.g(pathBuilderN, 9.0f, 9.0f, 5.0f, 5.0f);
        h.z(pathBuilderN, 8.0f, 9.0f, 20.0f, 15.0f);
        pathBuilderN.curveToRelative(-0.55f, 0.0f, -1.0f, -0.45f, -1.0f, -1.0f);
        pathBuilderN.reflectiveCurveToRelative(0.45f, -1.0f, 1.0f, -1.0f);
        pathBuilderN.reflectiveCurveToRelative(1.0f, 0.45f, 1.0f, 1.0f);
