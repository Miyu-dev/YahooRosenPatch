...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_lightbulb", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Lightbulb", "Landroidx/compose/material/icons/Icons$Rounded;", "getLightbulb", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class LightbulbKt {
    ...
    public static final ImageVector getLightbulb(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Lightbulb", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderB = h.b(9.0f, 19.0f, 6.0f);
        ...
        pathBuilderD2.curveTo(7.86f, 2.0f, 4.5f, 5.36f, 4.5f, 9.5f);
        pathBuilderD2.curveToRelative(0.0f, 3.82f, 2.66f, 5.86f, 3.77f, 6.5f);
        pathBuilderD2.horizontalLineToRelative(7.46f);
        pathBuilderD2.curveToRelative(1.11f, -0.64f, 3.77f, -2.68f, 3.77f, -6.5f);
        pathBuilderD2.curveTo(19.5f, 5.36f, 16.14f, 2.0f, 12.0f, 2.0f);
        pathBuilderD2.close();
