...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_keyboardDoubleArrowLeft", "Landroidx/compose/ui/graphics/vector/ImageVector;", "KeyboardDoubleArrowLeft", "Landroidx/compose/material/icons/Icons$Rounded;", "getKeyboardDoubleArrowLeft", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class KeyboardDoubleArrowLeftKt {
    ...
    public static final ImageVector getKeyboardDoubleArrowLeft(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.KeyboardDoubleArrowLeft", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderA = b.a(18.29f, 17.29f, 18.29f, 17.29f);
        pathBuilderA.curveToRelative(0.39f, -0.39f, 0.39f, -1.02f, 0.0f, -1.41f);
        pathBuilderA.lineTo(14.42f, 12.0f);
        ...
        pathBuilderA.curveToRelative(-0.39f, 0.39f, -0.39f, 1.02f, 0.0f, 1.41f);
        pathBuilderA.lineToRelative(4.59f, 4.59f);
        pathBuilderA.curveTo(17.27f, 17.68f, 17.9f, 17.68f, 18.29f, 17.29f);
        pathBuilderA.close();
        ...
        PathBuilder pathBuilderA2 = b.a(11.7f, 17.29f, 11.7f, 17.29f);
        pathBuilderA2.curveToRelative(0.39f, -0.39f, 0.39f, -1.02f, 0.0f, -1.41f);
        pathBuilderA2.lineTo(7.83f, 12.0f);
        ...
        pathBuilderA2.curveToRelative(-0.39f, 0.39f, -0.39f, 1.02f, 0.0f, 1.41f);
        pathBuilderA2.lineToRelative(4.59f, 4.59f);
        pathBuilderA2.curveTo(10.68f, 17.68f, 11.31f, 17.68f, 11.7f, 17.29f);
        pathBuilderA2.close();
