...
public final class AirlineSeatLegroomNormalKt {
    ...
    public static final ImageVector getAirlineSeatLegroomNormal(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.AirlineSeatLegroomNormal", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
