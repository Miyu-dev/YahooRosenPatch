...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_borderVertical", "Landroidx/compose/ui/graphics/vector/ImageVector;", "BorderVertical", "Landroidx/compose/material/icons/Icons$Rounded;", "getBorderVertical", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class BorderVerticalKt {
    ...
    public static final ImageVector getBorderVertical(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.BorderVertical", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        androidx.appcompat.graphics.drawable.a.z(pathBuilderC, -2.0f, 2.0f, 12.0f, 21.0f);
        pathBuilderC.curveToRelative(0.55f, 0.0f, 1.0f, -0.45f, 1.0f, -1.0f);
        pathBuilderC.lineTo(13.0f, 4.0f);
        ...
        pathBuilderC.curveToRelative(0.0f, 0.55f, 0.45f, 1.0f, 1.0f, 1.0f);
        b.r(pathBuilderC, 19.0f, 21.0f, 2.0f, -2.0f);
        androidx.appcompat.graphics.drawable.a.z(pathBuilderC, -2.0f, 2.0f, 19.0f, 13.0f);
        ...
        androidx.appcompat.graphics.drawable.a.A(pathBuilderC, 2.0f, 15.0f, 5.0f, 2.0f);
        s.w(pathBuilderC, 17.0f, 3.0f, -2.0f, 2.0f);
        a.x(pathBuilderC, 15.0f, 21.0f, 2.0f, -2.0f);
        androidx.appcompat.graphics.drawable.a.z(pathBuilderC, -2.0f, 2.0f, 15.0f, 13.0f);
