...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"__2kPlus", "Landroidx/compose/ui/graphics/vector/ImageVector;", "_2kPlus", "Landroidx/compose/material/icons/Icons$TwoTone;", "get_2kPlus", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class _2kPlusKt {
    ...
    public static final ImageVector get_2kPlus(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone._2kPlus", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        a.b.B(pathBuilderF, 11.0f, 9.0f, 6.0f, 12.5f);
        pathBuilderF.curveToRelative(0.0f, -0.55f, 0.45f, -1.0f, 1.0f, -1.0f);
        android.support.v4.media.a.z(pathBuilderF, 1.5f, -1.0f, 6.0f, 9.0f);
        pathBuilderF.horizontalLineToRelative(3.0f);
        pathBuilderF.curveToRelative(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        pathBuilderF.verticalLineToRelative(1.5f);
        pathBuilderF.curveToRelative(0.0f, 0.55f, -0.45f, 1.0f, -1.0f, 1.0f);
        c.b.e(pathBuilderF, 7.5f, 1.0f, 10.0f, 15.0f);
        ImageVector.Builder.m3359addPathoIyEayM$default(builder, a.i(pathBuilderF, 6.0f, 12.5f), defaultFillType, "", solidColor, 0.3f, null, 0.3f, 1.0f, iM3141getButtKaPHkGw, iM3151getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        a.B(pathBuilderB2, 6.0f, 1.5f, 2.5f, 1.0f);
        pathBuilderB2.horizontalLineTo(7.0f);
        pathBuilderB2.curveToRelative(-0.55f, 0.0f, -1.0f, 0.45f, -1.0f, 1.0f);
        ImageVector.Builder.m3359addPathoIyEayM$default(builder, v.q(pathBuilderB2, 15.0f, 4.0f, 13.5f), defaultFillType3, "", solidColor3, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw3, iM3151getBevelLxFBmk83, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
