...
public final class ExploreOffKt {
    ...
    public static final ImageVector getExploreOff(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.ExploreOff", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        a.C(pathBuilderA, 3.51f, 3.51f, 2.1f, 4.93f);
        pathBuilderA.moveTo(8.91f, 11.74f);
