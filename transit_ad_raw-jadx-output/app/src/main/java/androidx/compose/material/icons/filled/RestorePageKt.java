...
public final class RestorePageKt {
    ...
    public static final ImageVector getRestorePage(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.RestorePage", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderA.curveToRelative(-2.05f, 0.0f, -3.81f, -1.24f, -4.58f, -3.0f);
        pathBuilderA.horizontalLineToRelative(1.71f);
        pathBuilderA.curveToRelative(0.63f, 0.9f, 1.68f, 1.5f, 2.87f, 1.5f);
        pathBuilderA.curveToRelative(1.93f, 0.0f, 3.5f, -1.57f, 3.5f, -3.5f);
        pathBuilderA.reflectiveCurveTo(13.93f, 9.5f, 12.0f, 9.5f);
        pathBuilderA.curveToRelative(-1.35f, 0.0f, -2.52f, 0.78f, -3.1f, 1.9f);
        ...
        pathBuilderA.curveTo(8.69f, 8.92f, 10.23f, 8.0f, 12.0f, 8.0f);
