...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"__21mp", "Landroidx/compose/ui/graphics/vector/ImageVector;", "_21mp", "Landroidx/compose/material/icons/Icons$Rounded;", "get_21mp", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class _21mpKt {
    ...
    public static final ImageVector get_21mp(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded._21mp", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        g.f(pathBuilderB, 2.0f, 7.0f, 8.25f);
        pathBuilderB.curveTo(7.84f, 7.0f, 7.5f, 6.66f, 7.5f, 6.25f);
        pathBuilderB.reflectiveCurveTo(7.84f, 5.5f, 8.25f, 5.5f);
        pathBuilderB.horizontalLineTo(11.0f);
        pathBuilderB.curveToRelative(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        pathBuilderB.verticalLineTo(8.0f);
        pathBuilderB.curveToRelative(0.0f, 0.55f, -0.45f, 1.0f, -1.0f, 1.0f);
        a.s(pathBuilderB, 9.0f, 1.0f, 2.25f);
