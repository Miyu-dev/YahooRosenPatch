...
public final class AirlineSeatFlatAngledKt {
    ...
    public static final ImageVector getAirlineSeatFlatAngled(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.AirlineSeatFlatAngled", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m2844getBlack0d7_KjU(), null);
        int iM3141getButtKaPHkGw = StrokeCap.INSTANCE.m3141getButtKaPHkGw();
        int iM3151getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3151getBevelLxFBmk8();
        PathBuilder pathBuilderA = b.a(21.56f, 16.18f, 9.2f, 11.71f);
        pathBuilderA.lineToRelative(2.08f, -5.66f);
        a.n(pathBuilderA, 12.35f, 4.47f, -2.07f, 5.66f);
        pathBuilderA.moveTo(1.5f, 12.14f);
        pathBuilderA.lineTo(8.0f, 14.48f);
        androidx.compose.animation.a.o(pathBuilderA, 8.0f, 19.0f, 8.0f, -1.63f);
        pathBuilderA.lineTo(20.52f, 19.0f);
        pathBuilderA.lineToRelative(0.69f, -1.89f);
        a.n(pathBuilderA, -19.02f, -6.86f, -0.69f, 1.89f);
