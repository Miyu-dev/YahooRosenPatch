...
public final class DangerousKt {
    ...
    public static final ImageVector getDangerous(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.Dangerous", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderB = a.b(9.1f, 5.0f, 5.0f, 9.1f, 5.8f);
        pathBuilderB.lineTo(9.1f, 19.0f);
        c.a.l(pathBuilderB, 5.8f, 4.1f, -4.1f, 9.1f);
        i.b(pathBuilderB, 14.9f, 5.0f, 9.1f);
        pathBuilderB.moveTo(16.24f, 14.83f);
        ...
        pathBuilderB.lineTo(7.76f, 9.17f);
        pathBuilderB.lineToRelative(1.41f, -1.41f);
        pathBuilderB.lineTo(12.0f, 10.59f);
        pathBuilderB.lineToRelative(2.83f, -2.83f);
        pathBuilderB.lineToRelative(1.41f, 1.41f);
        ImageVector.Builder.m3359addPathoIyEayM$default(builder, v.l(pathBuilderB, 13.41f, 12.0f, 16.24f, 14.83f), defaultFillType, "", solidColor, 0.3f, null, 0.3f, 1.0f, iM3141getButtKaPHkGw, iM3151getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, h.p(pathBuilderA, 2.83f, -2.83f, 14.83f, 7.76f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw2, iM3151getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
