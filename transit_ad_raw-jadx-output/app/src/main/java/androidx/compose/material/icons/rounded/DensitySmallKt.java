...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_densitySmall", "Landroidx/compose/ui/graphics/vector/ImageVector;", "DensitySmall", "Landroidx/compose/material/icons/Icons$Rounded;", "getDensitySmall", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class DensitySmallKt {
    ...
    public static final ImageVector getDensitySmall(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.DensitySmall", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderA = b.a(3.0f, 3.0f, 3.0f, 3.0f);
        ...
        pathBuilderA.curveTo(3.45f, 2.0f, 3.0f, 2.45f, 3.0f, 3.0f);
        pathBuilderA.close();
        ...
        PathBuilder pathBuilderB = h.b(4.0f, 22.0f, 16.0f);
        ...
        pathBuilderB.curveToRelative(-0.55f, 0.0f, -1.0f, 0.45f, -1.0f, 1.0f);
        pathBuilderB.verticalLineToRelative(0.0f);
        pathBuilderB.curveTo(3.0f, 21.55f, 3.45f, 22.0f, 4.0f, 22.0f);
        pathBuilderB.close();
        ...
        PathBuilder pathBuilderB2 = h.b(4.0f, 16.0f, 16.0f);
        ...
        pathBuilderB2.curveToRelative(-0.55f, 0.0f, -1.0f, 0.45f, -1.0f, 1.0f);
        pathBuilderB2.verticalLineToRelative(0.0f);
        pathBuilderB2.curveTo(3.0f, 15.55f, 3.45f, 16.0f, 4.0f, 16.0f);
        pathBuilderB2.close();
        ...
        PathBuilder pathBuilderB3 = h.b(4.0f, 10.0f, 16.0f);
        ...
        pathBuilderB3.curveTo(3.45f, 8.0f, 3.0f, 8.45f, 3.0f, 9.0f);
        pathBuilderB3.verticalLineToRelative(0.0f);
        pathBuilderB3.curveTo(3.0f, 9.55f, 3.45f, 10.0f, 4.0f, 10.0f);
        pathBuilderB3.close();
