...
public final class PermIdentityKt {
    ...
    public static final ImageVector getPermIdentity(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.PermIdentity", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        androidx.compose.animation.a.t(pathBuilderD2, 18.0f, 18.0f, 6.0f, 18.0f);
        pathBuilderD2.verticalLineToRelative(-0.99f);
        pathBuilderD2.curveToRelative(0.2f, -0.72f, 3.3f, -2.01f, 6.0f, -2.01f);
        pathBuilderD2.reflectiveCurveToRelative(5.8f, 1.29f, 6.0f, 2.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, androidx.appcompat.view.menu.a.h(pathBuilderD2, 1.0f), defaultFillType3, "", solidColor3, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw3, iM3151getBevelLxFBmk83, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
