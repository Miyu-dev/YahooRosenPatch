...
public final class PauseCircleOutlineKt {
    ...
    public static final ImageVector getPauseCircleOutline(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.PauseCircleOutline", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m2844getBlack0d7_KjU(), null);
        int iM3141getButtKaPHkGw = StrokeCap.INSTANCE.m3141getButtKaPHkGw();
        int iM3151getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3151getBevelLxFBmk8();
        PathBuilder pathBuilderV = a.v(13.0f, 8.0f, 2.0f, 8.0f, -2.0f);
        androidx.appcompat.view.menu.a.x(pathBuilderV, 9.0f, 8.0f, 2.0f, 8.0f);
        androidx.appcompat.view.menu.a.z(pathBuilderV, 9.0f, 16.0f, 12.0f, 22.0f);
        pathBuilderV.curveToRelative(5.52f, 0.0f, 10.0f, -4.48f, 10.0f, -10.0f);
        pathBuilderV.reflectiveCurveTo(17.52f, 2.0f, 12.0f, 2.0f);
        pathBuilderV.reflectiveCurveTo(2.0f, 6.48f, 2.0f, 12.0f);
