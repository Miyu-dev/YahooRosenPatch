...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_bedroomParent", "Landroidx/compose/ui/graphics/vector/ImageVector;", "BedroomParent", "Landroidx/compose/material/icons/Icons$Outlined;", "getBedroomParent", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-outlined_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class BedroomParentKt {
    ...
    public static final ImageVector getBedroomParent(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.BedroomParent", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m2844getBlack0d7_KjU(), null);
        int iM3141getButtKaPHkGw = StrokeCap.INSTANCE.m3141getButtKaPHkGw();
        int iM3151getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3151getBevelLxFBmk8();
        PathBuilder pathBuilderN = s.n(18.35f, 11.45f, 9.0f);
        pathBuilderN.curveToRelative(0.0f, -1.1f, -0.9f, -2.0f, -2.0f, -2.0f);
        pathBuilderN.horizontalLineTo(13.0f);
        pathBuilderN.curveToRelative(-0.37f, 0.0f, -0.72f, 0.12f, -1.0f, 0.32f);
        pathBuilderN.curveTo(11.72f, 7.12f, 11.37f, 7.0f, 11.0f, 7.0f);
        pathBuilderN.horizontalLineTo(7.65f);
        pathBuilderN.curveToRelative(-1.1f, 0.0f, -2.0f, 0.9f, -2.0f, 2.0f);
        pathBuilderN.verticalLineToRelative(2.45f);
        pathBuilderN.curveTo(5.25f, 11.91f, 5.0f, 12.51f, 5.0f, 13.17f);
        s.y(pathBuilderN, 17.0f, 1.5f, -1.5f, 11.0f);
        a.o(pathBuilderN, 17.0f, 19.0f, -3.83f);
        pathBuilderN.curveTo(19.0f, 12.51f, 18.75f, 11.91f, 18.35f, 11.45f);
        b.r(pathBuilderN, 16.75f, 10.5f, -4.0f, -2.0f);
        a.b.m(pathBuilderN, 4.0f, 10.5f, 7.25f, 8.5f);
        androidx.compose.animation.a.B(pathBuilderN, 4.0f, 2.0f, -4.0f, 8.5f);
        androidx.appcompat.view.menu.a.x(pathBuilderN, 17.5f, 14.0f, -11.0f, -1.0f);
        pathBuilderN.curveToRelative(0.0f, -0.55f, 0.45f, -1.0f, 1.0f, -1.0f);
        pathBuilderN.horizontalLineToRelative(9.0f);
        pathBuilderN.curveToRelative(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        b.l(pathBuilderN, 14.0f, 20.0f, 4.0f, 16.0f);
