...
public final class DirectionsBikeKt {
    ...
    public static final ImageVector getDirectionsBike(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.DirectionsBike", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderD.lineTo(6.31f, 9.9f);
