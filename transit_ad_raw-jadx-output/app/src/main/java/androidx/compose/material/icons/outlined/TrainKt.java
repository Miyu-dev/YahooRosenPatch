...
public final class TrainKt {
    ...
    public static final ImageVector getTrain(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.Train", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderD.lineTo(6.43f, 5.0f);
        ...
        android.support.v4.media.a.C(pathBuilderD, 6.0f, 10.0f, 6.0f, 7.0f);
        ...
        s.w(pathBuilderD, 6.0f, 12.0f, 12.0f, 3.5f);
        pathBuilderD.moveTo(18.0f, 10.0f);
        androidx.appcompat.view.menu.a.y(pathBuilderD, -5.0f, 13.0f, 7.0f, 5.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, androidx.appcompat.view.menu.a.h(pathBuilderD, 3.0f), defaultFillType3, "", solidColor3, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw3, iM3151getBevelLxFBmk83, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
