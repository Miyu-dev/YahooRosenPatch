...
public final class CompressKt {
    ...
    public static final ImageVector getCompress(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Compress", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderA = b.a(4.0f, 10.0f, 4.0f, 10.0f);
        ...
        pathBuilderA.curveTo(4.45f, 9.0f, 4.0f, 9.45f, 4.0f, 10.0f);
        pathBuilderA.close();
        ...
        PathBuilder pathBuilderF = androidx.appcompat.app.m.f(9.21f, 19.0f, 11.0f, 2.0f);
        ...
        pathBuilderF.horizontalLineToRelative(1.79f);
        pathBuilderF.curveToRelative(0.45f, 0.0f, 0.67f, -0.54f, 0.35f, -0.85f);
        pathBuilderF.lineToRelative(-2.79f, -2.79f);
        pathBuilderF.curveToRelative(-0.2f, -0.2f, -0.51f, -0.2f, -0.71f, 0.0f);
        pathBuilderF.lineToRelative(-2.79f, 2.79f);
        pathBuilderF.curveTo(8.54f, 18.46f, 8.76f, 19.0f, 9.21f, 19.0f);
        pathBuilderF.close();
        ...
        PathBuilder pathBuilderB2 = h.b(5.0f, 14.0f, 14.0f);
        ...
        pathBuilderB2.curveToRelative(-0.55f, 0.0f, -1.0f, 0.45f, -1.0f, 1.0f);
        pathBuilderB2.verticalLineToRelative(0.0f);
        pathBuilderB2.curveTo(4.0f, 13.55f, 4.45f, 14.0f, 5.0f, 14.0f);
        pathBuilderB2.close();
