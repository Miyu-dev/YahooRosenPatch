...
public final class BluetoothSearchingKt {
    ...
    public static final ImageVector getBluetoothSearching(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.BluetoothSearching", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
