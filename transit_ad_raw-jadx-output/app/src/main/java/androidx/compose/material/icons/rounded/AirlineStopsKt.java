...
public final class AirlineStopsKt {
    ...
    public static final ImageVector getAirlineStops(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.AirlineStops", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m2844getBlack0d7_KjU(), null);
        int iM3141getButtKaPHkGw = StrokeCap.INSTANCE.m3141getButtKaPHkGw();
        int iM3151getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3151getBevelLxFBmk8();
        PathBuilder pathBuilderD = a.d(15.0f, 18.0f);
        pathBuilderD.curveToRelative(0.0f, 0.55f, -0.45f, 1.0f, -1.0f, 1.0f);
        pathBuilderD.horizontalLineToRelative(-4.0f);
        pathBuilderD.curveToRelative(-0.55f, 0.0f, -1.0f, -0.45f, -1.0f, -1.0f);
        pathBuilderD.curveToRelative(0.0f, -0.55f, 0.45f, -1.0f, 1.0f, -1.0f);
        pathBuilderD.horizontalLineToRelative(1.0f);
        pathBuilderD.curveToRelative(-0.47f, -4.21f, -3.89f, -7.55f, -8.12f, -7.96f);
        pathBuilderD.curveTo(2.37f, 8.99f, 2.0f, 8.56f, 2.0f, 8.05f);
        pathBuilderD.curveToRelative(0.0f, -0.59f, 0.52f, -1.06f, 1.11f, -1.0f);
        pathBuilderD.curveTo(7.03f, 7.44f, 10.37f, 9.87f, 12.0f, 13.3f);
        pathBuilderD.curveToRelative(1.13f, -2.43f, 2.99f, -4.25f, 4.78f, -5.52f);
        pathBuilderD.lineToRelative(-1.92f, -1.92f);
        pathBuilderD.curveTo(14.54f, 5.54f, 14.76f, 5.0f, 15.21f, 5.0f);
        pathBuilderD.horizontalLineToRelative(5.29f);
        pathBuilderD.curveTo(20.78f, 5.0f, 21.0f, 5.22f, 21.0f, 5.5f);
        ...
        pathBuilderD.horizontalLineToRelative(1.0f);
        pathBuilderD.curveTo(14.55f, 17.0f, 15.0f, 17.45f, 15.0f, 18.0f);
        pathBuilderD.close();
