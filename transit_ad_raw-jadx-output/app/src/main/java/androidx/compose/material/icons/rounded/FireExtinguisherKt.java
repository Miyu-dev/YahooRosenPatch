...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_fireExtinguisher", "Landroidx/compose/ui/graphics/vector/ImageVector;", "FireExtinguisher", "Landroidx/compose/material/icons/Icons$Rounded;", "getFireExtinguisher", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class FireExtinguisherKt {
    ...
    public static final ImageVector getFireExtinguisher(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.FireExtinguisher", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderO.moveTo(17.0f, 4.23f);
        pathBuilderO.verticalLineToRelative(3.54f);
        pathBuilderO.curveToRelative(0.0f, 0.63f, -0.58f, 1.11f, -1.21f, 0.98f);
        pathBuilderO.lineToRelative(-1.94f, -0.41f);
        pathBuilderO.curveToRelative(0.0f, 0.02f, 0.0f, 0.01f, -0.01f, 0.03f);
        pathBuilderO.curveToRelative(1.54f, 0.62f, 2.71f, 1.98f, 3.06f, 3.63f);
        ...
        pathBuilderO.lineTo(5.49f, 6.6f);
        pathBuilderO.curveTo(5.2f, 6.54f, 5.0f, 6.29f, 5.0f, 6.0f);
        pathBuilderO.verticalLineToRelative(0.0f);
        pathBuilderO.curveToRelative(0.0f, -0.29f, 0.2f, -0.54f, 0.49f, -0.6f);
        pathBuilderO.lineToRelative(3.88f, -0.81f);
        pathBuilderO.curveTo(9.87f, 3.65f, 10.86f, 3.0f, 12.0f, 3.0f);
        pathBuilderO.curveToRelative(0.7f, 0.0f, 1.34f, 0.25f, 1.85f, 0.66f);
        pathBuilderO.lineToRelative(1.94f, -0.41f);
        pathBuilderO.curveTo(16.42f, 3.12f, 17.0f, 3.6f, 17.0f, 4.23f);
        pathBuilderO.close();
        pathBuilderO.moveTo(13.0f, 6.0f);
