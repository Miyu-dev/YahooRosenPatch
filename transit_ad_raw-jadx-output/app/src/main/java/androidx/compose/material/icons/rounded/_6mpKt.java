...
public final class _6mpKt {
    ...
    public static final ImageVector get_6mp(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded._6mp", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderB.curveTo(14.5f, 6.66f, 14.16f, 7.0f, 13.75f, 7.0f);
        ...
        pathBuilderB.curveToRelative(-0.55f, 0.0f, -1.0f, -0.45f, -1.0f, -1.0f);
        android.support.v4.media.a.y(pathBuilderB, 6.5f, 12.5f, 17.75f);
