...
public final class FilePresentKt {
    ...
    public static final ImageVector getFilePresent(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.FilePresent", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderB.close();
        pathBuilderB.moveTo(16.0f, 15.0f);
        pathBuilderB.curveToRelative(0.0f, 2.34f, -2.01f, 4.21f, -4.39f, 3.98f);
        pathBuilderB.curveTo(9.53f, 18.78f, 8.0f, 16.92f, 8.0f, 14.83f);
        pathBuilderB.lineToRelative(0.0f, -5.19f);
        pathBuilderB.curveToRelative(0.0f, -1.31f, 0.94f, -2.5f, 2.24f, -2.63f);
        pathBuilderB.curveTo(11.74f, 6.86f, 13.0f, 8.03f, 13.0f, 9.5f);
        ...
        pathBuilderB.curveTo(11.0f, 9.22f, 10.78f, 9.0f, 10.5f, 9.0f);
        pathBuilderB.reflectiveCurveTo(10.0f, 9.22f, 10.0f, 9.5f);
        pathBuilderB.verticalLineToRelative(5.39f);
        pathBuilderB.curveToRelative(0.0f, 1.0f, 0.68f, 1.92f, 1.66f, 2.08f);
        pathBuilderB.curveTo(12.92f, 17.18f, 14.0f, 16.21f, 14.0f, 15.0f);
        pathBuilderB.verticalLineToRelative(-3.0f);
        pathBuilderB.curveToRelative(0.0f, -0.55f, 0.45f, -1.0f, 1.0f, -1.0f);
        pathBuilderB.horizontalLineToRelative(0.0f);
        pathBuilderB.curveToRelative(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        b.g(pathBuilderB, 15.0f, 14.0f, 7.0f, 4.0f);
        pathBuilderB.lineToRelative(4.0f, 4.0f);
        pathBuilderB.horizontalLineToRelative(-3.0f);
        pathBuilderB.curveTo(14.45f, 8.0f, 14.0f, 7.55f, 14.0f, 7.0f);
        pathBuilderB.close();
