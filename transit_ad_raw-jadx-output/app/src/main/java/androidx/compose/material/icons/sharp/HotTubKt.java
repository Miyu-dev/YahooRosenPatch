...
public final class HotTubKt {
    ...
    public static final ImageVector getHotTub(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.HotTub", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        b.s(pathBuilderD, 2.0f, 12.0f, 10.0f, 20.0f);
        android.support.v4.media.a.C(pathBuilderD, 22.0f, 12.0f, 11.15f, 12.0f);
