...
public final class ElectricCarKt {
    ...
    public static final ImageVector getElectricCar(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.ElectricCar", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderQ = a.q(5.0f, 13.0f, 14.0f, 8.0f, 5.0f);
        a.y(pathBuilderQ, 13.0f, 16.5f, 9.0f);
        pathBuilderQ.curveToRelative(0.83f, 0.0f, 1.5f, 0.67f, 1.5f, 1.5f);
        pathBuilderQ.curveToRelative(0.0f, 0.83f, -0.67f, 1.5f, -1.5f, 1.5f);
        pathBuilderQ.reflectiveCurveTo(15.0f, 11.33f, 15.0f, 10.5f);
        pathBuilderQ.curveTo(15.0f, 9.67f, 15.67f, 9.0f, 16.5f, 9.0f);
        pathBuilderQ.close();
        pathBuilderQ.moveTo(7.5f, 9.0f);
        pathBuilderQ.curveTo(8.33f, 9.0f, 9.0f, 9.67f, 9.0f, 10.5f);
        pathBuilderQ.curveTo(9.0f, 11.33f, 8.33f, 12.0f, 7.5f, 12.0f);
        pathBuilderQ.reflectiveCurveTo(6.0f, 11.33f, 6.0f, 10.5f);
        pathBuilderQ.curveTo(6.0f, 9.67f, 6.67f, 9.0f, 7.5f, 9.0f);
        pathBuilderQ.close();
        ...
        PathBuilder pathBuilderD = androidx.browser.browseractions.a.d(18.92f, 2.01f);
        ...
        pathBuilderD.horizontalLineToRelative(1.0f);
        pathBuilderD.curveToRelative(0.55f, 0.0f, 1.0f, -0.45f, 1.0f, -1.0f);
        h.u(pathBuilderD, 8.0f, 18.92f, 2.01f);
        pathBuilderD.moveTo(6.85f, 3.0f);
        androidx.compose.animation.a.C(pathBuilderD, 10.29f, 1.08f, 3.11f, 5.77f);
        androidx.appcompat.view.menu.a.z(pathBuilderD, 6.85f, 3.0f, 19.0f, 13.0f);
        ImageVector.Builder.m3359addPathoIyEayM$default(builder, g.e(pathBuilderD, 5.0f, 8.0f, 14.0f, 13.0f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw2, iM3151getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        int defaultFillType3 = VectorKt.getDefaultFillType();
        SolidColor solidColor3 = new SolidColor(companion.m2844getBlack0d7_KjU(), null);
        int iM3141getButtKaPHkGw3 = companion2.m3141getButtKaPHkGw();
        int iM3151getBevelLxFBmk83 = companion3.m3151getBevelLxFBmk8();
        PathBuilder pathBuilderB = v.b(7.5f, 10.5f, -1.5f, 0.0f);
        ...
        PathBuilder pathBuilderB2 = v.b(16.5f, 10.5f, -1.5f, 0.0f);
        ...
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, androidx.appcompat.graphics.drawable.a.e(pathBuilderA, -4.0f, 0.0f, 0.0f, 2.0f), defaultFillType5, "", solidColor5, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw5, iM3151getBevelLxFBmk85, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
