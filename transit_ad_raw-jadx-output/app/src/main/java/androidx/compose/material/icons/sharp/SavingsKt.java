...
public final class SavingsKt {
    ...
    public static final ImageVector getSavings(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.Savings", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderA.curveToRelative(0.23f, -0.56f, 0.56f, -1.06f, 0.97f, -1.5f);
        pathBuilderA.curveTo(18.15f, 2.21f, 17.35f, 2.0f, 16.5f, 2.0f);
