...
public final class SettingsRemoteKt {
    ...
    public static final ImageVector getSettingsRemote(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.SettingsRemote", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderA.curveToRelative(0.0f, -0.55f, -0.45f, -1.0f, -1.0f, -1.0f);
        a.j(pathBuilderA, 14.0f, 21.0f, -4.0f);
        ImageVector.Builder.m3359addPathoIyEayM$default(builder, b.k(pathBuilderA, 10.0f, 11.0f, 4.0f, 10.0f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw, iM3151getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
