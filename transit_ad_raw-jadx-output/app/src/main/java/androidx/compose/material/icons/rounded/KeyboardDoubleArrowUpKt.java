...
public final class KeyboardDoubleArrowUpKt {
    ...
    public static final ImageVector getKeyboardDoubleArrowUp(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.KeyboardDoubleArrowUp", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderA = b.a(6.7f, 18.29f, 6.7f, 18.29f);
        ...
        pathBuilderA.curveToRelative(-0.39f, -0.39f, -1.02f, -0.39f, -1.41f, 0.0f);
        pathBuilderA.lineTo(6.7f, 16.88f);
        pathBuilderA.curveTo(6.31f, 17.27f, 6.31f, 17.9f, 6.7f, 18.29f);
        pathBuilderA.close();
        ...
        PathBuilder pathBuilderA2 = b.a(6.7f, 11.7f, 6.7f, 11.7f);
        pathBuilderA2.curveToRelative(0.39f, 0.39f, 1.02f, 0.39f, 1.41f, 0.0f);
        pathBuilderA2.lineTo(12.0f, 7.83f);
        ...
        pathBuilderA2.curveToRelative(-0.39f, -0.39f, -1.02f, -0.39f, -1.41f, 0.0f);
        pathBuilderA2.lineTo(6.7f, 10.29f);
        pathBuilderA2.curveTo(6.31f, 10.68f, 6.31f, 11.31f, 6.7f, 11.7f);
        pathBuilderA2.close();
