...
public final class AirlineSeatReclineNormalKt {
    ...
    public static final ImageVector getAirlineSeatReclineNormal(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.AirlineSeatReclineNormal", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
