...
public final class GifKt {
    ...
    public static final ImageVector getGif(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Gif", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m2844getBlack0d7_KjU(), null);
        int iM3141getButtKaPHkGw = StrokeCap.INSTANCE.m3141getButtKaPHkGw();
        int iM3151getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3151getBevelLxFBmk8();
        PathBuilder pathBuilderD = a.d(12.25f, 9.0f);
        ...
        pathBuilderD.curveToRelative(0.0f, -0.41f, 0.34f, -0.75f, 0.75f, -0.75f);
        pathBuilderD.close();
        pathBuilderD.moveTo(10.0f, 9.75f);
        pathBuilderD.curveToRelative(0.0f, -0.41f, -0.34f, -0.75f, -0.75f, -0.75f);
        ...
        pathBuilderD.curveToRelative(0.0f, -0.41f, -0.34f, -0.75f, -0.75f, -0.75f);
        pathBuilderD.reflectiveCurveToRelative(-0.75f, 0.34f, -0.75f, 0.75f);
        a.l(pathBuilderD, 0.75f, -2.0f, -3.0f, 2.75f);
        pathBuilderD.curveToRelative(0.41f, 0.0f, 0.75f, -0.34f, 0.75f, -0.75f);
        pathBuilderD.close();
        pathBuilderD.moveTo(19.0f, 9.75f);
        pathBuilderD.curveToRelative(0.0f, -0.41f, -0.34f, -0.75f, -0.75f, -0.75f);
        pathBuilderD.lineTo(15.5f, 9.0f);
        ...
        b.s(pathBuilderD, 16.0f, 11.5f, -1.0f, 2.25f);
        pathBuilderD.curveToRelative(0.41f, 0.0f, 0.75f, -0.34f, 0.75f, -0.75f);
        pathBuilderD.close();
