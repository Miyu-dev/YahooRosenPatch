...
public final class MobileScreenShareKt {
    ...
    public static final ImageVector getMobileScreenShare(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.MobileScreenShare", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderA.verticalLineToRelative(-18.0f);
        pathBuilderA.curveTo(19.0f, 1.85f, 18.1f, 1.0f, 17.0f, 1.0f);
