...
public final class GridOffKt {
    ...
    public static final ImageVector getGridOff(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.GridOff", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderB.verticalLineToRelative(0.89f);
        pathBuilderB.lineToRelative(2.0f, 2.0f);
        pathBuilderB.lineTo(22.0f, 2.0f);
        ...
        pathBuilderB.horizontalLineToRelative(17.45f);
