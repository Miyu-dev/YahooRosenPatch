...
public final class NetworkWifi3BarKt {
    ...
    public static final ImageVector getNetworkWifi3Bar(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.NetworkWifi3Bar", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
