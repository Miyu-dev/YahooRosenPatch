...
public final class AccessTimeFilledKt {
    ...
    public static final ImageVector getAccessTimeFilled(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.AccessTimeFilled", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderD.curveTo(11.11f, 12.52f, 11.0f, 12.27f, 11.0f, 12.0f);
        ...
        pathBuilderD.curveTo(16.39f, 14.98f, 16.39f, 15.61f, 16.0f, 16.0f);
        pathBuilderD.close();
