...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_bedtimeOff", "Landroidx/compose/ui/graphics/vector/ImageVector;", "BedtimeOff", "Landroidx/compose/material/icons/Icons$Rounded;", "getBedtimeOff", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class BedtimeOffKt {
    ...
    public static final ImageVector getBedtimeOff(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.BedtimeOff", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderD = a.d(11.65f, 3.46f);
        pathBuilderD.curveToRelative(0.27f, -0.71f, -0.36f, -1.45f, -1.12f, -1.34f);
        pathBuilderD.curveTo(9.05f, 2.33f, 7.68f, 2.88f, 6.49f, 3.66f);
        pathBuilderD.lineToRelative(4.59f, 4.59f);
        pathBuilderD.curveTo(10.88f, 6.69f, 11.04f, 5.05f, 11.65f, 3.46f);
        pathBuilderD.close();
        ...
        pathBuilderA.curveToRelative(-1.4f, 2.11f, -2.02f, 4.77f, -1.46f, 7.56f);
        pathBuilderA.curveToRelative(0.79f, 3.94f, 3.99f, 7.07f, 7.94f, 7.78f);
        pathBuilderA.curveToRelative(2.74f, 0.49f, 5.3f, -0.15f, 7.35f, -1.51f);
