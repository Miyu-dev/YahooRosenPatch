...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_stairs", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Stairs", "Landroidx/compose/material/icons/Icons$Outlined;", "getStairs", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-outlined_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class StairsKt {
    ...
    public static final ImageVector getStairs(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.Stairs", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        androidx.appcompat.view.menu.a.z(pathBuilderU, 19.0f, 3.0f, 18.0f, 6.0f);
        androidx.appcompat.app.m.x(pathBuilderU, -4.42f, 3.33f, 11.0f, 3.33f);
        androidx.compose.animation.a.v(pathBuilderU, 8.42f, 16.0f, 6.0f, 2.0f);
        androidx.appcompat.app.m.x(pathBuilderU, 4.42f, -3.33f, 13.0f, -3.33f);
        pathBuilderU.horizontalLineToRelative(2.58f);
