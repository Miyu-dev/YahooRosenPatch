...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_settingsVoice", "Landroidx/compose/ui/graphics/vector/ImageVector;", "SettingsVoice", "Landroidx/compose/material/icons/Icons$TwoTone;", "getSettingsVoice", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class SettingsVoiceKt {
    ...
    public static final ImageVector getSettingsVoice(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.SettingsVoice", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderD.curveToRelative(0.56f, 0.0f, 0.99f, -0.44f, 0.99f, -1.0f);
        ...
        androidx.appcompat.view.menu.a.z(pathBuilderO, 7.0f, 24.0f, 12.0f, 13.0f);
        ...
        androidx.appcompat.view.menu.a.z(pathBuilderO, 11.0f, 4.0f, 11.0f, 22.0f);
        androidx.compose.animation.b.t(pathBuilderO, 2.0f, 2.0f, -2.0f);
        androidx.appcompat.view.menu.a.x(pathBuilderO, 15.0f, 22.0f, 2.0f, 2.0f);
        androidx.appcompat.view.menu.a.w(pathBuilderO, -2.0f, 19.0f, 10.0f, -1.7f);
