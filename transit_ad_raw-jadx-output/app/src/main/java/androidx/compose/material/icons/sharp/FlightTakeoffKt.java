...
public final class FlightTakeoffKt {
    ...
    public static final ImageVector getFlightTakeoff(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.FlightTakeoff", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderF.lineToRelative(1.82f, 3.16f);
        pathBuilderF.lineToRelative(0.77f, 1.33f);
