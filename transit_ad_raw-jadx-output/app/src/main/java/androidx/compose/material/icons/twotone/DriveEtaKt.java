...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_driveEta", "Landroidx/compose/ui/graphics/vector/ImageVector;", "DriveEta", "Landroidx/compose/material/icons/Icons$TwoTone;", "getDriveEta", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class DriveEtaKt {
    ...
    public static final ImageVector getDriveEta(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.DriveEta", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderA = b.a(5.12f, 11.0f, -0.12f, 0.34f);
        a.o(pathBuilderA, 5.0f, 16.0f, 14.0f, -4.66f);
        s.r(pathBuilderA, -0.12f, -0.34f, 5.12f, 11.0f);
        ...
        pathBuilderA.reflectiveCurveTo(8.33f, 15.0f, 7.5f, 15.0f);
        pathBuilderA.close();
        pathBuilderA.moveTo(16.5f, 15.0f);
        pathBuilderA.curveToRelative(-0.83f, 0.0f, -1.5f, -0.67f, -1.5f, -1.5f);
        ...
        PathBuilder pathBuilderD = androidx.browser.browseractions.a.d(18.92f, 5.01f);
        ...
        pathBuilderD.moveTo(6.85f, 6.0f);
        a.C(pathBuilderD, 10.29f, 1.04f, 3.0f, 5.81f);
        android.support.v4.media.a.t(pathBuilderD, 1.04f, -3.0f, 19.0f, 16.0f);
        a.z(pathBuilderD, 5.0f, -4.66f, 0.12f, -0.34f);
        pathBuilderD.horizontalLineToRelative(13.77f);
        pathBuilderD.lineToRelative(0.11f, 0.34f);
        ...
        PathBuilder pathBuilderB = v.b(7.5f, 13.5f, -1.5f, 0.0f);
        ...
        PathBuilder pathBuilderB2 = v.b(16.5f, 13.5f, -1.5f, 0.0f);
