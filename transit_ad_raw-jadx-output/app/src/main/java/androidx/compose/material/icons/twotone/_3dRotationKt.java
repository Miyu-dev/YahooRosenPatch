...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"__3dRotation", "Landroidx/compose/ui/graphics/vector/ImageVector;", "_3dRotation", "Landroidx/compose/material/icons/Icons$TwoTone;", "get_3dRotation", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class _3dRotationKt {
    ...
    public static final ImageVector get_3dRotation(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone._3dRotation", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m2844getBlack0d7_KjU(), null);
        int iM3141getButtKaPHkGw = StrokeCap.INSTANCE.m3141getButtKaPHkGw();
        int iM3151getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3151getBevelLxFBmk8();
        PathBuilder pathBuilderD = a.d(7.53f, 21.48f);
        pathBuilderD.curveTo(4.26f, 19.94f, 1.92f, 16.76f, 1.56f, 13.0f);
        pathBuilderD.lineTo(0.06f, 13.0f);
        ...
        pathBuilderD.moveTo(8.42f, 14.96f);
        ...
        pathBuilderD.curveTo(9.11f, 8.05f, 8.77f, 8.0f, 8.4f, 8.0f);
        ...
        android.support.v4.media.a.s(pathBuilderD, -0.77f, 1.03f, 0.77f);
        ...
        pathBuilderD.close();
        pathBuilderD.moveTo(16.97f, 9.04f);
        pathBuilderD.curveToRelative(-0.32f, -0.33f, -0.7f, -0.59f, -1.14f, -0.77f);
        pathBuilderD.curveToRelative(-0.44f, -0.18f, -0.93f, -0.27f, -1.47f, -0.27f);
        ...
        pathBuilderD.reflectiveCurveToRelative(-0.42f, -0.87f, -0.74f, -1.2f);
        pathBuilderD.close();
        ...
        androidx.appcompat.view.menu.a.y(pathBuilderD, -0.91f, 13.4f, 9.12f, 0.97f);
        ...
        android.support.v4.media.a.v(pathBuilderD, 0.4f, 12.01f, 0.0f);
        pathBuilderD.lineToRelative(-0.66f, 0.03f);
        ...
        pathBuilderD.curveTo(23.45f, 4.84f, 18.3f, 0.0f, 12.01f, 0.0f);
        pathBuilderD.close();
