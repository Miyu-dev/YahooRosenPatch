...
public final class PriceCheckKt {
    ...
    public static final ImageVector getPriceCheck(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.PriceCheck", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderN = s.n(12.0f, 13.0f, 9.0f);
        ...
        s.t(pathBuilderN, 9.5f, 3.0f, -2.0f, 1.0f);
        pathBuilderN.horizontalLineTo(6.0f);
        pathBuilderN.curveTo(5.45f, 4.0f, 5.0f, 4.45f, 5.0f, 5.0f);
        pathBuilderN.verticalLineToRelative(4.0f);
        pathBuilderN.curveToRelative(0.0f, 0.55f, 0.45f, 1.0f, 1.0f, 1.0f);
        androidx.appcompat.app.m.x(pathBuilderN, 4.0f, 2.0f, 5.0f, 2.0f);
        a.t(pathBuilderN, 2.5f, 1.0f, 2.0f, -1.0f);
        pathBuilderN.horizontalLineTo(11.0f);
        pathBuilderN.curveTo(11.55f, 14.0f, 12.0f, 13.55f, 12.0f, 13.0f);
        pathBuilderN.close();
