...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_systemUpdateAlt", "Landroidx/compose/ui/graphics/vector/ImageVector;", "SystemUpdateAlt", "Landroidx/compose/material/icons/Icons$Sharp;", "getSystemUpdateAlt", "(Landroidx/compose/material/icons/Icons$Sharp;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-sharp_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class SystemUpdateAltKt {
    ...
    public static final ImageVector getSystemUpdateAlt(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.SystemUpdateAlt", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        a.A(pathBuilderP, 8.0f, 12.0f, 4.0f, 4.0f);
        androidx.appcompat.view.menu.a.x(pathBuilderP, 23.0f, 3.0f, -8.0f, 1.99f);
        android.support.v4.media.a.w(pathBuilderP, 6.0f, 14.03f, 3.0f, 19.02f);
        pathBuilderP.lineTo(3.0f, 4.99f);
        pathBuilderP.horizontalLineToRelative(6.0f);
        pathBuilderP.lineTo(9.0f, 3.0f);
        b.s(pathBuilderP, 1.0f, 3.0f, 18.0f, 22.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, androidx.compose.animation.b.h(pathBuilderP, 23.0f, 3.0f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw, iM3151getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
