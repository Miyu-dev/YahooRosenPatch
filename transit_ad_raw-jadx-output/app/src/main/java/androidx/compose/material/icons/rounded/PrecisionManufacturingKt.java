...
public final class PrecisionManufacturingKt {
    ...
    public static final ImageVector getPrecisionManufacturing(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.PrecisionManufacturing", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderA.curveTo(8.34f, 4.66f, 6.96f, 3.75f, 5.4f, 4.06f);
        pathBuilderA.curveTo(4.23f, 4.29f, 3.27f, 5.25f, 3.05f, 6.42f);
        pathBuilderA.curveTo(2.8f, 7.76f, 3.45f, 8.96f, 4.48f, 9.58f);
        pathBuilderA.lineTo(7.08f, 18.0f);
        pathBuilderA.horizontalLineTo(5.5f);
        pathBuilderA.curveTo(4.67f, 18.0f, 4.0f, 18.67f, 4.0f, 19.5f);
        pathBuilderA.verticalLineToRelative(0.0f);
        pathBuilderA.curveTo(4.0f, 20.33f, 4.67f, 21.0f, 5.5f, 21.0f);
