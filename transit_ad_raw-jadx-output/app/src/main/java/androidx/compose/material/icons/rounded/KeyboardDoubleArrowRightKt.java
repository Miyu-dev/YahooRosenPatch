...
public final class KeyboardDoubleArrowRightKt {
    ...
    public static final ImageVector getKeyboardDoubleArrowRight(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.KeyboardDoubleArrowRight", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderA = b.a(5.7f, 6.71f, 5.7f, 6.71f);
        pathBuilderA.curveToRelative(-0.39f, 0.39f, -0.39f, 1.02f, 0.0f, 1.41f);
        pathBuilderA.lineTo(9.58f, 12.0f);
        pathBuilderA.lineTo(5.7f, 15.88f);
        pathBuilderA.curveToRelative(-0.39f, 0.39f, -0.39f, 1.02f, 0.0f, 1.41f);
        pathBuilderA.lineToRelative(0.0f, 0.0f);
        pathBuilderA.curveToRelative(0.39f, 0.39f, 1.02f, 0.39f, 1.41f, 0.0f);
        pathBuilderA.lineToRelative(4.59f, -4.59f);
        pathBuilderA.curveToRelative(0.39f, -0.39f, 0.39f, -1.02f, 0.0f, -1.41f);
        pathBuilderA.lineTo(7.12f, 6.71f);
        pathBuilderA.curveTo(6.73f, 6.32f, 6.09f, 6.32f, 5.7f, 6.71f);
        pathBuilderA.close();
        ...
        PathBuilder pathBuilderA2 = b.a(12.29f, 6.71f, 12.29f, 6.71f);
        pathBuilderA2.curveToRelative(-0.39f, 0.39f, -0.39f, 1.02f, 0.0f, 1.41f);
        pathBuilderA2.lineTo(16.17f, 12.0f);
        ...
        pathBuilderA2.curveToRelative(0.39f, -0.39f, 0.39f, -1.02f, 0.0f, -1.41f);
        pathBuilderA2.lineToRelative(-4.59f, -4.59f);
        pathBuilderA2.curveTo(13.32f, 6.32f, 12.68f, 6.32f, 12.29f, 6.71f);
        pathBuilderA2.close();
