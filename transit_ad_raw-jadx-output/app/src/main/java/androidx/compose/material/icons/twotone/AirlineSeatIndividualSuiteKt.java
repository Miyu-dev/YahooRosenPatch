...
public final class AirlineSeatIndividualSuiteKt {
    ...
    public static final ImageVector getAirlineSeatIndividualSuite(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.AirlineSeatIndividualSuite", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
