...
public final class NoEncryptionKt {
    ...
    public static final ImageVector getNoEncryption(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.NoEncryption", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m2844getBlack0d7_KjU(), null);
        int iM3141getButtKaPHkGw = StrokeCap.INSTANCE.m3141getButtKaPHkGw();
        int iM3151getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3151getBevelLxFBmk8();
        PathBuilder pathBuilderA = b.a(21.0f, 21.78f, 4.22f, 5.0f);
        ...
        pathBuilderA.curveToRelative(0.23f, 0.0f, 0.45f, -0.05f, 0.66f, -0.12f);
        a.C(pathBuilderA, 19.78f, 23.0f, 21.0f, 21.78f);
        ...
        pathBuilderA.horizontalLineTo(9.66f);
        pathBuilderA.lineTo(20.0f, 18.34f);
        ...
        pathBuilderA.curveToRelative(-2.56f, 0.0f, -4.64f, 1.93f, -4.94f, 4.4f);
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, s.i(pathBuilderA, 8.9f, 7.24f, 6.0f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw, iM3151getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
