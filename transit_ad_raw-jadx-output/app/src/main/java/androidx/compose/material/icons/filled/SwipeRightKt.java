...
public final class SwipeRightKt {
    ...
    public static final ImageVector getSwipeRight(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.SwipeRight", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        a.w(pathBuilderA, 19.91f, 5.5f, 17.0f, 7.0f);
        androidx.appcompat.app.m.w(pathBuilderA, 5.0f, 2.0f, -1.5f, 2.02f);
        pathBuilderA.curveTo(18.18f, 2.13f, 15.22f, 1.0f, 12.0f, 1.0f);
        pathBuilderA.curveTo(6.51f, 1.0f, 2.73f, 4.12f, 2.0f, 7.0f);
        pathBuilderA.horizontalLineToRelative(1.57f);
        pathBuilderA.curveTo(4.33f, 5.02f, 7.26f, 2.5f, 12.0f, 2.5f);
        pathBuilderA.curveTo(15.03f, 2.5f, 17.79f, 3.64f, 19.91f, 5.5f);
        pathBuilderA.close();
