...
public final class PhotoCameraFrontKt {
    ...
    public static final ImageVector getPhotoCameraFront(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.PhotoCameraFront", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        androidx.browser.browseractions.a.q(pathBuilderA, 16.0f, 17.0f, 8.0f, -0.57f);
