...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_luggage", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Luggage", "Landroidx/compose/material/icons/Icons$TwoTone;", "getLuggage", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class LuggageKt {
    ...
    public static final ImageVector getLuggage(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.Luggage", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderV = s.v(7.0f, 8.0f, 11.0f, 10.0f, 8.0f);
        h.r(pathBuilderV, 7.0f, 9.5f, 18.0f, 8.0f);
        a.v(pathBuilderV, 9.0f, 1.5f, 18.0f);
        androidx.browser.browseractions.a.A(pathBuilderV, 12.75f, 18.0f, -1.5f, 9.0f);
        b.m(pathBuilderV, 1.5f, 18.0f, 16.0f, 18.0f);
        pathBuilderV.horizontalLineToRelative(-1.5f);
        pathBuilderV.verticalLineTo(9.0f);
        pathBuilderV.horizontalLineTo(16.0f);
        pathBuilderV.verticalLineTo(18.0f);
        pathBuilderV.close();
        ...
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, g.e(pathBuilderG, 7.0f, 8.0f, 10.0f, 19.0f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw2, iM3151getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
