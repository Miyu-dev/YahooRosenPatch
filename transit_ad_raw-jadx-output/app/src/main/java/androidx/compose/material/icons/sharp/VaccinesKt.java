...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_vaccines", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Vaccines", "Landroidx/compose/material/icons/Icons$Sharp;", "getVaccines", "(Landroidx/compose/material/icons/Icons$Sharp;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-sharp_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class VaccinesKt {
    ...
    public static final ImageVector getVaccines(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.Vaccines", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m2844getBlack0d7_KjU(), null);
        int iM3141getButtKaPHkGw = StrokeCap.INSTANCE.m3141getButtKaPHkGw();
        int iM3151getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3151getBevelLxFBmk8();
        PathBuilder pathBuilderG = androidx.appcompat.app.m.g(12.0f, 5.5f, 8.0f, 4.0f, 1.5f);
        v.C(pathBuilderG, 2.0f, -5.0f, 2.0f, 6.0f);
        v.z(pathBuilderG, 1.5f, 2.0f, 2.0f);
        pathBuilderG.curveToRelative(0.0f, 0.0f, 0.45f, 0.0f, 1.0f, 0.0f);
        v.r(pathBuilderG, 17.0f, 3.0f, 4.0f);
        s.D(pathBuilderG, 2.0f, 1.5f, 17.0f, 3.0f);
        pathBuilderG.verticalLineTo(7.5f);
        pathBuilderG.curveToRelative(0.55f, 0.0f, 1.0f, 0.0f, 1.0f, 0.0f);
        a.y(pathBuilderG, 5.5f, 9.0f, 9.0f, 6.5f);
        c.a.h(pathBuilderG, 1.5f, 9.0f, 12.0f, 6.5f);
        pathBuilderG.verticalLineToRelative(1.5f);
        pathBuilderG.horizontalLineTo(9.0f);
        pathBuilderG.lineTo(9.0f, 15.0f);
        h.x(pathBuilderG, 5.0f, 7.5f, 4.0f, 9.0f);
        h.D(pathBuilderG, 19.5f, 10.5f, 10.0f, 1.0f);
        androidx.appcompat.app.m.u(pathBuilderG, 8.0f, -7.0f, -0.01f, 2.0f);
        pathBuilderG.horizontalLineToRelative(1.01f);
        pathBuilderG.verticalLineToRelative(0.5f);
        pathBuilderG.curveToRelative(0.0f, 0.5f, -1.5f, 1.16f, -1.5f, 3.0f);
        v.r(pathBuilderG, 22.0f, 8.0f, -8.5f);
