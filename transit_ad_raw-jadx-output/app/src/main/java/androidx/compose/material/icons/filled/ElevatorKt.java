...
public final class ElevatorKt {
    ...
    public static final ImageVector getElevator(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.Elevator", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        b.r(pathBuilderB, 11.0f, 14.0f, -1.0f, 4.0f);
        s.B(pathBuilderB, 7.0f, -4.0f, 6.0f, -2.5f);
        pathBuilderB.curveToRelative(0.0f, -1.1f, 0.9f, -2.0f, 2.0f, -2.0f);
        pathBuilderB.horizontalLineToRelative(1.0f);
        pathBuilderB.curveToRelative(1.1f, 0.0f, 2.0f, 0.9f, 2.0f, 2.0f);
        a.y(pathBuilderB, 14.0f, 15.5f, 17.0f);
        pathBuilderB.lineTo(13.0f, 13.0f);
        androidx.appcompat.view.menu.a.s(pathBuilderB, 5.0f, 15.5f, 17.0f);
        pathBuilderB.moveTo(13.0f, 11.0f);
        pathBuilderB.lineToRelative(2.5f, -4.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, v.k(pathBuilderB, 2.5f, 4.0f, 13.0f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw, iM3151getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
