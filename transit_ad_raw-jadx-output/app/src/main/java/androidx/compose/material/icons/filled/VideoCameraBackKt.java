...
public final class VideoCameraBackKt {
    ...
    public static final ImageVector getVideoCameraBack(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.VideoCameraBack", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        androidx.appcompat.view.menu.a.z(pathBuilderN, 18.0f, 10.48f, 5.0f, 16.0f);
        pathBuilderN.lineToRelative(2.38f, -3.17f);
        pathBuilderN.lineTo(9.0f, 15.0f);
        pathBuilderN.lineToRelative(2.62f, -3.5f);
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, androidx.browser.browseractions.a.j(pathBuilderN, 15.0f, 16.0f, 5.0f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw, iM3151getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
