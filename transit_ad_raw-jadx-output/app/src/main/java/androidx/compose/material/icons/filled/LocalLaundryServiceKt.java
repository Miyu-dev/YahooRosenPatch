...
public final class LocalLaundryServiceKt {
    ...
    public static final ImageVector getLocalLaundryService(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.LocalLaundryService", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderD.curveToRelative(1.56f, -1.56f, 1.56f, -4.1f, 0.0f, -5.66f);
        android.support.v4.media.a.t(pathBuilderD, -5.66f, 5.66f, 18.0f, 2.01f);
        ...
        pathBuilderD.curveToRelative(0.0f, -1.11f, -0.89f, -1.99f, -2.0f, -1.99f);
        pathBuilderD.close();
