...
public final class AutoFixNormalKt {
    ...
    public static final ImageVector getAutoFixNormal(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.AutoFixNormal", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        androidx.browser.browseractions.a.y(pathBuilderA2, 5.83f, 19.59f, -1.41f, -1.41f);
        pathBuilderA2.lineTo(11.59f, 11.0f);
        android.support.v4.media.a.C(pathBuilderA2, 13.0f, 12.41f, 5.83f, 19.59f);
        pathBuilderA2.moveTo(14.41f, 11.0f);
        pathBuilderA2.lineTo(13.0f, 9.59f);
        pathBuilderA2.lineToRelative(1.17f, -1.17f);
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, h.p(pathBuilderA2, 1.41f, 1.41f, 14.41f, 11.0f), defaultFillType3, "", solidColor3, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw3, iM3151getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
