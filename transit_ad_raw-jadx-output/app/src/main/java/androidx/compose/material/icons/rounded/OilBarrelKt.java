...
public final class OilBarrelKt {
    ...
    public static final ImageVector getOilBarrel(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.OilBarrel", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderD.curveToRelative(0.0f, -1.16f, 0.41f, -1.58f, 2.24f, -3.68f);
        pathBuilderD.curveToRelative(0.4f, -0.46f, 1.12f, -0.46f, 1.51f, 0.0f);
        pathBuilderD.curveToRelative(1.82f, 2.09f, 2.24f, 2.52f, 2.24f, 3.68f);
