...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_thunderstorm", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Thunderstorm", "Landroidx/compose/material/icons/Icons$TwoTone;", "getThunderstorm", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class ThunderstormKt {
    ...
    public static final ImageVector getThunderstorm(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.Thunderstorm", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderA = b.a(17.73f, 9.01f, 16.2f, 8.87f);
        pathBuilderA.lineToRelative(-0.25f, -1.52f);
        pathBuilderA.curveTo(15.63f, 5.44f, 13.94f, 4.0f, 12.0f, 4.0f);
        pathBuilderA.curveToRelative(-1.44f, 0.0f, -2.77f, 0.78f, -3.48f, 2.04f);
        pathBuilderA.lineTo(8.03f, 6.91f);
        pathBuilderA.lineTo(7.04f, 7.04f);
        pathBuilderA.curveTo(5.31f, 7.27f, 4.0f, 8.76f, 4.0f, 10.5f);
        pathBuilderA.curveTo(4.0f, 12.43f, 5.57f, 14.0f, 7.5f, 14.0f);
        pathBuilderA.horizontalLineToRelative(10.0f);
        pathBuilderA.curveToRelative(1.38f, 0.0f, 2.5f, -1.12f, 2.5f, -2.5f);
        pathBuilderA.curveTo(20.0f, 10.22f, 19.01f, 9.13f, 17.73f, 9.01f);
        pathBuilderA.close();
        ...
        PathBuilder pathBuilderA2 = androidx.compose.animation.b.a(14.8f, 17.0f, -2.9f, 3.32f);
        ...
        ImageVector.Builder.m3359addPathoIyEayM$default(builder, androidx.appcompat.graphics.drawable.a.e(pathBuilderA2, -2.0f, -1.0f, 2.35f, -2.68f), defaultFillType3, "", solidColor3, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw3, iM3151getBevelLxFBmk83, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        int defaultFillType4 = VectorKt.getDefaultFillType();
        SolidColor solidColor4 = new SolidColor(companion.m2844getBlack0d7_KjU(), null);
        int iM3141getButtKaPHkGw4 = companion2.m3141getButtKaPHkGw();
        int iM3151getBevelLxFBmk84 = companion3.m3151getBevelLxFBmk8();
        PathBuilder pathBuilderA3 = androidx.compose.animation.b.a(8.8f, 17.0f, -2.9f, 3.32f);
        pathBuilderA3.lineToRelative(2.0f, 1.0f);
        pathBuilderA3.lineToRelative(-2.35f, 2.68f);
        pathBuilderA3.lineToRelative(2.65f, 0.0f);
        pathBuilderA3.lineToRelative(2.9f, -3.32f);
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, androidx.appcompat.graphics.drawable.a.e(pathBuilderA3, -2.0f, -1.0f, 2.35f, -2.68f), defaultFillType4, "", solidColor4, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw4, iM3151getBevelLxFBmk84, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
