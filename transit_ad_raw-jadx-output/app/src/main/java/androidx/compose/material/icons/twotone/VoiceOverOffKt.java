...
public final class VoiceOverOffKt {
    ...
    public static final ImageVector getVoiceOverOff(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.VoiceOverOff", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderD.curveToRelative(0.22f, 0.0f, 0.42f, -0.04f, 0.62f, -0.11f);
        pathBuilderD.lineTo(7.11f, 8.38f);
        pathBuilderD.curveToRelative(-0.07f, 0.2f, -0.11f, 0.4f, -0.11f, 0.62f);
        pathBuilderD.close();
