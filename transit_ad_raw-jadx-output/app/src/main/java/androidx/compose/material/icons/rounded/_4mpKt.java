...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"__4mp", "Landroidx/compose/ui/graphics/vector/ImageVector;", "_4mp", "Landroidx/compose/material/icons/Icons$Rounded;", "get_4mp", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class _4mpKt {
    ...
    public static final ImageVector get_4mp(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded._4mp", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        c.b.g(pathBuilderB, 17.75f, 12.5f, 10.75f, 10.0f);
        pathBuilderB.horizontalLineToRelative(-2.0f);
        pathBuilderB.curveToRelative(-0.55f, 0.0f, -1.0f, -0.45f, -1.0f, -1.0f);
        pathBuilderB.verticalLineTo(6.25f);
        pathBuilderB.curveToRelative(0.0f, -0.41f, 0.34f, -0.75f, 0.75f, -0.75f);
        pathBuilderB.reflectiveCurveTo(11.0f, 5.84f, 11.0f, 6.25f);
        h.w(pathBuilderB, 8.5f, 1.5f, 6.25f);
        pathBuilderB.curveToRelative(0.0f, -0.41f, 0.34f, -0.75f, 0.75f, -0.75f);
        pathBuilderB.reflectiveCurveTo(14.0f, 5.84f, 14.0f, 6.25f);
        pathBuilderB.verticalLineTo(8.5f);
        pathBuilderB.horizontalLineToRelative(0.25f);
        pathBuilderB.curveTo(14.66f, 8.5f, 15.0f, 8.84f, 15.0f, 9.25f);
        pathBuilderB.reflectiveCurveTo(14.66f, 10.0f, 14.25f, 10.0f);
        pathBuilderB.horizontalLineTo(14.0f);
        pathBuilderB.verticalLineToRelative(0.75f);
        pathBuilderB.curveToRelative(0.0f, 0.41f, -0.34f, 0.75f, -0.75f, 0.75f);
        pathBuilderB.reflectiveCurveTo(12.5f, 11.16f, 12.5f, 10.75f);
        pathBuilderB.close();
        ...
        pathBuilderB.curveToRelative(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, a.j(pathBuilderB, 16.0f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw2, iM3151getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
