...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_spatialAudio", "Landroidx/compose/ui/graphics/vector/ImageVector;", "SpatialAudio", "Landroidx/compose/material/icons/Icons$Rounded;", "getSpatialAudio", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class SpatialAudioKt {
    ...
    public static final ImageVector getSpatialAudio(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.SpatialAudio", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderD = a.d(22.11f, 7.95f);
        pathBuilderD.curveToRelative(-1.89f, -0.23f, -5.57f, -1.83f, -6.09f, -6.09f);
        pathBuilderD.curveTo(15.96f, 1.36f, 15.54f, 1.0f, 15.04f, 1.0f);
        pathBuilderD.horizontalLineToRelative(0.0f);
        pathBuilderD.curveToRelative(-0.6f, 0.0f, -1.07f, 0.53f, -1.0f, 1.13f);
        pathBuilderD.curveToRelative(0.31f, 2.43f, 2.38f, 7.12f, 7.8f, 7.8f);
        pathBuilderD.curveToRelative(0.6f, 0.08f, 1.13f, -0.4f, 1.13f, -1.0f);
        pathBuilderD.verticalLineToRelative(0.0f);
        pathBuilderD.curveTo(22.97f, 8.43f, 22.6f, 8.01f, 22.11f, 7.95f);
        pathBuilderD.close();
        ...
        PathBuilder pathBuilderD2 = a.d(21.71f, 5.83f);
        pathBuilderD2.curveToRelative(0.64f, 0.17f, 1.26f, -0.31f, 1.26f, -0.97f);
        pathBuilderD2.curveToRelative(0.0f, -0.47f, -0.34f, -0.85f, -0.79f, -0.97f);
        pathBuilderD2.curveToRelative(-0.49f, -0.14f, -1.72f, -0.68f, -2.11f, -2.13f);
        pathBuilderD2.curveTo(19.95f, 1.32f, 19.57f, 1.0f, 19.11f, 1.0f);
        pathBuilderD2.horizontalLineTo(19.1f);
        pathBuilderD2.curveToRelative(-0.66f, 0.0f, -1.14f, 0.64f, -0.96f, 1.28f);
        pathBuilderD2.curveTo(18.74f, 4.5f, 20.58f, 5.53f, 21.71f, 5.83f);
        pathBuilderD2.close();
