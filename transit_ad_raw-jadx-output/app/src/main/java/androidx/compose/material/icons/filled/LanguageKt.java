...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_language", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Language", "Landroidx/compose/material/icons/Icons$Filled;", "getLanguage", "(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-filled_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class LanguageKt {
    ...
    public static final ImageVector getLanguage(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.Language", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderD.curveToRelative(0.0f, 0.68f, 0.06f, 1.34f, 0.14f, 2.0f);
        ...
        pathBuilderD.curveToRelative(0.0f, -0.68f, 0.07f, -1.35f, 0.16f, -2.0f);
        pathBuilderD.horizontalLineToRelative(4.68f);
        pathBuilderD.curveToRelative(0.09f, 0.65f, 0.16f, 1.32f, 0.16f, 2.0f);
        pathBuilderD.curveToRelative(0.0f, 0.68f, -0.07f, 1.34f, -0.16f, 2.0f);
        pathBuilderD.close();
