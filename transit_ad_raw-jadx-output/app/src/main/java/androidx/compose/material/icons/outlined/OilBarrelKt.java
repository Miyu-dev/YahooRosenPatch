...
public final class OilBarrelKt {
    ...
    public static final ImageVector getOilBarrel(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.OilBarrel", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderD = a.d(9.0f, 13.05f);
        pathBuilderD.curveTo(9.0f, 14.68f, 10.34f, 16.0f, 12.0f, 16.0f);
        pathBuilderD.reflectiveCurveToRelative(3.0f, -1.32f, 3.0f, -2.95f);
        pathBuilderD.curveToRelative(0.0f, -1.31f, -0.53f, -1.69f, -3.0f, -4.55f);
        pathBuilderD.curveTo(9.52f, 11.38f, 9.0f, 11.75f, 9.0f, 13.05f);
        pathBuilderD.close();
        ...
        PathBuilder pathBuilderD2 = a.d(20.0f, 13.0f);
        ...
        pathBuilderD2.curveToRelative(0.55f, 0.0f, 1.0f, -0.45f, 1.0f, -1.0f);
        pathBuilderD2.reflectiveCurveToRelative(-0.45f, -1.0f, -1.0f, -1.0f);
        s.q(pathBuilderD2, -1.0f, -6.0f, 20.0f);
        b.z(pathBuilderD2, 17.0f, 19.0f, 7.0f, -6.0f);
        pathBuilderD2.curveToRelative(0.55f, 0.0f, 1.0f, -0.45f, 1.0f, -1.0f);
        pathBuilderD2.reflectiveCurveToRelative(-0.45f, -1.0f, -1.0f, -1.0f);
        v.r(pathBuilderD2, 5.0f, 10.0f, 6.0f);
        pathBuilderD2.curveToRelative(-0.55f, 0.0f, -1.0f, 0.45f, -1.0f, 1.0f);
        pathBuilderD2.reflectiveCurveToRelative(0.45f, 1.0f, 1.0f, 1.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, android.support.v4.media.a.j(pathBuilderD2, 19.0f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw2, iM3151getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
