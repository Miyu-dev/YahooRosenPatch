...
public final class DownloadForOfflineKt {
    ...
    public static final ImageVector getDownloadForOffline(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.DownloadForOffline", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        androidx.compose.animation.a.t(pathBuilderD, 14.59f, 8.59f, 16.0f, 10.0f);
        pathBuilderD.lineToRelative(-4.0f, 4.0f);
        pathBuilderD.lineToRelative(-4.0f, -4.0f);
        pathBuilderD.lineToRelative(1.41f, -1.41f);
        androidx.appcompat.app.m.r(pathBuilderD, 11.0f, 10.17f, 6.0f, 2.0f);
        h.q(pathBuilderD, 4.17f, 14.59f, 8.59f);
        b.z(pathBuilderD, 17.0f, 17.0f, 7.0f, -2.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, androidx.compose.animation.a.g(pathBuilderD, 10.0f, 17.0f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw, iM3151getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
