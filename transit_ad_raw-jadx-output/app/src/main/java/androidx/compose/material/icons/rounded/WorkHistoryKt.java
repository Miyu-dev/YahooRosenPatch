...
public final class WorkHistoryKt {
    ...
    public static final ImageVector getWorkHistory(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.WorkHistory", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderD.curveToRelative(1.49f, 0.0f, 2.87f, 0.47f, 4.0f, 1.26f);
