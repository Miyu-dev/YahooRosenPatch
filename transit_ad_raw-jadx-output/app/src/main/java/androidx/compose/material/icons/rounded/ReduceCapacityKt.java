...
public final class ReduceCapacityKt {
    ...
    public static final ImageVector getReduceCapacity(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.ReduceCapacity", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        androidx.appcompat.view.menu.a.B(pathBuilderD, 22.0f, 13.79f, 13.0f, -1.04f);
        ...
        pathBuilderD.horizontalLineToRelative(-1.04f);
        ...
        pathBuilderD.lineToRelative(1.79f, -1.79f);
        pathBuilderD.curveTo(14.46f, 13.54f, 14.24f, 13.0f, 13.79f, 13.0f);
        pathBuilderD.close();
