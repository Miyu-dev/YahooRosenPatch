...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_directionsBus", "Landroidx/compose/ui/graphics/vector/ImageVector;", "DirectionsBus", "Landroidx/compose/material/icons/Icons$Outlined;", "getDirectionsBus", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-outlined_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class DirectionsBusKt {
    ...
    public static final ImageVector getDirectionsBus(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.DirectionsBus", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        androidx.compose.animation.a.t(pathBuilderD, 17.66f, 4.99f, 6.34f, 4.99f);
        pathBuilderD.curveTo(6.89f, 4.46f, 8.31f, 4.0f, 12.0f, 4.0f);
        pathBuilderD.reflectiveCurveToRelative(5.11f, 0.46f, 5.66f, 0.99f);
        androidx.compose.animation.a.t(pathBuilderD, 18.0f, 6.99f, 18.0f, 10.0f);
        pathBuilderD.lineTo(6.0f, 10.0f);
        h.m(pathBuilderD, 6.0f, 6.99f, 12.0f);
        pathBuilderD.moveTo(17.66f, 16.73f);
        pathBuilderD.lineToRelative(-0.29f, 0.27f);
        pathBuilderD.lineTo(6.63f, 17.0f);
        pathBuilderD.lineToRelative(-0.29f, -0.27f);
        pathBuilderD.curveTo(6.21f, 16.62f, 6.0f, 16.37f, 6.0f, 16.0f);
        android.support.v4.media.a.m(pathBuilderD, -4.0f, 12.0f, 4.0f);
