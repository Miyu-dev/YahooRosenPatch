...
public final class SupportAgentKt {
    ...
    public static final ImageVector getSupportAgent(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.SupportAgent", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderD.lineToRelative(0.0f, -4.81f);
        pathBuilderD.curveToRelative(0.0f, -3.83f, 2.95f, -7.18f, 6.78f, -7.29f);
        pathBuilderD.curveToRelative(3.96f, -0.12f, 7.22f, 3.06f, 7.22f, 7.0f);
