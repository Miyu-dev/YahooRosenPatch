...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_directionsRailwayFilled", "Landroidx/compose/ui/graphics/vector/ImageVector;", "DirectionsRailwayFilled", "Landroidx/compose/material/icons/Icons$Rounded;", "getDirectionsRailwayFilled", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class DirectionsRailwayFilledKt {
    ...
    public static final ImageVector getDirectionsRailwayFilled(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.DirectionsRailwayFilled", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderD.lineToRelative(-1.21f, 0.81f);
        pathBuilderD.curveTo(6.11f, 19.93f, 6.0f, 20.13f, 6.0f, 20.35f);
        pathBuilderD.verticalLineToRelative(0.0f);
        pathBuilderD.curveTo(6.0f, 20.71f, 6.29f, 21.0f, 6.65f, 21.0f);
        pathBuilderD.horizontalLineToRelative(10.7f);
        pathBuilderD.curveToRelative(0.36f, 0.0f, 0.65f, -0.29f, 0.65f, -0.65f);
        pathBuilderD.verticalLineToRelative(0.0f);
        pathBuilderD.curveToRelative(0.0f, -0.22f, -0.11f, -0.42f, -0.29f, -0.54f);
        ...
        pathBuilderD.reflectiveCurveTo(11.17f, 13.0f, 12.0f, 13.0f);
