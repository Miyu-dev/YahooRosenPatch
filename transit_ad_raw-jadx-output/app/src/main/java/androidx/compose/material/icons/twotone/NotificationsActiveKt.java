...
public final class NotificationsActiveKt {
    ...
    public static final ImageVector getNotificationsActive(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.NotificationsActive", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderD2.close();
        pathBuilderD2.moveTo(18.0f, 11.0f);
        ...
        s.s(pathBuilderD2, 16.0f, -1.0f, -2.0f, -2.0f);
        android.support.v4.media.a.v(pathBuilderD2, -5.0f, 16.0f, 17.0f);
        ...
        android.support.v4.media.a.v(pathBuilderD2, 6.0f, 7.58f, 4.08f);
        pathBuilderD2.lineTo(6.15f, 2.65f);
        pathBuilderD2.curveTo(3.75f, 4.48f, 2.17f, 7.3f, 2.03f, 10.5f);
        pathBuilderD2.horizontalLineToRelative(2.0f);
        pathBuilderD2.curveToRelative(0.15f, -2.65f, 1.51f, -4.97f, 3.55f, -6.42f);
        androidx.compose.animation.a.j(pathBuilderD2, 19.97f, 10.5f, 2.0f);
        pathBuilderD2.curveToRelative(-0.15f, -3.2f, -1.73f, -6.02f, -4.12f, -7.85f);
        pathBuilderD2.lineToRelative(-1.42f, 1.43f);
        pathBuilderD2.curveToRelative(2.02f, 1.45f, 3.39f, 3.77f, 3.54f, 6.42f);
        pathBuilderD2.close();
