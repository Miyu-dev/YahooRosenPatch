...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_emojiEmotions", "Landroidx/compose/ui/graphics/vector/ImageVector;", "EmojiEmotions", "Landroidx/compose/material/icons/Icons$TwoTone;", "getEmojiEmotions", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class EmojiEmotionsKt {
    ...
    public static final ImageVector getEmojiEmotions(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.EmojiEmotions", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderD.reflectiveCurveTo(20.0f, 16.42f, 20.0f, 12.0f);
        pathBuilderD.close();
        pathBuilderD.moveTo(8.5f, 8.0f);
        pathBuilderD.curveTo(9.33f, 8.0f, 10.0f, 8.67f, 10.0f, 9.5f);
        ...
        pathBuilderD.curveToRelative(-2.28f, 0.0f, -4.22f, -1.66f, -5.0f, -4.0f);
        pathBuilderD.horizontalLineToRelative(10.0f);
        pathBuilderD.curveTo(16.22f, 16.34f, 14.28f, 18.0f, 12.0f, 18.0f);
        pathBuilderD.close();
        ...
        ImageVector.Builder.m3359addPathoIyEayM$default(builder, h.t(pathBuilderD, 16.33f, 11.0f, 15.5f, 11.0f), defaultFillType, "", solidColor, 0.3f, null, 0.3f, 1.0f, iM3141getButtKaPHkGw, iM3151getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        pathBuilderD2.curveToRelative(0.0f, 5.52f, 4.47f, 10.0f, 9.99f, 10.0f);
        pathBuilderD2.curveTo(17.52f, 22.0f, 22.0f, 17.52f, 22.0f, 12.0f);
        pathBuilderD2.curveTo(22.0f, 6.48f, 17.52f, 2.0f, 11.99f, 2.0f);
        pathBuilderD2.close();
        ...
        pathBuilderD2.curveTo(20.0f, 16.42f, 16.42f, 20.0f, 12.0f, 20.0f);
        pathBuilderD2.close();
        ...
        PathBuilder pathBuilderD3 = a.d(12.0f, 18.0f);
        pathBuilderD3.curveToRelative(2.28f, 0.0f, 4.22f, -1.66f, 5.0f, -4.0f);
        pathBuilderD3.horizontalLineTo(7.0f);
        pathBuilderD3.curveTo(7.78f, 16.34f, 9.72f, 18.0f, 12.0f, 18.0f);
        pathBuilderD3.close();
