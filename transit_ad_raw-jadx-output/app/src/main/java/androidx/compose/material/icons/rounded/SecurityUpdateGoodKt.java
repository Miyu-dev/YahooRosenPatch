...
public final class SecurityUpdateGoodKt {
    ...
    public static final ImageVector getSecurityUpdateGood(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.SecurityUpdateGood", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
