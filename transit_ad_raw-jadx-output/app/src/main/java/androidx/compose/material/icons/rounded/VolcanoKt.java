...
public final class VolcanoKt {
    ...
    public static final ImageVector getVolcano(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Volcano", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderB = h.b(16.49f, 8.0f, -4.14f);
        pathBuilderB.curveToRelative(-0.82f, 0.0f, -1.55f, 0.5f, -1.86f, 1.26f);
        ...
        pathBuilderB.lineToRelative(-2.22f, 5.0f);
        pathBuilderB.curveTo(2.66f, 20.51f, 3.63f, 22.0f, 5.08f, 22.0f);
        pathBuilderB.horizontalLineToRelative(14.27f);
        pathBuilderB.curveToRelative(1.33f, 0.0f, 2.29f, -1.27f, 1.92f, -2.55f);
        pathBuilderB.lineToRelative(-2.86f, -10.0f);
        pathBuilderB.curveTo(18.17f, 8.59f, 17.38f, 8.0f, 16.49f, 8.0f);
        pathBuilderB.close();
        ...
        PathBuilder pathBuilderA = b.a(14.0f, 1.0f, 14.0f, 1.0f);
        ...
        pathBuilderA.curveTo(15.0f, 1.45f, 14.55f, 1.0f, 14.0f, 1.0f);
        pathBuilderA.close();
        ...
        PathBuilder pathBuilderA2 = b.a(19.66f, 3.34f, 19.66f, 3.34f);
        ...
        pathBuilderA2.curveToRelative(0.39f, 0.39f, 1.02f, 0.39f, 1.41f, 0.0f);
        pathBuilderA2.lineToRelative(1.41f, -1.41f);
        pathBuilderA2.curveTo(20.05f, 4.37f, 20.05f, 3.73f, 19.66f, 3.34f);
        pathBuilderA2.close();
        ...
        PathBuilder pathBuilderA3 = b.a(11.17f, 4.76f, 9.76f, 3.34f);
        ...
        pathBuilderA3.curveToRelative(0.39f, 0.39f, 1.02f, 0.39f, 1.41f, 0.0f);
        pathBuilderA3.lineToRelative(0.0f, 0.0f);
        pathBuilderA3.curveTo(11.56f, 5.78f, 11.56f, 5.15f, 11.17f, 4.76f);
        pathBuilderA3.close();
