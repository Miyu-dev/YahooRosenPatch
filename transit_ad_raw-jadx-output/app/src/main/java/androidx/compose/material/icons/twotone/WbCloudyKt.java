...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_wbCloudy", "Landroidx/compose/ui/graphics/vector/ImageVector;", "WbCloudy", "Landroidx/compose/material/icons/Icons$TwoTone;", "getWbCloudy", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class WbCloudyKt {
    ...
    public static final ImageVector getWbCloudy(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.WbCloudy", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderA = b.a(19.23f, 12.04f, -1.52f, -0.11f);
        pathBuilderA.lineToRelative(-0.3f, -1.5f);
        pathBuilderA.curveTo(16.89f, 7.86f, 14.62f, 6.0f, 12.01f, 6.0f);
        pathBuilderA.curveTo(9.95f, 6.0f, 8.08f, 7.14f, 7.13f, 8.96f);
        pathBuilderA.lineToRelative(-0.5f, 0.95f);
        pathBuilderA.lineToRelative(-1.07f, 0.11f);
        pathBuilderA.curveToRelative(-2.02f, 0.22f, -3.55f, 1.93f, -3.55f, 3.98f);
        ...
        pathBuilderA.curveToRelative(0.0f, -1.55f, -1.23f, -2.86f, -2.78f, -2.96f);
        pathBuilderA.close();
        ...
        PathBuilder pathBuilderD = a.d(19.36f, 10.04f);
        pathBuilderD.curveTo(18.67f, 6.59f, 15.65f, 4.0f, 12.01f, 4.0f);
        pathBuilderD.curveTo(9.11f, 4.0f, 6.6f, 5.64f, 5.35f, 8.04f);
        pathBuilderD.curveTo(2.35f, 8.36f, 0.01f, 10.91f, 0.01f, 14.0f);
        ...
        androidx.compose.animation.a.j(pathBuilderD, 19.01f, 18.0f, -13.0f);
        ...
        pathBuilderD.curveTo(8.08f, 7.14f, 9.95f, 6.0f, 12.01f, 6.0f);
        pathBuilderD.curveToRelative(2.61f, 0.0f, 4.89f, 1.86f, 5.4f, 4.43f);
        pathBuilderD.lineToRelative(0.3f, 1.5f);
        pathBuilderD.lineToRelative(1.52f, 0.11f);
        pathBuilderD.curveToRelative(1.56f, 0.11f, 2.78f, 1.41f, 2.78f, 2.96f);
