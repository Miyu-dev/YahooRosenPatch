...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_alarmOff", "Landroidx/compose/ui/graphics/vector/ImageVector;", "AlarmOff", "Landroidx/compose/material/icons/Icons$TwoTone;", "getAlarmOff", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class AlarmOffKt {
    ...
    public static final ImageVector getAlarmOff(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.AlarmOff", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderD.moveTo(19.24f, 18.32f);
        pathBuilderD.lineToRelative(-1.43f, -1.43f);
        pathBuilderD.lineToRelative(-9.7f, -9.7f);
        pathBuilderD.lineToRelative(-1.43f, -1.43f);
        pathBuilderD.lineToRelative(-0.74f, -0.74f);
        pathBuilderD.lineTo(4.52f, 3.6f);
        ...
        android.support.v4.media.a.n(pathBuilderD, 1.41f, -1.41f, -2.16f, -2.17f);
