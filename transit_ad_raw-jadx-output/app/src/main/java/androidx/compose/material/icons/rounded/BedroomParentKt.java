...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_bedroomParent", "Landroidx/compose/ui/graphics/vector/ImageVector;", "BedroomParent", "Landroidx/compose/material/icons/Icons$Rounded;", "getBedroomParent", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class BedroomParentKt {
    ...
    public static final ImageVector getBedroomParent(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.BedroomParent", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        androidx.compose.animation.a.t(pathBuilderB2, 18.25f, 17.0f, 18.25f, 17.0f);
        pathBuilderB2.curveToRelative(-0.41f, 0.0f, -0.75f, -0.34f, -0.75f, -0.75f);
        v.r(pathBuilderB2, 15.5f, -11.0f, 0.75f);
        pathBuilderB2.curveTo(6.5f, 16.66f, 6.16f, 17.0f, 5.75f, 17.0f);
        pathBuilderB2.horizontalLineToRelative(0.0f);
        pathBuilderB2.curveTo(5.34f, 17.0f, 5.0f, 16.66f, 5.0f, 16.25f);
        pathBuilderB2.verticalLineToRelative(-3.08f);
        ...
        pathBuilderB2.verticalLineToRelative(3.08f);
        pathBuilderB2.curveTo(19.0f, 16.66f, 18.66f, 17.0f, 18.25f, 17.0f);
        pathBuilderB2.close();
