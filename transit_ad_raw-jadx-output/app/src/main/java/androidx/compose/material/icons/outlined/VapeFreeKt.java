...
public final class VapeFreeKt {
    ...
    public static final ImageVector getVapeFree(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.VapeFree", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        b.B(pathBuilderB, 2.0f, 16.5f, 16.17f, 19.0f);
        a.s(pathBuilderB, 8.0f, -3.0f, 5.17f);
        pathBuilderB.lineTo(1.39f, 4.22f);
        pathBuilderB.lineToRelative(1.41f, -1.41f);
        pathBuilderB.lineToRelative(18.38f, 18.38f);
        s.r(pathBuilderB, -1.41f, 1.41f, 16.17f, 19.0f);
        b.z(pathBuilderB, 18.83f, 16.0f, 22.0f, 3.0f);
        androidx.appcompat.view.menu.a.s(pathBuilderB, -0.17f, 18.83f, 16.0f);
        ...
        pathBuilderB.close();
        pathBuilderB.moveTo(11.15f, 8.32f);
        pathBuilderB.curveToRelative(0.0f, -0.01f, 0.0f, -0.01f, 0.0f, -0.02f);
        pathBuilderB.curveToRelative(0.0f, -1.85f, 1.5f, -3.35f, 3.35f, -3.35f);
        ...
        pathBuilderB.curveToRelative(1.87f, 0.0f, 3.47f, 1.35f, 3.47f, 3.16f);
        androidx.appcompat.graphics.drawable.a.o(pathBuilderB, 15.0f, 18.0f, -1.3f);
        pathBuilderB.curveToRelative(0.0f, -1.31f, -0.92f, -2.05f, -1.97f, -2.05f);
        pathBuilderB.horizontalLineTo(14.5f);
        pathBuilderB.curveToRelative(-0.01f, 0.0f, -0.01f, 0.0f, -0.02f, 0.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, androidx.compose.animation.b.h(pathBuilderB, 11.15f, 8.32f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw, iM3151getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
