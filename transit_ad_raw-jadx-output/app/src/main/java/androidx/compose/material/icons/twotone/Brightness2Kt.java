...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_brightness2", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Brightness2", "Landroidx/compose/material/icons/Icons$TwoTone;", "getBrightness2", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class Brightness2Kt {
    ...
    public static final ImageVector getBrightness2(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.Brightness2", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderD.curveTo(10.9f, 6.23f, 12.0f, 9.05f, 12.0f, 12.0f);
        pathBuilderD.curveToRelative(0.0f, 2.95f, -1.1f, 5.77f, -3.01f, 7.93f);
        pathBuilderD.curveToRelative(0.33f, 0.05f, 0.67f, 0.07f, 1.01f, 0.07f);
        ...
        PathBuilder pathBuilderD2 = a.d(5.0f, 20.65f);
        pathBuilderD2.curveTo(6.47f, 21.5f, 8.18f, 22.0f, 10.0f, 22.0f);
        pathBuilderD2.curveToRelative(5.52f, 0.0f, 10.0f, -4.48f, 10.0f, -10.0f);
        pathBuilderD2.reflectiveCurveTo(15.52f, 2.0f, 10.0f, 2.0f);
        pathBuilderD2.curveToRelative(-1.82f, 0.0f, -3.53f, 0.5f, -5.0f, 1.35f);
        pathBuilderD2.curveTo(7.99f, 5.08f, 10.0f, 8.3f, 10.0f, 12.0f);
        pathBuilderD2.reflectiveCurveToRelative(-2.01f, 6.92f, -5.0f, 8.65f);
        pathBuilderD2.close();
        pathBuilderD2.moveTo(12.0f, 12.0f);
        pathBuilderD2.curveToRelative(0.0f, -2.95f, -1.1f, -5.77f, -3.01f, -7.93f);
        pathBuilderD2.curveTo(9.32f, 4.02f, 9.66f, 4.0f, 10.0f, 4.0f);
        ...
        pathBuilderD2.curveTo(10.9f, 17.77f, 12.0f, 14.95f, 12.0f, 12.0f);
        pathBuilderD2.close();
