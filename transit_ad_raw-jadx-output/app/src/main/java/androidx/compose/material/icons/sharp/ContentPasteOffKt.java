...
public final class ContentPasteOffKt {
    ...
    public static final ImageVector getContentPasteOff(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.ContentPasteOff", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        a.z(pathBuilderA, 11.17f, 2.0f, 2.0f, 3.0f);
