...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_pinch", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Pinch", "Landroidx/compose/material/icons/Icons$TwoTone;", "getPinch", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class PinchKt {
    ...
    public static final ImageVector getPinch(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.Pinch", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderA = d.a(21.0f, 15.56f, -4.24f, -1.89f, 15.0f);
        pathBuilderA.verticalLineTo(7.5f);
        pathBuilderA.curveTo(15.0f, 7.22f, 14.78f, 7.0f, 14.5f, 7.0f);
        pathBuilderA.reflectiveCurveTo(14.0f, 7.22f, 14.0f, 7.5f);
        pathBuilderA.verticalLineToRelative(10.61f);
        pathBuilderA.lineToRelative(-4.17f, -0.89f);
        pathBuilderA.lineToRelative(3.7f, 3.78f);
        ImageVector.Builder.m3359addPathoIyEayM$default(builder, a.r(pathBuilderA, 6.55f, 21.0f, 15.56f), defaultFillType, "", solidColor, 0.3f, null, 0.3f, 1.0f, iM3141getButtKaPHkGw, iM3151getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        androidx.compose.animation.a.x(pathBuilderC, 6.0f, 11.0f, 1.0f, 6.0f);
        a.w(pathBuilderC, 1.5f, 2.44f, 8.44f, 2.5f);
        ...
        androidx.compose.animation.a.j(pathBuilderC, 20.08f, 21.0f, -6.55f);
        ...
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, b.h(pathBuilderC, 20.08f, 21.0f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw2, iM3151getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
