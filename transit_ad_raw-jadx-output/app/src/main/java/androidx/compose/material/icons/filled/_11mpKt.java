...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"__11mp", "Landroidx/compose/ui/graphics/vector/ImageVector;", "_11mp", "Landroidx/compose/material/icons/Icons$Filled;", "get_11mp", "(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-filled_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class _11mpKt {
    ...
    public static final ImageVector get_11mp(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled._11mp", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderA.curveToRelative(0.0f, 0.55f, -0.45f, 1.0f, -1.0f, 1.0f);
        androidx.appcompat.graphics.drawable.a.z(pathBuilderA, -2.0f, 1.5f, 11.0f, 5.5f);
        pathBuilderA.verticalLineToRelative(6.0f);
        pathBuilderA.lineTo(9.5f, 11.5f);
        pathBuilderA.lineTo(9.5f, 7.0f);
        pathBuilderA.lineTo(8.0f, 7.0f);
        h.m(pathBuilderA, 8.0f, 5.5f, 3.0f);
        b.y(pathBuilderA, 16.0f, 5.5f, 6.0f, -1.5f);
        pathBuilderA.lineTo(14.5f, 7.0f);
        pathBuilderA.lineTo(13.0f, 7.0f);
        h.m(pathBuilderA, 13.0f, 5.5f, 3.0f);
