...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"__3kPlus", "Landroidx/compose/ui/graphics/vector/ImageVector;", "_3kPlus", "Landroidx/compose/material/icons/Icons$Rounded;", "get_3kPlus", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class _3kPlusKt {
    ...
    public static final ImageVector get_3kPlus(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded._3kPlus", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        v.t(pathBuilderB, 1.5f, -1.0f, 6.25f);
        pathBuilderB.curveToRelative(-0.41f, 0.0f, -0.75f, -0.34f, -0.75f, -0.75f);
        pathBuilderB.verticalLineToRelative(0.0f);
        ...
        pathBuilderB.lineTo(14.59f, 15.0f);
        ...
        pathBuilderB.lineToRelative(-0.03f, -4.49f);
        pathBuilderB.curveTo(10.96f, 9.34f, 11.3f, 9.0f, 11.72f, 9.0f);
        pathBuilderB.horizontalLineToRelative(0.0f);
        pathBuilderB.curveToRelative(0.41f, 0.0f, 0.75f, 0.33f, 0.75f, 0.74f);
        pathBuilderB.lineToRelative(0.03f, 1.51f);
        pathBuilderB.lineToRelative(1.54f, -1.98f);
