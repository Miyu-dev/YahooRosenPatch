...
public final class WorkspacePremiumKt {
    ...
    public static final ImageVector getWorkspacePremium(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.WorkspacePremium", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
