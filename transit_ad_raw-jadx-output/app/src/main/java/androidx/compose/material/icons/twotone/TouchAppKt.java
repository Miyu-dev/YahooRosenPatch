...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_touchApp", "Landroidx/compose/ui/graphics/vector/ImageVector;", "TouchApp", "Landroidx/compose/material/icons/Icons$TwoTone;", "getTouchApp", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class TouchAppKt {
    ...
    public static final ImageVector getTouchApp(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.TouchApp", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderA.curveToRelative(-2.08f, -0.44f, -2.01f, -0.44f, -2.26f, -0.44f);
        ...
        PathBuilder pathBuilderP = a.b.p(17.3f, 14.23f, -3.46f, -1.73f, -1.77f);
        pathBuilderP.verticalLineToRelative(-6.0f);
        pathBuilderP.curveToRelative(0.0f, -0.28f, -0.22f, -0.5f, -0.5f, -0.5f);
        pathBuilderP.curveToRelative(-0.28f, 0.0f, -0.5f, 0.22f, -0.5f, 0.5f);
        pathBuilderP.verticalLineToRelative(10.61f);
        pathBuilderP.lineToRelative(-4.25f, -0.89f);
        pathBuilderP.lineToRelative(3.68f, 3.68f);
        pathBuilderP.curveToRelative(0.06f, 0.06f, 0.15f, 0.1f, 0.24f, 0.1f);
        pathBuilderP.horizontalLineToRelative(6.3f);
        pathBuilderP.lineToRelative(0.8f, -4.71f);
        pathBuilderP.curveTo(17.91f, 14.86f, 17.69f, 14.43f, 17.3f, 14.23f);
        pathBuilderP.close();
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, pathBuilderP.getNodes(), defaultFillType2, "", solidColor2, 0.3f, null, 0.3f, 1.0f, iM3141getButtKaPHkGw2, iM3151getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
