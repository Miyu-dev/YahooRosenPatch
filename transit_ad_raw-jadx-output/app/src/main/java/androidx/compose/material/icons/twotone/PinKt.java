...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_pin", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Pin", "Landroidx/compose/material/icons/Icons$TwoTone;", "getPin", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class PinKt {
    ...
    public static final ImageVector getPin(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.Pin", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        androidx.appcompat.view.menu.a.B(pathBuilderQ, 18.0f, 16.84f, 12.38f, -0.5f);
        pathBuilderQ.verticalLineToRelative(-1.0f);
        pathBuilderQ.horizontalLineToRelative(0.46f);
        ...
        pathBuilderQ.curveToRelative(-0.5f, 0.0f, -0.74f, 0.32f, -0.85f, 0.64f);
        pathBuilderQ.lineToRelative(-0.99f, -0.41f);
        pathBuilderQ.curveTo(15.2f, 9.9f, 15.68f, 9.0f, 16.94f, 9.0f);
        ...
        pathBuilderQ.curveToRelative(0.37f, 0.52f, 0.33f, 1.27f, 0.01f, 1.76f);
        pathBuilderQ.curveTo(18.67f, 14.28f, 18.19f, 15.0f, 16.99f, 15.0f);
        pathBuilderQ.curveToRelative(-0.04f, 0.0f, -1.6f, 0.08f, -2.05f, -1.51f);
        pathBuilderQ.lineToRelative(1.03f, -0.41f);
        pathBuilderQ.curveToRelative(0.02f, 0.1f, 0.19f, 0.86f, 1.02f, 0.86f);
        pathBuilderQ.curveToRelative(0.41f, 0.0f, 0.89f, -0.28f, 0.89f, -0.77f);
        pathBuilderQ.curveTo(17.88f, 12.62f, 17.4f, 12.38f, 16.84f, 12.38f);
        pathBuilderQ.close();
        pathBuilderQ.moveTo(10.56f, 9.2f);
        ...
        androidx.appcompat.view.menu.a.D(pathBuilderQ, 0.03f, 0.05f, 2.37f, 15.0f);
        pathBuilderQ.horizontalLineTo(9.61f);
        pathBuilderQ.verticalLineToRelative(-1.02f);
        pathBuilderQ.curveToRelative(1.07f, -1.07f, 1.77f, -1.77f, 2.13f, -2.15f);
        ...
        pathBuilderQ.curveToRelative(-0.52f, 0.0f, -0.8f, 0.39f, -0.9f, 0.72f);
        pathBuilderQ.lineToRelative(-1.01f, -0.42f);
        pathBuilderQ.curveTo(9.57f, 10.33f, 9.74f, 9.59f, 10.56f, 9.2f);
        b.r(pathBuilderQ, 6.77f, 9.0f, 0.87f, 6.0f);
        androidx.compose.animation.a.z(pathBuilderQ, 6.49f, -4.5f, -0.9f, 0.66f);
        ImageVector.Builder.m3359addPathoIyEayM$default(builder, h.p(pathBuilderQ, -0.58f, -0.89f, 6.77f, 9.0f), defaultFillType, "", solidColor, 0.3f, null, 0.3f, 1.0f, iM3141getButtKaPHkGw, iM3151getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        ImageVector.Builder.m3359addPathoIyEayM$default(builder, androidx.appcompat.graphics.drawable.a.e(pathBuilderA, -1.76f, 1.27f, 0.58f, 0.89f), defaultFillType3, "", solidColor3, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw3, iM3151getBevelLxFBmk83, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        a.s(pathBuilderD2, -0.46f, 1.0f, 0.5f);
