...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_bedroomChild", "Landroidx/compose/ui/graphics/vector/ImageVector;", "BedroomChild", "Landroidx/compose/material/icons/Icons$Rounded;", "getBedroomChild", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class BedroomChildKt {
    ...
    public static final ImageVector getBedroomChild(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.BedroomChild", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        a.t(pathBuilderB2, 17.25f, 17.0f, 17.25f, 17.0f);
        pathBuilderB2.curveToRelative(-0.41f, 0.0f, -0.75f, -0.34f, -0.75f, -0.75f);
        v.r(pathBuilderB2, 15.5f, -9.0f, 0.75f);
        pathBuilderB2.curveTo(7.5f, 16.66f, 7.16f, 17.0f, 6.75f, 17.0f);
        pathBuilderB2.horizontalLineToRelative(0.0f);
        pathBuilderB2.curveTo(6.34f, 17.0f, 6.0f, 16.66f, 6.0f, 16.25f);
        pathBuilderB2.verticalLineToRelative(-3.38f);
        ...
        pathBuilderB2.verticalLineToRelative(3.38f);
        pathBuilderB2.curveTo(18.0f, 16.66f, 17.66f, 17.0f, 17.25f, 17.0f);
        pathBuilderB2.close();
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, pathBuilderB2.getNodes(), defaultFillType3, "", solidColor3, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw3, iM3151getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
