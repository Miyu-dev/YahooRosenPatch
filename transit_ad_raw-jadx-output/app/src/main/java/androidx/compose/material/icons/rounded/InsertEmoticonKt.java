...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_insertEmoticon", "Landroidx/compose/ui/graphics/vector/ImageVector;", "InsertEmoticon", "Landroidx/compose/material/icons/Icons$Rounded;", "getInsertEmoticon", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class InsertEmoticonKt {
    ...
    public static final ImageVector getInsertEmoticon(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.InsertEmoticon", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderD.close();
        pathBuilderD.moveTo(16.75f, 14.75f);
        pathBuilderD.curveTo(15.8f, 16.39f, 14.03f, 17.5f, 12.0f, 17.5f);
        pathBuilderD.reflectiveCurveToRelative(-3.8f, -1.11f, -4.75f, -2.75f);
        pathBuilderD.curveTo(7.06f, 14.42f, 7.31f, 14.0f, 7.69f, 14.0f);
        pathBuilderD.horizontalLineToRelative(8.62f);
        pathBuilderD.curveTo(16.7f, 14.0f, 16.94f, 14.42f, 16.75f, 14.75f);
        pathBuilderD.close();
