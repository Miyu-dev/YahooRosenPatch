...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_tabUnselected", "Landroidx/compose/ui/graphics/vector/ImageVector;", "TabUnselected", "Landroidx/compose/material/icons/Icons$Outlined;", "getTabUnselected", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-outlined_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class TabUnselectedKt {
    ...
    public static final ImageVector getTabUnselected(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.TabUnselected", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        b.r(pathBuilderC, 9.0f, 21.0f, 2.0f, -2.0f);
        b.k(pathBuilderC, 9.0f, 19.0f, 2.0f);
        a.x(pathBuilderC, 1.0f, 17.0f, 2.0f, -2.0f);
        b.k(pathBuilderC, 1.0f, 15.0f, 2.0f);
        pathBuilderC.moveTo(3.0f, 21.0f);
        pathBuilderC.verticalLineToRelative(-2.0f);
        pathBuilderC.lineTo(1.0f, 19.0f);
        pathBuilderC.curveToRelative(0.0f, 1.1f, 0.9f, 2.0f, 2.0f, 2.0f);
        b.r(pathBuilderC, 21.0f, 3.0f, -8.0f, 6.0f);
        pathBuilderC.horizontalLineToRelative(10.0f);
        pathBuilderC.lineTo(23.0f, 5.0f);
        pathBuilderC.curveToRelative(0.0f, -1.1f, -0.9f, -2.0f, -2.0f, -2.0f);
        b.r(pathBuilderC, 21.0f, 17.0f, 2.0f, -2.0f);
        androidx.appcompat.graphics.drawable.a.z(pathBuilderC, -2.0f, 2.0f, 9.0f, 5.0f);
        pathBuilderC.horizontalLineToRelative(2.0f);
        ...
        pathBuilderC.moveTo(21.0f, 21.0f);
        pathBuilderC.curveToRelative(1.1f, 0.0f, 2.0f, -0.9f, 2.0f, -2.0f);
        androidx.appcompat.graphics.drawable.a.z(pathBuilderC, -2.0f, 2.0f, 21.0f, 13.0f);
        a.b.A(pathBuilderC, 2.0f, -2.0f, -2.0f, 2.0f);
        a.x(pathBuilderC, 13.0f, 21.0f, 2.0f, -2.0f);
        androidx.appcompat.graphics.drawable.a.z(pathBuilderC, -2.0f, 2.0f, 17.0f, 21.0f);
