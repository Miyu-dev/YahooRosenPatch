...
public final class SwipeRightKt {
    ...
    public static final ImageVector getSwipeRight(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.SwipeRight", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        androidx.appcompat.view.menu.a.z(pathBuilderA, 17.08f, 21.0f, 12.0f, 2.5f);
        pathBuilderA.curveTo(7.26f, 2.5f, 4.33f, 5.02f, 3.57f, 7.0f);
        pathBuilderA.horizontalLineTo(2.0f);
        pathBuilderA.curveToRelative(0.73f, -2.88f, 4.51f, -6.0f, 10.0f, -6.0f);
        pathBuilderA.curveToRelative(3.22f, 0.0f, 6.18f, 1.13f, 8.5f, 3.02f);
        b.x(pathBuilderA, 2.0f, 22.0f, 5.0f, -5.0f);
        pathBuilderA.verticalLineTo(5.5f);
        pathBuilderA.horizontalLineToRelative(2.91f);
        pathBuilderA.curveTo(17.79f, 3.64f, 15.03f, 2.5f, 12.0f, 2.5f);
        pathBuilderA.close();
