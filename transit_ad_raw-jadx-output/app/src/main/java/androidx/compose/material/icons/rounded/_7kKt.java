...
public final class _7kKt {
    ...
    public static final ImageVector get_7k(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded._7k", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        a.k(pathBuilderB, 8.95f, 15.0f, 8.76f);
        ...
        pathBuilderB.curveTo(9.57f, 14.79f, 9.28f, 15.0f, 8.95f, 15.0f);
