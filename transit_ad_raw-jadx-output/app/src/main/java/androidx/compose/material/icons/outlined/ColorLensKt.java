...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_colorLens", "Landroidx/compose/ui/graphics/vector/ImageVector;", "ColorLens", "Landroidx/compose/material/icons/Icons$Outlined;", "getColorLens", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-outlined_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class ColorLensKt {
    ...
    public static final ImageVector getColorLens(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.ColorLens", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderD.curveTo(6.49f, 22.0f, 2.0f, 17.51f, 2.0f, 12.0f);
        pathBuilderD.reflectiveCurveTo(6.49f, 2.0f, 12.0f, 2.0f);
        pathBuilderD.reflectiveCurveToRelative(10.0f, 4.04f, 10.0f, 9.0f);
        pathBuilderD.curveToRelative(0.0f, 3.31f, -2.69f, 6.0f, -6.0f, 6.0f);
        pathBuilderD.horizontalLineToRelative(-1.77f);
        pathBuilderD.curveToRelative(-0.28f, 0.0f, -0.5f, 0.22f, -0.5f, 0.5f);
        pathBuilderD.curveToRelative(0.0f, 0.12f, 0.05f, 0.23f, 0.13f, 0.33f);
        pathBuilderD.curveToRelative(0.41f, 0.47f, 0.64f, 1.06f, 0.64f, 1.67f);
