...
public final class AodKt {
    ...
    public static final ImageVector getAod(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Aod", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        b.m(pathBuilderA, 10.0f, 18.0f, 8.75f, 10.0f);
        ...
        pathBuilderA.horizontalLineToRelative(-6.5f);
        pathBuilderA.curveTo(8.34f, 11.5f, 8.0f, 11.16f, 8.0f, 10.75f);
        pathBuilderA.verticalLineToRelative(0.0f);
        pathBuilderA.curveTo(8.0f, 10.34f, 8.34f, 10.0f, 8.75f, 10.0f);
        androidx.compose.animation.a.j(pathBuilderA, 9.75f, 13.0f, 4.5f);
        pathBuilderA.curveToRelative(0.41f, 0.0f, 0.75f, 0.34f, 0.75f, 0.75f);
        pathBuilderA.verticalLineToRelative(0.0f);
        pathBuilderA.curveToRelative(0.0f, 0.41f, -0.34f, 0.75f, -0.75f, 0.75f);
        pathBuilderA.horizontalLineToRelative(-4.5f);
        pathBuilderA.curveTo(9.34f, 14.5f, 9.0f, 14.16f, 9.0f, 13.75f);
        pathBuilderA.verticalLineToRelative(0.0f);
        pathBuilderA.curveTo(9.0f, 13.34f, 9.34f, 13.0f, 9.75f, 13.0f);
        pathBuilderA.close();
