...
public final class MarkUnreadChatAltKt {
    ...
    public static final ImageVector getMarkUnreadChatAlt(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.MarkUnreadChatAlt", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        a.D(pathBuilderO, 4.0f, -4.0f, 16.0f, 6.97f);
        pathBuilderO.curveTo(21.16f, 7.61f, 20.13f, 8.0f, 19.0f, 8.0f);
        h.r(pathBuilderO, 6.0f, 14.0f, 14.0f, 6.0f);
        androidx.appcompat.graphics.drawable.a.h(pathBuilderO, -2.0f, 8.0f, 14.0f);
