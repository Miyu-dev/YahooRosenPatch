...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_wc", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Wc", "Landroidx/compose/material/icons/Icons$Sharp;", "getWc", "(Landroidx/compose/material/icons/Icons$Sharp;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-sharp_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class WcKt {
    ...
    public static final ImageVector getWc(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.Wc", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m2844getBlack0d7_KjU(), null);
        int iM3141getButtKaPHkGw = StrokeCap.INSTANCE.m3141getButtKaPHkGw();
        int iM3151getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3151getBevelLxFBmk8();
        PathBuilder pathBuilderU = a.u(5.5f, 22.0f, -7.5f, 4.0f, 14.5f);
        androidx.compose.animation.a.o(pathBuilderU, 4.0f, 7.0f, 7.0f, 7.5f);
        pathBuilderU.lineTo(9.5f, 14.5f);
        h.m(pathBuilderU, 9.5f, 22.0f, -4.0f);
        b.y(pathBuilderU, 18.0f, 22.0f, -6.0f, 3.0f);
        pathBuilderU.lineToRelative(-3.0f, -9.0f);
        androidx.appcompat.graphics.drawable.a.B(pathBuilderU, -3.0f, -3.0f, 9.0f, 3.0f);
        androidx.appcompat.app.m.y(pathBuilderU, 6.0f, 3.0f, 7.5f, 6.0f);
