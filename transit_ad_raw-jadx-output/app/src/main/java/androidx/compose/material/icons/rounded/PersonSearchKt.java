...
public final class PersonSearchKt {
    ...
    public static final ImageVector getPersonSearch(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.PersonSearch", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderD.horizontalLineToRelative(8.54f);
        ...
        pathBuilderD2.curveToRelative(0.47f, -0.8f, 0.7f, -1.77f, 0.48f, -2.82f);
        pathBuilderD2.curveToRelative(-0.34f, -1.64f, -1.72f, -2.95f, -3.38f, -3.16f);
        pathBuilderD2.curveToRelative(-2.63f, -0.34f, -4.85f, 1.87f, -4.5f, 4.5f);
        pathBuilderD2.curveToRelative(0.22f, 1.66f, 1.52f, 3.04f, 3.16f, 3.38f);
        pathBuilderD2.curveToRelative(1.05f, 0.22f, 2.02f, -0.01f, 2.82f, -0.48f);
        pathBuilderD2.lineToRelative(1.86f, 1.86f);
        ...
        androidx.appcompat.view.menu.a.z(pathBuilderD2, 19.43f, 18.02f, 16.0f, 18.0f);
