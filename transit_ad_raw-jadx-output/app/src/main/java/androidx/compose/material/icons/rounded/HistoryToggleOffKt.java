...
public final class HistoryToggleOffKt {
    ...
    public static final ImageVector getHistoryToggleOff(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.HistoryToggleOff", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        androidx.compose.animation.a.t(pathBuilderA, 12.0f, 7.0f, 12.0f, 7.0f);
        ...
        pathBuilderA.curveTo(13.0f, 7.45f, 12.55f, 7.0f, 12.0f, 7.0f);
        pathBuilderA.close();
