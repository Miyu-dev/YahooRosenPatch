...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_allInclusive", "Landroidx/compose/ui/graphics/vector/ImageVector;", "AllInclusive", "Landroidx/compose/material/icons/Icons$Filled;", "getAllInclusive", "(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-filled_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class AllInclusiveKt {
    ...
    public static final ImageVector getAllInclusive(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.AllInclusive", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderD.lineTo(12.0f, 10.66f);
        pathBuilderD.lineTo(10.48f, 12.0f);
        ...
        pathBuilderD.curveToRelative(1.44f, 0.0f, 2.8f, -0.56f, 3.77f, -1.53f);
        pathBuilderD.lineToRelative(2.83f, -2.5f);
        pathBuilderD.lineToRelative(0.01f, 0.01f);
        pathBuilderD.lineTo(13.52f, 12.0f);
        pathBuilderD.horizontalLineToRelative(-0.01f);
        pathBuilderD.lineToRelative(2.69f, -2.39f);
        pathBuilderD.curveToRelative(0.64f, -0.64f, 1.49f, -0.99f, 2.4f, -0.99f);
        pathBuilderD.curveToRelative(1.87f, 0.0f, 3.39f, 1.51f, 3.39f, 3.38f);
