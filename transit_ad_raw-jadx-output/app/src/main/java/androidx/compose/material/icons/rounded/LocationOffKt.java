...
public final class LocationOffKt {
    ...
    public static final ImageVector getLocationOff(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.LocationOff", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m2844getBlack0d7_KjU(), null);
        int iM3141getButtKaPHkGw = StrokeCap.INSTANCE.m3141getButtKaPHkGw();
        int iM3151getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3151getBevelLxFBmk8();
        PathBuilder pathBuilderD = a.d(2.71f, 3.56f);
        ...
        pathBuilderD.curveToRelative(0.0f, 4.17f, 4.42f, 9.92f, 6.23f, 12.11f);
        pathBuilderD.curveToRelative(0.4f, 0.48f, 1.13f, 0.48f, 1.53f, 0.0f);
        pathBuilderD.curveToRelative(0.65f, -0.78f, 1.62f, -2.01f, 2.61f, -3.46f);
        ...
        pathBuilderD.curveToRelative(0.43f, -0.34f, 0.97f, -0.55f, 1.56f, -0.55f);
        pathBuilderD.curveToRelative(1.38f, 0.0f, 2.5f, 1.12f, 2.5f, 2.5f);
        pathBuilderD.curveToRelative(0.0f, 0.59f, -0.21f, 1.13f, -0.56f, 1.56f);
        pathBuilderD.lineToRelative(3.55f, 3.55f);
