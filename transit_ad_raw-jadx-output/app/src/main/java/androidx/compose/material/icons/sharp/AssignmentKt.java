...
public final class AssignmentKt {
    ...
    public static final ImageVector getAssignment(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.Assignment", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderB.reflectiveCurveToRelative(0.45f, -1.0f, 1.0f, -1.0f);
        androidx.compose.animation.a.t(pathBuilderB, 14.0f, 17.0f, 7.0f, 17.0f);
        a.n(pathBuilderB, -2.0f, 7.0f, 2.0f);
