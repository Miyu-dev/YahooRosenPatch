...
public final class PermIdentityKt {
    ...
    public static final ImageVector getPermIdentity(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.PermIdentity", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        v.y(pathBuilderD, 1.0f, 6.0f, 18.0f, -0.99f);
        pathBuilderD.curveToRelative(0.2f, -0.72f, 3.3f, -2.01f, 6.0f, -2.01f);
        pathBuilderD.moveToRelative(0.0f, -11.0f);
