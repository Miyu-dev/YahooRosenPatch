...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_face6", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Face6", "Landroidx/compose/material/icons/Icons$Outlined;", "getFace6", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-outlined_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class Face6Kt {
    ...
    public static final ImageVector getFace6(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.Face6", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderD.curveToRelative(3.68f, 0.0f, 6.78f, 2.51f, 7.71f, 5.9f);
        pathBuilderD.curveToRelative(-0.6f, -0.16f, -1.33f, -0.37f, -2.26f, -2.24f);
        pathBuilderD.curveTo(16.94f, 6.64f, 15.91f, 6.0f, 14.76f, 6.0f);
        pathBuilderD.horizontalLineTo(9.24f);
        pathBuilderD.curveTo(8.09f, 6.0f, 7.06f, 6.64f, 6.55f, 7.66f);
        pathBuilderD.curveTo(5.62f, 9.52f, 4.97f, 9.72f, 4.29f, 9.9f);
        pathBuilderD.curveTo(5.22f, 6.51f, 8.32f, 4.0f, 12.0f, 4.0f);
        pathBuilderD.close();
        pathBuilderD.moveTo(12.0f, 20.0f);
        pathBuilderD.curveToRelative(-4.41f, 0.0f, -8.0f, -3.59f, -8.0f, -8.0f);
        pathBuilderD.curveToRelative(0.0f, -0.01f, 0.0f, -0.02f, 0.0f, -0.03f);
        pathBuilderD.curveToRelative(2.31f, -0.22f, 3.43f, -1.59f, 4.34f, -3.41f);
        pathBuilderD.curveTo(8.51f, 8.21f, 8.85f, 8.0f, 9.24f, 8.0f);
        pathBuilderD.horizontalLineToRelative(5.53f);
        pathBuilderD.curveToRelative(0.38f, 0.0f, 0.72f, 0.21f, 0.89f, 0.55f);
        pathBuilderD.curveToRelative(0.9f, 1.8f, 1.99f, 3.19f, 4.34f, 3.41f);
        pathBuilderD.curveToRelative(0.0f, 0.01f, 0.0f, 0.02f, 0.0f, 0.03f);
