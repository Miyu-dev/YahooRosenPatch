...
public final class DeleteForeverKt {
    ...
    public static final ImageVector getDeleteForever(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.DeleteForever", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m2844getBlack0d7_KjU(), null);
        int iM3141getButtKaPHkGw = StrokeCap.INSTANCE.m3141getButtKaPHkGw();
        int iM3151getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3151getBevelLxFBmk8();
        PathBuilder pathBuilderA = b.a(14.12f, 10.47f, 12.0f, 12.59f);
        ...
        pathBuilderA.lineToRelative(2.12f, 2.12f);
        pathBuilderA.lineToRelative(1.41f, -1.41f);
        a.A(pathBuilderA, 13.41f, 14.0f, 2.12f, -2.12f);
        pathBuilderA.moveTo(15.5f, 4.0f);
        pathBuilderA.lineToRelative(-1.0f, -1.0f);
        a.C(pathBuilderA, -5.0f, -1.0f, 1.0f, 5.0f);
        androidx.appcompat.graphics.drawable.a.h(pathBuilderA, 2.0f, 14.0f, 4.0f);
        ...
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, androidx.browser.browseractions.a.i(pathBuilderA, 8.0f, 9.0f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw, iM3151getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
