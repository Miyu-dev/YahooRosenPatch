...
public final class PersonAddKt {
    ...
    public static final ImageVector getPersonAdd(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.PersonAdd", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderD = a.d(15.0f, 16.0f);
        ...
        PathBuilder pathBuilderB = v.b(15.0f, 8.0f, -2.0f, 0.0f);
        ...
        pathBuilderD2.reflectiveCurveToRelative(1.79f, 4.0f, 4.0f, 4.0f);
        pathBuilderD2.close();
        pathBuilderD2.moveTo(15.0f, 6.0f);
        ...
        androidx.appcompat.view.menu.a.z(pathBuilderD2, 9.0f, 18.0f, 6.0f, 15.0f);
        android.support.v4.media.a.m(pathBuilderD2, -3.0f, 3.0f, -2.0f);
        pathBuilderD2.lineTo(6.0f, 10.0f);
        pathBuilderD2.lineTo(6.0f, 7.0f);
        pathBuilderD2.lineTo(4.0f, 7.0f);
        v.y(pathBuilderD2, 3.0f, 1.0f, 10.0f, 2.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, v.j(pathBuilderD2, 3.0f, 3.0f), defaultFillType3, "", solidColor3, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw3, iM3151getBevelLxFBmk83, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
