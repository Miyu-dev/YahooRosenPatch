...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_transferWithinAStation", "Landroidx/compose/ui/graphics/vector/ImageVector;", "TransferWithinAStation", "Landroidx/compose/material/icons/Icons$Outlined;", "getTransferWithinAStation", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-outlined_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class TransferWithinAStationKt {
    ...
    public static final ImageVector getTransferWithinAStation(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.TransferWithinAStation", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        c.a.k(pathBuilderU, 22.0f, 17.0f, -1.5f, -5.51f);
        pathBuilderU.moveTo(19.51f, 19.75f);
        b.s(pathBuilderU, 14.0f, 19.75f, 1.5f, 5.51f);
        pathBuilderU.lineTo(19.51f, 23.0f);
        pathBuilderU.lineTo(22.0f, 20.5f);
        androidx.compose.animation.b.k(pathBuilderU, 19.51f, 18.0f, 1.75f);
        ...
        b.s(pathBuilderU, 9.0f, 17.0f, 6.0f, 2.0f);
