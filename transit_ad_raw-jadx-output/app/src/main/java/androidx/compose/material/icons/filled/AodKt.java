...
public final class AodKt {
    ...
    public static final ImageVector getAod(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.Aod", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        b.m(pathBuilderA, 10.0f, 18.0f, 8.0f, 10.0f);
        s.A(pathBuilderA, 8.0f, 1.5f, 8.0f, 10.0f);
        androidx.appcompat.view.menu.a.x(pathBuilderA, 9.0f, 13.0f, 6.0f, 1.5f);
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, androidx.browser.browseractions.a.i(pathBuilderA, 9.0f, 13.0f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw, iM3151getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
