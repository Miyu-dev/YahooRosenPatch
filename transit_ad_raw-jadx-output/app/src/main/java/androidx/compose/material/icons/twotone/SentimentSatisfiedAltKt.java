...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_sentimentSatisfiedAlt", "Landroidx/compose/ui/graphics/vector/ImageVector;", "SentimentSatisfiedAlt", "Landroidx/compose/material/icons/Icons$TwoTone;", "getSentimentSatisfiedAlt", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class SentimentSatisfiedAltKt {
    ...
    public static final ImageVector getSentimentSatisfiedAlt(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.SentimentSatisfiedAlt", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderD.reflectiveCurveToRelative(-3.58f, -8.0f, -8.0f, -8.0f);
        pathBuilderD.close();
        pathBuilderD.moveTo(15.5f, 8.0f);
        ...
        pathBuilderD.curveToRelative(0.7f, 1.19f, 1.97f, 2.0f, 3.45f, 2.0f);
        pathBuilderD.reflectiveCurveToRelative(2.76f, -0.81f, 3.45f, -2.0f);
        pathBuilderD.horizontalLineToRelative(1.67f);
        pathBuilderD.curveToRelative(-0.8f, 2.05f, -2.79f, 3.5f, -5.12f, 3.5f);
        pathBuilderD.close();
        ...
        PathBuilder pathBuilderB = v.b(15.5f, 9.5f, -1.5f, 0.0f);
        ...
        PathBuilder pathBuilderB2 = v.b(8.5f, 9.5f, -1.5f, 0.0f);
        ...
        pathBuilderD2.curveToRelative(-1.48f, 0.0f, -2.75f, -0.81f, -3.45f, -2.0f);
        pathBuilderD2.lineTo(6.88f, 14.0f);
        pathBuilderD2.curveToRelative(0.8f, 2.05f, 2.79f, 3.5f, 5.12f, 3.5f);
        pathBuilderD2.reflectiveCurveToRelative(4.32f, -1.45f, 5.12f, -3.5f);
        pathBuilderD2.horizontalLineToRelative(-1.67f);
        pathBuilderD2.curveToRelative(-0.69f, 1.19f, -1.97f, 2.0f, -3.45f, 2.0f);
        pathBuilderD2.close();
        pathBuilderD2.moveTo(11.99f, 2.0f);
        ...
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, androidx.appcompat.view.menu.a.j(pathBuilderD2, -3.58f, 8.0f, -8.0f, 8.0f), defaultFillType4, "", solidColor4, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw4, iM3151getBevelLxFBmk84, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
