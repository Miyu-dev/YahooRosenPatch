...
public final class FlashAutoKt {
    ...
    public static final ImageVector getFlashAuto(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.FlashAuto", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        androidx.compose.animation.a.A(pathBuilderP, 9.0f, 11.0f, 4.0f, -9.0f);
        pathBuilderP.moveTo(17.0f, 2.0f);
        pathBuilderP.lineToRelative(-3.2f, 9.0f);
        androidx.appcompat.graphics.drawable.a.B(pathBuilderP, 1.9f, 0.7f, -2.0f, 3.2f);
        pathBuilderP.lineToRelative(0.7f, 2.0f);
        h.C(pathBuilderP, 1.9f, 19.0f, 2.0f, -2.0f);
        pathBuilderP.moveTo(16.85f, 7.65f);
