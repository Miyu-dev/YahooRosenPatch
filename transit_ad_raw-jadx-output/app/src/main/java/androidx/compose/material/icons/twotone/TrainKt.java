...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_train", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Train", "Landroidx/compose/material/icons/Icons$TwoTone;", "getTrain", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class TrainKt {
    ...
    public static final ImageVector getTrain(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.Train", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderD.horizontalLineToRelative(11.13f);
        pathBuilderD.curveToRelative(-0.6f, -0.52f, -2.05f, -1.0f, -5.56f, -1.0f);
        pathBuilderD.close();
        pathBuilderD.moveTo(6.0f, 15.5f);
        ...
        b.k(pathBuilderD, 6.0f, 12.0f, 3.5f);
        ...
        pathBuilderD2.curveToRelative(-4.0f, 0.0f, -8.0f, 0.5f, -8.0f, 4.0f);
        pathBuilderD2.verticalLineToRelative(9.5f);
        pathBuilderD2.curveTo(4.0f, 17.43f, 5.57f, 19.0f, 7.5f, 19.0f);
        a.b.s(pathBuilderD2, 6.0f, 20.5f, 0.5f, 2.0f);
        pathBuilderD2.lineToRelative(2.0f, -2.0f);
        androidx.appcompat.graphics.drawable.a.B(pathBuilderD2, 4.0f, 2.0f, 2.0f, 2.0f);
        pathBuilderD2.verticalLineToRelative(-0.5f);
        pathBuilderD2.lineTo(16.5f, 19.0f);
        pathBuilderD2.curveToRelative(1.93f, 0.0f, 3.5f, -1.57f, 3.5f, -3.5f);
        pathBuilderD2.lineTo(20.0f, 6.0f);
        pathBuilderD2.curveToRelative(0.0f, -3.5f, -4.0f, -4.0f, -8.0f, -4.0f);
        pathBuilderD2.close();
        pathBuilderD2.moveTo(12.0f, 4.0f);
        pathBuilderD2.curveToRelative(3.51f, 0.0f, 4.96f, 0.48f, 5.57f, 1.0f);
        pathBuilderD2.lineTo(6.43f, 5.0f);
        pathBuilderD2.curveToRelative(0.61f, -0.52f, 2.06f, -1.0f, 5.57f, -1.0f);
        b.r(pathBuilderD2, 6.0f, 7.0f, 5.0f, 3.0f);
        android.support.v4.media.a.C(pathBuilderD2, 6.0f, 10.0f, 6.0f, 7.0f);
        pathBuilderD2.moveTo(18.0f, 15.5f);
        ...
        s.w(pathBuilderD2, 6.0f, 12.0f, 12.0f, 3.5f);
        pathBuilderD2.moveTo(18.0f, 10.0f);
        androidx.appcompat.view.menu.a.y(pathBuilderD2, -5.0f, 13.0f, 7.0f, 5.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, androidx.appcompat.view.menu.a.h(pathBuilderD2, 3.0f), defaultFillType4, "", solidColor4, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw4, iM3151getBevelLxFBmk84, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
