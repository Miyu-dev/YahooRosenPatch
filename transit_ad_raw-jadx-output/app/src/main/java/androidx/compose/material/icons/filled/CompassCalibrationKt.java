...
public final class CompassCalibrationKt {
    ...
    public static final ImageVector getCompassCalibration(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.CompassCalibration", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderD = a.d(12.0f, 10.07f);
        pathBuilderD.curveToRelative(1.95f, 0.0f, 3.72f, 0.79f, 5.0f, 2.07f);
        pathBuilderD.lineToRelative(5.0f, -5.0f);
        pathBuilderD.curveTo(19.44f, 4.59f, 15.9f, 3.0f, 12.0f, 3.0f);
        pathBuilderD.reflectiveCurveTo(4.56f, 4.59f, 2.0f, 7.15f);
        pathBuilderD.lineToRelative(5.0f, 5.0f);
