...
public final class SwapCallsKt {
    ...
    public static final ImageVector getSwapCalls(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.SwapCalls", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m2844getBlack0d7_KjU(), null);
        int iM3141getButtKaPHkGw = StrokeCap.INSTANCE.m3141getButtKaPHkGw();
        int iM3151getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3151getBevelLxFBmk8();
        PathBuilder pathBuilderA = b.a(17.65f, 4.35f, -2.79f, 2.79f);
        ...
        pathBuilderA.curveToRelative(0.0f, 1.0f, -0.67f, 1.93f, -1.66f, 2.09f);
        pathBuilderA.curveToRelative(-1.25f, 0.21f, -2.34f, -0.76f, -2.34f, -1.97f);
        pathBuilderA.verticalLineTo(8.17f);
        pathBuilderA.curveToRelative(0.0f, -2.09f, -1.53f, -3.95f, -3.61f, -4.15f);
        pathBuilderA.curveTo(7.01f, 3.79f, 5.0f, 5.66f, 5.0f, 8.0f);
        ...
        pathBuilderA.verticalLineTo(8.12f);
        pathBuilderA.curveToRelative(0.0f, -1.0f, 0.67f, -1.93f, 1.66f, -2.09f);
        pathBuilderA.curveTo(9.91f, 5.82f, 11.0f, 6.79f, 11.0f, 8.0f);
        pathBuilderA.verticalLineToRelative(6.83f);
        pathBuilderA.curveToRelative(0.0f, 2.09f, 1.53f, 3.95f, 3.61f, 4.15f);
        pathBuilderA.curveTo(16.99f, 19.21f, 19.0f, 17.34f, 19.0f, 15.0f);
