...
public final class SlowMotionVideoKt {
    ...
    public static final ImageVector getSlowMotionVideo(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.SlowMotionVideo", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m2844getBlack0d7_KjU(), null);
        int iM3141getButtKaPHkGw = StrokeCap.INSTANCE.m3141getButtKaPHkGw();
        int iM3151getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3151getBevelLxFBmk8();
        PathBuilder pathBuilderA = b.a(4.26f, 18.32f, 1.43f, -1.43f);
        pathBuilderA.curveToRelative(-0.86f, -1.1f, -1.44f, -2.43f, -1.62f, -3.89f);
        pathBuilderA.lineTo(2.05f, 13.0f);
        pathBuilderA.curveToRelative(0.2f, 2.01f, 1.0f, 3.84f, 2.21f, 5.32f);
        pathBuilderA.close();
        pathBuilderA.moveTo(7.1f, 5.69f);
        ...
        a.z(pathBuilderA, 7.1f, 5.69f, 2.05f, 11.0f);
        pathBuilderA.horizontalLineToRelative(2.02f);
        pathBuilderA.curveToRelative(0.18f, -1.46f, 0.76f, -2.79f, 1.62f, -3.9f);
        pathBuilderA.lineTo(4.26f, 5.68f);
        pathBuilderA.curveTo(3.05f, 7.16f, 2.25f, 8.99f, 2.05f, 11.0f);
        androidx.compose.animation.a.n(pathBuilderA, 13.05f, 2.05f, 2.02f);
        pathBuilderA.curveTo(16.97f, 4.59f, 20.0f, 7.95f, 20.0f, 12.0f);
        pathBuilderA.reflectiveCurveToRelative(-3.03f, 7.41f, -6.95f, 7.93f);
        pathBuilderA.verticalLineToRelative(2.02f);
        pathBuilderA.curveTo(18.08f, 21.42f, 22.0f, 17.16f, 22.0f, 12.0f);
        pathBuilderA.curveToRelative(0.0f, -5.16f, -3.92f, -9.42f, -8.95f, -9.95f);
        androidx.browser.browseractions.a.y(pathBuilderA, 16.0f, 12.0f, -2.95f, -2.21f);
        pathBuilderA.lineTo(10.0f, 7.5f);
        v.v(pathBuilderA, 9.0f, 3.05f, -2.29f);
