...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_sentimentDissatisfied", "Landroidx/compose/ui/graphics/vector/ImageVector;", "SentimentDissatisfied", "Landroidx/compose/material/icons/Icons$Rounded;", "getSentimentDissatisfied", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class SentimentDissatisfiedKt {
    ...
    public static final ImageVector getSentimentDissatisfied(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.SentimentDissatisfied", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderD.curveToRelative(-1.9f, 0.0f, -3.63f, 0.97f, -4.65f, 2.58f);
        pathBuilderD.curveToRelative(-0.22f, 0.35f, -0.11f, 0.81f, 0.24f, 1.03f);
        pathBuilderD.curveToRelative(0.35f, 0.22f, 0.81f, 0.11f, 1.03f, -0.24f);
        pathBuilderD.curveToRelative(0.74f, -1.18f, 2.0f, -1.88f, 3.38f, -1.88f);
        pathBuilderD.reflectiveCurveToRelative(2.64f, 0.7f, 3.38f, 1.88f);
        pathBuilderD.curveToRelative(0.14f, 0.23f, 0.39f, 0.35f, 0.64f, 0.35f);
        pathBuilderD.curveToRelative(0.14f, 0.0f, 0.27f, -0.04f, 0.4f, -0.11f);
        pathBuilderD.curveToRelative(0.35f, -0.22f, 0.46f, -0.68f, 0.24f, -1.03f);
        pathBuilderD.curveTo(15.63f, 14.96f, 13.9f, 14.0f, 12.0f, 14.0f);
        pathBuilderD.close();
