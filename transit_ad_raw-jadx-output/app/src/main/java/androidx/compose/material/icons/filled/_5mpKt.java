...
public final class _5mpKt {
    ...
    public static final ImageVector get_5mp(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled._5mp", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderA.curveToRelative(0.0f, 0.55f, -0.45f, 1.0f, -1.0f, 1.0f);
        androidx.appcompat.graphics.drawable.a.z(pathBuilderA, -2.0f, 1.5f, 14.5f, 7.0f);
        android.support.v4.media.a.s(pathBuilderA, -3.0f, 1.0f, 2.0f);
        pathBuilderA.curveToRelative(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        pathBuilderA.verticalLineToRelative(1.5f);
        pathBuilderA.curveToRelative(0.0f, 0.55f, -0.45f, 1.0f, -1.0f, 1.0f);
        pathBuilderA.lineTo(10.0f, 11.5f);
        pathBuilderA.lineTo(10.0f, 10.0f);
        androidx.appcompat.view.menu.a.y(pathBuilderA, 3.0f, 13.0f, 9.0f, -3.0f);
        pathBuilderA.lineTo(10.0f, 5.5f);
        androidx.appcompat.view.menu.a.s(pathBuilderA, 4.5f, 14.5f, 7.0f);
