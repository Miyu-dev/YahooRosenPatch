...
public final class FreeCancellationKt {
    ...
    public static final ImageVector getFreeCancellation(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.FreeCancellation", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        a.z(pathBuilderG, 4.38f, 2.0f, -2.0f, 4.0f);
        androidx.appcompat.app.m.w(pathBuilderG, -3.0f, 2.0f, -2.0f, 2.0f);
        androidx.compose.animation.a.v(pathBuilderG, 8.0f, 2.0f, 6.0f, 2.0f);
        androidx.compose.animation.a.s(pathBuilderG, 3.0f, 18.0f, 10.21f);
        androidx.appcompat.view.menu.a.z(pathBuilderG, 11.21f, 20.0f, 16.54f, 22.5f);
