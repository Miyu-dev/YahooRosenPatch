...
public final class SettingsInputCompositeKt {
    ...
    public static final ImageVector getSettingsInputComposite(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.SettingsInputComposite", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderD = a.d(3.0f, 16.0f);
