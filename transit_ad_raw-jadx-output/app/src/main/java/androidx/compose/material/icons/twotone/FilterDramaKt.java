...
public final class FilterDramaKt {
    ...
    public static final ImageVector getFilterDrama(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.FilterDrama", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderO.curveTo(17.5f, 8.47f, 15.03f, 6.0f, 12.0f, 6.0f);
        pathBuilderO.curveToRelative(-1.8f, 0.0f, -3.39f, 0.88f, -4.4f, 2.22f);
        pathBuilderO.curveToRelative(2.54f, 0.7f, 4.4f, 3.02f, 4.4f, 5.78f);
        ...
        ImageVector.Builder.m3359addPathoIyEayM$default(builder, a.j(pathBuilderO, -1.35f, -3.0f, -3.0f, -3.0f), defaultFillType, "", solidColor, 0.3f, null, 0.3f, 1.0f, iM3141getButtKaPHkGw, iM3151getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        pathBuilderD.curveToRelative(0.0f, -2.76f, -1.86f, -5.08f, -4.4f, -5.78f);
        pathBuilderD.curveTo(8.61f, 6.88f, 10.2f, 6.0f, 12.0f, 6.0f);
        ...
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, a.j(pathBuilderD, -1.35f, 3.0f, -3.0f, 3.0f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw2, iM3151getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
