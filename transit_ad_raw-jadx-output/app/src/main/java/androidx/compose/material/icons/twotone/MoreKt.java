...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_more", "Landroidx/compose/ui/graphics/vector/ImageVector;", "More", "Landroidx/compose/material/icons/Icons$TwoTone;", "getMore", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class MoreKt {
    ...
    public static final ImageVector getMore(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.More", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderA.lineToRelative(4.67f, 7.0f);
        pathBuilderA.lineTo(22.0f, 19.0f);
        pathBuilderA.lineTo(22.0f, 5.0f);
        pathBuilderA.lineTo(7.06f, 5.0f);
        ...
        pathBuilderA.reflectiveCurveToRelative(0.67f, -1.5f, 1.5f, -1.5f);
        pathBuilderA.close();
        pathBuilderA.moveTo(9.0f, 10.5f);
        pathBuilderA.curveToRelative(0.83f, 0.0f, 1.5f, 0.67f, 1.5f, 1.5f);
        pathBuilderA.reflectiveCurveToRelative(-0.67f, 1.5f, -1.5f, 1.5f);
        pathBuilderA.reflectiveCurveToRelative(-1.5f, -0.67f, -1.5f, -1.5f);
        ImageVector.Builder.m3359addPathoIyEayM$default(builder, a.j(pathBuilderA, 0.67f, -1.5f, 1.5f, -1.5f), defaultFillType, "", solidColor, 0.3f, null, 0.3f, 1.0f, iM3141getButtKaPHkGw, iM3151getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        pathBuilderA2.curveToRelative(0.36f, 0.53f, 0.97f, 0.89f, 1.66f, 0.89f);
        pathBuilderA2.lineTo(22.0f, 21.0f);
        ...
        androidx.compose.animation.a.t(pathBuilderA2, 22.0f, 19.0f, 7.07f, 19.0f);
        pathBuilderA2.lineTo(2.4f, 12.0f);
        pathBuilderA2.lineToRelative(4.66f, -7.0f);
        ImageVector.Builder.m3359addPathoIyEayM$default(builder, c.a.e(pathBuilderA2, 22.0f, 5.0f, 14.0f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw2, iM3151getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        int defaultFillType3 = VectorKt.getDefaultFillType();
        SolidColor solidColor3 = new SolidColor(companion.m2844getBlack0d7_KjU(), null);
        int iM3141getButtKaPHkGw3 = companion2.m3141getButtKaPHkGw();
        int iM3151getBevelLxFBmk83 = companion3.m3151getBevelLxFBmk8();
        PathBuilder pathBuilderB = v.b(9.0f, 12.0f, -1.5f, 0.0f);
        ...
        PathBuilder pathBuilderB2 = v.b(14.0f, 12.0f, -1.5f, 0.0f);
        ...
        PathBuilder pathBuilderB3 = v.b(19.0f, 12.0f, -1.5f, 0.0f);
