...
public final class UnsubscribeKt {
    ...
    public static final ImageVector getUnsubscribe(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.Unsubscribe", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderD.curveToRelative(0.92f, 0.0f, 1.76f, 0.26f, 2.5f, 0.69f);
        ...
        pathBuilderD.curveToRelative(0.0f, 1.1f, 0.9f, 2.0f, 2.0f, 2.0f);
        b.q(pathBuilderD, 8.55f, 12.0f, 10.5f);
