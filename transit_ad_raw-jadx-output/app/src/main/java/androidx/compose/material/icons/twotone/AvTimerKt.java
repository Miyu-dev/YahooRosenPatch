...
public final class AvTimerKt {
    ...
    public static final ImageVector getAvTimer(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.AvTimer", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        androidx.appcompat.graphics.drawable.a.u(pathBuilderD, -1.0f, 4.0f, 2.0f, 5.08f);
        ...
        PathBuilder pathBuilderB = v.b(12.0f, 17.0f, -1.0f, 0.0f);
        ...
        PathBuilder pathBuilderB3 = v.b(7.0f, 12.0f, -1.0f, 0.0f);
