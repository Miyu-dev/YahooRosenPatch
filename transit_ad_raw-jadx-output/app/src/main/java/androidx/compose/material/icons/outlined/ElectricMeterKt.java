...
public final class ElectricMeterKt {
    ...
    public static final ImageVector getElectricMeter(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.ElectricMeter", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderD.curveToRelative(0.0f, 3.92f, 2.51f, 7.24f, 6.0f, 8.48f);
        ...
        v.r(pathBuilderD, 22.0f, 2.0f, -2.52f);
        pathBuilderD.curveTo(18.49f, 18.24f, 21.0f, 14.92f, 21.0f, 11.0f);
        pathBuilderD.close();
        ...
        ImageVector.Builder.m3359addPathoIyEayM$default(builder, h.t(pathBuilderD, 15.86f, 18.0f, 12.0f, 18.0f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw, iM3151getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, androidx.appcompat.graphics.drawable.a.e(pathBuilderA, -1.25f, -1.25f, 1.25f, -1.25f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw2, iM3151getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
