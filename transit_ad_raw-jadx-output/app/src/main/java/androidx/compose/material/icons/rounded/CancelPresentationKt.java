...
public final class CancelPresentationKt {
    ...
    public static final ImageVector getCancelPresentation(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.CancelPresentation", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderA.curveToRelative(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        a.v(pathBuilderA, 12.0f, 15.29f, 8.7f);
        ...
        pathBuilderA.lineToRelative(1.89f, -1.89f);
        pathBuilderA.curveToRelative(0.38f, -0.38f, 0.38f, -1.02f, -0.01f, -1.41f);
        pathBuilderA.close();
