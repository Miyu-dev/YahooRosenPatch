...
public final class AssignmentIndKt {
    ...
    public static final ImageVector getAssignmentInd(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.AssignmentInd", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderD = androidx.browser.browseractions.a.d(20.66f, 3.88f);
        ...
        pathBuilderD.horizontalLineToRelative(-4.18f);
        pathBuilderD.curveTo(14.4f, 1.84f, 13.3f, 1.0f, 12.0f, 1.0f);
        pathBuilderD.reflectiveCurveToRelative(-2.4f, 0.84f, -2.82f, 2.0f);
        ...
        pathBuilderD.curveToRelative(0.0f, -0.41f, -0.13f, -0.8f, -0.34f, -1.12f);
        pathBuilderD.close();
        pathBuilderD.moveTo(12.0f, 2.75f);
        pathBuilderD.curveToRelative(0.22f, 0.0f, 0.41f, 0.1f, 0.55f, 0.25f);
        pathBuilderD.curveToRelative(0.12f, 0.13f, 0.2f, 0.31f, 0.2f, 0.5f);
        ...
        pathBuilderD.curveToRelative(0.0f, -0.19f, 0.08f, -0.37f, 0.2f, -0.5f);
        pathBuilderD.curveToRelative(0.14f, -0.15f, 0.33f, -0.25f, 0.55f, -0.25f);
        ...
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, b.h(pathBuilderD, 8.31f, 16.0f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw2, iM3151getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
