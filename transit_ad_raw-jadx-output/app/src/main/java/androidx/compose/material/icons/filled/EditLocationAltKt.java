...
public final class EditLocationAltKt {
    ...
    public static final ImageVector getEditLocationAlt(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.EditLocationAlt", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        ImageVector.Builder.m3359addPathoIyEayM$default(builder, b.h(pathBuilderB, 13.95f, 13.0f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw, iM3151getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        pathBuilderA2.curveTo(19.8f, 1.1f, 19.55f, 1.0f, 19.29f, 1.0f);
        pathBuilderA2.curveToRelative(-0.13f, 0.0f, -0.48f, 0.07f, -0.71f, 0.29f);
