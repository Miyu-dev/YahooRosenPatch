...
public final class TapasKt {
    ...
    public static final ImageVector getTapas(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.Tapas", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        androidx.appcompat.view.menu.a.o(pathBuilderC, 3.0f, 20.0f, 10.0f, 9.0f);
        c.a.i(pathBuilderC, 8.0f, 8.0f, 2.0f);
