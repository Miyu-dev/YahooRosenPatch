...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_vaccines", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Vaccines", "Landroidx/compose/material/icons/Icons$TwoTone;", "getVaccines", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class VaccinesKt {
    ...
    public static final ImageVector getVaccines(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.Vaccines", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderF = a.f(19.0f, 17.0f, -4.0f, -1.5f, 4.0f);
        androidx.compose.animation.a.y(pathBuilderF, 17.0f, 9.0f, 7.5f, 5.0f);
        androidx.appcompat.app.m.u(pathBuilderF, 15.0f, 4.0f, 0.0f, -1.5f);
        pathBuilderF.horizontalLineTo(7.25f);
        pathBuilderF.curveToRelative(-0.41f, 0.0f, -0.75f, -0.34f, -0.75f, -0.75f);
        pathBuilderF.curveTo(6.5f, 12.34f, 6.84f, 12.0f, 7.25f, 12.0f);
        b.r(pathBuilderF, 9.0f, -1.5f, 7.25f);
        pathBuilderF.curveToRelative(-0.41f, 0.0f, -0.75f, -0.34f, -0.75f, -0.75f);
        pathBuilderF.curveTo(6.5f, 9.34f, 6.84f, 9.0f, 7.25f, 9.0f);
        ImageVector.Builder.m3359addPathoIyEayM$default(builder, a.i(pathBuilderF, 9.0f, 7.5f), defaultFillType, "", solidColor, 0.3f, null, 0.3f, 1.0f, iM3141getButtKaPHkGw, iM3151getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        h.B(pathBuilderG, 19.0f, 15.5f, 17.0f, -4.0f);
        pathBuilderG.curveToRelative(0.0f, -0.51f, 0.0f, -1.02f, 0.0f, -1.5f);
        androidx.compose.animation.b.w(pathBuilderG, 19.0f, 15.0f, 20.0f);
        pathBuilderG.curveToRelative(0.0f, 0.0f, 0.0f, -0.63f, 0.0f, -1.5f);
        pathBuilderG.horizontalLineToRelative(4.0f);
        pathBuilderG.verticalLineTo(20.0f);
        pathBuilderG.horizontalLineTo(15.0f);
        pathBuilderG.close();
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, pathBuilderG.getNodes(), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw2, iM3151getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
