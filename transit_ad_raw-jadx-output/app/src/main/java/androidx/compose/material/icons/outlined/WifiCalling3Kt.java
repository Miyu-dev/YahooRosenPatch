...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_wifiCalling3", "Landroidx/compose/ui/graphics/vector/ImageVector;", "WifiCalling3", "Landroidx/compose/material/icons/Icons$Outlined;", "getWifiCalling3", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-outlined_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class WifiCalling3Kt {
    ...
    public static final ImageVector getWifiCalling3(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.WifiCalling3", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderD = a.d(16.49f, 4.5f);
        pathBuilderD.curveToRelative(1.79f, 0.0f, 3.42f, 0.73f, 4.59f, 1.91f);
        ...
        pathBuilderD.lineToRelative(1.06f, 1.06f);
        pathBuilderD.curveTo(13.08f, 5.23f, 14.7f, 4.5f, 16.49f, 4.5f);
        pathBuilderD.close();
        ...
        PathBuilder pathBuilderD2 = a.d(16.49f, 6.0f);
        pathBuilderD2.curveToRelative(-1.38f, 0.0f, -2.63f, 0.56f, -3.54f, 1.46f);
        ...
        PathBuilder pathBuilderD3 = a.d(16.49f, 9.0f);
        pathBuilderD3.curveToRelative(-0.55f, 0.0f, -1.05f, 0.22f, -1.41f, 0.59f);
        pathBuilderD3.lineTo(16.49f, 11.0f);
        pathBuilderD3.lineToRelative(1.41f, -1.41f);
        pathBuilderD3.curveTo(17.54f, 9.22f, 17.04f, 9.0f, 16.49f, 9.0f);
        pathBuilderD3.close();
        ...
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, s.i(pathBuilderA, 19.0f, 16.67f, 18.9f), defaultFillType4, "", solidColor4, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw4, iM3151getBevelLxFBmk84, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
