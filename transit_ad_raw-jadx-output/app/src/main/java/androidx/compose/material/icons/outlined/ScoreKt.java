...
public final class ScoreKt {
    ...
    public static final ImageVector getScore(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.Score", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderA.lineToRelative(4.0f, 4.0f);
        a.u(pathBuilderA, 6.0f, -6.0f, 6.0f);
        ...
        b.s(pathBuilderA, 7.0f, 6.0f, 1.5f, 2.5f);
        pathBuilderA.verticalLineToRelative(0.75f);
        pathBuilderA.lineTo(7.0f, 8.25f);
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, s.p(pathBuilderA, 7.0f, 12.0f, 4.0f), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw, iM3151getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
