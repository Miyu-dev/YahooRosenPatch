...
public final class AppBlockingKt {
    ...
    public static final ImageVector getAppBlocking(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.AppBlocking", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderP = a.p(19.0f, 23.0f, -6.0f, -2.0f, 1.0f);
        s.t(pathBuilderP, 7.0f, 6.0f, 10.0f, 1.0f);
        pathBuilderP.horizontalLineToRelative(2.0f);
        pathBuilderP.verticalLineTo(0.94f);
        pathBuilderP.lineTo(5.0f, 1.0f);
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, androidx.compose.animation.a.m(pathBuilderP, 22.0f, 19.0f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw2, iM3151getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
