...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_elderlyWoman", "Landroidx/compose/ui/graphics/vector/ImageVector;", "ElderlyWoman", "Landroidx/compose/material/icons/Icons$Outlined;", "getElderlyWoman", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-outlined_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class ElderlyWomanKt {
    ...
    public static final ImageVector getElderlyWoman(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.ElderlyWoman", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderD = a.d(18.5f, 11.0f);
        pathBuilderD.curveToRelative(-1.56f, 0.0f, -2.92f, -0.9f, -3.58f, -2.21f);
        ...
        pathBuilderD.lineToRelative(-2.1f, 2.8f);
        pathBuilderD.lineTo(8.0f, 23.0f);
        a.C(pathBuilderD, 3.0f, -4.0f, 2.0f, 4.0f);
        android.support.v4.media.a.w(pathBuilderD, 2.0f, -4.03f, 13.0f, 13.0f);
        pathBuilderD.lineToRelative(0.49f, -2.71f);
        pathBuilderD.curveToRelative(0.81f, 1.23f, 2.05f, 2.14f, 3.51f, 2.52f);
        android.support.v4.media.a.m(pathBuilderD, 0.69f, 1.0f, -1.0f);
        pathBuilderD.curveToRelative(0.0f, -0.28f, 0.22f, -0.5f, 0.5f, -0.5f);
        pathBuilderD.reflectiveCurveToRelative(0.5f, 0.22f, 0.5f, 0.5f);
        h.w(pathBuilderD, 23.0f, 1.0f, 12.5f);
        pathBuilderD.curveTo(20.0f, 11.67f, 19.33f, 11.0f, 18.5f, 11.0f);
        pathBuilderD.close();
