...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_watchOff", "Landroidx/compose/ui/graphics/vector/ImageVector;", "WatchOff", "Landroidx/compose/material/icons/Icons$Rounded;", "getWatchOff", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class WatchOffKt {
    ...
    public static final ImageVector getWatchOff(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.WatchOff", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderD.lineToRelative(-0.93f, -3.1f);
        pathBuilderD.curveTo(15.17f, 2.58f, 14.4f, 2.0f, 13.51f, 2.0f);
        pathBuilderD.horizontalLineToRelative(-3.02f);
        pathBuilderD.curveTo(9.6f, 2.0f, 8.83f, 2.58f, 8.57f, 3.42f);
        ...
        pathBuilderA.curveTo(8.83f, 21.42f, 9.6f, 22.0f, 10.49f, 22.0f);
        pathBuilderA.horizontalLineToRelative(3.02f);
        pathBuilderA.curveToRelative(0.88f, 0.0f, 1.66f, -0.58f, 1.92f, -1.43f);
        pathBuilderA.lineToRelative(0.53f, -1.78f);
        pathBuilderA.lineToRelative(3.11f, 3.11f);
