...
public final class SubtitlesOffKt {
    ...
    public static final ImageVector getSubtitlesOff(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.SubtitlesOff", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        a.s(pathBuilderS, 20.0f, 2.0f, -3.17f);
        ...
        android.support.v4.media.a.D(pathBuilderA, 8.0f, 12.0f, 2.0f, 4.0f);
        h.z(pathBuilderA, -2.0f, 8.0f, 14.0f, 16.83f);
        b.x(pathBuilderA, 18.0f, 4.0f, -2.0f, 9.17f);
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, b.h(pathBuilderA, 14.0f, 16.83f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw2, iM3151getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
