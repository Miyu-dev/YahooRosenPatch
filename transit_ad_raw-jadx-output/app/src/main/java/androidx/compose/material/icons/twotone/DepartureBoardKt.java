...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_departureBoard", "Landroidx/compose/ui/graphics/vector/ImageVector;", "DepartureBoard", "Landroidx/compose/material/icons/Icons$TwoTone;", "getDepartureBoard", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class DepartureBoardKt {
    ...
    public static final ImageVector getDepartureBoard(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.DepartureBoard", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderA = b.a(9.29f, 6.0f, 9.0f, 6.0f);
        pathBuilderA.curveToRelative(-3.69f, 0.0f, -5.11f, 0.46f, -5.66f, 0.99f);
        pathBuilderA.horizontalLineToRelative(5.74f);
        pathBuilderA.curveToRelative(0.05f, -0.33f, 0.12f, -0.67f, 0.21f, -0.99f);
        a.n(pathBuilderA, 3.0f, 14.0f, 4.0f);
        pathBuilderA.curveToRelative(0.0f, 0.37f, 0.21f, 0.62f, 0.34f, 0.73f);
        pathBuilderA.lineToRelative(0.29f, 0.27f);
        pathBuilderA.horizontalLineToRelative(10.74f);
        pathBuilderA.lineToRelative(0.29f, -0.27f);
        pathBuilderA.curveToRelative(0.13f, -0.11f, 0.34f, -0.36f, 0.34f, -0.73f);
        pathBuilderA.verticalLineToRelative(-3.08f);
        pathBuilderA.curveToRelative(-0.94f, -0.13f, -1.81f, -0.45f, -2.59f, -0.92f);
        androidx.appcompat.view.menu.a.z(pathBuilderA, 3.0f, 14.0f, 5.5f, 18.0f);
        pathBuilderA.curveToRelative(-0.83f, 0.0f, -1.5f, -0.67f, -1.5f, -1.5f);
        pathBuilderA.reflectiveCurveTo(4.67f, 15.0f, 5.5f, 15.0f);
        pathBuilderA.reflectiveCurveToRelative(1.5f, 0.67f, 1.5f, 1.5f);
        pathBuilderA.reflectiveCurveTo(6.33f, 18.0f, 5.5f, 18.0f);
        pathBuilderA.close();
        ...
        ImageVector.Builder.m3359addPathoIyEayM$default(builder, androidx.appcompat.view.menu.a.j(pathBuilderA, 1.5f, 0.67f, 1.5f, 1.5f), defaultFillType, "", solidColor, 0.3f, null, 0.3f, 1.0f, iM3141getButtKaPHkGw, iM3151getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        PathBuilder pathBuilderD = androidx.browser.browseractions.a.d(16.0f, 1.0f);
        ...
        a.j(pathBuilderD, 9.0f, 6.0f, 0.29f);
        ...
        a.j(pathBuilderD, 3.0f, 8.99f, 6.08f);
        ...
        pathBuilderD.reflectiveCurveToRelative(-2.24f, 5.0f, -5.0f, 5.0f);
        a.t(pathBuilderD, 16.5f, 4.0f, 15.0f, 4.0f);
        pathBuilderD.verticalLineToRelative(5.0f);
        pathBuilderD.lineToRelative(3.62f, 2.16f);
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, androidx.appcompat.graphics.drawable.a.e(pathBuilderD, 0.75f, -1.23f, -2.87f, -1.68f), defaultFillType4, "", solidColor4, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw4, iM3151getBevelLxFBmk84, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
