...
public final class TimelapseKt {
    ...
    public static final ImageVector getTimelapse(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.Timelapse", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderD = a.d(12.0f, 3.99f);
        ...
        pathBuilderD.reflectiveCurveToRelative(-3.58f, -8.0f, -8.0f, -8.0f);
        pathBuilderD.close();
        pathBuilderD.moveTo(16.25f, 16.23f);
        pathBuilderD.curveToRelative(-2.35f, 2.34f, -6.15f, 2.34f, -8.49f, 0.0f);
        pathBuilderD.lineTo(12.0f, 11.99f);
        pathBuilderD.verticalLineToRelative(-6.0f);
        pathBuilderD.curveToRelative(1.54f, 0.0f, 3.07f, 0.59f, 4.24f, 1.76f);
        pathBuilderD.curveToRelative(2.35f, 2.34f, 2.35f, 6.14f, 0.01f, 8.48f);
        pathBuilderD.close();
        ...
        PathBuilder pathBuilderD2 = a.d(16.24f, 7.75f);
        pathBuilderD2.curveToRelative(-1.17f, -1.17f, -2.7f, -1.76f, -4.24f, -1.76f);
        pathBuilderD2.verticalLineToRelative(6.0f);
        pathBuilderD2.lineToRelative(-4.24f, 4.24f);
        pathBuilderD2.curveToRelative(2.34f, 2.34f, 6.14f, 2.34f, 8.49f, 0.0f);
        pathBuilderD2.curveToRelative(2.34f, -2.34f, 2.34f, -6.14f, -0.01f, -8.48f);
        pathBuilderD2.close();
        pathBuilderD2.moveTo(12.0f, 1.99f);
        ...
        pathBuilderD2.reflectiveCurveToRelative(-4.48f, -10.0f, -10.0f, -10.0f);
        pathBuilderD2.close();
        pathBuilderD2.moveTo(12.0f, 19.99f);
        ...
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, androidx.appcompat.view.menu.a.j(pathBuilderD2, -3.58f, 8.0f, -8.0f, 8.0f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw2, iM3151getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
