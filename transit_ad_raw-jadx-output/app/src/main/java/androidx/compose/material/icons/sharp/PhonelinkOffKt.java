...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_phonelinkOff", "Landroidx/compose/ui/graphics/vector/ImageVector;", "PhonelinkOff", "Landroidx/compose/material/icons/Icons$Sharp;", "getPhonelinkOff", "(Landroidx/compose/material/icons/Icons$Sharp;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-sharp_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class PhonelinkOffKt {
    ...
    public static final ImageVector getPhonelinkOff(Icons.Sharp sharp) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.PhonelinkOff", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.INSTANCE.m2844getBlack0d7_KjU(), null);
        int iM3141getButtKaPHkGw = StrokeCap.INSTANCE.m3141getButtKaPHkGw();
        int iM3151getBevelLxFBmk8 = StrokeJoin.INSTANCE.m3151getBevelLxFBmk8();
        PathBuilder pathBuilderA = b.a(4.56f, 4.0f, -2.5f, -2.49f);
        a.z(pathBuilderA, 4.56f, 4.0f, 24.0f, 8.0f);
        s.s(pathBuilderA, -8.0f, 4.61f, 2.0f, 2.0f);
        androidx.compose.animation.a.o(pathBuilderA, 18.0f, 10.0f, 4.0f, 7.0f);
        pathBuilderA.horizontalLineToRelative(-1.61f);
        s.r(pathBuilderA, 3.0f, 3.0f, 24.0f, 20.0f);
        pathBuilderA.moveTo(22.0f, 6.0f);
        pathBuilderA.lineTo(22.0f, 4.0f);
        androidx.compose.animation.a.A(pathBuilderA, 7.39f, 4.0f, 2.0f, 2.0f);
        pathBuilderA.moveTo(2.06f, 1.51f);
        pathBuilderA.lineTo(0.65f, 2.92f);
        pathBuilderA.lineTo(2.0f, 4.27f);
        pathBuilderA.lineTo(2.0f, 17.0f);
        a.b.s(pathBuilderA, 0.0f, 17.0f, 3.0f, 17.73f);
