...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"__5k", "Landroidx/compose/ui/graphics/vector/ImageVector;", "_5k", "Landroidx/compose/material/icons/Icons$Rounded;", "get_5k", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class _5kKt {
    ...
    public static final ImageVector get_5k(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded._5k", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        a.q(pathBuilderB, 10.25f, 10.5f, 8.0f, 1.0f);
        ...
        b.r(pathBuilderB, 9.5f, -1.0f, 7.25f);
        pathBuilderB.curveToRelative(-0.41f, 0.0f, -0.75f, -0.34f, -0.75f, -0.75f);
        ...
        pathBuilderB.curveTo(10.66f, 9.0f, 11.0f, 9.34f, 11.0f, 9.75f);
        pathBuilderB.verticalLineToRelative(0.0f);
        pathBuilderB.curveTo(11.0f, 10.16f, 10.66f, 10.5f, 10.25f, 10.5f);
        androidx.compose.animation.a.t(pathBuilderB, 16.59f, 15.0f, 16.59f, 15.0f);
