...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_luggage", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Luggage", "Landroidx/compose/material/icons/Icons$Filled;", "getLuggage", "(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-filled_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class LuggageKt {
    ...
    public static final ImageVector getLuggage(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.Luggage", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        a.w(pathBuilderT, 9.5f, 18.0f, 8.0f, 9.0f);
        b.m(pathBuilderT, 1.5f, 18.0f, 12.75f, 18.0f);
        v.w(pathBuilderT, -1.5f, 9.0f, 1.5f, 18.0f);
        androidx.browser.browseractions.a.A(pathBuilderT, 13.5f, 6.0f, -3.0f, 3.5f);
        b.m(pathBuilderT, 3.0f, 6.0f, 16.0f, 18.0f);
        pathBuilderT.horizontalLineToRelative(-1.5f);
        pathBuilderT.verticalLineTo(9.0f);
        pathBuilderT.horizontalLineTo(16.0f);
        pathBuilderT.verticalLineTo(18.0f);
        pathBuilderT.close();
