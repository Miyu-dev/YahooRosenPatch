...
public final class SignalWifiStatusbarConnectedNoInternet4Kt {
    ...
    public static final ImageVector getSignalWifiStatusbarConnectedNoInternet4(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.SignalWifiStatusbarConnectedNoInternet4", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        s.D(pathBuilderD, 5.0f, -5.01f, 8.0f, 5.92f);
        pathBuilderD.curveTo(19.97f, 5.51f, 16.16f, 4.0f, 12.0f, 4.0f);
        pathBuilderD.close();
        ...
        ImageVector.Builder.m3359addPathoIyEayM$default(builder, b.i(19.0f, 18.0f, 2.0f, 2.0f, -2.0f), VectorKt.getDefaultFillType(), "", new SolidColor(companion.m2844getBlack0d7_KjU(), null), 1.0f, null, 1.0f, 1.0f, companion2.m3141getButtKaPHkGw(), companion3.m3151getBevelLxFBmk8(), 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, b.i(19.0f, 10.0f, 2.0f, 6.0f, -2.0f), VectorKt.getDefaultFillType(), "", new SolidColor(companion.m2844getBlack0d7_KjU(), null), 1.0f, null, 1.0f, 1.0f, companion2.m3141getButtKaPHkGw(), companion3.m3151getBevelLxFBmk8(), 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
