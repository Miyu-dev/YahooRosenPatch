...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_addAPhoto", "Landroidx/compose/ui/graphics/vector/ImageVector;", "AddAPhoto", "Landroidx/compose/material/icons/Icons$TwoTone;", "getAddAPhoto", "(Landroidx/compose/material/icons/Icons$TwoTone;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-twotone_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class AddAPhotoKt {
    ...
    public static final ImageVector getAddAPhoto(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.AddAPhoto", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderU = a.u(6.0f, 7.0f, 3.0f, 5.0f, 10.0f);
        a.x(pathBuilderU, 10.0f, 16.0f, 21.0f, 8.0f);
        pathBuilderU.horizontalLineToRelative(-4.05f);
        pathBuilderU.lineToRelative(-1.83f, -2.0f);
        pathBuilderU.lineTo(9.0f, 6.0f);
        h.q(pathBuilderU, 1.0f, 6.0f, 7.0f);
        pathBuilderU.moveTo(13.0f, 9.0f);
        pathBuilderU.curveToRelative(2.76f, 0.0f, 5.0f, 2.24f, 5.0f, 5.0f);
        pathBuilderU.reflectiveCurveToRelative(-2.24f, 5.0f, -5.0f, 5.0f);
        pathBuilderU.reflectiveCurveToRelative(-5.0f, -2.24f, -5.0f, -5.0f);
        ImageVector.Builder.m3359addPathoIyEayM$default(builder, androidx.appcompat.view.menu.a.j(pathBuilderU, 2.24f, -5.0f, 5.0f, -5.0f), defaultFillType, "", solidColor, 0.3f, null, 0.3f, 1.0f, iM3141getButtKaPHkGw, iM3151getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        int defaultFillType2 = VectorKt.getDefaultFillType();
        SolidColor solidColor2 = new SolidColor(companion.m2844getBlack0d7_KjU(), null);
        int iM3141getButtKaPHkGw2 = companion2.m3141getButtKaPHkGw();
        int iM3151getBevelLxFBmk82 = companion3.m3151getBevelLxFBmk8();
        PathBuilder pathBuilderC = s.c(21.0f, 6.0f, -3.17f, 16.0f, 4.0f);
        b.s(pathBuilderC, 9.0f, 4.0f, 2.0f, 6.12f);
        pathBuilderC.lineToRelative(1.83f, 2.0f);
        pathBuilderC.lineTo(21.0f, 8.0f);
        pathBuilderC.verticalLineToRelative(12.0f);
        pathBuilderC.lineTo(5.0f, 20.0f);
        pathBuilderC.lineTo(5.0f, 10.0f);
        pathBuilderC.lineTo(3.0f, 10.0f);
        ...
        pathBuilderC.reflectiveCurveToRelative(1.35f, -3.0f, 3.0f, -3.0f);
        androidx.compose.animation.a.t(pathBuilderC, 5.0f, 9.0f, 5.0f, 6.0f);
        ...
        ImageVector imageVectorBuild = ImageVector.Builder.m3359addPathoIyEayM$default(builder, v.j(pathBuilderC, 3.0f, 3.0f), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM3141getButtKaPHkGw2, iM3151getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
