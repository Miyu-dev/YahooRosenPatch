...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_gifBox", "Landroidx/compose/ui/graphics/vector/ImageVector;", "GifBox", "Landroidx/compose/material/icons/Icons$Rounded;", "getGifBox", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class GifBoxKt {
    ...
    public static final ImageVector getGifBox(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.GifBox", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderB.close();
        pathBuilderB.moveTo(10.5f, 10.5f);
        pathBuilderB.curveToRelative(0.0f, 0.28f, -0.22f, 0.5f, -0.5f, 0.5f);
        a.B(pathBuilderB, 8.5f, 2.0f, 1.0f, -0.5f);
        pathBuilderB.curveToRelative(0.0f, -0.29f, 0.25f, -0.53f, 0.55f, -0.5f);
        pathBuilderB.curveToRelative(0.26f, 0.02f, 0.45f, 0.26f, 0.45f, 0.52f);
        ...
        pathBuilderB.curveTo(10.28f, 10.0f, 10.5f, 10.22f, 10.5f, 10.5f);
        pathBuilderB.close();
        ...
        pathBuilderB.verticalLineToRelative(-3.0f);
        pathBuilderB.curveTo(11.5f, 10.22f, 11.72f, 10.0f, 12.0f, 10.0f);
        pathBuilderB.close();
        ...
        pathBuilderB.curveToRelative(0.28f, 0.0f, 0.5f, 0.22f, 0.5f, 0.5f);
        pathBuilderB.reflectiveCurveTo(16.28f, 11.0f, 16.0f, 11.0f);
        android.support.v4.media.a.s(pathBuilderB, -1.5f, 0.5f, 1.0f);
        pathBuilderB.curveToRelative(0.28f, 0.0f, 0.5f, 0.22f, 0.5f, 0.5f);
        pathBuilderB.reflectiveCurveToRelative(-0.22f, 0.5f, -0.5f, 0.5f);
        pathBuilderB.horizontalLineToRelative(-1.0f);
        pathBuilderB.verticalLineToRelative(1.0f);
        pathBuilderB.curveTo(14.5f, 13.78f, 14.28f, 14.0f, 14.0f, 14.0f);
        pathBuilderB.close();
