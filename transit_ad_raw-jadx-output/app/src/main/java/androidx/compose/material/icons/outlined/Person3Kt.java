...
public final class Person3Kt {
    ...
    public static final ImageVector getPerson3(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.Person3", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilderD2.close();
        pathBuilderD2.moveTo(9.24f, 8.37f);
        pathBuilderD2.curveTo(10.11f, 7.33f, 9.5f, 6.37f, 9.5f, 6.0f);
        pathBuilderD2.curveToRelative(0.0f, -0.41f, 0.24f, -0.77f, 0.62f, -0.92f);
        pathBuilderD2.curveToRelative(0.29f, -0.12f, 0.55f, -0.31f, 0.75f, -0.54f);
        pathBuilderD2.curveTo(11.04f, 4.33f, 11.42f, 4.0f, 12.0f, 4.0f);
        pathBuilderD2.reflectiveCurveToRelative(0.96f, 0.33f, 1.13f, 0.53f);
        pathBuilderD2.curveToRelative(0.2f, 0.24f, 0.46f, 0.42f, 0.75f, 0.54f);
        pathBuilderD2.curveTo(14.26f, 5.23f, 14.5f, 5.59f, 14.5f, 6.0f);
        pathBuilderD2.curveToRelative(0.0f, 0.37f, -0.61f, 1.33f, 0.26f, 2.37f);
        pathBuilderD2.curveTo(15.34f, 9.06f, 14.8f, 10.0f, 14.0f, 10.0f);
        pathBuilderD2.horizontalLineToRelative(-4.0f);
        pathBuilderD2.curveTo(9.2f, 10.0f, 8.66f, 9.06f, 9.24f, 8.37f);
        pathBuilderD2.close();
