...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_plumbing", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Plumbing", "Landroidx/compose/material/icons/Icons$Rounded;", "getPlumbing", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-rounded_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class PlumbingKt {
    ...
    public static final ImageVector getPlumbing(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Rounded.Plumbing", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        PathBuilder pathBuilderA2 = b.a(14.33f, 8.46f, -0.71f, 0.71f);
        ...
        pathBuilderA2.lineToRelative(3.18f, 3.18f);
        pathBuilderA2.lineToRelative(-7.0f, 7.0f);
        pathBuilderA2.curveToRelative(-0.7f, 0.7f, -0.88f, 1.84f, -0.29f, 2.65f);
        pathBuilderA2.curveToRelative(0.74f, 1.03f, 2.19f, 1.12f, 3.05f, 0.26f);
        ...
        pathBuilderA2.curveTo(15.35f, 8.07f, 14.72f, 8.07f, 14.33f, 8.46f);
        pathBuilderA2.close();
