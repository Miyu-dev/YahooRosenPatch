...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_dryCleaning", "Landroidx/compose/ui/graphics/vector/ImageVector;", "DryCleaning", "Landroidx/compose/material/icons/Icons$Filled;", "getDryCleaning", "(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-filled_release"}, k = 2, mv = {1, 8, 0}, xi = R.styleable.AppCompatTheme_checkboxStyle)
public final class DryCleaningKt {
    ...
    public static final ImageVector getDryCleaning(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.DryCleaning", Dp.m5267constructorimpl(24.0f), Dp.m5267constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        a.q(pathBuilderC, 18.58f, 14.0f, 17.0f, -1.0f);
        b.r(pathBuilderC, 7.0f, 1.0f, 5.42f);
        pathBuilderC.curveTo(5.19f, 14.0f, 5.0f, 13.81f, 5.0f, 13.57f);
        pathBuilderC.curveToRelative(0.0f, -0.17f, 0.1f, -0.32f, 0.25f, -0.38f);
        pathBuilderC.lineToRelative(6.75f, -3.0f);
        pathBuilderC.lineToRelative(6.75f, 3.0f);
        pathBuilderC.curveTo(18.9f, 13.26f, 19.0f, 13.41f, 19.0f, 13.58f);
        pathBuilderC.curveTo(19.0f, 13.81f, 18.81f, 14.0f, 18.58f, 14.0f);
        pathBuilderC.close();
