...
public final class NavigationDrawerTokens {
    ...
    static {
        ...
        ActiveIndicatorHeight = Dp.m5267constructorimpl((float) 56.0d);
        ActiveIndicatorShape = ShapeKeyTokens.CornerFull;
        ActiveIndicatorWidth = Dp.m5267constructorimpl((float) 336.0d);
        ...
        ContainerWidth = Dp.m5267constructorimpl((float) 360.0d);
        ...
        ModalContainerElevation = elevationTokens.m1976getLevel1D9Ej5fM();
        StandardContainerElevation = elevationTokens.m1975getLevel0D9Ej5fM();
    }
    ...
    public final float m2128getActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m2129getActiveIndicatorWidthD9Ej5fM() {
    ...
    public final float m2130getContainerWidthD9Ej5fM() {
    ...
    public final float m2132getModalContainerElevationD9Ej5fM() {
        return ModalContainerElevation;
    }

    /* JADX INFO: renamed from: getStandardContainerElevation-D9Ej5fM, reason: not valid java name */
    public final float m2133getStandardContainerElevationD9Ej5fM() {
