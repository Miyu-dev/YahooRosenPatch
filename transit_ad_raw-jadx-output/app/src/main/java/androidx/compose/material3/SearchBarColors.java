...
public final class SearchBarColors {
    ...
    public boolean equals(Object other) {
        ...
        if (!m.c(SearchBarColors.class, other != null ? other.getClass() : null)) {
            return false;
        }
        m.f(other, "null cannot be cast to non-null type androidx.compose.material3.SearchBarColors");
        SearchBarColors searchBarColors = (SearchBarColors) other;
        return Color.m2819equalsimpl0(this.containerColor, searchBarColors.containerColor) && Color.m2819equalsimpl0(this.dividerColor, searchBarColors.dividerColor) && m.c(this.inputFieldColors, searchBarColors.inputFieldColors);
    }
    ...
    public int hashCode() {
        return this.inputFieldColors.hashCode() + androidx.browser.browseractions.a.b(this.dividerColor, Color.m2825hashCodeimpl(this.containerColor) * 31, 31);
    }

    private SearchBarColors(long j, long j2, TextFieldColors textFieldColors) {
        m.h(textFieldColors, "inputFieldColors");
