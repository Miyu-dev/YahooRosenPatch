...
public final class DatePickerFormatter {
    ...
    public static /* synthetic */ String formatDate$material3_release$default(DatePickerFormatter datePickerFormatter, CalendarDate calendarDate, CalendarModel calendarModel, Locale locale, boolean z, int i2, Object obj) {
        if ((i2 & 8) != 0) {
            z = false;
        }
    ...
    public /* synthetic */ DatePickerFormatter(String str, String str2, String str3, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this((i2 & 1) != 0 ? DatePickerDefaults.YearMonthSkeleton : str, (i2 & 2) != 0 ? DatePickerDefaults.YearAbbrMonthDaySkeleton : str2, (i2 & 4) != 0 ? DatePickerDefaults.YearMonthWeekdayDaySkeleton : str3);
    }
}
