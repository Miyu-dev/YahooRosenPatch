...
public final class DateInputModalTokens {
    ...
    private static final float ContainerHeight = Dp.m5267constructorimpl((float) 512.0d);
    ...
    private static final float HeaderContainerHeight = Dp.m5267constructorimpl((float) 120.0d);
