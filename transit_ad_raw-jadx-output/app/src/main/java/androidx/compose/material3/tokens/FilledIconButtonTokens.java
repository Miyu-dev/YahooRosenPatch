...
public final class FilledIconButtonTokens {
    ...
    static {
        ...
        ContainerSize = Dp.m5267constructorimpl((float) 40.0d);
    ...
    public final float m2059getContainerSizeD9Ej5fM() {
    ...
    public final float m2060getSizeD9Ej5fM() {
        return Size;
    }
