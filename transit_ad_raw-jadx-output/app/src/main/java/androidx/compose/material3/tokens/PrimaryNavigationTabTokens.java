...
public final class PrimaryNavigationTabTokens {
    ...
    static {
        ...
        float f = (float) 3.0d;
        ActiveIndicatorHeight = Dp.m5267constructorimpl(f);
        ActiveIndicatorShape = RoundedCornerShapeKt.m781RoundedCornerShape0680j_4(Dp.m5267constructorimpl(f));
        ContainerColor = ColorSchemeKeyTokens.Surface;
        ContainerElevation = ElevationTokens.INSTANCE.m1975getLevel0D9Ej5fM();
        ContainerHeight = Dp.m5267constructorimpl((float) 48.0d);
        ContainerShape = ShapeKeyTokens.CornerNone;
        DividerColor = ColorSchemeKeyTokens.SurfaceVariant;
        DividerHeight = Dp.m5267constructorimpl((float) 1.0d);
        ...
        IconAndLabelTextContainerHeight = Dp.m5267constructorimpl((float) 64.0d);
    ...
    public final float m2252getActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m2253getContainerElevationD9Ej5fM() {
        return ContainerElevation;
    }

    /* JADX INFO: renamed from: getContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m2254getContainerHeightD9Ej5fM() {
    ...
    public final float m2255getDividerHeightD9Ej5fM() {
        return DividerHeight;
    }

    /* JADX INFO: renamed from: getIconAndLabelTextContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m2256getIconAndLabelTextContainerHeightD9Ej5fM() {
        return IconAndLabelTextContainerHeight;
    }

    /* JADX INFO: renamed from: getIconSize-D9Ej5fM, reason: not valid java name */
    public final float m2257getIconSizeD9Ej5fM() {
        return IconSize;
    }
