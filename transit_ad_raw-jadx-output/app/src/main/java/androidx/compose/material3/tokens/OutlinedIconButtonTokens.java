...
public final class OutlinedIconButtonTokens {
    ...
    private static final float ContainerSize = Dp.m5267constructorimpl((float) 40.0d);
    ...
    static {
        ...
        Size = Dp.m5267constructorimpl((float) 24.0d);
    ...
    public final float m2162getContainerSizeD9Ej5fM() {
    ...
    public final float m2163getSizeD9Ej5fM() {
        return Size;
    }
    ...
    public final float m2164getUnselectedOutlineWidthD9Ej5fM() {
