...
public final class ChipBorder {
    ...
    public final State<BorderStroke> borderStroke$material3_release(boolean z, Composer composer, int i2) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1899621712, i2, -1, "androidx.compose.material3.ChipBorder.borderStroke (Chip.kt:2045)");
        }
        State<BorderStroke> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(BorderStrokeKt.m201BorderStrokecXLIe8U(this.borderWidth, z ? this.borderColor : this.disabledBorderColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m2819equalsimpl0(this.borderColor, chipBorder.borderColor) && Color.m2819equalsimpl0(this.disabledBorderColor, chipBorder.disabledBorderColor) && Dp.m5272equalsimpl0(this.borderWidth, chipBorder.borderWidth);
    }

    public int hashCode() {
        return Dp.m5273hashCodeimpl(this.borderWidth) + androidx.browser.browseractions.a.b(this.disabledBorderColor, Color.m2825hashCodeimpl(this.borderColor) * 31, 31);
    }
