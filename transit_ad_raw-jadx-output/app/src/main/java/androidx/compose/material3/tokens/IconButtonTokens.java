...
public final class IconButtonTokens {
    ...
    private static final float IconSize = Dp.m5267constructorimpl((float) 24.0d);
    ...
    public final float m2095getStateLayerSizeD9Ej5fM() {
