...
public final class BadgeTokens {
    ...
    static {
        ...
        LargeSize = Dp.m5267constructorimpl((float) 16.0d);
        Shape = shapeKeyTokens;
        Size = Dp.m5267constructorimpl((float) 6.0d);
    }
    ...
    public final float m1852getLargeSizeD9Ej5fM() {
        return LargeSize;
    }
    ...
    public final float m1853getSizeD9Ej5fM() {
        return Size;
    }
}
