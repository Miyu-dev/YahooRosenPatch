...
public final class SelectableChipElevation {
    ...
    @ej.c(c = "androidx.compose.material3.SelectableChipElevation$animateElevation$2", f = "Chip.kt", l = {1711}, m = "invokeSuspend")
    ...
    /* JADX INFO: compiled from: Chip.kt */
    @Metadata(k = 3, mv = {1, 8, 0}, xi = androidx.appcompat.R.styleable.AppCompatTheme_checkboxStyle)
    @ej.c(c = "androidx.compose.material3.SelectableChipElevation$animateElevation$3", f = "Chip.kt", l = {1721}, m = "invokeSuspend")
    public static final class AnonymousClass3 extends SuspendLambda implements p<CoroutineScope, dj.c<? super j>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public AnonymousClass3(Animatable<Dp, AnimationVector1D> animatable, SelectableChipElevation selectableChipElevation, float f, Interaction interaction, dj.c<? super AnonymousClass3> cVar) {
            super(2, cVar);
            this.$animatable = animatable;
    ...
    private final State<Dp> animateElevation(boolean z, InteractionSource interactionSource, Composer composer, int i2) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(664514136, i2, -1, "androidx.compose.material3.SelectableChipElevation.animateElevation (Chip.kt:1650)");
        }
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m5272equalsimpl0(this.elevation, selectableChipElevation.elevation) && Dp.m5272equalsimpl0(this.pressedElevation, selectableChipElevation.pressedElevation) && Dp.m5272equalsimpl0(this.focusedElevation, selectableChipElevation.focusedElevation) && Dp.m5272equalsimpl0(this.hoveredElevation, selectableChipElevation.hoveredElevation) && Dp.m5272equalsimpl0(this.disabledElevation, selectableChipElevation.disabledElevation);
    }
    ...
    public final State<Dp> shadowElevation$material3_release(boolean z, InteractionSource interactionSource, Composer composer, int i2) {
        if (androidx.appcompat.view.menu.a.q(interactionSource, "interactionSource", composer, -1888175651)) {
            ComposerKt.traceEventStart(-1888175651, i2, -1, "androidx.compose.material3.SelectableChipElevation.shadowElevation (Chip.kt:1642)");
        }
    ...
    public final State<Dp> tonalElevation$material3_release(boolean z, InteractionSource interactionSource, Composer composer, int i2) {
        if (androidx.appcompat.view.menu.a.q(interactionSource, "interactionSource", composer, -93383461)) {
            ComposerKt.traceEventStart(-93383461, i2, -1, "androidx.compose.material3.SelectableChipElevation.tonalElevation (Chip.kt:1623)");
        }
        State<Dp> stateAnimateElevation = animateElevation(z, interactionSource, composer, (i2 & 896) | (i2 & 14) | (i2 & androidx.appcompat.R.styleable.AppCompatTheme_toolbarNavigationButtonStyle));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
