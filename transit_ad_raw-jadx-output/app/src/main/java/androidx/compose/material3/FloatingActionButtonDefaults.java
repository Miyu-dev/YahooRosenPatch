...
public final class FloatingActionButtonDefaults {
    ...
    public static /* synthetic */ FloatingActionButtonElevation m1307bottomAppBarFabElevationa9UjIt4$default(FloatingActionButtonDefaults floatingActionButtonDefaults, float f, float f2, float f3, float f4, int i2, Object obj) {
        ...
        return floatingActionButtonDefaults.m1308bottomAppBarFabElevationa9UjIt4(f, f2, f3, f4);
    }

    /* JADX INFO: renamed from: bottomAppBarFabElevation-a9UjIt4, reason: not valid java name */
    public final FloatingActionButtonElevation m1308bottomAppBarFabElevationa9UjIt4(float defaultElevation, float pressedElevation, float focusedElevation, float hoveredElevation) {
    ...
    public final FloatingActionButtonElevation m1309elevationxZ9QkE(float f, float f2, float f3, float f4, Composer composer, int i2, int i3) {
        composer.startReplaceableGroup(-241106249);
        if ((i3 & 1) != 0) {
            f = FabPrimaryTokens.INSTANCE.m2013getContainerElevationD9Ej5fM();
        }
        float f5 = f;
        if ((i3 & 2) != 0) {
            f2 = FabPrimaryTokens.INSTANCE.m2023getPressedContainerElevationD9Ej5fM();
        }
        float f6 = f2;
        if ((i3 & 4) != 0) {
            f3 = FabPrimaryTokens.INSTANCE.m2016getFocusContainerElevationD9Ej5fM();
        }
        float f7 = f3;
        if ((i3 & 8) != 0) {
            f4 = FabPrimaryTokens.INSTANCE.m2017getHoverContainerElevationD9Ej5fM();
        }
        float f8 = f4;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-241106249, i2, -1, "androidx.compose.material3.FloatingActionButtonDefaults.elevation (FloatingActionButton.kt:423)");
        }
    ...
    public final long getContainerColor(Composer composer, int i2) throws NoWhenBranchMatchedException {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1855656391, i2, -1, "androidx.compose.material3.FloatingActionButtonDefaults.<get-containerColor> (FloatingActionButton.kt:409)");
        }
    ...
    public final Shape getExtendedFabShape(Composer composer, int i2) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-536021915, i2, -1, "androidx.compose.material3.FloatingActionButtonDefaults.<get-extendedFabShape> (FloatingActionButton.kt:405)");
        }
    ...
    public final float m1310getLargeIconSizeD9Ej5fM() {
    ...
    public final Shape getLargeShape(Composer composer, int i2) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1835912187, i2, -1, "androidx.compose.material3.FloatingActionButtonDefaults.<get-largeShape> (FloatingActionButton.kt:402)");
        }
    ...
    public final Shape getShape(Composer composer, int i2) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-53247565, i2, -1, "androidx.compose.material3.FloatingActionButtonDefaults.<get-shape> (FloatingActionButton.kt:396)");
        }
    ...
    public final Shape getSmallShape(Composer composer, int i2) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(394933381, i2, -1, "androidx.compose.material3.FloatingActionButtonDefaults.<get-smallShape> (FloatingActionButton.kt:399)");
        }
    ...
    public final FloatingActionButtonElevation m1311loweredElevationxZ9QkE(float f, float f2, float f3, float f4, Composer composer, int i2, int i3) {
        composer.startReplaceableGroup(-285065125);
        if ((i3 & 1) != 0) {
            f = FabPrimaryTokens.INSTANCE.m2019getLoweredContainerElevationD9Ej5fM();
        }
        float f5 = f;
        if ((i3 & 2) != 0) {
            f2 = FabPrimaryTokens.INSTANCE.m2022getLoweredPressedContainerElevationD9Ej5fM();
        }
        float f6 = f2;
        if ((i3 & 4) != 0) {
            f3 = FabPrimaryTokens.INSTANCE.m2020getLoweredFocusContainerElevationD9Ej5fM();
        }
        float f7 = f3;
        if ((i3 & 8) != 0) {
            f4 = FabPrimaryTokens.INSTANCE.m2021getLoweredHoverContainerElevationD9Ej5fM();
        }
        float f8 = f4;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-285065125, i2, -1, "androidx.compose.material3.FloatingActionButtonDefaults.loweredElevation (FloatingActionButton.kt:446)");
        }
        FloatingActionButtonElevation floatingActionButtonElevation = new FloatingActionButtonElevation(f5, f6, f7, f8, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
