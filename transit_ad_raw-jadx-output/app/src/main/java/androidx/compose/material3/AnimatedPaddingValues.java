...
final class AnimatedPaddingValues implements PaddingValues {
    ...
    public AnimatedPaddingValues(State<Float> state, State<Dp> state2) {
        m.h(state, "animationProgress");
        m.h(state2, "topPadding");
    ...
    public float getBottom() {
        return Dp.m5267constructorimpl(this.animationProgress.getValue().floatValue() * SearchBarKt.getSearchBarVerticalPadding());
    }
    ...
    public float getTop() {
        return Dp.m5267constructorimpl(this.animationProgress.getValue().floatValue() * this.topPadding.getValue().m5281unboximpl());
    }
