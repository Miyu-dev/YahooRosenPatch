...
public final class SheetBottomTokens {
    ...
    private static final float DockedDragHandleHeight = Dp.m5267constructorimpl((float) 4.0d);
    private static final float DockedDragHandleWidth = Dp.m5267constructorimpl((float) 32.0d);
    private static final ShapeKeyTokens DockedMinimizedContainerShape = ShapeKeyTokens.CornerNone;

    static {
        ElevationTokens elevationTokens = ElevationTokens.INSTANCE;
        DockedModalContainerElevation = elevationTokens.m1976getLevel1D9Ej5fM();
        DockedStandardContainerElevation = elevationTokens.m1976getLevel1D9Ej5fM();
    }
    ...
    public final float m2267getDockedDragHandleHeightD9Ej5fM() {
        return DockedDragHandleHeight;
    }

    /* JADX INFO: renamed from: getDockedDragHandleWidth-D9Ej5fM, reason: not valid java name */
    public final float m2268getDockedDragHandleWidthD9Ej5fM() {
    ...
    public final float m2269getDockedModalContainerElevationD9Ej5fM() {
    ...
    public final float m2270getDockedStandardContainerElevationD9Ej5fM() {
