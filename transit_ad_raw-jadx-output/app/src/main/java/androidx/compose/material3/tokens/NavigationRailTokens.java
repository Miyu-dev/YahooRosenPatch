...
public final class NavigationRailTokens {
    ...
    static {
        ...
        float f = (float) 56.0d;
        ActiveIndicatorWidth = Dp.m5267constructorimpl(f);
        ...
        ContainerWidth = Dp.m5267constructorimpl((float) 80.0d);
        float f2 = (float) 24.0d;
        IconSize = Dp.m5267constructorimpl(f2);
        ...
        MenuIconSize = Dp.m5267constructorimpl(f2);
        MenuPressedIconColor = colorSchemeKeyTokens2;
        NoLabelActiveIndicatorHeight = Dp.m5267constructorimpl(f);
    ...
    public final float m2135getActiveIndicatorWidthD9Ej5fM() {
    ...
    public final float m2137getContainerWidthD9Ej5fM() {
    ...
    public final float m2139getMenuIconSizeD9Ej5fM() {
        return MenuIconSize;
    }
    ...
    public final float m2140getNoLabelActiveIndicatorHeightD9Ej5fM() {
