...
public final class RadioButtonColors {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m2819equalsimpl0(this.selectedColor, radioButtonColors.selectedColor) && Color.m2819equalsimpl0(this.unselectedColor, radioButtonColors.unselectedColor) && Color.m2819equalsimpl0(this.disabledSelectedColor, radioButtonColors.disabledSelectedColor) && Color.m2819equalsimpl0(this.disabledUnselectedColor, radioButtonColors.disabledUnselectedColor);
    }

    public int hashCode() {
        return Color.m2825hashCodeimpl(this.disabledUnselectedColor) + androidx.browser.browseractions.a.b(this.disabledSelectedColor, androidx.browser.browseractions.a.b(this.unselectedColor, Color.m2825hashCodeimpl(this.selectedColor) * 31, 31), 31);
    }
    ...
    public final State<Color> radioColor$material3_release(boolean z, boolean z2, Composer composer, int i2) {
        ...
        if (z) {
            ...
            stateRememberUpdatedState = SingleValueAnimationKt.m93animateColorAsStateeuL9pac(j, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer, 48, 12);
