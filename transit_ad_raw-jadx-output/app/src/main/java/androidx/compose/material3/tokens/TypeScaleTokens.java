...
public final class TypeScaleTokens {
    ...
    static {
        ...
        TextUnitKt.m5461checkArithmeticR2X_6o(sp);
        DisplayLargeTracking = TextUnitKt.pack(TextUnit.m5446getRawTypeimpl(sp), -TextUnit.m5448getValueimpl(sp));
