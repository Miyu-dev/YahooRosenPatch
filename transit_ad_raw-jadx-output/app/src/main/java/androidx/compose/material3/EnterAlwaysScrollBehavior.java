...
final class EnterAlwaysScrollBehavior implements TopAppBarScrollBehavior {
    ...
    public EnterAlwaysScrollBehavior(TopAppBarState topAppBarState, AnimationSpec<Float> animationSpec, DecayAnimationSpec<Float> decayAnimationSpec, kj.a<Boolean> aVar) {
    ...
    public /* synthetic */ EnterAlwaysScrollBehavior(TopAppBarState topAppBarState, AnimationSpec animationSpec, DecayAnimationSpec decayAnimationSpec, kj.a aVar, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(topAppBarState, animationSpec, decayAnimationSpec, (i2 & 8) != 0 ? new kj.a<Boolean>() { // from class: androidx.compose.material3.EnterAlwaysScrollBehavior.1
            /* JADX INFO: renamed from: invoke, reason: merged with bridge method [inline-methods] */
            public final Boolean m1276invoke() {
                return Boolean.TRUE;
            }
        } : aVar);
    }
