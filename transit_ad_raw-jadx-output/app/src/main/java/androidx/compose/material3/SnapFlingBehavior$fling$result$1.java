...
@ej.c(c = "androidx.compose.material3.SnapFlingBehavior$fling$result$1", f = "SnapFlingBehavior.kt", l = {androidx.appcompat.R.styleable.AppCompatTheme_selectableItemBackground, androidx.appcompat.R.styleable.AppCompatTheme_spinnerDropDownItemStyle}, m = "invokeSuspend")
public final class SnapFlingBehavior$fling$result$1 extends SuspendLambda implements p<CoroutineScope, dj.c<? super AnimationResult<Float, AnimationVector1D>>, Object> {
    ...
    public SnapFlingBehavior$fling$result$1(float f, SnapFlingBehavior snapFlingBehavior, ScrollScope scrollScope, dj.c<? super SnapFlingBehavior$fling$result$1> cVar) {
        super(2, cVar);
