...
public final /* data */ class FixedThreshold implements ThresholdConfig {
    ...
    public static /* synthetic */ FixedThreshold m1305copy0680j_4$default(FixedThreshold fixedThreshold, float f, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            f = fixedThreshold.offset;
        }
        return fixedThreshold.m1306copy0680j_4(f);
    }

    @Override // androidx.compose.material3.ThresholdConfig
    public float computeThreshold(Density density, float f, float f2) {
        m.h(density, "<this>");
        return (Math.signum(f2 - f) * density.mo348toPx0680j_4(this.offset)) + f;
    }

    /* JADX INFO: renamed from: copy-0680j_4, reason: not valid java name */
    public final FixedThreshold m1306copy0680j_4(float offset) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof FixedThreshold) && Dp.m5272equalsimpl0(this.offset, ((FixedThreshold) other).offset);
    }

    public int hashCode() {
        return Dp.m5273hashCodeimpl(this.offset);
    }

    public String toString() {
        return "FixedThreshold(offset=" + ((Object) Dp.m5278toStringimpl(this.offset)) + ')';
    }
