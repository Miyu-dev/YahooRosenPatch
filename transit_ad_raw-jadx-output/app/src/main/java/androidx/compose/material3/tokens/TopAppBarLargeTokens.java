...
public final class TopAppBarLargeTokens {
    ...
    private static final float ContainerElevation = ElevationTokens.INSTANCE.m1975getLevel0D9Ej5fM();
    private static final float ContainerHeight = Dp.m5267constructorimpl((float) 152.0d);
    ...
    public final float m2334getContainerHeightD9Ej5fM() {
    ...
    public final float m2335getLeadingIconSizeD9Ej5fM() {
    ...
    public final float m2336getTrailingIconSizeD9Ej5fM() {
