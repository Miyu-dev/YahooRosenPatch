...
@ej.c(c = "androidx.compose.material3.AppBarKt$TwoRowsTopAppBar$appBarDragModifier$2$1", f = "AppBar.kt", l = {1192}, m = "invokeSuspend")
public final class AppBarKt$TwoRowsTopAppBar$appBarDragModifier$2$1 extends SuspendLambda implements q<CoroutineScope, Float, dj.c<? super j>, Object> {
    final /* synthetic */ TopAppBarScrollBehavior $scrollBehavior;
    /* synthetic */ float F$0;
    int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AppBarKt$TwoRowsTopAppBar$appBarDragModifier$2$1(TopAppBarScrollBehavior topAppBarScrollBehavior, dj.c<? super AppBarKt$TwoRowsTopAppBar$appBarDragModifier$2$1> cVar) {
        super(3, cVar);
    ...
    public final Object invoke(CoroutineScope coroutineScope, float f, dj.c<? super j> cVar) {
        ...
        return appBarKt$TwoRowsTopAppBar$appBarDragModifier$2$1.invokeSuspend(j.a);
    }
}
