...
public final class SearchViewTokens {
    ...
    private static final float DockedHeaderContainerHeight = Dp.m5267constructorimpl((float) 56.0d);
    private static final ShapeKeyTokens FullScreenContainerShape = ShapeKeyTokens.CornerNone;
    private static final float FullScreenHeaderContainerHeight = Dp.m5267constructorimpl((float) 72.0d);
    ...
    public final float m2264getContainerElevationD9Ej5fM() {
    ...
    public final float m2265getDockedHeaderContainerHeightD9Ej5fM() {
    ...
    public final float m2266getFullScreenHeaderContainerHeightD9Ej5fM() {
