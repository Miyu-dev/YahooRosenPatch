...
public final class Shapes {
    ...
    public final Shapes copy(CornerBasedShape extraSmall, CornerBasedShape small, CornerBasedShape medium, CornerBasedShape large, CornerBasedShape extraLarge) {
        m.h(extraSmall, "extraSmall");
        m.h(small, "small");
        m.h(medium, "medium");
        m.h(large, "large");
        m.h(extraLarge, "extraLarge");
    ...
    public boolean equals(Object other) {
        ...
        return m.c(this.extraSmall, shapes.extraSmall) && m.c(this.small, shapes.small) && m.c(this.medium, shapes.medium) && m.c(this.large, shapes.large) && m.c(this.extraLarge, shapes.extraLarge);
    }
    ...
    public Shapes(CornerBasedShape cornerBasedShape, CornerBasedShape cornerBasedShape2, CornerBasedShape cornerBasedShape3, CornerBasedShape cornerBasedShape4, CornerBasedShape cornerBasedShape5) {
        m.h(cornerBasedShape, "extraSmall");
        m.h(cornerBasedShape2, "small");
        m.h(cornerBasedShape3, "medium");
        m.h(cornerBasedShape4, "large");
        m.h(cornerBasedShape5, "extraLarge");
