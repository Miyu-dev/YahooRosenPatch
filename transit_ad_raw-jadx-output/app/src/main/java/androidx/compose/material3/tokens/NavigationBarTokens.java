...
public final class NavigationBarTokens {
    ...
    static {
        ...
        ActiveIndicatorHeight = Dp.m5267constructorimpl((float) 32.0d);
        ActiveIndicatorShape = ShapeKeyTokens.CornerFull;
        ActiveIndicatorWidth = Dp.m5267constructorimpl((float) 64.0d);
        ...
        ContainerElevation = ElevationTokens.INSTANCE.m1977getLevel2D9Ej5fM();
        ContainerHeight = Dp.m5267constructorimpl((float) 80.0d);
    ...
    public final float m2123getActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m2124getActiveIndicatorWidthD9Ej5fM() {
    ...
    public final float m2127getIconSizeD9Ej5fM() {
        return IconSize;
    }
