...
public final class InputChipTokens {
    ...
    static {
        ...
        ContainerElevation = elevationTokens.m1975getLevel0D9Ej5fM();
        ContainerHeight = Dp.m5267constructorimpl((float) 32.0d);
        ...
        SelectedOutlineWidth = Dp.m5267constructorimpl((float) 0.0d);
        ...
        UnselectedOutlineWidth = Dp.m5267constructorimpl((float) 1.0d);
        UnselectedPressedLabelTextColor = colorSchemeKeyTokens3;
        AvatarShape = ShapeKeyTokens.CornerFull;
        AvatarSize = Dp.m5267constructorimpl((float) 24.0d);
        DisabledLeadingIconColor = colorSchemeKeyTokens;
        float f = (float) 18.0d;
        LeadingIconSize = Dp.m5267constructorimpl(f);
        ...
        TrailingIconSize = Dp.m5267constructorimpl(f);
    ...
    public final float m2096getAvatarSizeD9Ej5fM() {
        return AvatarSize;
    }
    ...
    public final float m2100getLeadingIconSizeD9Ej5fM() {
    ...
    public final float m2101getSelectedOutlineWidthD9Ej5fM() {
    ...
    public final float m2102getTrailingIconSizeD9Ej5fM() {
    ...
    public final float m2103getUnselectedOutlineWidthD9Ej5fM() {
