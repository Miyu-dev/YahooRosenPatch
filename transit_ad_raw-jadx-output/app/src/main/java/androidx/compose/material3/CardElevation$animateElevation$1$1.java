...
@ej.c(c = "androidx.compose.material3.CardElevation$animateElevation$1$1", f = "Card.kt", l = {619}, m = "invokeSuspend")
public final class CardElevation$animateElevation$1$1 extends SuspendLambda implements p<CoroutineScope, dj.c<? super j>, Object> {
    final /* synthetic */ InteractionSource $interactionSource;
    final /* synthetic */ SnapshotStateList<Interaction> $interactions;
    int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CardElevation$animateElevation$1$1(InteractionSource interactionSource, SnapshotStateList<Interaction> snapshotStateList, dj.c<? super CardElevation$animateElevation$1$1> cVar) {
        super(2, cVar);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i2 == 0) {
            ...
            FlowCollector<Interaction> flowCollector = new FlowCollector<Interaction>() { // from class: androidx.compose.material3.CardElevation$animateElevation$1$1.1
