...
public final class OutlinedCardTokens {
    ...
    static {
        ...
        OutlineWidth = Dp.m5267constructorimpl((float) 1.0d);
    ...
    public final float m2160getOutlineWidthD9Ej5fM() {
        return OutlineWidth;
    }
