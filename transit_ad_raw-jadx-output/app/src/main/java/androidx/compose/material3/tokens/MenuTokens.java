...
public final class MenuTokens {
    ...
    private static final float ContainerElevation = ElevationTokens.INSTANCE.m1977getLevel2D9Ej5fM();
    ...
    private static final float ListItemContainerHeight = Dp.m5267constructorimpl((float) 48.0d);
    ...
    static {
        ...
        float f = (float) 24.0d;
        ListItemLeadingIconSize = Dp.m5267constructorimpl(f);
        ...
        ListItemTrailingIconSize = Dp.m5267constructorimpl(f);
    }
    ...
    public final float m2120getListItemContainerHeightD9Ej5fM() {
    ...
    public final float m2121getListItemLeadingIconSizeD9Ej5fM() {
    ...
    public final float m2122getListItemTrailingIconSizeD9Ej5fM() {
