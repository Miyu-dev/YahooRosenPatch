...
public final class SliderTokens {
    ...
    static {
        ...
        float f = (float) 4.0d;
        ActiveTrackHeight = Dp.m5267constructorimpl(f);
        ...
        DisabledHandleElevation = elevationTokens.m1975getLevel0D9Ej5fM();
        DisabledInactiveTrackColor = colorSchemeKeyTokens2;
        FocusHandleColor = colorSchemeKeyTokens;
        HandleColor = colorSchemeKeyTokens;
        HandleElevation = elevationTokens.m1976getLevel1D9Ej5fM();
        float f2 = (float) 20.0d;
        HandleHeight = Dp.m5267constructorimpl(f2);
        HandleShape = shapeKeyTokens;
        HandleWidth = Dp.m5267constructorimpl(f2);
        HoverHandleColor = colorSchemeKeyTokens;
        InactiveTrackColor = ColorSchemeKeyTokens.SurfaceVariant;
        InactiveTrackHeight = Dp.m5267constructorimpl(f);
        InactiveTrackShape = shapeKeyTokens;
        LabelContainerColor = colorSchemeKeyTokens;
        LabelContainerElevation = elevationTokens.m1975getLevel0D9Ej5fM();
        LabelContainerHeight = Dp.m5267constructorimpl((float) 28.0d);
        ...
        TrackElevation = elevationTokens.m1975getLevel0D9Ej5fM();
        OverlapHandleOutlineColor = colorSchemeKeyTokens3;
        OverlapHandleOutlineWidth = Dp.m5267constructorimpl((float) 1.0d);
        TickMarksActiveContainerColor = colorSchemeKeyTokens3;
        TickMarksContainerShape = shapeKeyTokens;
        TickMarksContainerSize = Dp.m5267constructorimpl((float) 2.0d);
    ...
    public final float m2271getActiveTrackHeightD9Ej5fM() {
    ...
    public final float m2272getDisabledHandleElevationD9Ej5fM() {
    ...
    public final float m2273getHandleElevationD9Ej5fM() {
        return HandleElevation;
    }

    /* JADX INFO: renamed from: getHandleHeight-D9Ej5fM, reason: not valid java name */
    public final float m2274getHandleHeightD9Ej5fM() {
        return HandleHeight;
    }
    ...
    public final float m2275getHandleWidthD9Ej5fM() {
        return HandleWidth;
    }
    ...
    public final float m2276getInactiveTrackHeightD9Ej5fM() {
    ...
    public final float m2277getLabelContainerElevationD9Ej5fM() {
        return LabelContainerElevation;
    }

    /* JADX INFO: renamed from: getLabelContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m2278getLabelContainerHeightD9Ej5fM() {
    ...
    public final float m2279getOverlapHandleOutlineWidthD9Ej5fM() {
    ...
    public final float m2281getTickMarksContainerSizeD9Ej5fM() {
    ...
    public final float m2282getTrackElevationD9Ej5fM() {
