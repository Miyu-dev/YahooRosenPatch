...
public final class NavigationRailDefaults {
    ...
    public final long getContainerColor(Composer composer, int i2) throws NoWhenBranchMatchedException {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1949394041, i2, -1, "androidx.compose.material3.NavigationRailDefaults.<get-ContainerColor> (NavigationRail.kt:263)");
        }
    ...
    public final WindowInsets getWindowInsets(Composer composer, int i2) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1546379058, i2, -1, "androidx.compose.material3.NavigationRailDefaults.<get-windowInsets> (NavigationRail.kt:270)");
        }
