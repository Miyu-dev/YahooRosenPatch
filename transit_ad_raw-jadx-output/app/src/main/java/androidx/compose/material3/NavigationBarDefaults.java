...
public final class NavigationBarDefaults {
    ...
    private static final float Elevation = NavigationBarTokens.INSTANCE.m2125getContainerElevationD9Ej5fM();
    ...
    public final long getContainerColor(Composer composer, int i2) throws NoWhenBranchMatchedException {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1528098623, i2, -1, "androidx.compose.material3.NavigationBarDefaults.<get-containerColor> (NavigationBar.kt:265)");
        }
    ...
    public final float m1383getElevationD9Ej5fM() {
        return Elevation;
    }
    ...
    public final WindowInsets getWindowInsets(Composer composer, int i2) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1938678202, i2, -1, "androidx.compose.material3.NavigationBarDefaults.<get-windowInsets> (NavigationBar.kt:272)");
        }
