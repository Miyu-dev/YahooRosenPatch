...
public final class LinearProgressIndicatorTokens {
    ...
    static {
        ...
        TrackHeight = Dp.m5267constructorimpl(f);
    ...
    public final float m2104getActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m2105getTrackHeightD9Ej5fM() {
        return TrackHeight;
    }
