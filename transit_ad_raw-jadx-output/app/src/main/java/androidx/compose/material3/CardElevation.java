...
public final class CardElevation {
    ...
    @ej.c(c = "androidx.compose.material3.CardElevation$animateElevation$2", f = "Card.kt", l = {681, 688}, m = "invokeSuspend")
    public static final class AnonymousClass2 extends SuspendLambda implements p<CoroutineScope, dj.c<? super j>, Object> {
        ...
        public AnonymousClass2(boolean z, Animatable<Dp, AnimationVector1D> animatable, CardElevation cardElevation, float f, Interaction interaction, dj.c<? super AnonymousClass2> cVar) {
            super(2, cVar);
            this.$enabled = z;
        ...
        public final dj.c<j> create(Object obj, dj.c<?> cVar) {
            return new AnonymousClass2(this.$enabled, this.$animatable, this.this$0, this.$target, this.$interaction, cVar);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i2 == 0) {
                ...
                if (this.$enabled) {
                    ...
                    this.label = 2;
                    if (animatable2.snapTo(dpM5265boximpl, this) == coroutineSingletons) {
                        return coroutineSingletons;
                    }
                }
            } else {
    ...
    private final State<Dp> animateElevation(boolean z, InteractionSource interactionSource, Composer composer, int i2) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1421890746, i2, -1, "androidx.compose.material3.CardElevation.animateElevation (Card.kt:612)");
        }
        ...
        EffectsKt.LaunchedEffect(Dp.m5265boximpl(f), new AnonymousClass2(z, animatable, this, f, interaction, null), composer, 64);
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m5272equalsimpl0(this.defaultElevation, cardElevation.defaultElevation) && Dp.m5272equalsimpl0(this.pressedElevation, cardElevation.pressedElevation) && Dp.m5272equalsimpl0(this.focusedElevation, cardElevation.focusedElevation) && Dp.m5272equalsimpl0(this.hoveredElevation, cardElevation.hoveredElevation) && Dp.m5272equalsimpl0(this.disabledElevation, cardElevation.disabledElevation);
    }
    ...
    public final State<Dp> shadowElevation$material3_release(boolean z, InteractionSource interactionSource, Composer composer, int i2) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1763481333, i2, -1, "androidx.compose.material3.CardElevation.shadowElevation (Card.kt:601)");
        }
        ...
        if (objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Dp.m5265boximpl(this.defaultElevation), null, 2, null);
            composer.updateRememberedValue(objRememberedValue);
        }
        composer.endReplaceableGroup();
    ...
    public final State<Dp> tonalElevation$material3_release(boolean z, InteractionSource interactionSource, Composer composer, int i2) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1757792649, i2, -1, "androidx.compose.material3.CardElevation.tonalElevation (Card.kt:579)");
        }
