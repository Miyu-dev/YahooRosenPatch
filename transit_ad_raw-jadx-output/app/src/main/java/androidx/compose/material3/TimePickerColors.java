...
public final class TimePickerColors {
    ...
    public final long m1689clockDialContentColorvNxB06k$material3_release(boolean selected) {
    ...
    public boolean equals(Object other) {
        ...
        if (!m.c(TimePickerColors.class, other != null ? other.getClass() : null)) {
            return false;
        }
        m.f(other, "null cannot be cast to non-null type androidx.compose.material3.TimePickerColors");
        TimePickerColors timePickerColors = (TimePickerColors) other;
        return Color.m2819equalsimpl0(this.clockDialColor, timePickerColors.clockDialColor) && Color.m2819equalsimpl0(this.selectorColor, timePickerColors.selectorColor) && Color.m2819equalsimpl0(this.containerColor, timePickerColors.containerColor) && Color.m2819equalsimpl0(this.periodSelectorBorderColor, timePickerColors.periodSelectorBorderColor) && Color.m2819equalsimpl0(this.periodSelectorSelectedContainerColor, timePickerColors.periodSelectorSelectedContainerColor) && Color.m2819equalsimpl0(this.periodSelectorUnselectedContainerColor, timePickerColors.periodSelectorUnselectedContainerColor) && Color.m2819equalsimpl0(this.periodSelectorSelectedContentColor, timePickerColors.periodSelectorSelectedContentColor) && Color.m2819equalsimpl0(this.periodSelectorUnselectedContentColor, timePickerColors.periodSelectorUnselectedContentColor) && Color.m2819equalsimpl0(this.timeSelectorSelectedContainerColor, timePickerColors.timeSelectorSelectedContainerColor) && Color.m2819equalsimpl0(this.timeSelectorUnselectedContainerColor, timePickerColors.timeSelectorUnselectedContainerColor) && Color.m2819equalsimpl0(this.timeSelectorSelectedContentColor, timePickerColors.timeSelectorSelectedContentColor) && Color.m2819equalsimpl0(this.timeSelectorUnselectedContentColor, timePickerColors.timeSelectorUnselectedContentColor);
    }
    ...
    public int hashCode() {
        return Color.m2825hashCodeimpl(this.timeSelectorUnselectedContentColor) + androidx.browser.browseractions.a.b(this.timeSelectorSelectedContentColor, androidx.browser.browseractions.a.b(this.timeSelectorUnselectedContainerColor, androidx.browser.browseractions.a.b(this.timeSelectorSelectedContainerColor, androidx.browser.browseractions.a.b(this.periodSelectorUnselectedContentColor, androidx.browser.browseractions.a.b(this.periodSelectorSelectedContentColor, androidx.browser.browseractions.a.b(this.periodSelectorUnselectedContainerColor, androidx.browser.browseractions.a.b(this.periodSelectorSelectedContainerColor, androidx.browser.browseractions.a.b(this.periodSelectorBorderColor, androidx.browser.browseractions.a.b(this.containerColor, androidx.browser.browseractions.a.b(this.selectorColor, Color.m2825hashCodeimpl(this.clockDialColor) * 31, 31), 31), 31), 31), 31), 31), 31), 31), 31), 31);
    }

    /* JADX INFO: renamed from: periodSelectorContainerColor-vNxB06k$material3_release, reason: not valid java name */
    public final long m1694periodSelectorContainerColorvNxB06k$material3_release(boolean selected) {
    ...
    public final long m1695periodSelectorContentColorvNxB06k$material3_release(boolean selected) {
    ...
    public final long m1696timeSelectorContainerColorvNxB06k$material3_release(boolean selected) {
    ...
    public final long m1697timeSelectorContentColorvNxB06k$material3_release(boolean selected) {
