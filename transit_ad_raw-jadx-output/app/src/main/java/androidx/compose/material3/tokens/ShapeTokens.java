...
public final class ShapeTokens {
    ...
    private static final RoundedCornerShape CornerMedium = RoundedCornerShapeKt.m781RoundedCornerShape0680j_4(Dp.m5267constructorimpl((float) 12.0d));
    private static final Shape CornerNone = RectangleShapeKt.getRectangleShape();
    private static final RoundedCornerShape CornerSmall = RoundedCornerShapeKt.m781RoundedCornerShape0680j_4(Dp.m5267constructorimpl((float) 8.0d));

    static {
        float f = (float) 28.0d;
        CornerExtraLarge = RoundedCornerShapeKt.m781RoundedCornerShape0680j_4(Dp.m5267constructorimpl(f));
        float f2 = (float) 0.0d;
        CornerExtraLargeTop = RoundedCornerShapeKt.m782RoundedCornerShapea9UjIt4(Dp.m5267constructorimpl(f), Dp.m5267constructorimpl(f), Dp.m5267constructorimpl(f2), Dp.m5267constructorimpl(f2));
        float f3 = (float) 4.0d;
        CornerExtraSmall = RoundedCornerShapeKt.m781RoundedCornerShape0680j_4(Dp.m5267constructorimpl(f3));
        CornerExtraSmallTop = RoundedCornerShapeKt.m782RoundedCornerShapea9UjIt4(Dp.m5267constructorimpl(f3), Dp.m5267constructorimpl(f3), Dp.m5267constructorimpl(f2), Dp.m5267constructorimpl(f2));
        float f4 = (float) 16.0d;
        CornerLarge = RoundedCornerShapeKt.m781RoundedCornerShape0680j_4(Dp.m5267constructorimpl(f4));
        CornerLargeEnd = RoundedCornerShapeKt.m782RoundedCornerShapea9UjIt4(Dp.m5267constructorimpl(f2), Dp.m5267constructorimpl(f4), Dp.m5267constructorimpl(f4), Dp.m5267constructorimpl(f2));
        CornerLargeTop = RoundedCornerShapeKt.m782RoundedCornerShapea9UjIt4(Dp.m5267constructorimpl(f4), Dp.m5267constructorimpl(f4), Dp.m5267constructorimpl(f2), Dp.m5267constructorimpl(f2));
    }
