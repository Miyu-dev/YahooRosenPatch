...
public final class FilledCardTokens {
    ...
    static {
        ...
        DraggedContainerElevation = elevationTokens.m1978getLevel3D9Ej5fM();
        FocusContainerElevation = elevationTokens.m1975getLevel0D9Ej5fM();
        HoverContainerElevation = elevationTokens.m1976getLevel1D9Ej5fM();
        IconColor = ColorSchemeKeyTokens.Primary;
        IconSize = Dp.m5267constructorimpl((float) 24.0d);
        PressedContainerElevation = elevationTokens.m1975getLevel0D9Ej5fM();
    }
    ...
    public final float m2052getContainerElevationD9Ej5fM() {
    ...
    public final float m2057getIconSizeD9Ej5fM() {
        return IconSize;
    }

    /* JADX INFO: renamed from: getPressedContainerElevation-D9Ej5fM, reason: not valid java name */
    public final float m2058getPressedContainerElevationD9Ej5fM() {
