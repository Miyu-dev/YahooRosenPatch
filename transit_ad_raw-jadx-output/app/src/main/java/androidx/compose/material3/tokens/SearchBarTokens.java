...
public final class SearchBarTokens {
    ...
    static {
        ...
        AvatarSize = Dp.m5267constructorimpl((float) 30.0d);
    ...
    public final float m2261getAvatarSizeD9Ej5fM() {
        return AvatarSize;
    }
    ...
    public final float m2262getContainerElevationD9Ej5fM() {
        return ContainerElevation;
    }

    /* JADX INFO: renamed from: getContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m2263getContainerHeightD9Ej5fM() {
