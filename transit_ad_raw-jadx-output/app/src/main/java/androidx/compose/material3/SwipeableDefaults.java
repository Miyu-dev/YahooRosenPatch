...
public final class SwipeableDefaults {
    ...
    public static /* synthetic */ ResistanceConfig resistanceConfig$material3_release$default(SwipeableDefaults swipeableDefaults, Set set, float f, float f2, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            f = 10.0f;
        }
        if ((i2 & 4) != 0) {
    ...
    public final float m1602getVelocityThresholdD9Ej5fM$material3_release() {
    ...
    public final ResistanceConfig resistanceConfig$material3_release(Set<Float> anchors, float factorAtMin, float factorAtMax) {
        ...
        Float fC1 = y.C1(anchors);
        m.e(fC1);
        float fFloatValue = fC1.floatValue();
        Float fD1 = y.D1(anchors);
        m.e(fD1);
        return new ResistanceConfig(fFloatValue - fD1.floatValue(), factorAtMin, factorAtMax);
    }
}
