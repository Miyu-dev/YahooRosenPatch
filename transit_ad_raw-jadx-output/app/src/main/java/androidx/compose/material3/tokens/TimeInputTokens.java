...
public final class TimeInputTokens {
    ...
    private static final float ContainerElevation = ElevationTokens.INSTANCE.m1978getLevel3D9Ej5fM();
    ...
    static {
        ...
        float f = (float) 72.0d;
        PeriodSelectorContainerHeight = Dp.m5267constructorimpl(f);
        ShapeKeyTokens shapeKeyTokens = ShapeKeyTokens.CornerSmall;
        PeriodSelectorContainerShape = shapeKeyTokens;
        PeriodSelectorContainerWidth = Dp.m5267constructorimpl((float) 52.0d);
        ...
        TimeFieldContainerColor = ColorSchemeKeyTokens.SurfaceVariant;
        TimeFieldContainerHeight = Dp.m5267constructorimpl(f);
        TimeFieldContainerShape = shapeKeyTokens;
        TimeFieldContainerWidth = Dp.m5267constructorimpl((float) 96.0d);
        ...
        TimeFieldFocusOutlineWidth = Dp.m5267constructorimpl((float) 2.0d);
    ...
    public final float m2314getPeriodSelectorContainerHeightD9Ej5fM() {
    ...
    public final float m2315getPeriodSelectorContainerWidthD9Ej5fM() {
    ...
    public final float m2316getPeriodSelectorOutlineWidthD9Ej5fM() {
    ...
    public final float m2317getTimeFieldContainerHeightD9Ej5fM() {
    ...
    public final float m2318getTimeFieldContainerWidthD9Ej5fM() {
    ...
    public final float m2319getTimeFieldFocusOutlineWidthD9Ej5fM() {
