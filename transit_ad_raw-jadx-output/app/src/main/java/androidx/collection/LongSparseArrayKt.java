...
public final class LongSparseArrayKt {
    ...
    public static final class C01191<T> implements Iterator<T>, a {
    ...
    public static final <T> boolean contains(LongSparseArray<T> longSparseArray, long j) {
        m.i(longSparseArray, "receiver$0");
        return longSparseArray.containsKey(j);
    }

    public static final <T> void forEach(LongSparseArray<T> longSparseArray, p<? super Long, ? super T, j> pVar) {
        m.i(longSparseArray, "receiver$0");
        m.i(pVar, "action");
    ...
    public static final <T> T getOrElse(LongSparseArray<T> longSparseArray, long j, kj.a<? extends T> aVar) {
        m.i(longSparseArray, "receiver$0");
