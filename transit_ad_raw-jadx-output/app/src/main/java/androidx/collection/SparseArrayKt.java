...
public final class SparseArrayKt {
    ...
    public static final class C01201<T> implements Iterator<T>, a {
        final /* synthetic */ SparseArrayCompat $this_valueIterator;
        private int index;

        public C01201(SparseArrayCompat<T> sparseArrayCompat) {
    ...
    public static final <T> boolean contains(SparseArrayCompat<T> sparseArrayCompat, int i2) {
        m.i(sparseArrayCompat, "receiver$0");
    ...
    public static final <T> T getOrElse(SparseArrayCompat<T> sparseArrayCompat, int i2, kj.a<? extends T> aVar) {
        m.i(sparseArrayCompat, "receiver$0");
    ...
    public static final <T> Iterator<T> valueIterator(SparseArrayCompat<T> sparseArrayCompat) {
        m.i(sparseArrayCompat, "receiver$0");
        return new C01201(sparseArrayCompat);
    }
}
