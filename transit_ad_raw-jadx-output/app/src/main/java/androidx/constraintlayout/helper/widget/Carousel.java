...
public class Carousel extends MotionHelper {
    ...
    public Carousel(Context context) {
        ...
        this.mTargetIndex = -1;
        this.mAnimateTargetDelay = ComposerKt.invocationKey;
        this.mLastStartId = -1;
    ...
    public void updateItems() {
        ...
        if (i5 != -1 && i5 != this.mIndex) {
            this.mMotionLayout.post(new u(this, i6));
    ...
    public void onAttachedToWindow() {
        super/*androidx.constraintlayout.widget.ConstraintHelper*/.onAttachedToWindow();
        if (getParent() instanceof MotionLayout) {
            MotionLayout parent = getParent();
            for (int i2 = 0; i2 < ((ConstraintHelper) this).mCount; i2++) {
                int i3 = ((ConstraintHelper) this).mIds[i2];
                View viewById = parent.getViewById(i3);
