...
public class Layer extends ConstraintHelper {
    ...
    private void reCacheViews() {
        int i2;
        if (this.mContainer == null || (i2 = ((ConstraintHelper) this).mCount) == 0) {
            return;
        }
        ...
        for (int i3 = 0; i3 < ((ConstraintHelper) this).mCount; i3++) {
            this.mViews[i3] = this.mContainer.getViewById(((ConstraintHelper) this).mIds[i3]);
        }
    }
    ...
    public void updatePostLayout(ConstraintLayout constraintLayout) {
        ...
        this.mComputedCenterX = Float.NaN;
        this.mComputedCenterY = Float.NaN;
        ConstraintWidget constraintWidget = getLayoutParams().getConstraintWidget();
