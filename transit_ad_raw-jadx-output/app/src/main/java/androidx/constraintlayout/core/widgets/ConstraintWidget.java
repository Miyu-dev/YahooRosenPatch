...
public class ConstraintWidget {
    ...
    */
    ...
    private void serializeDimensionRatio(StringBuilder sb, String str, float f, int i2) {
        if (f == 0.0f) {
            return;
        }
        sb.append(str);
    ...
    private void serializeSize(StringBuilder sb, String str, int i2, int i3, int i4, int i5, int i6, int i7, float f, float f2) {
        sb.append(str);
        sb.append(" :  {\n");
    ...
    public boolean hasResolvedTargets(int i2, int i3) {
        ...
        if (i2 == 0) {
            ...
            if (constraintAnchor4 != null && constraintAnchor4.hasFinalValue() && (constraintAnchor = this.mBottom.mTarget) != null && constraintAnchor.hasFinalValue()) {
                return (this.mBottom.mTarget.getFinalValue() - this.mBottom.getMargin()) - (this.mTop.getMargin() + this.mTop.mTarget.getFinalValue()) >= i3;
            }
        }
        return false;
    }
  ...
  0x0086: PHI (r0v2 int) = (r0v1 int), (r0v0 int), (r0v0 int), (r0v0 int), (r0v0 int), (r0v0 int) binds: [B:46:0x0086, B:36:0x007f, B:24:0x0051, B:26:0x0057, B:28:0x0063, B:30:0x0067] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    public String toString() {
        ...
        sb.append(this.mType != null ? a.f(new StringBuilder("type: "), this.mType, " ") : "");
        sb.append(this.mDebugName != null ? a.f(new StringBuilder("id: "), this.mDebugName, " ") : "");
        sb.append("(");
        sb.append(this.mX);
        sb.append(", ");
        sb.append(this.mY);
        ...
        sb.append(" x ");
        return android.support.v4.media.a.g(sb, this.mHeight, ")");
    }
    ...
    private void getSceneString(StringBuilder sb, String str, int i2, int i3, int i4, int i5, int i6, int i7, float f, float f2) {
        sb.append(str);
        sb.append(" :  {\n");
