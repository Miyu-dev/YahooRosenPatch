...
public class StopLogicEngine implements StopEngine {
    ...
    public String debug(String str, float f) {
        StringBuilder sbG = androidx.browser.browseractions.a.g(androidx.appcompat.view.menu.a.f(androidx.browser.browseractions.a.g(str, " ===== "), this.mType, "\n"), str);
        sbG.append(this.mBackwards ? "backwards" : "forward ");
        sbG.append(" time = ");
        sbG.append(f);
        sbG.append("  stages ");
        String str2 = android.support.v4.media.a.g(sbG, this.mNumberOfStages, "\n") + str + " dur " + this.mStage1Duration + " vel " + this.mStage1Velocity + " pos " + this.mStage1EndPosition + "\n";
        ...
        float f2 = this.mStage1Duration;
        if (f <= f2) {
            return v.g(str2, str, "stage 0\n");
        }
        int i2 = this.mNumberOfStages;
        if (i2 == 1) {
            return v.g(str2, str, "end stage 0\n");
        }
        float f3 = f - f2;
        float f4 = this.mStage2Duration;
        return f3 < f4 ? v.g(str2, str, " stage 1\n") : i2 == 2 ? v.g(str2, str, "end stage 1\n") : f3 - f4 < this.mStage3Duration ? v.g(str2, str, " stage 2\n") : v.g(str2, str, " end stage 2\n");
    }
