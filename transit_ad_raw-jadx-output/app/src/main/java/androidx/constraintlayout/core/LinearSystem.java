...
public class LinearSystem {
    ...
    private void displayRows() {
        ...
        String strF = "";
        for (int i2 = 0; i2 < this.mNumRows; i2++) {
            StringBuilder sbH = b.h(strF);
            sbH.append(this.mRows[i2]);
            strF = s.f(sbH.toString(), "\n");
        }
        StringBuilder sbH2 = b.h(strF);
        sbH2.append(this.mGoal);
        sbH2.append("\n");
        System.out.println(sbH2.toString());
    }
    ...
    private void displaySolverVariables() {
        ...
        sb.append("x");
        System.out.println(a.g(sb, this.mNumColumns, ")\n"));
    }
    ...
    private String getDisplaySize(int i2) {
        ...
        return i5 > 0 ? b.e("", i5, " Mb") : i4 > 0 ? b.e("", i4, " Kb") : b.e("", i3, " bytes");
    }
    ...
    public void addCentering(SolverVariable solverVariable, SolverVariable solverVariable2, int i2, float f, SolverVariable solverVariable3, SolverVariable solverVariable4, int i3, int i4) {
        ArrayRow arrayRowCreateRow = createRow();
        arrayRowCreateRow.createRowCentering(solverVariable, solverVariable2, i2, f, solverVariable3, solverVariable4, i3);
        if (i4 != 8) {
    ...
    */
    ...
    public void displayReadableRows() {
        displaySolverVariables();
        String strG = a.g(new StringBuilder(" num vars "), this.mVariablesID, "\n");
        for (int i2 = 0; i2 < this.mVariablesID + 1; i2++) {
            SolverVariable solverVariable = this.mCache.mIndexedVariables[i2];
            if (solverVariable != null && solverVariable.isFinalValue) {
                strG = strG + " $[" + i2 + "] => " + solverVariable + " = " + solverVariable.computedValue + "\n";
            }
        }
        String strF = s.f(strG, "\n");
        for (int i3 = 0; i3 < this.mVariablesID + 1; i3++) {
            ...
            if (solverVariable2 != null && solverVariable2.isSynonym) {
                strF = strF + " ~[" + i3 + "] => " + solverVariable2 + " = " + solverVariableArr[solverVariable2.synonym] + " + " + solverVariable2.synonymDelta + "\n";
            }
        }
        String strF2 = s.f(strF, "\n\n #  ");
        for (int i4 = 0; i4 < this.mNumRows; i4++) {
            StringBuilder sbH = b.h(strF2);
            sbH.append(this.mRows[i4].toReadableString());
            strF2 = s.f(sbH.toString(), "\n #  ");
        }
        if (this.mGoal != null) {
            StringBuilder sbG = androidx.browser.browseractions.a.g(strF2, "Goal: ");
    ...
    public void displayVariablesReadableRows() {
        ...
        for (int i2 = 0; i2 < this.mNumRows; i2++) {
            if (this.mRows[i2].variable.mType == SolverVariable.Type.UNRESTRICTED) {
                StringBuilder sbH = b.h(strF);
                sbH.append(this.mRows[i2].toReadableString());
                strF = s.f(sbH.toString(), "\n");
            }
        }
        StringBuilder sbH2 = b.h(strF);
