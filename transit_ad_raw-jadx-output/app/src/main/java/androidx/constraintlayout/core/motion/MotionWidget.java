...
public class MotionWidget implements TypedValues {
    ...
    public void setCustomAttribute(String str, int i2, float f) {
        this.widgetFrame.setCustomAttribute(str, i2, f);
    }
    ...
    public boolean setValueAttributes(int i2, float f) {
        switch (i2) {
            case 303:
    ...
    public boolean setValue(int i2, float f) {
        if (setValueAttributes(i2, f)) {
            return true;
        }
        return setValueMotion(i2, f);
    }
    ...
    public boolean setValueMotion(int i2, float f) {
        switch (i2) {
            case 600:
