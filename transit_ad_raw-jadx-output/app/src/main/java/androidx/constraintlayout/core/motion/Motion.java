...
public class Motion implements TypedValues {
    ...
    private float getPreCycleDistance() {
        ...
        while (i2 < 100) {
            ...
            if (i3 > 0) {
                c2 = 0;
                fHypot = (float) (Math.hypot(d2 - ((double) fArr[1]), d - ((double) fArr[0])) + ((double) f7));
            } else {
                c2 = 0;
                fHypot = f7;
            }
    ...
    public void buildRectangles(float[] fArr, int i2) {
        float f = 1.0f / (i2 - 1);
        for (int i3 = 0; i3 < i2; i3++) {
            this.mSpline[0].getPos(getAdjustedPosition(i3 * f, null), this.mInterpolateData);
    ...
    public MotionKeyPosition getPositionKeyframe(int i2, int i3, float f, float f2) {
        ...
        for (MotionKey motionKey : this.mKeyList) {
            if (motionKey instanceof MotionKeyPosition) {
                MotionKeyPosition motionKeyPosition = (MotionKeyPosition) motionKey;
                if (motionKeyPosition.intersects(i2, i3, floatRect, floatRect2, f, f2)) {
    ...
    public boolean interpolate(MotionWidget motionWidget, float f, long j, KeyCache keyCache) {
        ...
        if (curveFitArr != null) {
            ...
            float f4 = motionPaths.x;
            MotionPaths motionPaths2 = this.mEndMotionPath;
            float fA = a.a(motionPaths2.x, f4, adjustedPosition, f4);
            float f5 = motionPaths.y;
            float fA2 = a.a(motionPaths2.y, f5, adjustedPosition, f5);
            float f6 = motionPaths.width;
            float fA3 = a.a(motionPaths2.width, f6, adjustedPosition, f6);
            float f7 = motionPaths.height;
            float f8 = fA + 0.5f;
            float f9 = fA2 + 0.5f;
            motionWidget.layout((int) f8, (int) f9, (int) (f8 + fA3), (int) (f9 + a.a(motionPaths2.height, f7, adjustedPosition, f7)));
        }
    ...
    public void setup(int i2, int i3, float f, long j) {
        ...
        while (true) {
            ...
            if (iArr2[i17] < MotionPaths.names.length) {
                String strF = androidx.appcompat.view.menu.a.f(new StringBuilder(), MotionPaths.names[this.mInterpolateVariables[i17]], " [");
                for (int i18 = 0; i18 < size; i18++) {
                    StringBuilder sbH = b.h(strF);
                    sbH.append(dArr[i18][i17]);
                    strF = sbH.toString();
                }
            }
            i17++;
        ...
        while (true) {
            ...
            while (i20 < size) {
                if (motionPathsArr[i20].hasCustomData(str9)) {
                    ...
                    motionPaths.getCustomData(str9, dArr4[i21], i4);
                    i21++;
                }
                i20++;
                i7 = 2;
