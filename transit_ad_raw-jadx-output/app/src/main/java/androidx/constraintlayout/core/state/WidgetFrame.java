...
public class WidgetFrame {
    ...
    public static void interpolate(int i2, int i3, WidgetFrame widgetFrame, WidgetFrame widgetFrame2, WidgetFrame widgetFrame3, Transition transition, float f) {
        int i4;
        float f2;
        int i5;
        int i6;
        ...
        if (widgetFrame.widget == null || !transition.hasPositionKeyframes()) {
            ...
            if (keyPositionFindPreviousPosition != null) {
                i6 = (int) (keyPositionFindPreviousPosition.x * i2);
                i11 = i17;
                i10 = i3;
                i7 = (int) (keyPositionFindPreviousPosition.y * i10);
            ...
            if (keyPositionFindNextPosition != null) {
                int i23 = (int) (keyPositionFindNextPosition.x * i2);
                int i24 = (int) (keyPositionFindNextPosition.y * i10);
        ...
        int i25 = (int) (((i9 - i8) * f5) + i8);
        widgetFrame.left = i25;
        int i26 = (int) ((f5 * (i18 - r10)) + i7);
        widgetFrame.top = i26;
        float f10 = 1.0f - f;
        widgetFrame.right = i25 + ((int) ((i21 * f) + (i4 * f10)));
        widgetFrame.bottom = i26 + ((int) ((i22 * f) + (f10 * i5)));
    ...
    public void logv(String str) {
        ...
        StringBuilder sbG = androidx.browser.browseractions.a.g(".(" + stackTraceElement.getFileName() + ":" + stackTraceElement.getLineNumber() + ") " + stackTraceElement.getMethodName(), " ");
        sbG.append(hashCode() % 1000);
        String string = sbG.toString();
        if (this.widget != null) {
            StringBuilder sbG2 = androidx.browser.browseractions.a.g(string, "/");
            sbG2.append(this.widget.hashCode() % 1000);
            strF = sbG2.toString();
        } else {
            strF = s.f(string, "/NULL");
        }
    ...
    public void printCustomAttributes() {
        ...
        if (map != null) {
            for (String str : map.keySet()) {
                ...
                StringBuilder sbH = a.b.h(strF);
                sbH.append(this.mCustom.get(str).toString());
                printStream.println(sbH.toString());
            }
        }
    }
    ...
    public void setCustomAttribute(String str, int i2, float f) {
        if (this.mCustom.containsKey(str)) {
            this.mCustom.get(str).setFloatValue(f);
        } else {
            this.mCustom.put(str, new CustomVariable(str, i2, f));
        }
    }
    ...
    private static float interpolate(float f, float f2, float f3, float f4) {
        ...
        return androidx.appcompat.graphics.drawable.a.a(f2, f, f4, f);
    }
}
