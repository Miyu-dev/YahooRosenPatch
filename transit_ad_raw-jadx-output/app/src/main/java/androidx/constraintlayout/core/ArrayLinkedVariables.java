...
public class ArrayLinkedVariables implements ArrayRow.ArrayRowVariables {
    ...
    public String toString() {
        ...
        String string = "";
        for (int i3 = 0; i2 != -1 && i3 < this.currentSize; i3++) {
            StringBuilder sbH = b.h(s.f(string, " -> "));
            sbH.append(this.mArrayValues[i2]);
            sbH.append(" : ");
            StringBuilder sbH2 = b.h(sbH.toString());
            sbH2.append(this.mCache.mIndexedVariables[this.mArrayIndices[i2]]);
