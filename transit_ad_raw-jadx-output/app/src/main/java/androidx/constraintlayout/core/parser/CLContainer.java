...
public class CLContainer extends CLElement {
    ...
    public CLElement get(String str) throws CLParsingException {
        ...
        throw new CLParsingException(a.e("no element for key <", str, ">"), this);
    }
    ...
    public CLArray getArray(String str) throws CLParsingException {
        ...
        StringBuilder sbI = h.i("no array found for key <", str, ">, found [");
        sbI.append(cLElement.getStrClass());
        sbI.append("] : ");
        sbI.append(cLElement);
        throw new CLParsingException(sbI.toString(), this);
    }
    ...
    public boolean getBoolean(String str) throws CLParsingException {
        ...
        StringBuilder sbI = h.i("no boolean found for key <", str, ">, found [");
        sbI.append(cLElement.getStrClass());
        sbI.append("] : ");
        sbI.append(cLElement);
        throw new CLParsingException(sbI.toString(), this);
    ...
    public float getFloat(String str) throws CLParsingException {
        ...
        StringBuilder sbI = h.i("no float found for key <", str, ">, found [");
        sbI.append(cLElement.getStrClass());
        sbI.append("] : ");
        sbI.append(cLElement);
        throw new CLParsingException(sbI.toString(), this);
    ...
    public int getInt(String str) throws CLParsingException {
        ...
        StringBuilder sbI = h.i("no int found for key <", str, ">, found [");
        sbI.append(cLElement.getStrClass());
        sbI.append("] : ");
        sbI.append(cLElement);
        throw new CLParsingException(sbI.toString(), this);
    ...
    public CLObject getObject(String str) throws CLParsingException {
        ...
        StringBuilder sbI = h.i("no object found for key <", str, ">, found [");
        sbI.append(cLElement.getStrClass());
        sbI.append("] : ");
        sbI.append(cLElement);
        throw new CLParsingException(sbI.toString(), this);
    ...
    public String getString(String str) throws CLParsingException {
        ...
        StringBuilder sbI = v.i("no string found for key <", str, ">, found [", cLElement != null ? cLElement.getStrClass() : null, "] : ");
        sbI.append(cLElement);
        throw new CLParsingException(sbI.toString(), this);
    }
    ...
    public float getFloat(int i2) throws CLParsingException {
        ...
        throw new CLParsingException(a.c("no float at index ", i2), this);
    }
    ...
    public int getInt(int i2) throws CLParsingException {
        ...
        throw new CLParsingException(a.c("no int at index ", i2), this);
    }
    ...
    public CLArray getArray(int i2) throws CLParsingException {
        ...
        throw new CLParsingException(a.c("no array at index ", i2), this);
    }
    ...
    public boolean getBoolean(int i2) throws CLParsingException {
        ...
        throw new CLParsingException(a.c("no boolean at index ", i2), this);
    }
    ...
    public CLObject getObject(int i2) throws CLParsingException {
        ...
        throw new CLParsingException(a.c("no object at index ", i2), this);
    }
    ...
    public CLElement get(int i2) throws CLParsingException {
        ...
        throw new CLParsingException(a.c("no element at index ", i2), this);
    }
    ...
    public String getString(int i2) throws CLParsingException {
        ...
        throw new CLParsingException(a.c("no string at index ", i2), this);
    }
}
