...
public class CustomSupport {
    ...
    public static void setInterpolatedValue(ConstraintAttribute constraintAttribute, View view, float[] fArr) {
        ...
        try {
            ...
            StringBuilder sbI = h.i("cannot access method ", str, " on View \"");
            sbI.append(Debug.getName(view));
            sbI.append("\"");
            Log.e(TAG, sbI.toString());
            e.printStackTrace();
        } catch (NoSuchMethodException e2) {
            StringBuilder sbI2 = h.i("no method ", str, " on View \"");
            sbI2.append(Debug.getName(view));
            sbI2.append("\"");
            Log.e(TAG, sbI2.toString());
            e2.printStackTrace();
