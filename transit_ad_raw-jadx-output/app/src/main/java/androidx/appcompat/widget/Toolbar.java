...
public class Toolbar extends ViewGroup implements MenuHost {
    ...
    /* JADX WARN: Removed duplicated region for block: B:105:0x02a0 A[LOOP:0: B:104:0x029e->B:105:0x02a0, LOOP_END] */
    ...
    */
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        ...
        if (i2 != 0 && this.mExpandedMenuPresenter != null && supportMenuPeekMenu != null && (menuItemFindItem = supportMenuPeekMenu.findItem(i2)) != null) {
        ...
        if (Build.VERSION.SDK_INT >= 33) {
            ...
            if (z && this.mBackInvokedDispatcher == null) {
                if (this.mBackInvokedCallback == null) {
                    this.mBackInvokedCallback = Api33Impl.newOnBackInvokedCallback(new u(this, 0));
                }
    ...
    public Toolbar(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2) {
        ...
        this.mMenuHostHelper = new MenuHostHelper(new t(this, 0));
