...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    private Drawable getActivityIcon(ComponentName componentName) {
        ...
        try {
            ...
            StringBuilder sbG = androidx.appcompat.view.menu.a.g("Invalid icon resource ", iconResource, " for ");
            sbG.append(componentName.flattenToShortString());
            Log.w(LOG_TAG, sbG.toString());
            return null;
    ...
    public void changeCursor(Cursor cursor) {
        ...
        try {
            super/*androidx.cursoradapter.widget.CursorAdapter*/.changeCursor(cursor);
            if (cursor != null) {
    ...
    public Drawable getDrawableFromResourceUri(Uri uri) throws FileNotFoundException {
        ...
        if (TextUtils.isEmpty(authority)) {
            throw new FileNotFoundException(s.e("No authority: ", uri));
        }
        try {
            ...
            if (pathSegments == null) {
                throw new FileNotFoundException(s.e("No path: ", uri));
            }
            ...
            if (size == 1) {
                try {
                    ...
                    throw new FileNotFoundException(s.e("Single path segment is not a resource ID: ", uri));
                }
            } else {
                if (size != 2) {
                    throw new FileNotFoundException(s.e("More than two path segments: ", uri));
                }
            ...
            throw new FileNotFoundException(s.e("No resource found for: ", uri));
        } catch (PackageManager.NameNotFoundException unused2) {
            throw new FileNotFoundException(s.e("No package found for authority: ", uri));
        }
    }

    public View getDropDownView(int i2, View view, ViewGroup viewGroup) {
        try {
            return super/*androidx.cursoradapter.widget.CursorAdapter*/.getDropDownView(i2, view, viewGroup);
    ...
    public View getView(int i2, View view, ViewGroup viewGroup) {
        try {
            return super/*androidx.cursoradapter.widget.CursorAdapter*/.getView(i2, view, viewGroup);
        } catch (RuntimeException e) {
            Log.w(LOG_TAG, "Search suggestions cursor threw exception.", e);
