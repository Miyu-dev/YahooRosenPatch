...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent, NestedScrollingParent2, NestedScrollingParent3 {
    ...
    */
    ...
    public void onMeasure(int i2, int i3) {
        ...
        boolean z = (ViewCompat.getWindowSystemUiVisibility(this) & Optimizer.OPTIMIZATION_CACHE_MEASURES) != 0;
        if (z) {
    ...
    public void onWindowSystemUiVisibilityChanged(int i2) {
        ...
        boolean z = (i2 & 4) == 0;
        boolean z2 = (i2 & Optimizer.OPTIMIZATION_CACHE_MEASURES) != 0;
        ...
        if ((i3 & Optimizer.OPTIMIZATION_CACHE_MEASURES) == 0 || this.mActionBarVisibilityCallback == null) {
            return;
        }
        ViewCompat.requestApplyInsets(this);
    }
