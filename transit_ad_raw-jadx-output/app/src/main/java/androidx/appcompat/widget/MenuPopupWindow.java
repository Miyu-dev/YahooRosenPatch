    ...
    public static class MenuDropDownListView extends DropDownListView {
        ...
        public boolean onHoverEvent(MotionEvent motionEvent) {
            ...
            if (this.mHoverListener != null) {
                ...
                SupportMenuItem item = (motionEvent.getAction() == 10 || (iPointToPosition = pointToPosition((int) motionEvent.getX(), (int) motionEvent.getY())) == -1 || (i2 = iPointToPosition - headersCount) < 0 || i2 >= menuAdapter.getCount()) ? null : menuAdapter.getItem(i2);
