...
class AlertController {
    ...
    private void setupContent(ViewGroup viewGroup) {
        NestedScrollView nestedScrollViewFindViewById = this.mWindow.findViewById(androidx.appcompat.R.id.scrollView);
        this.mScrollView = nestedScrollViewFindViewById;
        nestedScrollViewFindViewById.setFocusable(false);
    ...
    private void setupView() {
        ...
        if (!z) {
            ...
            if (nestedScrollView2 != null) {
                setScrollIndicators(viewGroupResolvePanel2, nestedScrollView2, z2 | (z3 ? 2 : 0), 3);
            }
        }
