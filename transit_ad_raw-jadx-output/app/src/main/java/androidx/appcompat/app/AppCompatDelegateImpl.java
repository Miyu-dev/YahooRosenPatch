...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    public class AppCompatWindowCallback extends WindowCallbackWrapper {
        ...
        public void onProvideKeyboardShortcuts(List<KeyboardShortcutGroup> list, Menu menu, int i2) {
            ...
            if (panelState == null || (supportMenu = panelState.menu) == null) {
                super.onProvideKeyboardShortcuts(list, menu, i2);
            } else {
                super.onProvideKeyboardShortcuts(list, supportMenu, i2);
            }
        }
    ...
    public final class PanelMenuPresenterCallback implements MenuPresenter.Callback {
        ...
        public void onCloseMenu(@NonNull MenuBuilder menuBuilder, boolean z) {
            ...
            PanelFeatureState panelFeatureStateFindMenuPanel = appCompatDelegateImpl.findMenuPanel(supportMenu);
    ...
    @NonNull
    private Configuration createOverrideAppConfiguration(@NonNull Context context, int i2, @Nullable LocaleListCompat localeListCompat, @Nullable Configuration configuration, boolean z) {
    ...
    */
    ...
    private void reopenMenu(boolean z) {
        ...
        SupportMenu supportMenu = panelState2.menu;
        if (supportMenu == null || panelState2.refreshMenuContent || !windowCallback.onPreparePanel(0, panelState2.createdPanelView, supportMenu)) {
            return;
        }
    ...
    private AppCompatActivity tryUnwrapContext() {
        for (Object baseContext = this.mContext; baseContext != null; baseContext = ((ContextWrapper) baseContext).getBaseContext()) {
    ...
    */
    ...
    private void updateResourcesConfiguration(int i2, @Nullable LocaleListCompat localeListCompat, boolean z, @Nullable Configuration configuration) {
