...
class TwilightCalculator {
    ...
    public void calculateTwilight(long j, double d, double d2) {
        ...
        double dSin = (Math.sin(r4 * 3.0f) * 5.236000106378924E-6d) + m.a(2.0f * r4, 3.4906598739326E-4d, m.a(d3, 0.03341960161924362d, d3)) + 1.796593063d + 3.141592653589793d;
        double dSin2 = (Math.sin(2.0d * dSin) * (-0.0069d)) + m.a(d3, 0.0053d, ((double) (Math.round(((double) (r3 - J0)) - r4) + J0)) + ((-d2) / 360.0d));
