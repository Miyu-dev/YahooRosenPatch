...
public abstract class AppCompatDelegate {
            ...
            if (BuildCompat.isAtLeastT()) {
                ...
                sSerialExecutorForLocalesStorage.execute(new Runnable() { // from class: androidx.appcompat.app.a
                    ...
                    public final void run() {
                        ...
                        switch (i3) {
                            case 0:
                                AppCompatDelegate.lambda$syncRequestedAndStoredLocales$1(context2);
                                break;
                            default:
                                ProfileInstallerInitializer.b(context2);
                                break;
                        }
                    }
                });
    ...
    public void asyncExecuteSyncRequestedAndStoredLocales(Context context) {
        sSerialExecutorForLocalesStorage.execute(new android.view.f(context, 1));
    }
