...
public class MenuBuilder implements SupportMenu {
    ...
    */
    ...
    /* JADX WARN: Type inference failed for: r9v1, types: [android.view.MenuItem, androidx.appcompat.view.menu.MenuItemImpl, java.lang.Object] */
    public MenuItem addInternal(int i2, int i3, int i4, CharSequence charSequence) {
        int ordering = getOrdering(i4);
        ?? CreateNewMenuItem = createNewMenuItem(i2, i3, i4, ordering, charSequence, this.mDefaultShowAsAction);
    ...
    /* JADX WARN: Type inference failed for: r2v2, types: [android.view.MenuItem, androidx.appcompat.view.menu.MenuItemImpl] */
    ...
    public MenuItem getItem(int i2) {
        return (MenuItem) this.mItems.get(i2);
    }
    ...
    public boolean performShortcut(int i2, KeyEvent keyEvent, int i3) {
        SupportMenuItem supportMenuItemFindItemWithShortcutForKey = findItemWithShortcutForKey(i2, keyEvent);
        boolean zPerformItemAction = supportMenuItemFindItemWithShortcutForKey != null ? performItemAction(supportMenuItemFindItemWithShortcutForKey, i3) : false;
        if ((i3 & 2) != 0) {
            close(true);
        }
