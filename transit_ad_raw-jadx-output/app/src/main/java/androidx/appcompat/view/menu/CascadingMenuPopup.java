...
final class CascadingMenuPopup extends MenuPopup implements View.OnKeyListener, PopupWindow.OnDismissListener {
    ...
    private int getNextMenuPosition(int i2) {
        ListView listView = ((CascadingMenuInfo) a.d(this.mShowingMenus, 1)).getListView();
        int[] iArr = new int[2];
    ...
    private void showMenu(@NonNull MenuBuilder menuBuilder) {
        ...
        if (this.mShowingMenus.size() > 0) {
            cascadingMenuInfo = (CascadingMenuInfo) a.d(this.mShowingMenus, 1);
        ...
        if (viewFindParentViewForSubmenu != null) {
            ...
            if ((this.mDropDownGravity & 5) != 5) {
                width = z ? i2 + viewFindParentViewForSubmenu.getWidth() : i2 - iMeasureIndividualMenuWidth;
