...
public abstract class CustomTabsService extends Service {
    ...
    public class AnonymousClass1 extends b.a {
            ...
            try {
                IBinder.DeathRecipient deathRecipient = new IBinder.DeathRecipient() { // from class: androidx.browser.customtabs.a
                    ...
                    public final void binderDied() {
                        this.f125a.lambda$newSessionInternal$0(customTabsSessionToken);
                    }
                };
        ...
        @Override // android.support.customtabs.b
        public boolean receiveFile(@NonNull android.support.customtabs.a aVar, @NonNull Uri uri, int i2, @Nullable Bundle bundle) {
            return CustomTabsService.this.receiveFile(new CustomTabsSessionToken(aVar, getSessionIdFromBundle(bundle)), uri, i2, bundle);
        }
        ...
        @Override // android.support.customtabs.b
        public boolean validateRelationship(@NonNull android.support.customtabs.a aVar, int i2, @NonNull Uri uri, @Nullable Bundle bundle) {
            return CustomTabsService.this.validateRelationship(new CustomTabsSessionToken(aVar, getSessionIdFromBundle(bundle)), i2, uri, bundle);
        }
