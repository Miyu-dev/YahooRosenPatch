...
public final class BrowserServiceFileProvider extends FileProvider {
    ...
    private static Uri generateUri(Context context, String str) {
        return new Uri.Builder().scheme(CONTENT_SCHEME).authority(context.getPackageName() + AUTHORITY_SUFFIX).path(android.support.v4.media.a.e(FILE_SUB_DIR_NAME, str, FILE_EXTENSION)).build();
    }
    ...
    @NonNull
    public static l<Bitmap> loadBitmap(@NonNull final ContentResolver contentResolver, @NonNull final Uri uri) {
    ...
    public static ResolvableFuture<Uri> saveBitmap(@NonNull Context context, @NonNull Bitmap bitmap, @NonNull String str, int i2) {
        StringBuilder sbG = a.g(str, "_");
        sbG.append(Integer.toString(i2));
