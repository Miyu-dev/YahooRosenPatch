...
public final class TrustedWebActivityServiceConnection {
    ...
    public static void ensureBundleContains(Bundle bundle, String str) {
        if (!bundle.containsKey(str)) {
            throw new IllegalArgumentException(h.f("Bundle must contain ", str));
        }
    }
    ...
    private static android.support.customtabs.trusted.a wrapCallback(@Nullable final TrustedWebActivityCallback trustedWebActivityCallback) {
        ...
        return new a.AbstractBinderC0004a() { // from class: androidx.browser.trusted.TrustedWebActivityServiceConnection.1
    ...
    public void cancel(@NonNull String str, int i2) {
    ...
    public boolean notify(@NonNull String str, int i2, @NonNull Notification notification, @NonNull String str2) {
