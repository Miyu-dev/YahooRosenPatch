...
public abstract class AbstractResolvableFuture<V> implements l<V> {
    ...
    public static final class SetFuture<V> implements Runnable {
        final l<? extends V> future;
        final AbstractResolvableFuture<V> owner;

        public SetFuture(AbstractResolvableFuture<V> abstractResolvableFuture, l<? extends V> lVar) {
    ...
    public final boolean cancel(boolean z) {
        ...
        while (true) {
            if (ATOMIC_HELPER.casValue(abstractResolvableFuture, obj, cancellation)) {
                ...
                l<? extends V> lVar = ((SetFuture) obj).future;
                if (!(lVar instanceof AbstractResolvableFuture)) {
                    lVar.cancel(z);
                    return true;
                }
    ...
    public final V get(long j, TimeUnit timeUnit) throws InterruptedException, TimeoutException {
        ...
        if (nanos + 1000 < 0) {
            ...
            string3 = s.f(strF, "delay)");
        }
        if (isDone()) {
            throw new TimeoutException(s.f(string3, " but future completed as timeout expired"));
        }
        throw new TimeoutException(v.g(string3, " for ", string));
    }
    ...
    public String pendingToString() {
        Object obj = this.value;
        if (obj instanceof SetFuture) {
            return androidx.appcompat.view.menu.a.f(new StringBuilder("setFuture=["), userObjectToString(((SetFuture) obj).future), "]");
        }
